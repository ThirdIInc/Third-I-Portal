...
<%
 ...
 HashMap groupMap = (HashMap) request.getAttribute("groupMap");
	String menuType = "Payroll Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("PC")) {
			menuType = "Payroll Configuration";
		} else if (menuType.equals("PP")) {
			menuType = "Payroll Process";
