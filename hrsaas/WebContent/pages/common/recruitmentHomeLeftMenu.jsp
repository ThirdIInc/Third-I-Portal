		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<div align="center"><a href="javascript:void(0)"><img
					...
					title="Configurations" onclick="return callAction('RC');" /></a></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('RC');" class="servicelink"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('RP');" class="servicelink"
			...
			<tr>
				...
				<td nowrap="nowrap"><a onclick="return callAction('RR');"
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/RecruitmentHome_getRecruitmentMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
