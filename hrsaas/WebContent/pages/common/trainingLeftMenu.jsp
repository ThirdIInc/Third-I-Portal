		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('TC');" class="servicelink"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('TA');" class="servicelink"
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/TrainingHome_getTrainingMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
