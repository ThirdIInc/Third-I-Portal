  ...
  function retrieveURL(url,nameOfFormToPost) {
    ...
    if (window.XMLHttpRequest) { // Non-IE browsers
      ...
      if (req) {
        ...
        req.send();
          alert('Task has been Added to Planner  Successfully ');   
      }
    }     
...
/*
 ...
 function getFormAsString(formName) {
 	...
 	for ( var i=formElements.length-1; i>=0; --i ){
 		...
 		if( formElements[i].name=='plannerBean.hiddentask' || formElements[i].name=='plannerBean.newtask' || formElements[i].name=='plannerBean.newtaskDate'
 		    || formElements[i].name=='plannerBean.taskStartTime' || formElements[i].name=='plannerBean.taskEndTime')
 		{ 		
