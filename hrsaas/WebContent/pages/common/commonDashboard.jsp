...
String  dashletmenuCode ="";
 	try{
 		...
 		dashletmenuCode= (String) request.getAttribute("dashletmenuCode");
	...
	if(dashletSet != null && dashletSet.length > 0) {
			...
			if(dashletmenuCode!=null &&dashletmenuCode.equals("35"))
			{
				...
				configObj=configObj1;
				  ...
				  totRows =Integer.parseInt(String.valueOf(dashletSet[0][1]));
				  totCols =Integer.parseInt(String.valueOf(dashletSet[0][2]));
				  widths =String.valueOf(dashletSet[0][3]);
				  totdashs =Integer.parseInt(String.valueOf(dashletSet[0][4]));
			}
...
<table width="100%" border="0" cellspacing="5px" cellpadding="0" align="center">
	<%
				int counter = 0;
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="98%" border="0" align="center" cellpadding="0"
					cellspacing="0">
					<tr>
						<td width="17px"><img src="../pages/mypage/images/icons/<%=configObj[counter][7]%>"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="33%">
								<div align="right"><a href="javascript:void(0);" class="link"><img
									src="../pages/common/css/default/images/update1.gif" width="16"
