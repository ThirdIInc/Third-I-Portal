		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<div align="center"><img
					...
					title="Configurations" onclick="return callAction('LAC');"/></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('LAC');" class="servicelink"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('LAP');" class="servicelink"
					title="Processes">Processes</a><br />
				<span class="smalltext">Process Leaves, Daily Attendance, Regularizations & Month End Attendance</span></td> 
			</tr>
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/LeaveHome_getLeaveAttendanceMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
