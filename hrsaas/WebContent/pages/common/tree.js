...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' NAME='insertChk' onChange=\"javascript:hasParentNode('"+nodeValues[0]+"','insert');\" onClick=\"javascript:checkNode('"+nodeValues[0]+"','insert');\" id=\"insert"+nodeValues[0]+"\" value ='"+nodeValues[0]+"' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' onChange=\"javascript:hasParentNode('"+nodeValues[0]+"','update');\"  onClick=\"javascript:checkNode('"+nodeValues[0]+"','update');\" id=\"update"+nodeValues[0]+"\" NAME='updateChk' value ='"+nodeValues[0]+"' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' onChange=\"javascript:hasParentNode('"+nodeValues[0]+"','delete');\"  onClick=\"javascript:checkNode('"+nodeValues[0]+"','delete');\" id=\"delete"+nodeValues[0]+"\" NAME='deleteChk' value ='"+nodeValues[0]+"' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' onChange=\"javascript:hasParentNode('"+nodeValues[0]+"','view');\" onClick=\"javascript:checkNode('"+nodeValues[0]+"','view');\" id=\"view"+nodeValues[0]+"\" NAME='viewChk' value ='"+nodeValues[0]+"' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' onChange=\"javascript:hasParentNode('"+nodeValues[0]+"','general');\"  onClick=\"javascript:checkNode('"+nodeValues[0]+"','general');\" id=\"general"+nodeValues[0]+"\" NAME='generalChk' value ='"+nodeValues[0]+"' ></div>");
