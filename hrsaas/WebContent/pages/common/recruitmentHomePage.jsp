...
<%
	...
	String menuType = "Recruitment Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("RC")) {
			menuType = "Recruitment Configuration";
		} else if (menuType.equals("RP")) {
			menuType = "Recruitment Process";
		} else if (menuType.equals("RR")) {
			menuType = "Recruitment Reports";
		} else if (menuType.equals("RD")) {
			menuType = "Recruitment Dashboard";
		}
	} catch (Exception e) {
		menuType = "Recruitment Home";
	}
%>
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> Recruitment >> <%=menuType%> </strong></td>
