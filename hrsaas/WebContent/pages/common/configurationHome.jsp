...
HashMap groupMap = (HashMap) request.getAttribute("groupMap");
	String menuType = "Configuration Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("CC")) {
			menuType = "Configuration";
		} else if (menuType.equals("CP")) {
			menuType = "Configuration Process";
		} else if (menuType.equals("CR")) {
			menuType = "Configuration Reports";
		} else if (menuType.equals("CD")) {
			menuType = "Configuration Dashboard";
		}
	} catch (Exception e) {
		menuType = "Configuration Home";
	}
%>
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> Configuration >> <%=menuType%> </strong></td>
