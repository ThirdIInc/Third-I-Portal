		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<div align="center"><img
					src="../pages/mypage/images/icons/settings.png" /></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('AC');" class="servicelink"
			...
			<tr>
				<td width="12%">
				<div align="center"><img
					src="../pages/mypage/images/icons/process-32.png" /></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('AP');" class="servicelink"
					title="Processes">Processes</a><br />
				<span class="smalltext">Process Asset , Helpdesk Requests, Travel & Conference Bookings, Cash Vouchers and other Administration activities.</span></td> 
			</tr>
			...
			<tr>
				<td>
				<div align="center"><img
					src="../pages/mypage/images/icons/settings_events.png" height="32" width="32" /></div>
				</td>
				<td nowrap="nowrap"><a
					onclick="return callAction('AR');"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callMyPageAction('myservices');" class="servicelink"
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/AdminHome_getAdminMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
