...
function initDragableBoxes()
{
		...
		dashletURLs= new Array('<%=request.getContextPath()%>/common/HrmHome_getmanPower.action',
		'<%=request.getContextPath()%>/common/HrmHome_getSugg.action'
		
		);
		
		dashletWidths= new Array("99");
		dashletHeights= new Array("200","200");
		columnNos= new Array("1","1");
		dashHeaders= new Array("Manpower Status",
...
function viewSettlementDue(){
var path='<%=request.getContextPath()%>';
window.open(path+'/common/HrmHome_showSettlementDue.action','','width=700,height=300,scrollbars=yes,resizable=yes,top=50,left=100');
