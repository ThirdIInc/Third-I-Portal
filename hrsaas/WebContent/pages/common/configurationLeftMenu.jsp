		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('CC');" class="servicelink"
			...
			<!--<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('CP');" class="servicelink"
					title="Processes">Processes</a><br />
				<span class="smalltext">Process Salary, Tax, and other payroll activities</span></td> 
			</tr>
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/ConfigurationHome_getConfigureMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
