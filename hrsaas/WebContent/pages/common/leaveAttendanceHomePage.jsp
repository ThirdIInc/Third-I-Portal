...
<%
  Object serviceMenuObj[][] = (Object[][]) request.getAttribute("serviceMenulst");
  HashMap groupMap = (HashMap) request.getAttribute("groupMap");
	String menuType = "Leave/Attendance Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("LAC")) {
			menuType = "Leave/Attendance Configuration";
		} else if (menuType.equals("LAP")) {
			menuType = "Leave/Attendance Process";
		} else if (menuType.equals("LAR")) {
			menuType = "Leave/Attendance Reports";
		} else if (menuType.equals("LAD")) {
			menuType = "Leave/Attendance Dashboard";
		}
	} catch (Exception e) {
		menuType = "Leave/Attendance Home";
	}
%>
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> Leave/Attendance >> <%=menuType%> </strong></td>
