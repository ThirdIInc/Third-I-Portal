		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('PC');" class="servicelink"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('PP');" class="servicelink"
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/PayrollHome_getPayrollMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
