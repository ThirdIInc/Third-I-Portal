...
<%
	...
	String menuType = "HRM Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("HC")) {
			menuType = "HRM Configuration";
		} else if (menuType.equals("HP")) {
			menuType = "HRM Process";
		} else if (menuType.equals("HR")) {
			menuType = "HRM Reports";
		} else if (menuType.equals("HD")) {
			menuType = "HRM Dashboard";
		}
	} catch (Exception e) {
		menuType = "HRM Home";
	}
