...
<s:form name="paraFrm" id="paraFrm">
	...
	<%
		...
		String[][] quickLinkObj = null;
		try {
			twoDimObjArr = (String[][]) request
			.getAttribute("twoDimObjArr");
			quickLinkObj = (String[][]) request
			.getAttribute("quickLinkObj");
		} catch (Exception e) {
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<table width="97%" border="0" cellpadding="0" cellspacing="0" style="border: 1px;" >
										<tr>
											<td>
											...
											<table border="0" width="100%" height="100%">
												<tr>
													...
													<table>
														...
														%>
														<tr>
															<td><a href="javascript:d.openAll();">open all</a> |
															<a href="javascript:d.closeAll();">close all</a></td>
														</tr>
														<%
														}
														%>
