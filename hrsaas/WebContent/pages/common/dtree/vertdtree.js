...
function dTree(objName) {
	...
	this.icon = {
		root			: '../pages/common/img/base.gif',
		folder			: '../pages/common/img/line.gif',
		folderOpen		: '../pages/common/img/line.gif',
		node			: '../pages/common/img/line.gif',
		empty			: '../pages/common/img/empty.gif',
		line			: '../pages/common/img/line.gif',
		join			: '../pages/common/img/join.gif',
		joinBottom		: '../pages/common/img/joinbottom.gif',
		plus			: '../pages/common/img/plus.gif',
		plusBottom		: '../pages/common/img/plusbottom.gif',
		minus			: '../pages/common/img/minus.gif',
		minusBottom		: '../pages/common/img/minusbottom.gif',
		nlPlus			: '../pages/common/img/nolines_plus.gif',
		nlMinus			: '../pages/common/img/nolines_minus.gif',
		
		middleLine		: '../pages/common/img/myline2.gif',
		
		leftLine		: '../pages/common/img/myline2.gif',
		
		smallLine		: '../pages/common/img/smallLine.gif',
		
		rightLine		: '../pages/common/img/myline2.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		str += '<br><img id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt="" />';
	...
	var newName='';
	newName='<div style="border:1px;"><table  cellpadding=0 cellspacing=0 width=120 ><tr><td align="center" ';
	if(nodeId==1){
	newName+='>'+node.name+'</td></tr></table></div>';
	}
	else{
	newName+='>'+node.name+'</td></tr></table></div>';
	}
