...
<s:form id="form" name="Login" theme="simple" method="post">
 ...
 %>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left"
		...
		<table class="formbg" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><strong class="text_head"><img align="absmiddle"
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
				<tr>
					<td width="78%" align="left"><s:submit cssClass="token"
						action="Login_saveImage" theme="simple" value="Save"
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="80%" colspan="2" align="left"><s:textfield name="userText" maxlength="30"/><input type="text" name="login" style="visibility: hidden ;" /></td>
				</tr>
				<tr>
...
try
{
 document.getElementById('form_userText').focus();
