...
extArray = new Array(".gif", ".jpg", ".png",".jpeg" , ".bmp");     // , ".pdf",".xls",".csv",".ppt",".doc",  ".txt",".rtf");
function uploadFile(){
...
var field='<%=field%>';
		...
		document.getElementById('paraFrm').action="<%=request.getContextPath()%>/common/FileUpload_changePicture.action?path="+pathAlter+"&field="+field+"&userImage="+userImage;
