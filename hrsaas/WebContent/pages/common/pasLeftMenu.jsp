<!-- Author: Prajakta B     Date:24 May 2013 -->
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<div align="center"><a href="javascript:void(0)"><img
					...
					title="Configurations" onclick="return callAction('PAC');" /></a></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('PAC');" class="servicelink"
			...
			<tr>
				<td width="12%">
				<div align="center"><a href="javascript:void(0)"><img
					src="../pages/mypage/images/icons/process-32.png" class="iconImage" /></a></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('PAP');" class="servicelink"
					title="Processes">Processes</a><br />
				<span class="smalltext">Process promotion, increment,
				probation, settlement etc.</span></td> 
			</tr>
			...
			<tr>
				...
				<div align="center"><a href="javascript:void(0)"><img
					...
					width="32" class="iconImage"/></a></div>
				</td>
				<td nowrap="nowrap"><a onclick="return callAction('PAR');"
...
{   
	...
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/PerformanceHome_getPasMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
