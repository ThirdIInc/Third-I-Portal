...
<%
	...
	String menuType = "Performance Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("PAC")) {
			menuType = "Performance Configuration";
		} else if (menuType.equals("PAP")) {
			menuType = "Performance Process";
		} else if (menuType.equals("PAR")) {
			menuType = "Performance Reports";
		} else if (menuType.equals("PAD")) {
			menuType = "Performance Dashboard";
		}
	} catch (Exception e) {
		menuType = "Performance Home";
	}
%>
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> Performance Appraisal>> <%=menuType%> </strong></td>
