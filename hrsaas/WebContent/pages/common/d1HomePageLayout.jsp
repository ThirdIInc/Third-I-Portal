...
<%
	...
	String menuType = "D1 Home";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("D1C")) {
			menuType = "DecisionOne Configuration";
		} else if (menuType.equals("D1A")) {
			menuType = "DecisionOne Application";
		} else if (menuType.equals("D1R")) {
			menuType = "DecisionOne Reports";
		} else if (menuType.equals("D1D")) {
			menuType = "DecisionOne Dashboard";
		}
	} catch (Exception e) {
		menuType = "D1 Home";
	}
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> DecisionOne >> <%=menuType%> </strong></td>
