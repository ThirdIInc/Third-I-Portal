		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
				...
				<div align="center"><a href="javascript:void(0)"><img
					...
					title="Configurations" onclick="return callAction('HC');" /></a></div>
				</td>
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('HC');" class="servicelink"
			...
			<tr>
				...
				<td width="88%"><a href="javascript:void(0)"
					onclick="return callAction('HP');" class="servicelink"
			...
			<tr>
				...
				<td nowrap="nowrap"><a onclick="return callAction('HR');"
...
//alert(id);
	try{
		document.getElementById('paraFrm').target = "_self";
	 	document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/common/HrmHome_getHrmMenu.action?menuType='+id+'&mymessage_random='+Math.random();
		document.getElementById('paraFrm').submit();
		return true;
	}
	catch(e)
