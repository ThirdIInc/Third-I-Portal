...
<%
 ...
 HashMap groupMap = (HashMap) request.getAttribute("groupMap");
	String menuType = "Training and Development";
	try {
		menuType = request.getParameter("menuType");
		if (menuType.equals("TC")) {
			menuType = "Training and Development Home";
		} else if (menuType.equals("TA")) {
			menuType = "Training and Development Application";
		} else if (menuType.equals("PR")) {
			menuType = "Payroll Reports";
		} else if (menuType.equals("PD")) {
			menuType = "Payroll Dashboard";
		}
	} catch (Exception e) {
		menuType = "Training and Development Home";
	}
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					>> Training and Development >> <%=menuType%> </strong></td>
