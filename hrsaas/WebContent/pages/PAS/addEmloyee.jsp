...
<table width="100%" border="0" align="right" cellpadding="2" cellspacing="2" class="formbg">
	...
	<jsp:include page="/pages/ApplicationStudio/navigationPanel.jsp" />
	        ...
	        <tr>
	        	<td colspan="3">
	        		<table width="100%" class="formbg" >
	        			...
	        			<tr>
							...
							<td width="25%">
								<label  class = "set" name="branch"  id="branch" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label><font color="red"></font>  :
							</td>
				...
				<tr>
					<td width="25%">
								<label  class = "set" name="department"  id="department" ondblclick="callShowDiv(this);"><%=label.get("department")%></label><font color="red"></font> :
						</td>
...
function resetValues(){
	document.getElementById("paraFrm").action="AppraiserConfig_resetEmployee.action";
...
function viewEmployeeList(){
	...
	document.getElementById("paraFrm").action="AppraiserConfig_viewEmployeeList.action";
	document.getElementById("paraFrm").submit();
}
function backFun(){
	...
	function callAddAppraisee(){
		...
		var conf=confirm("Do you really want to add these Appraisee ?");
  			if(conf) {
					...
					document.getElementById("paraFrm").action="AppraiserConfig_addMultipleAppraisee.action";
					document.getElementById("paraFrm").submit();
  			}else{
  				return false;
  			}
