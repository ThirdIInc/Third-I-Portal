...
<s:form action="AppraisalConfigReport" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='AppraisalConfigReport_genReport.action'/>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Appraisal Configuration Report
					  </strong></td>
				</tr>
			</table>
			</td>
				...
				<tr>
					...
					<td colspan="1" width="85%"><s:textfield size="40" readonly="true"
						...
						<img src="../pages/images/recruitment/search2.gif" width="16"
								...
								onclick="javascript:callsF9(500,325,'AppraisalConfigReport_f9AppraisalCode.action');" />
						</td>
				</tr>
				<tr>
					<td colspan="1" width="15%"><label name="temp.code"
						...
						color="red">*</font> :</td>
					<td colspan="1" width="85%"><s:textfield size="40" readonly="true"
						name="tempName" /> <s:hidden name="tempCode" />
						<img src="../pages/images/recruitment/search2.gif" width="16"
								class="iconImage" height="15"
...
function validateTemplate()
{
	...
	callsF9(500,325,'AppraisalConfigReport_f9TemplateCode.action');
}
...
function validateGroup()
{
	...
	callsF9(500,325,'AppraisalConfigReport_f9Group.action');
}
...
function validateReport()
{
	...
	callReport("AppraisalConfigReport_previewReport.action");
	resetScreen();
	return true;
}
...
if(document.getElementById('paraFrm_apprCode').value=="")
	...
	if(document.getElementById('paraFrm_tempCode').value=="")
	{
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='AppraisalConfigReport_mailReport.action';
