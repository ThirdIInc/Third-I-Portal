      ...
      <td colspan="3"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="formbg">
          <tr>
            ...
            <tr>
			  ...
			  <td width="25%" colspan="1" height="20" nowrap="nowrap"><s:select name="moveGroupName" headerKey=""
				headerValue="--Select--" list="%{hashmapGroup}" cssStyle="width:153" /></td>
			  <td width="25%" colspan="1" height="20" nowrap="nowrap"><input type="button" value=" Move" class="token" onclick="return callMove();"/></td>
			  <td width="25%" colspan="1" height="20" nowrap="nowrap" ></td><s:hidden name="apprId"/><s:hidden name="moveEmpId"/>
            </tr>
...
<script>
		function callMove(){
			...
			opener.document.getElementById('paraFrm').action="AppraiserConfig_moveToGroup.action?empId="+empId+"&moveGroupName="+moveGroupName;
