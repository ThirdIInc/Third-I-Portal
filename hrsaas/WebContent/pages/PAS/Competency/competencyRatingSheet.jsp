...
<s:form action="CompetencyRatingSheet" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='CompetencyRatingSheet_genReport.action'/>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">Competency Rating Sheet</strong></td>
            ...
            <td><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							...
							<td colspan="1" width="30%"><s:hidden name="compId"/><s:hidden name="compfromDate"/><s:hidden name="compToDate"/><s:textfield
								...
								onclick="javascript:callsF9(500,325,'CompetencyRatingSheet_f9CompAction.action');">
						...
						<td colspan="1" width="20%"><label class="set" id="desgName"
							...
							<td colspan="1" width="30%"><s:hidden name="desgId"/><s:textfield
								name="desgName" theme="simple" readonly="true"
								maxlength="50" size="25" /> <img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'CompetencyRatingSheet_f9Desg.action');">
						...
						<tr>
							...
							<td colspan="3" width="80%"><s:hidden name="divisionId" /> <s:textfield
								...
								<img src="../pages/images/recruitment/search2.gif"
									...
									onclick="javascript:callsF9(500,325,'CompetencyRatingSheet_f9Division.action');">
...
var fields=["paraFrm_compName"];
	...
	if(!validateBlank(fields,labels,flags)){
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='CompetencyRatingSheet_mailReport.action';
