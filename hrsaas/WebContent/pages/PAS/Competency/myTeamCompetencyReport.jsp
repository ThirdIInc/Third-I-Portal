...
<s:form action="MyTeamCompReport" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='MyTeamCompReport_genReport.action'/>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">My Team Competency Rating  Report</strong></td>
            ...
            <td><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							<td colspan="1" width="20%"><label class="set" id="goal"
								name="goal" ondblclick="callShowDiv(this);"><%=label.get("comp")%></label> : <font
								color="red">*</font></td>
							<td colspan="1" width="30%"><s:hidden name="compId"/><s:hidden name="compFromDate"/><s:hidden name="compToDate"/><s:textfield
								...
								onclick="javascript:callsF9(500,325,'MyTeamCompReport_f9CompAction.action');">
						...
						--><!--  <tr>
							...
							:</td>
							<td><s:select	name="goalStatus" headerKey="" theme="simple"  headerValue="Select" cssStyle="width:110"
											list="#{'1':'Draft','2':'Pending','3':'Approved'}" />
							</td>
						...
						<tr>
							...
							<td colspan="3" width="80%"><s:hidden name="empId" /> <s:textfield
								...
								<img src="../pages/images/recruitment/search2.gif"
									...
									onclick="javascript:callsF9(500,325,'MyTeamCompReport_f9employee.action');">
...
var fields=["paraFrm_compName"];
	...
	/*if(!validateBlank(fields,labels,flags)){
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='MyTeamCompReport_mailReport.action';
