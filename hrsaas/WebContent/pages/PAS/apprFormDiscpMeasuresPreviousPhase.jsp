  ...
  <tr>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">Previous Phase Disciplinary Action Details</strong></td>
     ...
     <tr>
            <td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
	            ...
	            <td class="formth" width="2%">
	            <label  class = "set" name="discip.phase"  id="discip.phase" ondblclick="callShowDiv(this);"><%=label.get("discip.phase")%></label>
	            </td>	            
				...
				<%	for(int i=0;i<data.length;i++){	%> 
						<tr>
						 ...
						 <td class="td_bottom_border"><%=data[i][6] %></td>
						 <td class="td_bottom_border"><%=data[i][0] %></td>
						 <td class="td_bottom_border"><%=data[i][1] %></td>
						 <td class="td_bottom_border" align="center"><%=data[i][2] %></td>
						 <td class="td_bottom_border"><%=data[i][3] %></td>
						</tr>
				<%}}else{%>
