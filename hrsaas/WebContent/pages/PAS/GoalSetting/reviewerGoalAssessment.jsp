...
<s:form action="ReviewerGoalAssessment" validate="true" id="paraFrm"
	theme="simple">
		...
		<tr>
			...
			<table width="100%">
				<tr>
					...
					Reviewer Goal Assessment</a> | <a href="#" onclick="setAction('P2')">Processed
					Reviewer Goal Assessment</a></td>
					<script type="text/javascript">
							function setAction(listType)
							{
								...
								if(listType == "P2") {
									document.getElementById('paraFrm').action = 'ReviewerGoalAssessment_getProcessedList.action';
									document.getElementById('paraFrm').submit();
								}
	...
	<s:if test="%{listType=='pending'}">
		 <tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr>
					<td colspan="4">
						Pending for Reviewer Assessment
					</td>
				</tr>
				<tr>
						...
						<s:if test="noData">
							...
							<s:iterator value="dataList">
								...
								<tr>
									...
									'<s:property value="empId"/>','<s:property value="goalAssessmentId"/>','<s:property value="scheduledAssessmentDateList" />','<s:property value="confgoalId"/>')" >Process</a>
	...
	<s:if test="%{listType=='processed'}">
		 <tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr>
					<td colspan="1">
						Processed Reviewer Assessment List
					</td>
					...
					<% int totalPage1 = 0; int pageNo1 = 0; %>
						...
						<td id="ctrlShow" width="30%" align="right" class="">
							...
							%>
							<a href="#" onclick="callPage('1', 'F', '<%=totalPage1%>', 'ReviewerGoalAssessment_getProcessedList.action');">
								<img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage"/>
							</a>&nbsp;
							<a href="#" onclick="callPage('P', 'P', '<%=totalPage1%>', 'ReviewerGoalAssessment_getProcessedList.action');" >
								<img title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10" class="iconImage"/>
							</a> 
							<input type="text" name="pageNoField" id="pageNoField" size="3" value="<%=pageNo1%>" maxlength="10"
							onkeypress="callPageText(event, '<%=totalPage1%>', 'ReviewerGoalAssessment_getProcessedList.action');return numbersOnly();" /> of <%=totalPage1%>
							<a href="#" onclick="callPage('N', 'N', '<%=totalPage1%>', 'ReviewerGoalAssessment_getProcessedList.action')" >
								<img title="Next Page" src="../pages/common/img/next.gif" class="iconImage" />
							</a>&nbsp;
							<a href="#" onclick="callPage('<%=totalPage1%>', 'L', '<%=totalPage1%>', 'ReviewerGoalAssessment_getProcessedList.action');" >
...
function callHidden(goalId,empCode,goalAsmtId,assessmentDate,confgoalId){
	...
	document.getElementById('paraFrm').action = "ReviewerGoalAssessment_retrieveGoalDetails.action?goalId="+goalId+"&empId="+empCode+"&asmtId="+goalAsmtId+"&confGoalId="+confgoalId;
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target = 'main';
}
