...
<s:form action="GoalRatingReport" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='GoalRatingReport_genReport.action'/>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">Goal  Rating Sheet</strong></td>
...
var fields=["paraFrm_goalName"];
	...
	if(!validateBlank(fields,labels,flags)){
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='GoalRatingReport_mailReport.action';
