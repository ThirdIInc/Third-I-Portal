...
<s:form action="EmpGoalReport" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='EmpGoalReport_genReport.action'/>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">Employee Goal Report</strong></td>
            ...
            <td><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							...
							<td colspan="1" width="30%"><s:hidden name="goalId"/><s:hidden name="goalFromDate"/><s:hidden name="goalToDate"/><s:textfield
								...
								onclick="javascript:callsF9(500,325,'EmpGoalReport_f9GoalAction.action');">
						...
						<!--<tr>
							...
							<td colspan="1" width="30%"><s:hidden name="divisionId"></s:hidden><s:textfield
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'EmpGoalReport_f9Division.action');">
							...
							<s:textfield name="branchName" theme="simple" readonly="true"
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'EmpGoalReport_f9Branch.action');">
						...
						--><!--<tr>
							...
							<td><s:hidden name="deptId" /> <s:textfield
								...
								onclick="javascript:callsF9(500,325,'EmpGoalReport_f9Dept.action');">
							</td>
							...
							<s:textfield name="desgName" theme="simple" readonly="true"
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'EmpGoalReport_f9Desg.action');">
      ...
      <td colspan="3"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="formbg">
          <tr>
            <td><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							<td colspan="1" width="30%"><label class="set" id="show.selfAssessment"
								name="show.selfAssessment" ondblclick="callShowDiv(this);"><%=label.get("show.selfAssessment")%></label> :</td>
							<td colspan="1" width="20%"><s:checkbox value="true" name="showSelfAssessment" /></td>


							<td colspan="1" width="30%"><label class="set" id="show.managerAssessment"
								name="show.managerAssessment" ondblclick="callShowDiv(this);"><%=label.get("show.managerAssessment")%></label> :</td>
							<td colspan="1" width="20%"><s:checkbox value="true" name="showManagerAssessment" /></td>
						</tr>
...
function callReport(type){
	...
	var fields=["paraFrm_goalName","paraFrm_empToken"];
	var labels=["goal","employee"];
	var flags=["select","select"];
	if(!validateBlank(fields,labels,flags)){
		return false;
	}
	if(document.getElementById('paraFrm_showSelfAssessment').checked==false && document.getElementById('paraFrm_showManagerAssessment').checked==false){
...
var fields=["paraFrm_goalName","paraFrm_empToken"];
	...
	return false;
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='EmpGoalReport_mailReport.action';
