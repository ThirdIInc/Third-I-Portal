...
<s:form action="MyTeamGoalReport" validate="true" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction" value='MyTeamGoalReport_genReport.action'/>
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">My Team Goal Report</strong></td>
            ...
            <td><table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
						...
						<tr>
							...
							<td colspan="1" width="30%"><s:hidden name="goalId"/><s:hidden name="goalFromDate"/><s:hidden name="goalToDate"/><s:textfield
								...
								onclick="javascript:callsF9(500,325,'MyTeamGoalReport_f9GoalAction.action');">
						...
						--><tr>
							...
							:</td>
							<td><s:select	name="goalStatus" headerKey="" theme="simple" cssStyle="width:110"
											list="#{'0':'Select --','1':'Draft','2':'Pending','3':'Approved','4':'Send Back'}" />
							</td>
						...
						<tr>
							...
							<td colspan="3" width="80%"><s:hidden name="empId" /> <s:textfield
								...
								<img src="../pages/images/recruitment/search2.gif"
									...
									onclick="javascript:callsF9(500,325,'MyTeamGoalReport_f9employee.action');">
...
var fields=["paraFrm_goalName"];
	...
	if(!validateBlank(fields,labels,flags)){
		...
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='MyTeamGoalReport_mailReport.action';
...
function callReset(){
	...
	document.getElementById('paraFrm_goalStatus').value="0";
}
