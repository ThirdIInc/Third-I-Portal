...
<s:form action="LoanMisReport" method="post" id="paraFrm">
	<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          ...
          <td width="93%" class="txt"><strong class="text_head">Loan MIS Report   </strong></td>
          	...
          	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	...
                	<!-- class="search"  --> 
						...
						<s:submit cssClass="reset" action="LoanMisReport_reset" theme="simple" value="    Reset  " />
					</td>
								...
								<td width="82%" colspan="3" nowrap="nowrap"><s:textfield name="employeeToken" size="10" theme="simple" readonly="true" />
									<s:textfield name="employeeName" size="50" theme="simple" readonly="true" /> 
										<img src="../pages/images/recruitment/search2.gif" height="18" align="absmiddle" width="18" 
											onclick="javascript:callsF9(500,325,'LoanMisReport_f9actionEmployeeName.action');">
								</td>
						 	</tr>
...
<script type="text/javascript">
	...
	function validateForm(){
		...
		callReport('LoanMisReport_report.action')
	}
