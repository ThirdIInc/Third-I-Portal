			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="23%" colspan="1"><img
						...
						onclick="javascript:callsF9(500,325,'NewLoanIssuedRpt_f9divaction.action');"></td>
					...
					<td width="23%" colspan="1"><img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'NewLoanIssuedRpt_f9department.action');"></td>
				...
				<tr>
					...
					<td width="23%" colspan="1"><img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'NewLoanIssuedRpt_f9branch.action');"></td>
					...
					<td width="23%" colspan="1"><img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'NewLoanIssuedRpt_f9designation.action');"></td>
				...
				<tr>
					...
					<td width="23%" colspan="1"><img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'NewLoanIssuedRpt_f9employee.action');"></td>
						<td width="20%" colspan="1"><label class="set" name="loan.type"
						id="loan.type1" ondblclick="callShowDiv(this);"><%=label.get("loan.type")%></label>:</td>
					<td width="20%" colspan="1">
					
					 	<s:select name="loanType" headerKey="1" list="lstLoanType"
						  headerValue="--All--"  cssStyle="width:150"	/>
					</td>
					<td width="23%" colspan="1"></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.loanAmountFlag" onclick="AddItem('loan.amount',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="loan.type" id="loan.type" ondblclick="callShowDiv(this);"><%=label.get("loan.type")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.loanTypeFlag" onclick="AddItem('loan.type',this);" /></td>
						</tr>
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.loanPaymentDateFlag" onclick="AddItem('loan.paymentDt',this);" /></td>

							<td width="20%" align="right" colspan="1"><label class="set"
								name="loan.monthInstall" id="loan.monthInstall"
								ondblclick="callShowDiv(this);"><%=label.get("loan.monthInstall")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.loanInstallmentFlag"
								onclick="AddItem('loan.monthInstall',this);" /></td>
							<td align="right" colspan="1"><label class="set"
								name="noOfInstall" id="noOfInstall"
								ondblclick="callShowDiv(this);"><%=label.get("noOfInstall")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.noOfInstallFlag" onclick="AddItem('noOfInstall',this);" /></td>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					...
					<td width="47" colspan="1" height="22"><s:textfield
						name="misreport.loanFromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_misreport_loanFromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_misreport_loanFromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="90" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_misreport_loanFromDate','DDMMYYYY');">
					...
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel" height="22"><s:textfield
								name="misreport.loanToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_misreport_loanToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_misreport_loanToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker"><s:a
								href="javascript:NewCal('paraFrm_misreport_loanToDate','DDMMYYYY');">
								<img class="iconImage"
...
<script>
	...
	function search()
	{
		callsF9(500,325,'NewLoanIssuedRpt_searchSavedReport.action');	
	}
	...
	function generateReport()
	{
		try{
			...
			var frmDate = document.getElementById('paraFrm_misreport_loanFromDate').value;
			var toDate = document.getElementById('paraFrm_misreport_loanToDate').value;
			...
			if(document.getElementById("reportViewR").checked){
				...
				if(document.getElementById("paraFrm_loanDateSelect").value=="BN"){
		 		...
		 		if(frmDate!=""||frmDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_misreport_loanFromDate'];
				  	var lbl=['bean.date'];
	  			...
	  			if(toDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_misreport_loanToDate'];
			  		var lbl=['bean.date'];
		...
		if(document.getElementById("reportViewV").checked){
			...
			document.getElementById('paraFrm').action="NewLoanIssuedRpt_report.action";
			document.getElementById('paraFrm').submit();
...
function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="NewLoanIssuedRpt_saveReport.action";
		document.getElementById('paraFrm').submit();
