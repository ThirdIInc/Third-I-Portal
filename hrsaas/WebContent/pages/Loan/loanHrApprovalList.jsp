...
<s:form action="LoanApproval" id="paraFrm"
		...
		<tr>
			...
			<table class="" width="100%">
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='LoanApproval_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="r"){
		     
		      	document.getElementById('paraFrm').action='LoanApproval_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'LoanApproval_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'LoanApproval_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'LoanApproval_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'LoanApproval_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'LoanApproval_input.action');">
...
<s:hidden name="empCode" />
										...
										<s:hidden name="applicationStatus"/>
											<td  align="center"><input type="button"  id="ctrlShow"
															...
															onclick="editApplicationFunction('<s:property value="loanApplCode"/>')"></td>
						...
						%>
							<s:if test="approvedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'LoanApproval_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'LoanApproval_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'LoanApproval_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'LoanApproval_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'LoanApproval_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
									...
									<s:iterator value="approvedIteratorList">
										...
										<s:hidden name="applicationStatus"/>		
											<td width="78%" align="center"><input type="button"  id="ctrlShow"
														...
														onclick="viewApplicationFunction('<s:property value="loanApplCode"/>')"></td>
						...
						%>
							<s:if test="rejectedListLength"> 
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'LoanApproval_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'LoanApproval_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'LoanApproval_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'LoanApproval_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'LoanApproval_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="rejectedIteratorList">
										...
										onmouseout="javascript:oldRowColor(this);">
											...
											<s:hidden name="loanApplCode" />
											<td align="center" class="sortableTD"><%=count5++%></td>
	...
	function editApplicationFunction(ittloanApplCode){	
		///alert(ittloanApplCode);
		  document.getElementById('paraFrm').target = "_self";
	   	  document.getElementById('paraFrm').action="LoanApproval_editApplication.action?ittloanApplCode="+ittloanApplCode;
		  document.getElementById('paraFrm').submit();
	}
	function viewApplicationFunction(ittloanApplCode){
	///alert(ittloanApplCode);
		  document.getElementById('paraFrm').target = "_self";
	   	  document.getElementById('paraFrm').action="LoanApproval_viewApplication.action?ittloanApplCode="+ittloanApplCode;
		  document.getElementById('paraFrm').submit();
	}
//new added end
