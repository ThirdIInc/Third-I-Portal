...
<s:form action="PensionRegister" validate="true" id="paraFrm"
					...
					<table width="98%" border="0" align="center" cellpadding="2"
						...
						<tr>
							...
							<s:textfield name="penReg.divName" theme="simple" readonly="true"
								...
								onclick="javascript:callsF9(500,325,'PensionRegister_f9div.action');">
							</td>
							...
							<td colspan="1" width="30%"><s:hidden
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'PensionRegister_f9centeraction.action');">
							</td>
						</tr>
						<tr>
							...
							<td><s:hidden name="penReg.deptCode" /> <s:textfield
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'PensionRegister_f9deptaction.action');">
							</td>
							...
							<td><s:hidden name="penReg.desgCode" /> <s:textfield
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'PensionRegister_f9rankaction.action');">
							</td>
						</tr>
						<tr>
...
function callCheck(){
 ...
 {	 		
	...
	document.getElementById('paraFrm').action="PensionRegister_getReport.action";	
