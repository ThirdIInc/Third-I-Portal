...
<s:form action="Form5Report" validate="true" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
				<tr>
					<td width="3%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">PF Form 5</strong></td>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td colspan="1" width="20%"><label class="set" id="months"
										name="months" ondblclick="callShowDiv(this);"><%=label.get("months")%></label>:<font
										color="red"> *</font></td>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td colspan="1" width="30%"><s:textfield name="division"
										...
										onclick="javascript:callsF9(500,325,'Form5Report_f9actionDiv.action');"></td>
								</tr>
							</table>
							</td>
						</tr>
	...
	<s:hidden name="reportAction" value='Form5Report_form5Report.action' />
</s:form>
...
function resetFun(){
	document.getElementById('paraFrm').action='Form5Report_reset.action';
...
function mailReportFun(type){
	if(!validateFields()){
		...
		document.getElementById('paraFrm_reportType').value=type;
		document.getElementById('paraFrm').action='Form5Report_mailReport.action';
		document.getElementById('paraFrm').submit();
	}	
}
