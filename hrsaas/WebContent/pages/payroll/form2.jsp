...
<s:form action="Form2" validate="true" id="paraFrm" theme="simple">
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="3%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Form2</strong></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="78%"><input type="button" class="token"
						...
						cssClass="reset" action="Form2_reset" theme="simple"
						value="    Reset" /></td>
					-->
					<td width="22%">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="3"><s:hidden name="empId" /> <s:hidden
								...
								onclick="javascript:callsF9(500,325,'Form2_f9Employee.action');">
							</td>
						</tr>
	...
	<s:hidden name="reportAction" value='Form2_report.action' />
</s:form>
...
function resetFun(){
	document.getElementById('paraFrm').action='Form2_reset.action';
...
function mailReportFun(type){
	if(!validation()){
		...
		document.getElementById('paraFrm_reportType').value=type;
		document.getElementById('paraFrm').action='Form2_mailReport.action';
		document.getElementById('paraFrm').submit();
	}	
}
...
function validation(){
	...
	return true;
	//callReport('Form2_report.action');
}
function add(){
