...
<s:form action="ReconciliationControlSheet" validate="true" id="paraFrm"
	...
	<table class="formbg" width="100%">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Salary Reconciliation Control Sheet </strong></td>
		...
		<iframe id="reportFrame" frameborder="0" onload=alertsize();
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td width="80%">
						<s:submit cssClass="reset" action="ReconciliationControlSheet_reset"
		...
		--><tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
									<td colspan="6" class="formhead"><strong
										class="forminnerhead">Reconcile control sheet between following months:</strong></td>
								</tr>
								<tr>
						...
						<tr>
							...
							<tr>
				<td width="35%"><label class="set" id="division1"
				...
				<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
							onclick="javascript:callDropdown('paraFrm_divName',350,250,'ReconciliationControlSheet_f9Div.action',event,'false','no','right')"></td>
			</tr>	
			...
			<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
						onclick="javascript:callDropdown('paraFrm_cadreName',350,250,'ReconciliationControlSheet_f9gradeaction.action',event,'false','no','right')"></td>
		</tr>			
			...
			<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
						onclick="javascript:callDropdown('paraFrm_branchName',350,250,'ReconciliationControlSheet_f9Brch.action',event,'false','no','right')"></td>
		</tr>
			...
			<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
						onclick="javascript:callDropdown('paraFrm_deptName',350,250,'ReconciliationControlSheet_f9Department.action',event,'false','no','right')"></td>
		</tr>					
			...
			<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
						onclick="javascript:callDropdown('paraFrm_paybillName',350,250,'ReconciliationControlSheet_f9PayBill.action',event,'false','no','right')"></td>
		</tr>	
		...
		<tr>
			...
			<td width="25%"><img src="../pages/images/search2.gif" class="iconImage" height="16" align="absmiddle" width="16"
						onclick="javascript:callDropdown('paraFrm_costCenterName',350,250,'ReconciliationControlSheet_f9CostCenter.action',event,'false','no','right')"></td>
		</tr>
									...
									<table width="100%" border="0" align="center" cellpadding="1"
										...
										<tr>
											<td colspan="1" width="25%"><label
												id="group.by" name="group.by"
												ondblclick="callShowDiv(this);"><%=label.get("group.by")%></label>
											:</td>
											<td width="75%"><!--Grade
											<input type="checkbox" theme="simple"
						name="gradeChk"  />
												
												Cost Center<s:checkbox
												name="costCenterChk" ></s:checkbox>
												
												Department<s:checkbox
												name="deptChk" ></s:checkbox>
												
												--><input type="radio" name="groupByGrade" id="grdse" value="Gr"
						
						onclick="setType(this);"/>Grade
						<input type="radio"  name="groupByGrade" id="cost"  value="Cc"
						onclick="setType(this);"/>CostCenter
						<input type="radio"  name="groupByGrade" id="dept"  value="Dp"
						onclick="setType(this);"/>Department
...
<tr>
	...
	<s:hidden name="groupByRadio" />
	<s:hidden name="reportAction" value='ReconciliationControlSheet_getReport.action'/>
...
function getYear(){
	...
	document.getElementById('paraFrm_groupByRadio').value="Gr";
	if(document.getElementById('paraFrm_groupByRadio').value="Gr"){
		document.getElementById('grdse').checked= true;
	} 
...
function setType(id){	
	var setvalue=document.getElementById('paraFrm_groupByRadio').value = id.value;	
...
function generateReport(){ 
	...
	//document.getElementById('paraFrm_report').value=type;
		if(!validateFields()){
				...
				document.getElementById('paraFrm').action="ReconciliationControlSheet_getReport.action";
 ...
 function mailReportFun(type){
		if(!validateFields()){
			return false;
				...
				//callDropdown(obj.name,200,250,'ReconciliationControlSheet_mailReport.action','false');
			document.getElementById('paraFrm_report').value=type;
		
			document.getElementById('paraFrm').action='ReconciliationControlSheet_mailReport.action';
			document.getElementById('paraFrm').submit();
			//return true;
		}	
	}
...
function resetFun(){
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action="ReconciliationControlSheet_reset.action";
		document.getElementById('paraFrm').submit();
	}
