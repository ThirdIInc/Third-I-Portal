...
<tr>
 <td colspan="3"  class="text_head">Employee Investment ewee</td>
</tr>
<tr>
...
<tr>
	...
	<td width="25%"><s:textfield name="empInv.centerNo" theme="simple" maxlength="50" size="30"  readonly="true" />
...
<tr>
	...
	<td width="25%">
		<s:select  name="empInv.rptTyp" id="rptType"  list="#{'Pdf':'PDF','Xls':'XLS'}"  theme="simple"/>		
	</td>
</tr>
...
<tr>
  ...
  <td width="10%">&nbsp;</td>
  <td width="25%">
	   <s:submit cssClass="pagebutton"  theme="simple"  value='Report' action="EmpInvstmnt_report" onclick="validate();"  />
  </td>
</tr>
...
function callReport(){
		//if(document.getElementById("rptType").value=="Pdf"){
			document.getElementById('paraFrm').target="_blank";
			document.getElementById('paraFrm').action="EmpInvstmnt_report.action";
