...
<s:form action="EsicMonthlyReconciliation" validate="true" id="paraFrm"
	theme="simple">
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="3%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">ESIC Monthly Reconciliation Report</strong></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="2" id="reportBodyTable" >
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="5%" nowrap="nowrap"><label  class = "set"  id="months" name="months" ondblclick="callShowDiv(this);"><%=label.get("months")%></label>
							...
							<td width="5%"><label  class = "set"  id="finYearFrm" name="finYearFrm" ondblclick="callShowDiv(this);"><%=label.get("finYearFrm")%></label>
								 :<font	color="red"> *</font></td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td>	
								...
								onclick="javascript:callDropdown('paraFrm_divName',200,250,'EsicMonthlyReconciliation_f9division.action',event,'false','','right')">
							</td>
						</tr>
						<tr>	
							...
							<td>	
								<img src="../pages/images/search2.gif" class="iconImage"
								height="16" align="absmiddle" width="16"
								onclick="javascript:callDropdown('paraFrm_brnName',200,250,'EsicMonthlyReconciliation_f9brn.action',event,'false','','right')">
							</td>	
						</tr>
						<tr>
							...
							<td>	
								<img src="../pages/images/search2.gif" class="iconImage"
								height="16" align="absmiddle" width="16"
								onclick="javascript:callDropdown('paraFrm_deptName',200,250,'EsicMonthlyReconciliation_f9dept.action',event,'false','','right')">
							</td>
						</tr>
						<tr>
							...
							<td>	
								<img src="../pages/images/search2.gif" class="iconImage"
									height="16" align="absmiddle" width="16"
									onclick="javascript:callDropdown('paraFrm_payBillName',200,250,'EsicMonthlyReconciliation_f9payBill.action',event,'false','','right')">
							</td>
						</tr>
						<tr>
							...
							<td>	
								<img src="../pages/images/search2.gif"
									...
									onclick="javascript:callDropdown('paraFrm_cadreName',200,250,'EsicMonthlyReconciliation_f9grade.action',event,'false','','right')">
							</td>
						</tr>
					</table>
					</td>
	...
	<s:hidden name="reportAction" value='EsicMonthlyReconciliation_report.action' />
...
function mailReportFun(type){
	if(!validateFields()){
		...
		document.getElementById('paraFrm_reportType').value=type;
		document.getElementById('paraFrm').action='EsicMonthlyReconciliation_reportMail.action';
		document.getElementById('paraFrm').submit();
	}	
}

function resetFun(){
	document.getElementById('paraFrm').action='EsicMonthlyReconciliation_reset.action';
	document.getElementById('paraFrm').submit();
}
