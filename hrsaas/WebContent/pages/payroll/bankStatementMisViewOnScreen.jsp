...
<s:form action="BankStatementMis" validate="true" id="paraFrm"
	theme="simple">
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head"> Bank Statement Mis Report   
					 </strong></td>
		...
		<s:hidden name="bankStatementMisBean.reportId"/>
		<s:hidden name="bankStatementMisBean.divName" />
		<s:hidden name="bankStatementMisBean.divCode" />
		<s:hidden name="bankStatementMisBean.centerName" />
		<s:hidden name="bankStatementMisBean.centerCode" />
		<s:hidden name="bankStatementMisBean.bankCode" />
		<s:hidden name="bankStatementMisBean.bankName" />
			<s:hidden name="month" />
		<s:hidden name="year" />
	 
		<s:hidden name="bankStatementMisBean.accNumberFlag" />
		<s:hidden name="bankStatementMisBean.currencyCodeFlag" />
		<s:hidden name="bankStatementMisBean.solIdFlag" />
		<s:hidden name="bankStatementMisBean.creditdebitFlag" />
		<s:hidden name="bankStatementMisBean.transactiontypeFlag" />
		<s:hidden name="bankStatementMisBean.ifsccodeFlag" />
		 
		<s:hidden name="bankStatementMisBean.empnameFlag" />
		<s:hidden name="bankStatementMisBean.transactionDtlFlag" />
		<s:hidden name="bankStatementMisBean.transactionDateFlag" />
		<s:hidden name="bankStatementMisBean.bankFlag" />
		<s:hidden name="bankStatementMisBean.bankbrnNameFlag" />
		<s:hidden name="bankStatementMisBean.beneficaryEmailidFlag" />
		<s:hidden name="bankStatementMisBean.customerrefnoFlag" />
		<s:hidden name="bankStatementMisBean.divisionAccountNoFlag" />
		...
		<s:hidden name="bankStatementMisBean.reportTitle" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong> Bank Statement Mis Report  </strong></td>
							<%
							int totalPage=0;
							int pageNo =0;
							try{
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('BankStatementMis_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='BankStatementMis_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
