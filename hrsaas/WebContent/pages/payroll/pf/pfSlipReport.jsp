				...
				<tr>
					...
					<table width="98%" border="0" align="center" cellpadding="2"
						...
						<tr>
							...
							<td width="93%" class="txt"><strong class="text_head">PF Slip Report</strong></td>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<s:else>
					...
					<tr>
						...
						<td width="30%"> 
							<s:textfield name="sDesignation" readonly="true" /><img src="../pages/images/recruitment/search2.gif" height="16" align="absmiddle" width="17" theme="simple" onclick="validateF9('f9Designation');">
...
<script type="text/javascript">
	...
	{
		javascript:callsF9(500,325,'PFSlipReport_'+action+'.action'); 
	}
	...
	function reportFun()
	{
		...
		document.getElementById('paraFrm').action="PFSlipReport_report.action";
