...
<s:form action="UMC_SalaryProcess" name="SalaryProcess" validate="true" id="paraFrm" target="main" theme="simple">
				...
				<table width="100%">
					<tr>
						<td>
							...
							<s:submit action="UMC_SalaryProcess_reset" value="Reset" cssClass="reset" title="Clear the fields" />
							<s:submit action="UMC_SalaryProcess_input" value="Return to List" cssClass="token" 
								...
								<s:if test="divisionFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'UMC_SalaryProcess_f9Division.action');">
										</td>
										</s:else>
								...
								<s:if test="branchFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'UMC_SalaryProcess_f9Branch.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="departmentFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'UMC_SalaryProcess_f9Department.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="employeeTypeFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'UMC_SalaryProcess_f9EmployeeType.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="payBillFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'UMC_SalaryProcess_f9PayBill.action');">
										</td>
									</tr>
								</s:if>
						...
						<td width="100%"><b>View Salary</b>
							<table width="100%" align="center" >
								<tr>
									...
									<td width="30%" ><s:submit action="UMC_SalaryProcess_viewSalaryReport" value="View Records" cssClass="token" 
										title="View Records" /></td>
									<td width="20%">View salary in editable mode :</td>
									<td width="34%" align="left" ><s:submit action="UMC_SalaryProcess_viewEditableSalary" value="Edit Records" cssClass="token" 
							...
							<table width="100%" border ="0">
								<tr>
									...
									<td>	
										...
										onclick="callsF9(500,325,'UMC_SalaryProcess_f9CreditAction.action');">
									</td>
							...
							<table width="100%" border ="0">
								<tr>
									...
									<td>	
										<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" 
										align="middle" width="18" title="Select the pay bill group" 
										onclick="callsF9(500,325,'UMC_SalaryProcess_f9DebitAction.action');">
									</td>
									<td><input type="button" value="Download Template" class="token" onclick="downloadTemplate();" /></td>
								</tr>
								<tr>
							...
							<table width="100%" border ="0">
								...
								<td width="100" align="left">
									<s:if test="extraWorkFlag">
										...
										<input type="button" class="token" onclick="return callPullOtherIncome('UMC_SalaryProcess_pullExtraWorkBenefit.action')" value='Extrawork Benefits'/>
									</s:if>
									<s:if test="leaveEncashFlag">
									
										<input type="button" class="token" onclick="return callPullOtherIncome('UMC_SalaryProcess_pullLeaveEncashment.action')" value='Leave Encashment'/>
									</s:if>
									<s:if test="allowanceFlag">
									
										<input type="button" class="token" onclick="return callPullOtherIncome('UMC_SalaryProcess_pullAllowance.action')" value='Allowance'/>
									</s:if>
								</td>
	...
	if(processType=='process'){
		...
		document.getElementById('paraFrm_payBillId').value == "") {
			...
			return false;
				...
				document.getElementById('paraFrm').action = "UMC_SalaryProcess_processSalary.action";
			...
			var con=confirm('Do you really want to re-Process the salary?');
				...
				document.getElementById("progressBar").style.visibility = "";
				document.getElementById("progressBar").style.display = "";
				document.getElementById('paraFrm').action = "UMC_SalaryProcess_deleteAndProcessSalary.action";
				document.getElementById('paraFrm').submit();
		}
		return true;
	}
	function uploadFile(fieldName) 
{
	...
	function downloadTemplate(){
		document.getElementById('paraFrm').action="UMC_SalaryProcess_downloadTemplate.action";
		document.getElementById('paraFrm').submit();
	}
...
function checkCreditUpload(){
	...
	document.getElementById('paraFrm').action='UMC_SalaryProcess_uploadCredit.action';
	document.getElementById('paraFrm').submit();
}
...
function checkFun(action){
 	 var ledgerStatus = document.getElementById("paraFrm_ledgerStatus").value;
		...
		if(action=='Lock'){
				...
				document.getElementById('paraFrm').action="UMC_SalaryProcess_recalculateTax.action";
				document.getElementById('paraFrm').submit();
			}
 ...
 function unlockSal() {
	...
	function doUnlock() {
		//enableBlockDiv();
		document.getElementById('paraFrm').action="UMC_SalaryProcess_unLockSalary.action";
		document.getElementById('paraFrm').submit();
	}
...
var ledgerStatus = document.getElementById("paraFrm_ledgerStatus").value;
    ...
    var Debithead = document.getElementById('paraFrm_uploadDebitCode').value;
		...
		document.getElementById('paraFrm').action='UMC_SalaryProcess_uploadDebit.action';
		document.getElementById('paraFrm').submit();
