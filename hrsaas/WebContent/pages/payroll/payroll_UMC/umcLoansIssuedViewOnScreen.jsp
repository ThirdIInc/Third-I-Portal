...
<s:form action="LoanIssuedRpt" validate="true" id="paraFrm"
	...
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<s:hidden name="loanAmountFlag" />
		<s:hidden name="loanTypeFlag" />
		<s:hidden name="loanPaymentDateFlag" />
		<s:hidden name="loanInstallmentFlag" />
		<s:hidden name="noOfInstallFlag" />
		<s:hidden name="refundable"></s:hidden>
		<s:hidden name="loanAmountPaidChkBox"></s:hidden>
		<s:hidden name="loanPendingAmtChkBox"></s:hidden>
		...
		<s:hidden name='loanFromDate' />
		<s:hidden name='loanToDate' />
...
function callOnLoad(){
 ...
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('LoanIssuedRpt_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='LoanIssuedRpt_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
