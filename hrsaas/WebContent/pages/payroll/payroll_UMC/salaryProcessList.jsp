...
<s:form action="UMC_SalaryProcess" validate="true" id="paraFrm" name="paraFrm"	theme="simple">
		...
		<tr>
			<td width="100%" align="left" colspan="3">
				<table width="100%" align="left" cellspacing="0" cellpadding="0" >
					<tr>
						<td width="70%">
							<s:submit action="UMC_SalaryProcess_addNew" value="Add New" cssClass="token"  
							onclick="callAddNew()" /> 
							<input type="button" class="search" value="    Search " 
							onclick="callsF9(500,325,'UMC_SalaryProcess_f9action.action');" />
						</td>
						...
						<td id="ctrlShow" width="30%" align="right" class="">
							...
							%>
							<a href="#" onclick="callPage('1', 'F', '<%=totalPage%>', 'UMC_SalaryProcess_callPage.action');">
								<img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage"/>
							</a>&nbsp;
							<a href="#" onclick="callPage('P', 'P', '<%=totalPage%>', 'UMC_SalaryProcess_callPage.action');" >
								<img title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10" class="iconImage"/>
							</a>
							<input type="text" name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>" maxlength="10"
							onkeypress="callPageText(event, '<%=totalPage%>', 'UMC_SalaryProcess_callPage.action');return numbersOnly();" /> of <%=totalPage%>
							<a href="#" onclick="callPage('N', 'N', '<%=totalPage%>', 'UMC_SalaryProcess_callPage.action')" >
								<img title="Next Page" src="../pages/common/img/next.gif" class="iconImage" />
							</a>&nbsp;
							<a href="#" onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'UMC_SalaryProcess_callPage.action');" >
...
<script type="text/javascript">
	...
	function callForEdit(lcode, month,year,etname, etid, pbname,pbid,deptname,deptid,branchname,branchid,divname,divid,status) 
	{
		...
		document.getElementById("paraFrm").action="UMC_SalaryProcess_callForEdit.action";
