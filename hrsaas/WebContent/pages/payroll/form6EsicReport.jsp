...
<s:form action="Form6Report" validate="true" id="paraFrm"
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="3%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Form 6 Report</strong></td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="25%" colspan="1" nowrap="nowrap"><s:hidden
								name="divisionCode" /> <s:hidden
								name="divisionAbbrevation" /> <s:textfield name="divisionName"
								size="25" readonly="true" /> <img
								src="../pages/images/search2.gif" class="iconImage" height="17"
								align="absmiddle" width="17"
								onclick="javascript:callsF9(500,325,'Form6Report_f9divisionAction.action');">
						...
						<s:hidden name="reportAction" value='Form6Report_report.action'/>
					</table>
					</td>
				</tr>
...
<script>
	...
	function validateFields()
	{
	 ...
	 function mailReportFun(type){
		...
		document.getElementById('paraFrm').action='Form6Report_mailReport.action';
