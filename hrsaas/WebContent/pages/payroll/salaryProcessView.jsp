...
<s:form action="SalaryProcess" name="SalaryProcess" id="paraFrm" theme="simple">
	...
	<table width="98%" class="formbg">
		...
		<tr>
			<td width="100%">
				<table width="100%">
					<tr>
						<td><s:submit action="SalaryProcess_callForEdit" value="Back" cssClass="token" title="Back" />
								...
								<s:hidden name="divisionId" /><s:hidden name="branchViewId" />
									<tr>
										...
										<td  width="35%"><s:textfield name="branchViewName" readonly="true" size="35" cssStyle="background-color: #F2F2F2;" />
												<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="middle" width="18" title="Select the branch" onclick="callsF9(500,325,'SalaryProcess_f9BranchView.action');"></td>
									</tr>
									...
									<tr>
										...
										<td  width="35%"><s:textfield name="departmentViewName" readonly="true" size="35" cssStyle="background-color: #F2F2F2;" />
												<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="middle" width="18" title="Select the department" onclick="callsF9(500,325,'SalaryProcess_f9DepartmentView.action');"></td>
										...
										<td  width="35%"><s:textfield name="employeeTypeViewName" readonly="true" size="35" cssStyle="background-color: #F2F2F2;" />
												<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="middle" width="18" title="Select the type of an employee" onclick="callsF9(500,325,'SalaryProcess_f9EmployeeTypeView.action');"> </td>
									</tr>
									...
									<tr>
										...
										<td  width="35%"><s:textfield name="payBillViewName" readonly="true" size="35" cssStyle="background-color: #F2F2F2;" />
												<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="middle" width="18" title="Select the pay bill group" onclick="callsF9(500,325,'SalaryProcess_f9PayBillView.action');"> </td>
										...
										<td  width="35%"><s:textfield name="empViewName" readonly="true" size="35" cssStyle="background-color: #F2F2F2;" />
												<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="middle" width="18" title="Select the employee" onclick="callsF9(500,325,'SalaryProcess_f9employee.action');"> </td>
									</tr>
									<tr>
										<td  width="15%"></td>
...
<script type="text/javascript">
function resetFun(){
		document.getElementById('paraFrm').action="SalaryProcess_resetRecords.action";
...
function proceedWithSave(){
	try{
			document.getElementById("confirmationDiv").style.visibility = 'hidden';
			enableBlockDiv();
			document.getElementById('paraFrm').action="SalaryProcess_saveSalaryAfterRecalculate.action";
			document.getElementById('paraFrm').submit();
		}catch(e){
			alert(e);
		}
...
function checkRecordRecal()
	{
		...
		try{
			...
			//alert(1);
				retrieveURLRecalNew('SalaryProcess_recalSalary.action?','paraFrm');
				document.getElementById("overlay").style.visibility = "hidden";
				document.getElementById("overlay").style.display = "none";
				document.getElementById("progressBar").style.visibility = "hidden";
				document.getElementById("progressBar").style.display = "none";
...
function removeOnHold()
	{
		...
		try{
			if(ledgerStatus=="SAL_FINAL"){
				...
				retrieveURLRemoveOnHoldNew('SalaryProcess_removeOnHold.action?','paraFrm',ledgerCode);
				for(var i = 0; i < eCode.length; i++)
					{
						try{
							if(document.getElementById(eCode[i]+"onHoldChk").checked)
...
function callOnhold()
	{
		...
		if(ledgerStatus=="SAL_FINAL"){
			...
			var ledgerCode=document.getElementById("paraFrm_ledgerCode").value;
			//alert(ledgerCode);
			retrieveURLOnHoldNew('SalaryProcess_onholdSave.action?','paraFrm',ledgerCode);
			for(var i = 0; i < eCode.length; i++)
			{
