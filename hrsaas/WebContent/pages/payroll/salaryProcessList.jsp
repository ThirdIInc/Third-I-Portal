...
<s:form action="SalaryProcess" validate="true" id="paraFrm" name="paraFrm"	theme="simple">
		...
		<tr>
			<td width="100%" align="left" colspan="3">
				<table width="100%" align="left" cellspacing="0" cellpadding="0" >
					<tr>
						<td width="70%">
							<!--<s:submit action="SalaryProcess_addNew" value="Add New" cssClass="token"  
							onclick="callAddNew()" /> 
						...
						<td id="ctrlShow" width="30%" align="right" class="">
							...
							%>
							<a href="#" onclick="callPage('1', 'F', '<%=totalPage%>', 'SalaryProcess_callPage.action');">
								<img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage"/>
							</a>&nbsp;
							<a href="#" onclick="callPage('P', 'P', '<%=totalPage%>', 'SalaryProcess_callPage.action');" >
								<img title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10" class="iconImage"/>
							</a>
							<input type="text" name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>" maxlength="10"
							onkeypress="callPageText(event, '<%=totalPage%>', 'SalaryProcess_callPage.action');return numbersOnly();" /> of <%=totalPage%>
							<a href="#" onclick="callPage('N', 'N', '<%=totalPage%>', 'SalaryProcess_callPage.action')" >
								<img title="Next Page" src="../pages/common/img/next.gif" class="iconImage" />
							</a>&nbsp;
							<a href="#" onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'SalaryProcess_callPage.action');" >
										...
										<s:iterator value="iteratorList">
											...
											<%if(count%2==0){
												...
												ondblclick="javascript:callForEdit('<s:property value="listLedgerCode"/>',
																...
																'<s:property value="listLedgerStatus" />','<s:property value="listUploadSalaryFlag" />');">
												<script type="text/javascript">
												...
												<td width="10%" align="left" class="sortableTD">
			                                        ...
			                                        <s:hidden name="listMonthName" /> <s:hidden name="listUploadSalaryFlag" />
...
<script type="text/javascript">
	...
	function callForEdit(lcode, month,year,etname, etid, pbname,pbid,deptname,deptid,branchname,branchid,divname,divid,status,listUploadSalaryFlag) 
	{
		...
		document.getElementById("paraFrm_uploadSalaryFlag").value = listUploadSalaryFlag;
		document.getElementById("paraFrm").action="SalaryProcess_callForEdit.action";
