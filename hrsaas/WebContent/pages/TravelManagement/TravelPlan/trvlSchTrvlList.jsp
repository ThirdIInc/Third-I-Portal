				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
							...
							<tr>
								...
								<table width="100%" cellpadding="1" cellspacing="1"
									...
									<tr>
										...
										<td class="formth"><label class="set" id="city"
									...
									<s:iterator value="localConvDtls">
										<tr>
											...
											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConCity" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConSource" />&nbsp;</td>

											<td class="sortableTD" width="10%" nowrap="nowrap"
												colspan="1"><s:property value="locConDate" />&nbsp;</td>
											...
											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlModNum" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlConPer" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlConNum" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlPcPer" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlPcTime" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlPcPlace" />&nbsp;</td>

											<td class="sortableTD" width="15%" nowrap="nowrap"
												colspan="1"><s:property value="locConTrvlPcToriffCst" />&nbsp;</td>
									...
									<tr>
										<td colspan="11" align="right"><label class="set"
											id="tms.TotTariffCost" name="tms.TotTariffCost"
											ondblclick="callShowDiv(this);"><%=label.get("tms.TotTariffCost")%></label>:</td>
										<td colspan="1" class="sortableTD"><s:label
											name="totTariffCost" theme="simple" value="%{totTariffCost}" /></td>
						...
						<s:if test="lodgFlg">
							...
							<tr>
								<td><strong><label class="set"
									id="tms.trvlLodgDtls" name="tms.trvlLodgDtls"
									ondblclick="callShowDiv(this);"><%=label.get("tms.trvlLodgDtls")%></label></strong></td>
							</tr>
							...
							<tr>
								...
								<table width="100%" cellpadding="1" cellspacing="1"
									...
									<s:iterator value="lodgingDtls">
										<tr>
											<td class="sortableTD" nowrap="nowrap"><%=k2%> <s:hidden
												name="lodgeDtlId" /></td>
								...
								<td class="border2" ><s:property
								 ...
								 -->
									...
									<tr>
										...
										<td colspan="1"><s:label name="totLodgCost"
											theme="simple" value="%{totLodgCost}" /></td>
						...
						<tr>
							...
							<table width="100%" cellpadding="2" cellspacing="2"
								...
								<tr>
									...
									<td colspan="3"><s:label name="schComment" theme="simple"
										value="%{schComment}" /></td>
...
<script type="text/javascript">
	...
	{    
	   ...
	   document.getElementById('paraFrm').action = "TrvlSchl_callStatus.action?status=P";  
