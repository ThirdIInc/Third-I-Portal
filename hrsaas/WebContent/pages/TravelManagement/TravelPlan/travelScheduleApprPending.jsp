...
<s:form action="TravelSchAppr" validate="true" id="paraFrm"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1"
			...
			<table width="99%" border="0" align="center" class="formbg">
				<tr>
					...
					<td width="93%" class="txt" colspan="2"><strong
						class="text_head">Travel Schedule dddd </strong></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<s:submit
				action="TravelSchAppr_approve" value="Approve " theme="simple"  onclick=" return callFun();"  cssClass="token"/> <s:submit
				action="TravelSchAppr_reject" value="Reject" theme="simple"  cssClass="token"/> <s:submit
				value="  Back" theme="simple" onclick=" callBack();"  cssClass="token" />
					</td>
		...
		<tr>
			...
			<table width="100%" class="formbg">
				...
				<s:if test="jourBkFlg">
					...
					<tr>
						<td width="100%">
						<div style="overflow-x: auto; overflow-y: auto; width: 765;">
						<table width="100%" border="0" class="formbg">
							<tr>
								<td class="formth" width="3%" nowrap="nowrap"><label
								...
								<td class="formth" width="6%"><label class="set"
								...
								<td class="formth" width="7%"><label class="set"
							...
							<s:iterator value="travelSchList">
								...
								<tr>
									<td valign="top" class="sortableTD" width="3%"><%=k%> <s:hidden
										name="appJournDtlFrom" /> <s:hidden name="appJournDtlTo" />
									<s:hidden name="appJournDtlId" /></td>

									<td colspan="1" valign="top" class="sortableTD" width="10%"><s:property
										value="sourceAndDest" /></td>


									<td width="6%" valign="top" class="sortableTD"><input
									...
									<td valign="top" class="sortableTD" width="5%"><input
										type="text" name="travelTime" theme="simple" size="8"
										value="<s:property value="travelTime"/>"
										onblur="return validateTime('paraFrm_travelTime','Time');"
									...
									<%
										...
										String trModeClassId = (String) request
												.getAttribute("trModeId" + k);
									
									  String uploadFileName1 = (String) request.getAttribute("paraFrm_uploadFileName" + k);
									%>


									<td valign="top" class="sortableTD" width="7%" nowrap="nowrap"><s:hidden
									...
									<td valign="top" class="sortableTD" width="5%"><input
										...
										maxlength="12" onkeypress="return alphaNumeric();"></td>
									...
									<td valign="top" class="sortableTD" width="5%"><input
										type="text" name="<%="uploadFileName"+k %>" size="8"
										id="<%="paraFrm_uploadFileName"+k %>" /> <input name="Browse"
                                ...
                                <input
										type="hidden" name="uploadFileName" id="uploadFileName<%=k%>"
										value="<s:property value="uploadFileName"/>" />    
									<input	type="button" name="Download" class="token" value="Download"
							...
							<s:iterator value="localConvDtls">
								<tr>
									...
									<td width="10%" nowrap="nowrap" colspan="1" valign="top"
										class="sortableTD"><input type="text" name="locConDate"
										id="locConDate<%=k1%>"
									...
									<td width="15%" nowrap="nowrap" colspan="1" valign="top"
										...
										size="8" maxlength="8" onkeypress="return alphaNumeric();" /></td>

									<td width="15%" nowrap="nowrap" colspan="1" valign="top"
										class="sortableTD"><input type="text"
										name="locConTrvlConPer" theme="simple"
										value='<s:property
										value="locConTrvlConPer" />'
										size="8" maxlength="30"
										onkeypress="return charactersOnly(this);" /></td>
									...
									<td width="15%" nowrap="nowrap" colspan="1" valign="top"
										class="sortableTD"><input type="text"
										name="locConTrvlPcTime" theme="simple"
										value='<s:property
										value="locConTrvlPcTime" />'
										size="8" maxlength="5" onkeypress="return numbersWithColon();" /></td>
									...
									<td width="15%" nowrap="nowrap" colspan="1" valign="top"
										...
										size="8" maxlength="30" onkeypress="return alphaNumeric();" /></td>
						...
						<table width="100%" class="formbg">
							...
							<s:iterator value="lodgingDtls">
								<tr>
									...
									<td width="5%" nowrap="nowrap" valign="top" class="sortableTD"><input
										...
										onkeypress="return numbersWithHiphen();"
										onblur="return validateDate('lodgFrmDate
										<%=k2%>','tms.FrmDate');"
										maxlength="10"
									...
									<td valign="top" class="sortableTD"><input type="text"
										name="lodgChkOutTm" theme="simple" size="4"
										value='<s:property
										value="lodgChkOutTm"  />'
										onblur="return validateTime('paraFrm_lodgChkOutTm','Check out time');"
										maxlength="5" onkeypress="return numbersWithColon();" /></td>
									...
									<td width="4%" colspan="1" valign="top" class="sortableTD"><input
										...
										onkeypress="return numbersOnly();" maxlength="8" /></td>
									...
									<!-- 
									<td valign="top" class="sortableTD"><input type="hidden"
										name="<%="lodgUploadFileName"+k2 %>"
										id="<%="paraFrm_lodgUploadFileName"+k2 %>" /> <input
								    ...
								    <td class="sortableTD" nowrap="nowrap">
								      ...
								      <input
										type="hidden" name="lodgUploadFileName" id="lodgUploadFileName<%=k2%>"
										value="<s:property value="lodgUploadFileName"/>" /> 
								    <input
							...
							<tr>
								...
								<td colspan="1"><input type="text" name="totLodgCost"
									...
									id="paraFrm_totLodgCost" size="8" align="right"></td>
					...
					<table width="100%" cellpadding="2" cellspacing="2" class="formbg">
						...
						<tr>
							...
							<td width="25%" colspan="1"><input type="text"
								...
								align="right" onkeypress="return numbersOnly();" /></td>
							<td width="25%" colspan="1"><label class="set"
								id="tms.PrefPayMode" name="tms.PrefPayMode"
								ondblclick="callShowDiv(this);"><%=label.get("tms.PrefPayMode")%></label>:</td>

							<td width="25%" colspan="1" align="left"><s:label
								name="schPayMode" theme="simple" value="%{schPayMode}" /></td>
						</tr>
		...
		<tr>
			<td align="left" colspan="4"><s:submit action="TravelSchAppr_approve"
				 value="Approve " theme="simple"  onclick=" return callFun();"  cssClass="token"/> <s:submit
				action="TravelSchAppr_reject" value="Reject" theme="simple"  cssClass="token"/> <s:submit
				value="  Back" theme="simple" onclick=" callBack();"  cssClass="token"/></td>
