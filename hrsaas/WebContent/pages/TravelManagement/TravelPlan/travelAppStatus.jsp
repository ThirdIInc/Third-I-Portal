	          ...
	          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
	              ...
	              <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg">
	                <tr>
	                  <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	                      <tr>
	                        <td height="27" class="formtxt"> <a href="TravelAppr_callStatus.action?status=P">Pending List</a> |  <a href="TravelAppr_callStatus.action?status=A">Approved List</a> |  <a href="TravelAppr_callStatus.action?status=R">Rejected List</a> </td>
	            ...
	            <tr>
	              <td width="78%"><img src="../pages/images/recruitment/space.gif" width="5" height="4" /><br />
	               <input name="Submit222" type="button" class="save" value="    Add New " onclick="addnewFun();" />
	               &nbsp; <input name="Submit222" type="button" class="save" value="    Search " onclick="searchFun();" />
	             </td>
                    ...
                    <td><s:hidden name = "travelViewNo"/>    
                      <table width="100%" border="1" cellpadding="1" cellspacing="1"   class="sortable">
				       ...
				       <s:iterator value="travelList"> 
					         <tr>	
							      <td class="sortableTD" width="5%"><%=k %><s:hidden name="travelEmpId"/> 
							       <s:hidden name="appDate"/> 
							         ...
							         <input type="hidden" name="trRequestName" id ="trRequestName<%=k%>" value='<s:property value="trRequestName"/>'/>
							          ...
							          <input type="hidden" name="alertFlag" id ="alertFlag<%=k%>" value="<s:property value="alertFlag"/>"/> 
							          <input type="hidden" name="alertMode" id ="alertMode<%=k%>" value="<s:property value="alertMode"/>"/> 
							           <input type="hidden" name="alertShowFlag" id ="alertShowFlag<%=k%>" value="<s:property value="alertShowFlag"/>"/>   
							       </td>
							      <td class="sortableTD" width="22%"><s:property value="empName"/></td>
							       ...
							       <td class="sortableTD" width="15%" align="center">	 
							        ...
							        <s:if test="traApp.apprflag"><input type="button" name="view_Details" class="token" value="Details" onclick = "viewDetails('<s:property value="travelAppId"/>','<s:property value="level"/>','<s:property value="travelEmpId"/>')" /></s:if>
							       <s:else> 
							       <input type="button" name="view_Details" class="token" value="Details1111" onclick = "viewDetails('<s:property value="travelAppId"/>','<s:property value="level"/>','<s:property value="travelEmpId"/>')" />
							       </s:else>
							        
							        
							       </td>
							       <td class="sortableTD" width="20%"><s:if test="traApp.apprflag"><s:property value="remark"/></s:if><s:else><s:textarea name="remark" value="%{remark}" rows="1" cols="20"></s:textarea></s:else></td>
					             <script>
