...
function createTree1(arrName, startNode, openNode) {
	...
	if (nodes1.length > 0) {
		...
		if (startNode !=0) {
			...
			document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img class='iconImage'    src=\"../pages/common/img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a>");
...
function addNode1(parentNode, recursedNodes) {
	for (var i = 0; i < nodes1.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
            ...
            document.write("<table><tr><td width='55%'>");
			document.write("<div style ='position:relative;left:30px;'>");
			...
			// End link
			document.write("</a></div></td><td><div style ='position:relative;left:30px;");
			if(hcn){
			//alert('hcn1...'+hcn);
			//alert('nodeValues   '+nodeValues[0]);
			 document.write("visibility:hidden;");
			
			}
			document.write("'>");
			
			document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' NAME='insertChk1'  onClick=\"javascript:checkNode1('"+nodeValues[0]+"','insertlodge');hasParentNode1('"+nodeValues[0]+"','insertlodge');\" id=\"insertlodge"+nodeValues[0]+"\" value ='"+nodeValues[0]+"' ></div></td></tr></table>");
...
function openMeLodge(node) {
//alert('open/close'+node);
...
for (var i = 0; i < nodes1.length; i++) {
	//alert('gg'+nodes.length);
		...
		var hcn	= hasChildNode1(nodeVal[0]);
		if (hcn){
		//alert('hcnlodge...'+nodeVal[0]);
		openMeLodge(nodeVal[0]);
		}
...
for (var i = 0; i < nodes1.length; i++) {
	//alert('gg'+nodes.length);
		...
		var hcn	= hasChildNode1(nodeVal[0]);
		if (hcn){
		//alert('hcn lodge...'+nodeVal[0]);
		closeMeLodge(nodeVal[0]);
		}
