...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
            ...
            document.write("<table><tr><td width='55%' align='left'>");
			...
			// End link
			document.write("</a></div></td><td width='100%' align='middle'><div style ='position:relative;left:30px;");
			if(hcn){
			//alert('hcn...'+hcn);
			...
			document.write("'>");
			document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE='checkbox' NAME='insertChk'  onclick=\"javascript:checkNode('"+nodeValues[0]+"','insert');hasParentNode('"+nodeValues[0]+"','insert');\" id=\"insert"+nodeValues[0]+"\" value ='"+nodeValues[0]+"' ></div></td><tr></table>");
...
for (var i = 0; i < nodes.length; i++) {
	//alert('gg'+nodes.length);
		...
		var hcn	= hasChildNode(nodeVal[0]);
		if (hcn){
		//alert('hcn...'+nodeVal[0]);
		openMe(nodeVal[0]);
		}
