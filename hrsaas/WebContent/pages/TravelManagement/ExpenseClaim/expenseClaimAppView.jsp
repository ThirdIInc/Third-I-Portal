			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="13%" colspan="1" class="formtext" height="22"><label  class = "set" name="employee" id="employee1" ondblclick="callShowDiv(this);"><%=label.get("employee")%></label> :
							<td width="60%" colspan="3"><s:property  value="empToken"
						...
						<tr>
							<td width="13%" class="formtext" height="22"><label  class = "set" name="branch" id="branch" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>:</td>
							<td width="25%"><s:property value="branchName"/></td>

							<td width="10%" class="formtext"><label  class = "set" name="department" id="department" ondblclick="callShowDiv(this);"><%=label.get("department")%></label>:</td>
						...
						<tr>
							...
							<td width="13%" class="formtext" height="22"><label  class = "set" name="designation" id="designation" ondblclick="callShowDiv(this);"><%=label.get("designation")%></label>:</td>
							<td width="25%"><s:property value="desgName" /></td>
							<td width="10%" class="formtext"><label  class = "set" name="application.date" id="application.date1" ondblclick="callShowDiv(this);"><%=label.get("application.date")%></label>:</td>
							<td width="25%"><s:property value="applDate"/> </td>
						...
						<tr>
							...
							<td width="13%" class="formtext" height="22"><label  class = "set" name="sts" id="sts1" ondblclick="callShowDiv(this);"><%=label.get("sts")%></label>:</td>
							<td width="25%"><s:property value="statusFld" /><s:hidden name="hidSts" /></td>
							<td width="10%" class="formtext"><label  class = "set" name="grd" id="grd1" ondblclick="callShowDiv(this);"><%=label.get("grd")%></label>:</td>
							<td width="25%"><s:property value="grdName" /><s:hidden
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="13%" class="formtext" height="22" colspan="1"><label  class = "set" name="request" id="request" ondblclick="callShowDiv(this);"><%=label.get("request")%></label> <s:if test="addNewFlag">
								<font color="red">*</font>
							</s:if>:</td>
							<td width="25%" colspan="1"><s:property value="requestName"/><s:hidden
								name="requestCode"></s:hidden></td>

							<td width="12%" class="formtext" colspan="1"><label  class = "set" name="advance" id="advance" ondblclick="callShowDiv(this);"><%=label.get("advance")%></label>
							:</td>
							<td width="27%" colspan="1"><s:property value="advAmt" /></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="13%" class="formtext" colspan="1"><label  class = "set" name="voucher.head" id="voucher.head" ondblclick="callShowDiv(this);"><%=label.get("voucher.head")%></label><font
								color="red">*</font>:</td>
							<td width="25%" colspan="1"><s:property value="voucherHead"/><s:hidden
								name="voucherHeadCode" /><s:hidden name="hiddenEdit" /> <input type="hidden"
								name="voucherAmt" id="paraFrm_voucherAmt" /></td>

							<td width="12%" class="formtext" colspan="1"><label  class = "set" name="expense.date" id="expense.date" ondblclick="callShowDiv(this);"><%=label.get("expense.date")%></label> <font
								color="red">*</font>:</td>
							<td width="27%" colspan="1"><s:textfield name="expenseDate"
								theme="simple" size="10" maxlength="10"
								onblur="return validateDate(expenseDate);"
						...
						<tr>
							<td width="13" class="formtext" colspan="1"><label  class = "set" name="amount" id="amount" ondblclick="callShowDiv(this);"><%=label.get("amount")%></label><font
								color="red">*</font>:</td>
							...
							<td class="formtext" width="12%" colspan="1"><label  class = "set" name="proof" id="proof" ondblclick="callShowDiv(this);"><%=label.get("proof")%></label> :</td>
						...
						<tr>
							<td width="13%" class="formtext" colspan="1"><label  class = "set" name="particulars" id="particulars" ondblclick="callShowDiv(this);"><%=label.get("particulars")%></label> :</td>
							<td width="25%" colspan="1"><s:textarea name="particulars"
								theme="simple" cols="32" rows="2" /></td>

							<td width="5%" class="formtext" id="chqId" colspan="1"><label  class = "set" name="upload" id="upload" ondblclick="callShowDiv(this);"><%=label.get("upload")%></label> <font color="red">*</font>:</td>
							<td width="27%" id="chqTextId" colspan="1"><s:textfield
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td width="20%"></td><!--<input type="button" class="token"
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="5%" valign="top" class="formth"><label  class = "set" name="sr.no" id="sr.no1" ondblclick="callShowDiv(this);"><%=label.get("sr.no")%></label></td>
							<td width="15%" valign="top" class="formth"><label  class = "set" name="voucher.head" id="voucher.head1" ondblclick="callShowDiv(this);"><%=label.get("voucher.head")%></label></td>
							<td width="12%" valign="top" class="formth"><label  class = "set" name="particulars" id="particulars" ondblclick="callShowDiv(this);"><%=label.get("particulars")%></label></td>
							<td width="17%" valign="top" class="formth"><label  class = "set" name="expense.date" id="expense.date1" ondblclick="callShowDiv(this);"><%=label.get("expense.date")%></label></td>
							<td width="12%" valign="top" class="formth"><label  class = "set" name="amount" id="amount1" ondblclick="callShowDiv(this);"><%=label.get("amount")%></label></td>
							<td width="10%" valign="top" class="formth"><label  class = "set" name="valid.amount" id="valid.amount" ondblclick="callShowDiv(this);"><%=label.get("valid.amount")%></label></td>
							<td width="10%" valign="top" class="formth"><label  class = "set" name="proof.attached" id="proof.attached" ondblclick="callShowDiv(this);"><%=label.get("proof.attached")%></label></td>
							<td width="12%" valign="top" class="formth"><label  class = "set" name="upload.file" id="upload.file" ondblclick="callShowDiv(this);"><%=label.get("upload.file")%></label></td>
						...
						<s:iterator value="expList">
							<tr ondblclick="javascript:callForEdit('<s:property value="itVoucher"/>','<s:property value="itVoucherHeadCode"/>','<s:property value="itvoucherAmt"/>','<s:property value="itParticulars"/>','<s:property value="itExpenseDate"/>','<s:property value="itAmount"/>','<s:property value="isProof"/>','<s:property value="itUpload"/>','<%=k+1%>');">
								...
								<td class="sortableTD" width="15%"><s:property
									...
									name="itVoucherHeadCode" /><s:hidden value="itVoucherHeadCode" /><s:hidden name="itvoucherAmt" /><s:hidden value="itvoucherAmt"/></td>
								...
								<td class="sortableTD" width="10%" align="center"><input type="text" align="middle"
									size="8" readonly="true" onkeypress="return numbersOnly();"
									name="itValAmount" value='<s:property value="itValAmount"/>' /><input
						...
						<td class="sortableTD"></td>
						<td class="sortableTD"></td>
						<td align="right"><label  class = "set" name="total.amount" id="total.amount" ondblclick="callShowDiv(this);"><%=label.get("total.amount")%></label>:</td>
						<td class="sortableTD" align="right"><s:property value="expAmt" /><s:hidden name="expAmt" /></td>
						<td class="sortableTD"></td>
						<td class="sortableTD"></td>
						<td class="sortableTD"></td>
						<td class="sortableTD"></td>
						...
						<s:if test="maxLimit">
						<tr>
						<td colspan="8"><font color="red">You have crossed your maximum limit which is <s:label name="voucherAmt" theme="simple"
								value="%{voucherAmt}" /></font></td></tr></s:if>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="15%" class="formtext" height="22" colspan="1"><label  class = "set" name="payment.mode" id="payment.mode" ondblclick="callShowDiv(this);"><%=label.get("payment.mode")%></label> :</td>
							<td width="65%" colspan="1"><s:hidden name="mode"/><s:hidden name="hidMode"/><s:property value="hidMode"/></td>

						</tr>
						<s:hidden name="bankName"></s:hidden>
						<s:hidden name="accNo"></s:hidden>
						<tr id="salId">
							<td width="13%" class="formtext" height="22" colspan="1"><label  class = "set" name="month" id="month" ondblclick="callShowDiv(this);"><%=label.get("month")%></label><font
								color="red">*</font>:</td>
							<td width="65%" colspan="1">  
							 <s:hidden name="salMonth" /><s:hidden name="hidMonth"/><s:property value="hidMonth"/>
							
							 </td>
						</tr>
						<tr id="salYrId">
							<td width="13%" class="formtext" height="22" colspan="1"><label  class = "set" name="year" id="year" ondblclick="callShowDiv(this);"><%=label.get("year")%></label><font
								color="red">*</font>:</td>
							<td width="65%" colspan="1"><s:textfield name="year"
								theme="simple" size="10" maxlength="4" onkeypress="return numbersOnly();"/></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="13%" class="formtext" height="22" colspan="4"><label  class = "set" name="comments" id="comments" ondblclick="callShowDiv(this);"><%=label.get("comments")%></label>
							:</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="13%" class="formtext" height="22" colspan="4"><label  class = "set" name="approver.comments" id="approver.comments" ondblclick="callShowDiv(this);"><%=label.get("approver.comments")%></label>
							:</td>							
							<td width="60%"><s:property value="approverComments" /></td>
						</tr>
	...
	<s:if test="%{isApprove}">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				class="formbg">
				<tr>
					<td colspan="4" class="text_head"><strong>Approver Comments</strong></td>
				</tr>
				
				<tr>
							<td class="formth" width="8%"><label  class = "set" name="sr.no" id="sr.no2" ondblclick="callShowDiv(this);"><%=label.get("sr.no")%></label></td>
							<td class="formth" width="30%"><label  class = "set" name="approver.name" id="approver.name" ondblclick="callShowDiv(this);"><%=label.get("approver.name")%></label></td>
							<td class="formth" width="15%" align="center"><label  class = "set" name="date" id="date" ondblclick="callShowDiv(this);"><%=label.get("date")%></label></td>
							<td class="formth" width="10%" align="center"><label  class = "set" name="sts" id="sts4" ondblclick="callShowDiv(this);"><%=label.get("sts")%></label></td>
							<td class="formth" width="30%"><label  class = "set" name="comments" id="comments1" ondblclick="callShowDiv(this);"><%=label.get("comments")%></label></td>
						</tr>
						<%
							int j = 1;
							%>
...
try{
	...
	if(status=="A" || status=="P"){
		...
		//alert(vamt);
			var listLen=<%=j%>;
			if(vhead=="" && listLen=="0"){	
				alert("Please enter voucher head ");
				return false;	
			}	
			if(vdate=="" && listLen=="0"){	
