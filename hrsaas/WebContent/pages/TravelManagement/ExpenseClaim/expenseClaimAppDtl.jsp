...
<s:form action="ExpenseClaimApp" method="post" id="paraFrm">
	<table width="100%" border="0" align="right" cellpadding="0"
		cellspacing="0"><s:hidden name="cancelFlag" />
		...
		<tr>
			...
			Claim Application11111111</strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="2">
						<td><strong class="formhead">Travel Request </strong></td>


						<tr>
							<td width="20%" class="formtext" height="22">Travel Request
							Name:</td>
							<td width="25%"><s:textfield name="requestName"
								theme="simple" size="40" readonly="true" /><s:hidden
								name="requestCode"></s:hidden></td>

							<td width="10%" class="formtext">Advance Amount :</td>
							<td width="25%"><s:textfield name="advAmt" theme="simple"
								size="35" readonly="true" /></td>
...
<s:if test="viewApprFlag"></s:if><s:elseif test="viewRejFlag"></s:elseif><s:else>
		<tr>
			<td colspan="3">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				class="formbg">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="25%"><s:textfield name="amount" theme="simple"
								size="25" onkeypress="return numbersOnly();"/></td><s:hidden name="balAmt"/>
						...
						<s:iterator value="expList">
							<tr>
								...
								<td class="border2" width="12%"><s:property
									value="itVoucher" /><s:hidden name="itVoucher" /><s:hidden name="itVoucherHeadCode"/><s:hidden value="itVoucherHeadCode"/></td>
								...
								<td class="border2" width="15%"><input type="text" onkeypress="return numbersOnly();"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								</tr><s:hidden name="accNo"/><s:hidden name="bankName"></s:hidden>								
								<tr id="salId">
...
<script>
	...
	function callAdd(){ 
	    ...
	    document.getElementById('paraFrm').action = "ExpenseClaimApp_addExpenseDtl.action";
