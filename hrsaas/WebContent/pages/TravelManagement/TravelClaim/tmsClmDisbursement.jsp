			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Claim	Disbursement  </strong></td>
					...
					<tr>
						...
						<td align="right" ><b>Page:</b>
										<%
											...
											pageNo = (Integer) request.getAttribute("pageNo");
										%> <a href="#"
											onclick="callPage('1', 'F', '<%=totalPage%>', 'TravelExpDisbrsmnt_getClosedList.action');">
										<img title="First Page" src="../pages/common/img/first.gif"
											width="10" height="10" class="iconImage" /> </a>&nbsp; <a
											href="#"
											onclick="callPage('P', 'P', '<%=totalPage%>', 'TravelExpDisbrsmnt_getClosedList.action');">
										<img title="Previous Page"
											src="../pages/common/img/previous.gif" width="10" height="10"
											class="iconImage" /> </a> <input type="text" name="pageNoField"
											id="pageNoField" size="3" value="<%=pageNo%>" maxlength="10"
											onkeypress="callPageText(event, '<%=totalPage%>', 'TravelExpDisbrsmnt_getClosedList.action');return numbersOnly();" />
										of <%=totalPage%> <a href="#"
											onclick="callPage('N', 'N', '<%=totalPage%>', 'TravelExpDisbrsmnt_getClosedList.action');">
										<img title="Next Page" src="../pages/common/img/next.gif"
											class="iconImage" /> </a>&nbsp; <a href="#"
											onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'TravelExpDisbrsmnt_getClosedList.action');">
										<img title="Last Page" src="../pages/common/img/last.gif"
											width="10" height="10" class="iconImage" /> </a></td>
					</tr>
					<tr>
						...
						<table width="100%" cellpadding="1" cellspacing="1" class="formbg">
							<tr>
								<td width="5%" class="formth" colspan="1"><strong>Sr.No</strong></td>
								<td width="10%" class="formth" colspan="1"><strong>Division</strong></td>
								<td width="20%" class="formth" colspan="1"><strong>Travel
								Id</strong></td>
								<td width="25%" class="formth" colspan="1"><strong>Employee
								Name</strong></td>
								<td width="15%" class="formth" colspan="1"><strong>Application
								...
								<td width="15%" class="formth" colspan="1"><strong>Claim
								Amount</strong></td>
								<td width="15%" class="formth" colspan="1"><strong>View</strong></td>
							</tr>
							<%!int ii = 0;
						...
						%>
									...
									ondblclick="javascript:viewDetails('<s:property value="itClmAppId"/>','<s:property value="itClmStatus"/>','<s:property value="appId"/>','<s:property value="appCode"/>','<s:property value="currentStatus"/>')">
									<td class="sortableTD"><%=++closedSr%> <s:hidden
										name="itClmAppId" /> <s:hidden name="itClmStatus"
										id='<%="itClmStatus"+kk%>' /> <s:hidden name="currentStatus"
										id='<%="currentStatus"+kk%>' />
