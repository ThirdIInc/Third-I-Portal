...
<s:form action="HotelMaster" validate="true" id="paraFrm"
	...
	<s:hidden name="city" />
	<s:hidden name="phone1" />
	<s:hidden name="phone2" />
	...
	<table width="100%" border="0" align="right" class="formbg">
		...
		<tr>
			...
			<table width="100%">
				...
				<s:if test="modeLength">
					...
					%> <a href="#"
						onclick="callPage('1', 'F', '<%=totalPage%>', 'HotelMaster_callPage.action');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPage('P', 'P', '<%=totalPage%>', 'HotelMaster_callPage.action');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
						maxlength="10"
						onkeypress="callPageText(event, '<%=totalPage%>', 'HotelMaster_callPage.action');return numbersOnly();" />
					of <%=totalPage%> <a href="#"
						onclick="callPage('N', 'N', '<%=totalPage%>', 'HotelMaster_callPage.action')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'HotelMaster_callPage.action');">
		...
		<tr>
			...
			<table class="formbg" width="100%" cellspacing="0" cellspacing="1"
				border="0">
				<tr>
					<td colspan="2" class="txt"><strong class="text_head">Hotel
					Master</strong></td>
						...
						<tr>
							...
							<table width="100%" border="0">
								<tr>
									...
									<td class="formth" align="center"><label class="set"
										name="hotelname" id="hotelname"
										ondblclick="callShowDiv(this);"><%=label.get("hotelname")%></label></td>

									<td class="formth" align="center"><label class="set"
										name="hoteladdress" id="hoteladdress"
										ondblclick="callShowDiv(this);"><%=label.get("hoteladdress")%></label></td>
									...
									<s:if test="modeLength">
										...
										<s:iterator value="hoteldataList">
											<tr <%if(count%2==0){
												%> class="tableCell1"
												...
												ondblclick="javascript:callForEdit('<s:property value="hotelId"/>');">
												...
												<s:hidden value="%{hotelId}" id='<%="hotelId" + i%>'></s:hidden>
												<script type="text/javascript">
													records[<%=i%>] = document.getElementById('hotelId' + '<%=i%>').value;
												</script>
												<td width="40%" align="left" class="sortableTD"><s:property
													value="hotelName" /> <input type="hidden"
												...
												<td id="ctrlShow" align="center" nowrap="nowrap"
													...
													onclick="callForDelete1('<s:property value="hotelId"/>','<%=i%>')" /></td>
											</tr>
...
function addnewFun() {
		...
		document.getElementById('paraFrm').action = 'HotelMaster_addNew.action';
...
function searchFun() {
		...
		document.getElementById("paraFrm").action ='HotelMaster_f9action.action';
		document.getElementById("paraFrm").submit();
	}
...
function callForDelete1(id,i)
	...
	function chkDelete()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="HotelMaster_deleteChkRecords.action";
	   document.getElementById('paraFrm').target = "_self";
	    document.getElementById('paraFrm').submit();
	    }
	    else
...
function chk(){
	...
	callButton('NA', 'Y', 2);
	  	document.getElementById('paraFrm_hiddencode').value=id;
	   	document.getElementById("paraFrm").action="HotelMaster_calforedit.action";
	   	document.getElementById('paraFrm').target = "_self";
	    document.getElementById("paraFrm").submit();
   }
