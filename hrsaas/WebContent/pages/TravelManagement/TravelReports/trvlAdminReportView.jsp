...
<!-- hidden variables -->
		...
		<s:hidden name="adminRepBean.reportId"/>
		<s:hidden name="finanYear"/>
		<s:hidden name="adminRepBean.gradeName"/>
		<s:hidden name="adminRepBean.gradeId"/>
		<s:hidden name="trvlType"/>
		<s:hidden name="adminRepBean.appliFor"/>
		<s:hidden name="adminRepBean.travelCheck"/>
		<s:hidden name="hidTravelSelf"/>
		<s:hidden name="hidTravelComp"/>
		<s:hidden name="adminRepBean.accomCheck"/>
		<s:hidden name="hidAccomSelf"/>
		<s:hidden name="hidAccomComp"/>
		<s:hidden name="adminRepBean.localCheck"/>
		<s:hidden name="hidLocalSelf"/>
		<s:hidden name="hidLocalComp"/>
		
		<s:hidden name="adminRepBean.empIdFlag"/>
		<s:hidden name="adminRepBean.appliNameFlag"/>
		<s:hidden name="adminRepBean.gradeFlag"/>
		<s:hidden name="adminRepBean.appliDateFlag"/>
		<s:hidden name="adminRepBean.travelIdFlag"/>
		<s:hidden name="adminRepBean.startDateFlag"/>
		<s:hidden name="adminRepBean.endDateFlag"/>
		<s:hidden name="adminRepBean.purposeFlag"/>
		<s:hidden name="adminRepBean.typeFlag"/>
		<s:hidden name="adminRepBean.apprvdAmtFlag"/>
		<s:hidden name="adminRepBean.travelCostFlag"/>
		<s:hidden name="adminRepBean.accomCostFlag"/>
		<s:hidden name="adminRepBean.localCostFlag"/>
		...
		<s:hidden name="adminRepBean.branchName"/>
		<s:hidden name="adminRepBean.branchId"/>
		<s:hidden name="adminRepBean.deptName"/>
		<s:hidden name="adminRepBean.deptId"/>
		<s:hidden name="adminRepBean.empId"/>
		<s:hidden name="adminRepBean.empToken"/>
		<s:hidden name="adminRepBean.empName"/>
		...
		<s:hidden name="adminRepBean.reportTitle" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>Report for Admin Head </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('TravelAdminReport_report.action');   
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='TravelAdminReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}		
</script>