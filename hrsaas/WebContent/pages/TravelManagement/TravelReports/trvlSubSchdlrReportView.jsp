...
<s:form action="TravelSubSchdlrReport" validate="true" id="paraFrm"
	theme="simple">
	...
	<s:hidden name="bookCycleSelect" />
	<s:hidden name="bookCycleFrom" />
	<s:hidden name="bookCycleTo" />
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">Report
					For Sub Scheduler</strong></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>Report
							For Sub Scheduler </strong></td>
							<%
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('TravelSubSchdlrReport_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='TravelSubSchdlrReport_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
