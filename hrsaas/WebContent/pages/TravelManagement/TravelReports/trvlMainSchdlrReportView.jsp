...
<s:form action="TravelMainSchdlrReport" validate="true" id="paraFrm"
	theme="simple">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">Report For Main Scheduler</strong></td>
	...
	<s:hidden name="applDateSelect" />
	<s:hidden name="applDateFrm" />
	<s:hidden name="applDateTo" />	
	<s:hidden name="applStatus" />
	<s:hidden name="apprvrToken" />
	<s:hidden name="apprvrCode" />
	<s:hidden name="apprvrName" />
	<s:hidden name="subSchdlrToken" />
	<s:hidden name="subSchdlrCode" />
	<s:hidden name="subSchdlrName" />
	<s:hidden name="applFor" />
	<s:hidden name="travelCheckVal" />
	<s:hidden name="travelCheck" />
	<s:hidden name="hidTravelSelf" />
	<s:hidden name="trvlSelf" />
	<s:hidden name="hidTravelComp" />
	<s:hidden name="trvlComp" />
	<s:hidden name="accomCheckVal" />
	<s:hidden name="accomCheck" />
	<s:hidden name="hidAccomSelf" />
	<s:hidden name="accomSelf" />
	<s:hidden name="hidAccomComp" />
	<s:hidden name="accomComp" />
	<s:hidden name="localCheckVal" />
	<s:hidden name="localCheck" />
	<s:hidden name="hidLocalSelf" />
	<s:hidden name="localSelf" />
	<s:hidden name="hidLocalComp" />	
	<s:hidden name="localComp" />
	<s:hidden name="empIdFlag"/>
	<s:hidden name="travelIdFlag" />
	<s:hidden name="trvlTypeFlag" />
	<s:hidden name="branchFlag" />
	<s:hidden name="travelStrtDateFlag" />
	<s:hidden name="subSchdlrFlag" />
	<s:hidden name="gradeFlag" />
	<s:hidden name="travelEndDateFlag" />
	<s:hidden name="applcntNameFlag" />
	<s:hidden name="trvlPurposeFlag" />
	<s:hidden name="travelAssignDateFlag" />
	<s:hidden name="apprvrFlag" />
	<s:hidden name="trvlStatusFlag" />
	<s:hidden name="trvlBkngDateFlag" />
	<s:hidden name="trvlInitrNameFlag" />	
	...
	<s:hidden name="assignDateSelect" />
	<s:hidden name="TADfromDate" />
	<s:hidden name="TADToDate" />
	<s:hidden name="trvlStrtDateSelect" />
	<s:hidden name="TSDfromDate" />
	<s:hidden name="TSDToDate" />
	<s:hidden name="trvlBookingDateSelect" />
	<s:hidden name="TBDfromDate" />
	<s:hidden name="TBDToDate" />
	<s:hidden name="schCycleSelect" />
	<s:hidden name="schCycleFrom" />
	<s:hidden name="schCycleTo" />
	<s:hidden name="trvlType" />
	<s:hidden name="gradeId" />
	<s:hidden name="gradeName" />
	<s:hidden name="brnchCode" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>Report For Main Scheduler </strong></td>
							<%
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<s:if test="noData">
									<tr>
										<td width="100%" colspan="16" align="center"><font
											color="red">There is no data to display.</font></td>
									</tr>
								</s:if>
								<s:else>
									<tr>
										<td width="100%" colspan="16" align="right"><b>Total
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('TravelMainSchdlrReport_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='TravelMainSchdlrReport_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
