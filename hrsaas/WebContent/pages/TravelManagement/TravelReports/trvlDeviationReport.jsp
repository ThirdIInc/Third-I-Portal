...
<s:form action="TrvlDeviationReport" method="post" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Deviation
					Report </strong></td>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					...
					<input type ="button" value=" Generate Report" name="Generate Report" class="token"
						onclick="javascript:return callReport('deviationReport');">
					</td>
				</tr>
...
function callReport(action){
	if(!validateFilter()){
		...
		document.getElementById('paraFrm').action='TrvlDeviationReport_'+action+'.action';
