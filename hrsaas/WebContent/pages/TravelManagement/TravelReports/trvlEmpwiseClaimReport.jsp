...
<s:form action="TrvlEmpClaimReport" method="post" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Claim Employeewise Report</strong></td>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					...
					<input type ="button" value=" Generate Report" name="Generate Report" class="token"
						onclick="javascript:return callReport('empwiseClaimReport');">
					</td>
				</tr>
...
function callReport(action){
	...
	document.getElementById('paraFrm').action='TrvlEmpClaimReport_'+action+'.action';
