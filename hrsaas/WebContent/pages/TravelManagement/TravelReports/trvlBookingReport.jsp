...
<s:form action="TrvlBookingReport" method="post" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Booking
					Report </strong></td>
...
<script>
	...
	if(!validateFilter()){
		...
		document.getElementById('paraFrm').action='TrvlBookingReport_generateReport.action';
