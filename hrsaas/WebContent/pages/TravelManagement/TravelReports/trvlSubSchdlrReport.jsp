...
<s:form action="TravelSubSchdlrReport" id="paraFrm" theme="simple">
	...
	<table width="100%" border="0" align="right" cellpadding="2"
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					Report For Sub Scheduler </strong></td>
		...
		document.getElementById("paraFrm").action = 'TravelSubSchdlrReport_searchSavedReport.action';
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td colspan="6"><s:hidden name="apprvrToken" /> <s:hidden
						...
						onclick="javascript:callsF9(500,325,'TravelSubSchdlrReport_f9ApprvrAction.action');">
					</td>
				</tr>
			...
			<!-- MAIN SCHEDULER -->
				...
				<tr>
					<td colspan="1" width="20%"><label class="set"
						name="tms.mainSchdlr" id="tms.mainSchdlr"
						ondblclick="callShowDiv(this);"><%=label.get("tms.mainSchdlr")%></label>
					:</td>
					<td colspan="6"><s:hidden name="mainSchdlrToken" /> <s:hidden
						name="mainSchdlrCode" /> <s:textfield size="25" name="mainSchdlrName"
						readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelSubSchdlrReport_f9MainSchdlrAction.action');">
					</td>
				</tr>
		 ...
		 for(var i=0;i<3;i++)
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="30%" align="right" colspan="1"><label class="set" name="branch"
						id="branch12" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>:</td>
							<td colspan="1">
							<s:checkbox theme="simple"
								name="branchFlag" onclick="AddItem('branch',this);" />							
							</td>
						</tr>
						<!-- TRAVEL START DATE,TRAVEL MAIN SCHEDULER NAME,GRADE-->
						<tr>
							<td width="30%" align="right" colspan="1"><label class="set"
							...
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.mainSchdlr" id="tms.mainSchdlr12"
								ondblclick="callShowDiv(this);"><%=label.get("tms.mainSchdlr")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="mainSchdlrFlag" onclick="AddItem('tms.mainSchdlr12',this);" /></td>
							<td width="30%" align="right" colspan="1"><label class="set"
								name="grade" id="grade12"
								ondblclick="callShowDiv(this);"><%=label.get("grade")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="gradeFlag" onclick="AddItem('grade',this);" /></td>
						</tr>
						...
						<tr>
							...
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.trvlStatus" id="tms.trvlStatus1"
								ondblclick="callShowDiv(this);"><%=label.get("tms.trvlStatus")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="trvlStatusFlag"
								onclick="AddItem('tms.trvlStatus1',this);" /></td>
						</tr>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					...
					<td colspan="1" width="20%"><label class="set"
						name="tms.bookngCycleWise" id="tms.bookngCycleWise123"
						ondblclick="callShowDiv(this);"><%=label.get("tms.bookngCycleWise")%></label>:</td>
					<td colspan="1" align="left" width="10%"><s:select
						theme="simple" name="bookCycleSelect" value="%{bookCycleSelect}"
						cssStyle="width: 80px"
						list="#{'':'--Select--','IE':'=','LT':'<','GT':'>','LE':'<=',
						'GE':'>=','BN':'Between'}"
						onchange="callBetween(this,'5');" /></td>

					<td>&nbsp;<s:textfield name="bookCycleFrom" size="9"
						onkeypress="return numbersOnly();" maxlength="2" /></td>
					<td colspan="4" id="betweenOn5" width="70%" height="22">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td colspan="1" id="toDateDiv4" width="15%" align="center"><strong>
							AND </strong></td>
							<td colspan="1" height="22" width="10%" id="toDivAndText"><s:textfield
								name="bookCycleTo" size="9" onkeypress="return numbersOnly();"
								maxlength="2" /></td>
							<td colspan="2">&nbsp;</td>
						</tr>
					</table>
				...
				<tr>
					...
					<td colspan="6"><s:hidden name="gradeId" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelSubSchdlrReport_f9cadretaction.action');">
					</td>
				</tr>
				<tr>
					...
					<td colspan="6"><s:hidden name="brnchCode" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelSubSchdlrReport_f9centeraction.action');">
					</td>
				</tr>
				<tr>
					<td colspan="1" width="20%"><label class="set"
					...
					<td colspan="6"><s:hidden name="deptCode" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelSubSchdlrReport_f9deptaction.action');">
					</td>
				</tr>
			</table>
			</div>
...
<script>
 	...
 	function callAllDisable(){
 	 ...
 	 var fields= ["","assignDateSelect","trvlStrtDateSelect","trvlBookingDateSelect"]; 	 
  		...
  		for(var idNo=1;idNo <=3;idNo++){  		
	  	       ...
	  	       if(document.getElementById("paraFrm_bookCycleSelect").value=="BN"){
	...
	//To Travel Assign Date
		...
		//Travel Start Date
			...
			//Schedule Cycle Wise:
              if(document.getElementById("paraFrm_bookCycleSelect").value!=""){
				if(document.getElementById("paraFrm_bookCycleFrom").value==""){
					alert("Please enter Booking Cycle Wise");
					return false;
				}
				if(document.getElementById("paraFrm_bookCycleSelect").value=="BN"){
					if(document.getElementById("paraFrm_bookCycleTo").value==""){
						alert("Please enter Booking Cycle Wise");
						document.getElementById('paraFrm_bookCycleTo').focus();
						return false;
					}
				}
			}
	//validations endds
   	  ...
   	  // == end of sort======
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="TravelSubSchdlrReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="TravelSubSchdlrReport_report.action";
			document.getElementById('paraFrm').submit();
	...
	{
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="TravelSubSchdlrReport_reset.action";
		document.getElementById('paraFrm').submit();
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="TravelSubSchdlrReport_saveReport.action";
		document.getElementById('paraFrm').submit();
