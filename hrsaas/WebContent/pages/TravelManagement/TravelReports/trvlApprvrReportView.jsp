...
<s:form action="TravelApprvrReport" validate="true" id="paraFrm"
	theme="simple">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">Report For Approver</strong></td>
	...
	<s:hidden name="apprvrAmtSelect"/>
	<s:hidden name="apprvrAmtFrom"/>
	<s:hidden name="apprvrAmtTo"/>
	<s:hidden name="apprvdDateSelect"/>
	<s:hidden name="apprvdDateFrm"/>
	<s:hidden name="apprvdDateTo"/>
	...
	<s:hidden name="DOAfromDate"/>
	<s:hidden name="DOAToDate"/>
	<s:hidden name="schTrvlDateSelect"/>
	<s:hidden name="STDfromDate"/>
	<s:hidden name="STDToDate"/>
	<s:hidden name="trvlStrtDateSelect"/>
	<s:hidden name="TSDfromDate"/>
	<s:hidden name="TSDToDate"/>
	<s:hidden name="trvlEndDateSelect"/>
	<s:hidden name="TEDfromDate"/>
	<s:hidden name="TEDToDate"/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>Report For Approver </strong></td>
							<%
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('TravelApprvrReport_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='TravelApprvrReport_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
