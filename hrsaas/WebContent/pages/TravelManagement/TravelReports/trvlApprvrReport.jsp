...
<s:form action="TravelApprvrReport" id="paraFrm" theme="simple">
	...
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<tr>
			<td valign="bottom" class="txt" width="100%" colspan="3">
			<table width="100%" border="0" align="right" cellpadding="0"
				cellspacing="0" class="formbg">
				<tr>
					<td colspan="1" width="3%"><strong class="text_head"><img
						src="../pages/images/recruitment/review_shared.gif" width="25"
						height="25" /></strong></td>
					<td width="93%" class="txt" colspan="1"><strong
						class="text_head"> Report For Approver </strong></td>
					<td valign="top" class="txt" colspan="1" width="4%">
					<div align="right"><img
		...
		document.getElementById("paraFrm").action = 'TravelApprvrReport_searchSavedReport.action';
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="formbg"
				...
				<tr>
					...
					<td colspan="1" width="70%"><s:textfield size="30"
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="1" width="20%"><label class="set"
						name="tms.empName" id="tms.empName1"
						ondblclick="callShowDiv(this);"><%=label.get("tms.empName")%></label>
					:</td>
					<td colspan="6"><s:hidden name="empToken" /> <s:hidden
						name="empCode" /> <s:textfield size="25" name="empName"
						readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelApprvrReport_f9EMPaction.action');">
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="6"><s:select name="applStatus" id="sta"
						...
						list="#{'A':'Approved','R':'Rejected','B':'Returned'}"
						value="%{applStatus}" /></td>
				...
				<tr>
					...
					<td colspan="1" width="20%"><label class="set"
						name="tms.apprvdAmt" id="tms.apprvdAmt1"
						ondblclick="callShowDiv(this);"><%=label.get("tms.apprvdAmt")%></label>:</td>
					<td colspan="1" align="left" width="10%"><s:select
						theme="simple" name="apprvrAmtSelect" value="%{apprvrAmtSelect}"
						cssStyle="width: 80px"
						list="#{'':'--Select--','IE':'=','LT':'<','GT':'>','LE':'<=',
						'GE':'>=','BN':'Between'}"
						onchange="callBetween(this,'1');" /></td>

					<td>&nbsp;<s:textfield name="apprvrAmtFrom" size="9"
						onkeypress="return numbersOnly();" maxlength="6" /></td>
					<td colspan="4" id="betweenOn1" width="70%" height="22">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td colspan="1" height="22" width="10%" id="toDivAndText"><s:textfield
								name="apprvrAmtTo" size="9" onkeypress="return numbersOnly();"
								maxlength="6" /></td>
							<td colspan="2">&nbsp;</td>
						</tr>
				...
				<tr>
					...
					<td colspan="1" height="22" width="20%"><label class="set"
						name="tms.apprvrDate" id="tms.apprvrDate"
						ondblclick="callShowDiv(this);"><%=label.get("tms.apprvrDate")%></label>:</td>
					<td colspan="1" align="left" width="10%"><s:select
						theme="simple" name="apprvdDateSelect" value="%{apprvdDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="call2DateDisp4ApprvdDate(this,'1','apprvdDate' );" /></td>

					<td colspan="1" width="10%">&nbsp;<s:textfield size="9"
						onkeypress="return numbersWithHiphen();" name="apprvdDateFrm"
						onblur="setText('paraFrm_apprvdDateFrm','dd-mm-yyyy')"
						onfocus="clearText('paraFrm_apprvdDateFrm','dd-mm-yyyy')"
						maxlength="10" /></td>
					<td>&nbsp;<s:a
						href="javascript:NewCal('paraFrm_apprvdDateFrm','DDMMYYYY');">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td colspan="1" id="apprvdDTToDateDiv" width="15%" align="center"><strong>AND
							</strong></td>
							<td width="10%" colspan="1" id="apprvdDTToDateDivLabel"
								height="22"><s:textfield size="9"
								onkeypress="return numbersWithHiphen();" name="apprvdDateTo"
								onblur="setText('paraFrm_apprvdDateTo','dd-mm-yyyy')"
								onfocus="clearText('paraFrm_apprvdDateTo','dd-mm-yyyy')"
								maxlength="10" /></td>
							<td id="apprvdDTToDatePicker">&nbsp;<s:a
								href="javascript:NewCal('paraFrm_apprvdDateTo','DDMMYYYY');">
								<img class="iconImage"
		 ...
		 for(var i=0;i<3;i++)
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<!-- EMPLOYEE ID,TRAVEL TYPE,ADVANCE AMOUNT-->
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple" name="empIdFlag"
								onclick="AddItem('employee.id',this);" /></td>
							<td width="30%" align="right" colspan="1"><label class="set"
							...
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.advanceAmt" id="tms.advanceAmt"
								ondblclick="callShowDiv(this);"><%=label.get("tms.advanceAmt")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple" name="advAmtFlag"
								onclick="AddItem('tms.advanceAmt',this);" /></td>
						</tr>
						<!-- EMPLOYEE NAME,TRAVEL APPLICATION DATE,APPROVED AMOUNT-->
						<tr>
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.empName" id="tms.empName"
								ondblclick="callShowDiv(this);"><%=label.get("tms.empName")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="empNameFlag" onclick="AddItem('tms.empName',this);" /></td>
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.applDate" id="tms.applDate"
								ondblclick="callShowDiv(this);"><%=label.get("tms.applDate")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="applDateFlag" onclick="AddItem('tms.applDate',this);" /></td>
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.apprvdAmt" id="tms.apprvdAmt"
								ondblclick="callShowDiv(this);"><%=label.get("tms.apprvdAmt")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="apprvdAmtFlag" onclick="AddItem('tms.apprvdAmt',this);" /></td>
						</tr>

						<!-- TRAVEL START DATE,TRAVEL PURPOSE,TRAVEL END DATE-->
						<tr>
					<!-- 	<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.trvlId" id="tms.trvlId"
								ondblclick="callShowDiv(this);"><%=label.get("tms.trvlId")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"   
								name="travelIdFlag" onclick="AddItem('tms.trvlId',this);" /></td>
					-->
							<td width="30%" align="right" colspan="1"><label class="set"
						...
						<tr>
							...
							<td width="30%" align="right" colspan="1"><label class="set"
								name="tms.polViolated" id="tms.polViolated"
								ondblclick="callShowDiv(this);"><%=label.get("tms.polViolated")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="polViolatedFlag"
								onclick="AddItem('tms.polViolated',this);" /></td>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					...
					<td colspan="1" height="22" width="20%"><label class="set"
						name="tms.applDate" id="tms.applDate1"
						ondblclick="callShowDiv(this);"><%=label.get("tms.applDate")%></label>:</td>
					<td colspan="1" align="left" width="10%" align="left"><s:select
						theme="simple" name="applDateSelect" value="%{applDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'1','DOA');" /></td>

					<td colspan="1" width="10%" height="22"><s:textfield
						name="DOAfromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_DOAfromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_DOAfromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td><s:a
						href="javascript:NewCal('paraFrm_DOAfromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					...
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="10%" colspan="1" id="toDateDivLabel1" height="22">&nbsp;<s:textfield
								name="DOAToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_DOAToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_DOAToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td id="toDatePicker1"><s:a
								href="javascript:NewCal('paraFrm_DOAToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
				...
				<td colspan="1" height="22"><label class="set"
					name="tms.schTrvlDate" id="tms.schTrvlDate"
					ondblclick="callShowDiv(this);"><%=label.get("tms.schTrvlDate")%></label>:</td>
				<td colspan="1" width="80" align="left"><s:select
					theme="simple" name="schTrvlDateSelect"
					value="%{schTrvlDateSelect}"
					list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
					onchange="callToDateDispOnClick(this,'2','STD');" /></td>

				<td width="47" colspan="1" height="22"><s:textfield
					name="STDfromDate" maxlength="10"
					onkeypress="return numbersWithHiphen();"
					onfocus="clearText('paraFrm_STDfromDate','dd-mm-yyyy')"
					onblur="setText('paraFrm_STDfromDate','dd-mm-yyyy')" maxlength="10"
					size="9" /></td>
				<td width="90" colspan="1" height="22"><s:a
					href="javascript:NewCal('paraFrm_STDfromDate','DDMMYYYY');">
					<img class="iconImage" src="../pages/images/recruitment/Date.gif"
						width="16" height="16" border="0" align="absmiddle" />
				</s:a></td>
				<td colspan="3" height="22">
				<table cellspacing="0" cellpadding="0" border="0"
					...
					<tr>
						...
						<td width="52" id="toDateDivLabel2" height="22"><s:textfield
							name="STDToDate" maxlength="10"
							onkeypress="return numbersWithHiphen();"
							onfocus="clearText('paraFrm_STDToDate','dd-mm-yyyy')"
							onblur="setText('paraFrm_STDToDate','dd-mm-yyyy')" maxlength="10"
							size="9" /></td>
						<td width="449" id="toDatePicker2"><s:a
							href="javascript:NewCal('paraFrm_STDToDate','DDMMYYYY');">
							<img class="iconImage" src="../pages/images/recruitment/Date.gif"
								width="16" height="16" border="0" align="absmiddle" />
						</s:a></td>
					</tr>
				...
				<td colspan="1" height="22"><label class="set"
					name="tms.trvlStrtDate" id="tms.trvlStrtDate1"
					ondblclick="callShowDiv(this);"><%=label.get("tms.trvlStrtDate")%></label>:</td>
				<td colspan="1" width="80" align="left"><s:select
					...
					list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
					onchange="callToDateDispOnClick(this,'3','TSD');" /></td>
				...
				<tr>
					...
					<td colspan="1" height="22"><label class="set"
						name="tms.trvlEndDate" id="tms.trvlEndDate1"
						ondblclick="callShowDiv(this);"><%=label.get("tms.trvlEndDate")%></label>:</td>
					<td colspan="1" width="80" align="left"><s:select
						theme="simple" name="trvlEndDateSelect"
						value="%{trvlEndDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'4','TED');" /></td>

					<td width="47" colspan="1" height="22"><s:textfield
						name="TEDfromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_TEDfromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_TEDfromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="90" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_TEDfromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22">
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel4" height="22"><s:textfield
								name="TEDToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_TEDToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_TEDToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker4"><s:a
								href="javascript:NewCal('paraFrm_TEDToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
				...
				<tr>
					...
					<td colspan="1" width="20%"><label class="set"
						name="tms.schCycleWise" id="tms.schCycleWise"
					...
					<td colspan="4" id="betweenOn2" width="70%" height="22">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
				...
				<tr>
					...
					<td colspan="6"><s:hidden name="gradeId" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelApprvrReport_f9cadretaction.action');">
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="6"><s:hidden name="brnchCode" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelApprvrReport_f9centeraction.action');">
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="6"><s:hidden name="deptCode" /> <s:textfield
						...
						src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage"
						onclick="javascript:callsF9(500,325,'TravelApprvrReport_f9deptaction.action');">
					</td>
				</tr>
...
<script>
	...
	function callToDateDispOnClick(obj,idNo,idName)
 	...
 	//alert("id num---"+idNo+" idName-------------"+idName);
 	//alert("callToDateDispOnClick");
   		try{
 	...
 	function call2DateDisp4ApprvdDate(obj,idNo,idName)
 	{
 	//alert("call2DateDisp4ApprvdDate");
   		try{
   			var dateFilter= obj.value;
 			//alert(dateFilter);
   			document.getElementById('paraFrm_apprvdDateTo').value="";  
   			if(dateFilter=="BN"){
     			document.getElementById('apprvdDTToDateDiv').style.display=''; 
     			document.getElementById('apprvdDTToDateDivLabel').style.display='';  
	  			document.getElementById('apprvdDTToDatePicker').style.display='';
 
      			setText('paraFrm_apprvdDateTo',"dd-mm-yyyy");
   			}else {
      			setText('paraFrm_apprvdDateTo',"dd-mm-yyyy");
     			document.getElementById('apprvdDTToDateDiv').style.display='none'; 
     			document.getElementById('apprvdDTToDateDivLabel').style.display='none';  
	  			document.getElementById('apprvdDTToDatePicker').style.display='none';
   			} 
   		}catch(e){
   			alert(e);
   		}
	...
	function callBetween(obj,idNo)
	{
 	...
 	function callAllDisable(){
 	      ...
 	      var fields= ["","applDateSelect","schTrvlDateSelect","trvlStrtDateSelect","trvlEndDateSelect"]; 	      
 	
		  		for(var idNo=1;idNo <=4;idNo++){ 		  		
			  	...
			  	if(document.getElementById("paraFrm_apprvdDateSelect").value=="BN"){
			  	document.getElementById('apprvdDTToDateDiv').style.display=''; 
		     	document.getElementById('apprvdDTToDateDivLabel').style.display='';  
			  	document.getElementById('apprvdDTToDatePicker').style.display='';
			  	}
		     	...
		     	document.getElementById('apprvdDTToDateDivLabel').style.display='none';  
			  	...
			  	if(document.getElementById("paraFrm_apprvrAmtSelect").value=="BN"){
				...
				{
				  document.getElementById('betweenOn2').style.display='none';
				}
...
//approved amount
              if(document.getElementById("paraFrm_apprvrAmtSelect").value!=""){
				if(document.getElementById("paraFrm_apprvrAmtFrom").value==""){
					alert("Please enter Approved amount");
					document.getElementById('paraFrm_apprvrAmtFrom').focus();
					return false;
				}
				if(document.getElementById("paraFrm_apprvrAmtSelect").value=="BN"){
					if(document.getElementById("paraFrm_apprvrAmtTo").value==""){
						alert("Please enter Approved amount");
						document.getElementById('paraFrm_apprvrAmtTo').focus();
						return false;
					}
					var v1 = parseFloat(document.getElementById("paraFrm_apprvrAmtFrom").value);
					var v2 = parseFloat(document.getElementById("paraFrm_apprvrAmtTo").value);
					if(v1>v2)
					{
						alert(document.getElementById('tms.apprvdAmt').innerHTML+" from value should less than to value");
						document.getElementById('paraFrm_apprvrAmtTo').focus();
						return false;
					}
				}
		    ...
		    var apprvdfrmDate=document.getElementById('paraFrm_apprvdDateFrm').value;
			var apprvdtoDate=document.getElementById('paraFrm_apprvdDateTo').value;
	

		if(document.getElementById("paraFrm_apprvdDateSelect").value!=""){
				if(apprvdfrmDate=="" || apprvdfrmDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('tms.apprvrDate').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_apprvdDateSelect").value=="BN"){
					if(apprvdtoDate==""||apprvdtoDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('tms.apprvrDate').innerHTML);
						return false;
					}
				}
				...
				if(apprvdfrmDate!=""||apprvdfrmDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_apprvdDateFrm'];
				  	var lbl=['tms.apprvrDate'];
	  			...
	  			if(apprvdtoDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_apprvdDateTo'];
			  		var lbl=['tms.apprvrDate'];
...
//application date
			var applfrmDate=document.getElementById('paraFrm_DOAfromDate').value;
			var appltoDate=document.getElementById('paraFrm_DOAToDate').value;


		if(document.getElementById("paraFrm_applDateSelect").value!=""){
				if(applfrmDate=="" || applfrmDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('tms.applDate1').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_applDateSelect").value=="BN"){
					if(appltoDate==""||appltoDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('tms.applDate1').innerHTML);
						return false;
					}
				}
				...
				if(applfrmDate!=""||applfrmDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_DOAfromDate'];
				  	var lbl=['tms.applDate1'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(appltoDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_appltoDate'];
			  		  	var lbl=['tms.applDate1'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
...
//Scheduled Travel Date
			...
			var schfrmDate=document.getElementById('paraFrm_STDfromDate').value;
			var schtoDate=document.getElementById('paraFrm_STDToDate').value;
			
						if(document.getElementById("paraFrm_schTrvlDateSelect").value!=""){
				if(schfrmDate=="" || schfrmDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('tms.schTrvlDate').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_schTrvlDateSelect").value=="BN"){
					if(schtoDate==""||schtoDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('tms.schTrvlDate').innerHTML);
						return false;
					}
				}
				...
				if(schfrmDate!=""||schfrmDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_STDfromDate'];
				  	var lbl=['tms.schTrvlDate'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(schtoDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_STDToDate'];
			  	  	var lbl=['tms.schTrvlDate'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
...
//Travel Start Date
			var strtfrmDate=document.getElementById('paraFrm_TSDfromDate').value;
			var strttoDate=document.getElementById('paraFrm_TSDToDate').value;
			
			if(document.getElementById("paraFrm_trvlStrtDateSelect").value!=""){
				if(strtfrmDate=="" || strtfrmDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('tms.trvlStrtDate1').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_trvlStrtDateSelect").value=="BN"){
					if(strttoDate==""||strttoDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('tms.trvlStrtDate1').innerHTML);
						return false;
					}
				}
...
//Travel End Date
			...
			var endfrmDate=document.getElementById('paraFrm_TEDfromDate').value;
			var endtoDate=document.getElementById('paraFrm_TEDToDate').value;
			
if(document.getElementById("paraFrm_trvlEndDateSelect").value!=""){
				if(endfrmDate=="" || endfrmDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('tms.trvlEndDate1').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_trvlEndDateSelect").value=="BN"){
				...
				if(endfrmDate!=""||endfrmDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_TEDfromDate'];
				  	var lbl=['tms.trvlEndDate1'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
...
//validations end
   	  ...
   	  // == end of sort======
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="TravelApprvrReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="TravelApprvrReport_report.action";
			document.getElementById('paraFrm').submit();
	...
	{
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="TravelApprvrReport_reset.action";
		document.getElementById('paraFrm').submit();
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="TravelApprvrReport_saveReport.action";
		document.getElementById('paraFrm').submit();
