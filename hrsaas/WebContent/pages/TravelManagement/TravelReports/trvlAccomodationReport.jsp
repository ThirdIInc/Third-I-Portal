...
<s:form action="TrvlAccomReport" method="post" id="paraFrm"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1"
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					<td width="30%">
					<s:a href="#" onclick="javascript:return callReport('empwiseAccomodationReport');">
					Click to generate Employeewise Report</s:a>
					</td>
					<td width="30%"><s:a href="#" onclick="javascript:return callReport('deptwiseAccomodationReport');">
					Click to generate Departmentwise Report</s:a>
					</td>
					<td width="30%"><s:a href="#" onclick="javascript:return callReport('zonewiseAccomodationReport');">
...
function callReport(action){
	...
	document.getElementById('paraFrm').action='TrvlAccomReport_'+action+'.action';
