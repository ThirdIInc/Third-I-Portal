...
<s:form action="TrvlAirlinesCostReport" method="post" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Mode Cost Report </strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					...
					:</td>
					<td colspan="3"><s:select theme="simple" name="reportType"
				...
				<tr>
					...
					<td>Select Mode: </td>
					<td colspan="3"><s:select name="travelMode" list="travelModeMap"  size="1" 
								cssStyle="width:150" theme="simple"  /></td>
				</tr>

				<tr>
					<td width="50%" colspan="2">
					<s:a href="#" onclick="javascript:return callReport('modewiseReport');">
					Click to generate Modewise Cost Report</s:a>
					</td>
					<td width="50%" colspan="2"><s:a href="#" onclick="javascript:return callReport('routewiseModewiseReport');">
					Click to generate Routewise Modewise Cost Report</s:a>
					</td>
...
function callReport(action){
	...
	document.getElementById('paraFrm').action='TrvlAirlinesCostReport_'+action+'.action';
