...
<s:form action="TrvlApplicantReport" validate="true" id="paraFrm"
	theme="simple">
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">Applicant
					Report</strong></td>
		...
		<s:hidden name="selectAdvanceFilter " />
		<s:hidden name="costwiseSelect" />
		<s:hidden name="costwise " />
		<s:hidden name="startDate " />
		<s:hidden name="startDtSelect " />
		<s:hidden name="endDate " />
		<s:hidden name="endDtSelect " />
		<s:hidden name="cyclewiseSelect" />
		<s:hidden name="cyclewise " />
		<s:hidden name="durationwiselSelect " />
		<s:hidden name="durationwise " />
		<s:hidden name="trvlFlag " />
		<s:hidden name="accoFlag " />
		<s:hidden name="convFlag " />

		<s:hidden name="applDtSelect" />
		<s:hidden name="applicationDate" />
		<s:hidden name="applForSelect " />
		<s:hidden name="stsSelect" />
		<s:hidden name="travelId " />
		<s:hidden name="trvlPurpose" />
		<s:hidden name="trvlPurposeId" />
		<s:hidden name="arrangeSelect " />
		<s:hidden name="trvlId " />
		<s:hidden name="empId" />
		<s:hidden name="empName " />
		<s:hidden name=" applDate" />
		<s:hidden name=" branch " />
		<s:hidden name=" travelStartDate " />
		<s:hidden name=" grade" />
		<s:hidden name=" travelEndDate " />
		<s:hidden name="travelType  " />
		<s:hidden name="travelPurpose" />
		<s:hidden name="trvlAdvAmt " />
		<s:hidden name="approver " />
		<s:hidden name="initName " />

		<s:hidden name="hTrvChk " />
		<s:hidden name="trvChk " />
		...
		<s:hidden name="hAccomChk " />
		<s:hidden name="accomChk " />
		<s:hidden name="accomRadio " />
		<s:hidden name="hTrConv " />
		<s:hidden name="trConv " />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>Applicant
							Report </strong></td>
							<%
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<s:else>
									<tr>
										<td width="100%" colspan="14" align="right"><b>Total
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('TrvlApplicantReport_report.action');    
}
...
function callBack()
 {
  ...
  document.getElementById('paraFrm').action='TrvlApplicantReport_callBack.action';
  document.getElementById('paraFrm').submit(); 
 }
