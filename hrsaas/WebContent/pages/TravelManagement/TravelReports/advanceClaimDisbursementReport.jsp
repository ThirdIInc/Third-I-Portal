...
<s:form action="AdvanceClaimDisbursementReport" method="post" id="paraFrm"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="1"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Report for Advance/Claim Disbursement</strong></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="right"><span class="style2"><font
						color="red">*</font></span> Indicates Required  
						</div>
					</td>
				</tr>
			</table>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					<td ><label class="set" name="payment.Mode"
						id="payment.Mode" ondblclick="callShowDiv(this);"><%=label.get("payment.Mode.sel")%></label>
					:</td>
					<td><s:select name="paymentMode"
						theme="simple" headerKey="" headerValue="--Select--"
						list="#{'CA':'Cash','CH':'Cheque','TR':'Transfer','IS':'In Salary'}" /></td>
				...
				<tr>
					...
					<td><s:select theme="simple" name="reportType"
						cssStyle="width:152" list="#{'X':'Xls','P':'Pdf','T':'Txt'}" /></td>
...
function resetFun() {
  	 ...
  	 document.getElementById('paraFrm').action = 'AdvanceClaimDisbursementReport_reset.action';
 ...
 function reportFun(){
	...
	document.getElementById('paraFrm').target='_self';
	document.getElementById('paraFrm').action='AdvanceClaimDisbursementReport_generateReport.action';
	document.getElementById('paraFrm').submit();
	}
}
