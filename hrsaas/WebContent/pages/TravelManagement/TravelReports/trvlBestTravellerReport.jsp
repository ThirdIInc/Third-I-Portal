...
<s:form action="TrvlBestTravellerReport" method="post" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Best Traveler Report  </strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					...
					<td><input type="button" value="Generate Report" Class="token"
									onclick="return callGenerateReport();">
					</td>
				</tr>
	<!-- 
				<tr>
...
<script>
	...
	if(!validateFilter()){
		...
		document.getElementById('paraFrm').action='TrvlBestTravellerReport_generateReport.action';
	...
	function callReport(action){
		alert(action);
		document.getElementById('paraFrm').target='_self';
		document.getElementById('paraFrm').action='TrvlBestTravellerReport_'+action+'.action';
		document.getElementById('paraFrm').submit();
	}
	*/
