					    ...
					    <tr>
						     <td>
									<table width="100%" border="0" align="center" cellpadding="0"
										cellspacing="0">
										<tr>
											<td height="27" class="text_head"><strong>Offer Letter Information </strong></td>
                               <%
					      ...
					      <tr> 
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1" class="sortable"><!--Table 6-->
								<tr>   
									...
									<td width="25%" valign="top" class="formth"><label  class = "set" name="reqs.code" id="reqs.code2" ondblclick="callShowDiv(this);"><%=label.get("reqs.code")%></label></td>
									</s:if>
									...
									<td width="" valign="top" class="formth" ><label  class = "set" name="offerDueLabel" id="offerDueLabel" ondblclick="callShowDiv(this);"><%=label.get("offerDueLabel")%></label></td>
									</s:if> 
			            	 	    <s:if test="offerIssueChkFlag">
			            	 	    <td width="" valign="top" class="formth" ><label  class = "set" name="offerIssueLabel" id="offerIssueLabel" ondblclick="callShowDiv(this);"><%=label.get("offerIssueLabel")%></label></td> 
			            		    </s:if>
									...
									<td width="" valign="top" class="formth" ><label  class = "set" name="offerRejectedLabel" id="offerRejectedLabel" 	ondblclick="callShowDiv(this);"><%=label.get("offerRejectedLabel")%></label></td> 
			            	 	    </s:if> 
				            	 	 <s:if test="offerCancelChkFlag">
				            	 	 <td width="" valign="top" class="formth" ><label  class = "set" name="offerCancelLabel" id="offerCancelLabel"  ondblclick="callShowDiv(this);"><%=label.get("offerCancelLabel")%></label></td> 
				            		</s:if> 
				            		
				            		<td width="25%" valign="top" class="formth" ><label  class = "set" name="offerDateLabel" id="offerDateLabel"  ondblclick="callShowDiv(this);"><%=label.get("offerDateLabel")%></label></td>
				              	</tr>
								...
								<s:iterator value="openViewList">  
									...
									<td width="25%"  class="sortableTD"> <s:property value="ivPostion"/></td> 
									 ...
									 <s:if test="reqDateChkFlag">
									<td width="20%" align="center" class="sortableTD"> <s:property value="ivReqDate"/></td> 
									 </s:if>  
									 <s:if test="novacChkFlag">
									<td  class="sortableTD"  align="right"> <s:property value="ivNoVac"/> </td>
									</s:if>
									 <s:if test="offerDueChkFlag">
									<td width=""  align="right"  class="sortableTD"> <s:property value="ivOfferDue"/></td> 
									</s:if> 
									 <s:if test="offerIssueChkFlag">
									<td width=""  align="right"  class="sortableTD"> <s:property value="ivOfferIssue"/></td> 
									</s:if>
									 <s:if test="offerAccptedChkFlag">
									<td class="sortableTD"  align="right" > <s:property value="ivOfferAccept"/>   </td>
									</s:if>
									<s:if test="offerRejectedChkFlag">
									<td width="" class="sortableTD" align="right"  > <s:property value="ivOfferReject"/> </td>
									</s:if>
									 <s:if test="offerCancelChkFlag">
									<td width=""  class="sortableTD" align="right"> <s:property value="ivOfferCancel"/></td> 
									</s:if>  
									<td width="25%"  class="sortableTD" align="right"> <s:property value="ivOfferDate"/></td>
								</tr>  
								</s:iterator>
								<s:if test="noData">
									<tr>
...
function callBack()
 {
  ...
  document.getElementById('paraFrm').action='OfferLetterAnalysis_callBack.action';
  document.getElementById('paraFrm').submit(); 
 }
