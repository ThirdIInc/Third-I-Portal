		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0" class="formbg">
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">Resume
					Approval </strong></td>
		...
		<tr>
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
										<s:if test='%{checkStatus=="N"}'>
											<td width="78%" align="left"><s:submit
										action="ResumeApproval_doFunction" value="Approve "
										theme="simple" onclick=" return callFun('Y');"
										cssClass="token" /> <s:submit
										action="ResumeApproval_doFunction" value="Reject"
										theme="simple" onclick=" return callFun('R');"
										cssClass="token" /> <s:submit
										action="ResumeApproval_previous" value="Previous"
										theme="simple" onclick=" " cssClass="token" /> <s:submit
										action="ResumeApproval_callPage" value="Cancel"
										theme="simple" onclick=" " cssClass="token" /></td>
										</s:if>
										<s:else>
											<td width="78%" align="left"><s:submit
										action="ResumeApproval_previous" value="Previous"
			...
			-->
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td><strong class="formhead">Qualification
									Details :</strong></td>
									<td align="right"></td>
								</tr>
								<tr>
									...
									<table id="tblQuali" width="100%" class="formbg">
										...
										%>
										<%
											Object[][] qualObj = (Object[][]) request
														.getAttribute("qualObj");
										%>
										...
										<s:iterator value="qualList">
											...
											<tr>
												...
												<td align="left" width="21%" class="sortableTD">&nbsp;
												<%=String.valueOf(qualObj[i][0])%></td>
												<td width="21%" align="left" class="sortableTD">&nbsp;
												<%=String.valueOf(qualObj[i][1]).equals(
											"null") ? "" : String
									.valueOf(qualObj[i][1])%></td>

												<td width="18%" align="left" class="sortableTD">&nbsp;
												<%=String.valueOf(qualObj[i][2]).equals(
											"null") ? "" : String
									.valueOf(qualObj[i][2])%></td>
										...
										<s:else>
											...
											<tr>
												<td width="100%" align="center" colspan="6"><font
				...
				height="4" /></td>
						...
						<tr>
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td><strong class="text_head">Experience History
									:</strong></td>
								</tr>
								<tr>
									<td>
									<table id="tblExp" width="100%" class="formbg">
										<tr>
											...
											<td valign="top" class="formth" align="left" nowrap="nowrap"
												width="14%"><b><label name="empr" id="empr"
												ondblclick="callShowDiv(this);"><%=label.get("empr")%></label></b></td>
											<td valign="top" class="formth" align="left" nowrap="nowrap"
												width="12%"><b><label name="lastJobPrf"
												id="lastJobPrf" ondblclick="callShowDiv(this);"><%=label.get("lastJobPrf")%></label></b></td>
											<td valign="top" class="formth" align="left" width="12%"
												nowrap="nowrap"><b><label name="jDate" id="jDate"
												ondblclick="callShowDiv(this);"><%=label.get("jDate")%></label></b></td>
											<td valign="top" class="formth" align="left" width="12%"
												nowrap="nowrap"><b><label name="rDate" id="rDate"
												ondblclick="callShowDiv(this);"><%=label.get("rDate")%></label></b></td>
											...
											<td valign="top" class="formth" align="left" width="10%"><b><label
												name="indsabbr" id="indsabbr"
												ondblclick="callShowDiv(this);"><%=label.get("indsabbr")%></label></b></td>
										...
										<s:iterator value="expList">
											...
											<tr>
												...
												<s:property value="lastJobPro" /></td>

												<td width="12%" align="left" class="sortableTD"
													nowrap="nowrap">&nbsp; <s:property value="joinDate" /></td>

												<td width="12%" align="left" nowrap="nowrap"
													class="sortableTD">&nbsp; <s:property value="relvDate" /></td>

												<td width="15%" align="left" class="sortableTD">&nbsp;
												<%=String.valueOf(expObj[i][0]).equals(
											"null") ? "" : String
									.valueOf(expObj[i][0])%></td>


												<td width="10%" align="left" class="sortableTD">&nbsp;<s:property
													value="specAch" /></td>
												<td width="10%" align="left" nowrap="nowrap"
													class="sortableTD">&nbsp; <%=String.valueOf(expObj[i][1]).equals(
											"null") ? "" : String
									.valueOf(expObj[i][1])%></td>
										...
										<s:else>
											...
											<tr>
												<td width="100%" align="center" colspan="9"><font
													color="red">There is no data to display.</font></td>
										...
										<tr>
											...
											<table id="tblSkill" width="100%" class="formbg">
												<tr>
													...
													<td valign="top" class="formth" align="left"
														nowrap="nowrap" width="49%"><b><label
												...
												<%
													Object[][] skillObj = (Object[][]) request
																.getAttribute("skillObj");
												%>
												<s:iterator value="skillList">
													...
													<tr>
														...
														<%=String.valueOf(skillObj[i][0]).equals(
											"null") ? "" : String
									.valueOf(skillObj[i][0])%></td>
												...
												<s:else>
													...
													<tr>
														<td width="100%" align="center" colspan="3"><font
															color="red">There is no data to display.</font></td>
											...
											<table width="100%" border="0" cellpadding="0"
												...
												<tr>
													...
													<table id="tblFunc" width="100%" class="formbg">
														<tr>
															<td valign="top" class="formth" width="1%"
															...
															<td valign="top" class="formth" align="left"
																nowrap="nowrap" width="50%"><b><label
																name="expInY" id="expInY"
														...
														<%
															Object[][] funcObj = (Object[][]) request
																		.getAttribute("funcObj");
														%>
														<s:iterator value="funcList">
															...
															<tr>
																...
																<%=String.valueOf(funcObj[i][0]).equals(
											"null") ? "" : String
									.valueOf(funcObj[i][0])%></td>
														...
														<s:else>
															...
															<tr>
																<td width="100%" align="center" colspan="3"><font
																	color="red">There is no data to dsiplay.</font></td>
															</tr>
...
<script>
   ...
   function editFun(){
  		 ...
  		 document.getElementById("paraFrm").action="ResumeApproval_editSec.action";
   ...
   function deleteFun(){
	...
	function previousFun(){
	  	document.getElementById("paraFrm").action="ResumeApproval_previous.action";
	    document.getElementById("paraFrm").submit();
		   return false;
	}
