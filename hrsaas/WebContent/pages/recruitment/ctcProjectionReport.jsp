...
<s:form action="CTCProjection" method="post" id="paraFrm"
	theme="simple">
			...
			<table width="100%" border="0" align="center" cellpadding="1"
				...
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">CTC
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1">
				<tr>
					<td width="78%" colspan="3"><input type="button" class="token"
						action="CTCProjection_reset" value=" Show Report" onclick="return calReport();"/> <s:submit
						cssClass="reset" action="CTCProjection_reset" theme="simple"
						value="    Reset"  /></td>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td width="20%" nowrap="nowrap"><s:hidden name="divisonCode" /><s:textfield
						...
						onclick="javascript:callsF9(500,325,'CTCProjection_f9Divison.action');">
					</td>
					<td width="20%" class="formtext"><label class="set"
					...
					<td width="20%" nowrap="nowrap"><s:hidden name="branchCode" /><s:textfield
						...
						src="../pages/images/recruitment/search2.gif" height="15"
						align="absmiddle" width="16"
						onclick="javascript:callsF9(500,325,'CTCProjection_f9Branch.action');">
					</td>
				</tr>
				...
				<tr>
					...
					<td width="20%" nowrap="nowrap"><s:hidden name="deptCode" /><s:textfield
						...
						src="../pages/images/recruitment/search2.gif" height="15"
						align="absmiddle" width="16"
						onclick="javascript:callsF9(500,325,'CTCProjection_f9Department.action');">
					</td>
					<td width="20%" class="formtext"><label class="set"
					...
					<td width="20%" nowrap="nowrap"><s:hidden name="designationCode" /><s:textfield
						...
						src="../pages/images/recruitment/search2.gif" height="15"
						align="absmiddle" width="16"
						onclick="javascript:callsF9(500,325,'CTCProjection_f9Designation.action');">
					</td>
				</tr>
			</table>
			</td>
...
<script>
function calReport(){
	document.getElementById('paraFrm').action = 'CTCProjection_callJspView.action';
