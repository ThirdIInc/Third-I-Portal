			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<img src="../pages/images/recruitment/search2.gif" width="16"
									...
									onclick="javascript:callsF9(500,325,'ResumeApproval_f9searchCand.action');">
							...
							<tr>
								...
								<td width="25%" height="22"><s:select name="candStatus"
									cssStyle="width:152"
									list="#{'':'--Select--','S':'ShortListed','N':'New','R':'Rejected'}" />
					...
					<tr>
						<td colspan="2">
						<%
							String[] dispArr = (String[]) request
											.getAttribute("dispArr");
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td align="center" colspan="5">&nbsp; <input type="button"
									...
									action="ResumeApproval_searchCandDet" theme="simple"
						...
						<table width="100%" border="0" cellpadding="1" cellspacing="1"
							...
							<tr>
								<td height="27" class="formtxt"><a
									href="ResumeApproval_input.action" onclick="">Pending List
								</a> |<a href="#" onclick="showFilterLink('Y');">Approved List </a>
								| <a href="#" onclick="showFilterLink('R')">Rejected List </a></td>
										...
										<td height="27" class="formtxt"><strong> <%
											 	String status = (String) request.getParameter("status");
											 			...
											 			if (status == null) {
											 				...
											 				out.println("Rejected List");
											 				status = "R";
											
											 			} else if (status.equals("Y")) {
											 				out.println("Approved List");
								...
								<table width="100%" border="0" cellpadding="1" cellspacing="1"
									...
									<tr>
										...
										<td width="15%" valign="top" class="formth" nowrap="nowrap"><b><label
											class="set" name="dob" id="dob"
											ondblclick="callShowDiv(this);"><%=label.get("dob")%></label></b></td>
										<td width="20%" valign="top" class="formth"><b><label
											class="set" name="experience" id="experience6"
						...
						<table width="98%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="27%" height="22"><s:textfield name="titleName"
									...
									onclick="javascript:callsF9(500,325,'ResumeApproval_f9TitleAction.action')"
 ...
 %>
							...
							<tr>
								...
								<td height="22" nowrap="nowrap"><s:textfield size="30"
									...
									height="15" class="iconImage"
									onclick="javascript:callsF9(500,325,'ResumeApproval_f9cityaction1.action');">
								...
								<td height="22" nowrap="nowrap"><s:textfield size="30"
									...
									src="../pages/images/recruitment/search2.gif" width="16"
									height="15" class="iconImage"
									onclick="javascript:callsF9(500,325,'ResumeApproval_f9cityaction2.action');">
								</td>
							...
							<tr>
								...
								<td height="22"><s:textfield size="30" name="email"
									maxlength="50" onblur="return validateEmail('paraFrm_email');" />
							...
							<tr>
								...
								<td height="22"><s:textfield size="30"
									name="candidateCompany" onkeypress="return alphaNumeric();" /></td>
								<td height="22" class="formtext"><label
									name="candidate.position" id="candidatePosition"
									ondblclick="callShowDiv(this);"><%=label.get("candidate.position")%></label>
								:</td>
								<td height="22"><s:textfield size="30"
									name="candidatePosition" onkeypress="return alphaNumeric();" /></td>
							</tr>
							...
							<tr>
								<td height="22" class="formtext"><label
									name="candidate.location" id="candidate.location"
									ondblclick="callShowDiv(this);"><%=label.get("candidate.location")%></label>
								:</td>
								<td height="22"><s:textfield size="30"
									name="currentLocation" onkeypress="return alphaNumeric();" /></td>
...
function applyFilters(){
			...
			var fDate=document.getElementById('paraFrm_fromDate').value;
			 ...
			 if(fDate!="dd-mm-yyyy" && tDate!="dd-mm-yyyy")
					...
					document.getElementById("hideFilter").style.display='none';
					document.getElementById("showFilterToApp").style.display='none';
					document.getElementById('paraFrm').action='ResumeApproval_searchCandDet.action';
...
function addRowToRef()
	...
	function addnewFun(){
		document.getElementById("paraFrm").action="ResumeApproval_addNew.action";
	    document.getElementById("paraFrm").submit();
	    return false;
	}
	...
	function saveFun(){
		...
		var fieldName = ["paraFrm_gender",
							...
							"paraFrm_email","paraFrm_uploadFileName"];
		...
		var lableName = ["gender","marstatus","exper","address","city","mobile","email.id","resume"];
	...
	if(document.getElementById("paraFrm_updateFirst").value=="true"){
			     	     ...
			     	     return false;
			     	      ...
			     	      alert("Maximum length of "+document.getElementById('ref').innerHTML.toLowerCase()+" is 100 characters");
			     	       return false;
			     	        ...
			     	        document.getElementById("paraFrm").action="ResumeApproval_updateFirst.action";
				          	document.getElementById("paraFrm").submit();
			     	    }
		...
		if(!validateBlank(fieldName,lableName,flag)){
			...
			alert("Please enter month less than 12");	   	     
   	     	return false;
   	     }else if(!validateEmail('paraFrm_email')){
   	     	return false;
   	    ...
   	    // }
					...
					if(emp==""){
						...
						return false;					
			     		...
			     		document.getElementById("paraFrm").action="ResumeApproval_saveFirst.action";
	    				document.getElementById("paraFrm").submit();
			     	}
	...
	var fieldName = ["paraFrm_gender",
							"paraFrm_maritalStatus","paraFrm_minExp","paraFrm_address","paraFrm_city","paraFrm_mobile",
							"paraFrm_email","paraFrm_uploadFileName"];
		var lableName = ["gender","marstatus","exper",
							"address","city","mobile","email.id","resume"];
		var flag = ["select","select","enter","enter","select","enter","enter",""];
			     	     ...
			     	     return false;
			     	      ...
			     	      alert("Maximum length of "+document.getElementById('ref').innerHTML.toLowerCase()+" is 100 characters.");
			     	       return false;
			     	        ...
			     	        document.getElementById("paraFrm").action="ResumeApproval_nextPage.action";
				          	document.getElementById("paraFrm").submit();
			     	    }
	...
	function nextFun(){
		document.getElementById("paraFrm").action="ResumeApproval_searchRecSecond.action";
	    document.getElementById("paraFrm").submit();
	}
	...
	function cancelFun(){
		...
		if(document.getElementById("paraFrm_cancelFirst").value=="true"){
			...
			document.getElementById("paraFrm").action="ResumeApproval_cancelFirst.action";
	    	document.getElementById("paraFrm").submit();
	...
	function searchFun(){
		...
		callsF9(500,325,'ResumeApproval_f9search.action');
		return false;
	}
  ...
  function chkDeleteVacancy()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="ResumeApproval_deleteRowRef.action";
	    document.getElementById('paraFrm').submit();
	    } else{
	    		for (var idx = 1; idx < rowLen; idx++) {
...
/*function callPage(id){
	    ...
	    document.getElementById('paraFrm').action="ResumeApproval_callPage.action";
	    document.getElementById('paraFrm').submit();
   }	*/
...
function newRowColor(cell)
 ...
 function showEmpId(){
  ...
  function callForEdit(id){
		...
		document.getElementById("paraFrm").action="ResumeApproval_callForEdit.action";
	   	document.getElementById("paraFrm").target="main";
	    document.getElementById("paraFrm").submit();
   }
...
*/	
  ...
  function callFun(status){
	...
	document.getElementById("paraFrm_status").value=status;
	   document.getElementById("paraFrm").action='ResumeApproval_callstatus.action?status='+status;
	   document.getElementById("paraFrm").submit();
	}
