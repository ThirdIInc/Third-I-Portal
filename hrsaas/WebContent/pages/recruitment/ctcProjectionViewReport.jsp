...
<s:form action="CTCProjection" validate="true" id="paraFrm" validate="true" theme="simple">
<s:hidden name="show" />
...
<table class="formbg" width="100%">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">CTC Projection Report</strong></td>
		...
		<tr>
			<td width="78%"><s:if test="noData"></s:if><s:else>
			...
			<table width="100%" class="formbg">
				...
				<s:else>
					<tr>
						...
						:</td>
						<td width="25%" colspan="1"><s:property value="division" /></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td align="right"><b>Page:</b>
					 <input type="hidden" name="totalPage"  id="totalPage" value="<%=totalPage%>,'CTCProjection_callJspView.action'">
						 	<a href="#" onclick="callPage('1','F','<%=totalPage %>','RequisitionAnalysis_callJspView.action');"  >
										<img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage"/>
									</a>&nbsp;
									<a href="#" onclick="callPage('P','P','<%=totalPage %>','CTCProjection_callJspView.action');" >
										<img  title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10" class="iconImage"/>
									</a> 
							    <input type ="text" name="pageNoField" id="pageNoField" theme="simple" size="3"  value="<%= pageNo%>"  onkeypress="callPageText(event,'<%=totalPage %>','CTCProjection_callJspView.action');return numbersOnly()"   maxlength="4" /> of <%=totalPage%>
						 		 		<a href="#" onclick="callPage('N','N','<%=totalPage %>','CTCProjection_callJspView.action')" >
											<img  title="Next Page" src="../pages/common/img/next.gif" class="iconImage" />
										</a>&nbsp;
										<a href="#" onclick="callPage('<%=totalPage%>','L','<%=totalPage %>','CTCProjection_callJspView.action');" >
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1">
						<tr>
							<td height="15" class="formhead" nowrap="nowrap" colspan="10"><strong
								class="forminnerhead">CTC Projection List</strong></td>
						</tr>
						<tr>
							...
							<label class="set" name="branch" id="branch1" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>
 							...
 							<td width="10%" class="formth" align="center">
 							<label class="set" name="projectedHike" id="projectedHike" ondblclick="callShowDiv(this);"><%=label.get("projectedHike")%></label>
 							</td>
 							<td width="10%" class="formth" align="center">
 							<label class="set" name="projectedCtcinLac" id="projectedCtcinLac" ondblclick="callShowDiv(this);"><%=label.get("projectedCtcinLac")%></label>
 							</td>
 					</tr>
							<%!int k=0; %>
						<%int i=0; %>
						...
						<s:if test="noData">
	                        ...
	                        <td width="10%" align="left" class="sortableTD">&nbsp; <s:property value="projectHikes"/> </td>
	                        <td width="10%" align="left" class="sortableTD">&nbsp; <s:property value="projectedCtc"/> </td>
	                        </tr>	
							</s:iterator>
							<%
							k=i;
...
<script>
	function callBack()
	{
		document.getElementById('paraFrm').target =""; 
	 	document.getElementById('paraFrm').action = "CTCProjection_input.action";
     	document.getElementById('paraFrm').submit(); 
	}
	function callReport(reportType){
		document.getElementById('paraFrm').action = "CTCProjection_report.action?selectedType="+reportType;
		document.getElementById('paraFrm').submit(); 
	}
</script>