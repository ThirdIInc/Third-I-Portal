...
<s:form action="PostResume" id="paraFrm" theme="simple" validate="true">
	...
	<table class="formbg" width="100%">
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="78%" colspan="2"><s:if test="forwardFlag">
						<s:submit cssClass="token" value="Forward To Hiring Manager"
							action="PostResume_submitResume" onclick="return submitForm();" />
					</s:if> <s:else>
						<s:submit cssClass="token" value="Submit Resume"
							action="PostResume_submitResume" onclick="return submitForm();" />
					</s:else> <s:if test="partnerFlag">
					...
					</s:else> <input type="button" value=" Export In Xls " class="token"
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="25%" nowrap="nowrap" height="22"><s:textfield
								name="requisitionName" size="40" readonly="true" /> <s:if
								test="addCandidateFlag">
							</s:if> <s:elseif test="referalFlag">

							</s:elseif><s:else>
								<img class="iconImage"
									src="../pages/images/recruitment/search2.gif" width="15"
									height="16"
									onclick="javascript:callsF9(500,325,'PostResume_f9RequisitionCodeAction.action');" />
							</s:else></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="30%" align="right"><s:submit cssClass="delete"
						value="Remove" action="PostResume_delete"
				...
				<s:iterator status="stat" value="formValueList">
					<s:hidden name="formValue" />
				</s:iterator>
				<s:iterator status="stat" value="valuesList">
					<s:hidden name="listValue" />
				</s:iterator>
			</table>
			</td>
		</tr>
		<s:if test="forwardFlag">
			<!-- KEEP INFORMED TABLE  STARTS -->
			<tr>
				<td colspan="7">
				<table width="100%" border="0" cellpadding="1" cellspacing="0"
					...
					<tr>
						...
						<td width="13%"><s:hidden name="employeeId" /> <s:hidden
							name="employeeToken" /> <s:textfield name="employeeName"
							readonly="true" size="35" /></td>
						<td width="2%"><img
							src="../pages/common/css/default/images/search2.gif"
							class="iconImage" width="16" height="15"
							onclick="javascript:callsF9(500,325,'PostResume_f9KeepInformedEmployee.action');" />
						</td>
						<td width="15%"><input type="button" name="" value=" Clear"
							class="reset" onclick="return clearKeepInformed();" /></td>
					</tr>
				</table>
				</td>
			</tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<s:textfield name="candFirstName" size="25" maxlength="50"
								...
								width="15" height="16"
								onclick="javascript:callsF9(500,325,'PostResume_f9CandidateAction.action');" />
							</span></td>
						...
						<tr>
							...
							<td width="25%" nowrap="nowrap" height="22"><s:textfield
								...
								src="../pages/images/recruitment/search2.gif" width="15"
								height="16"
								onclick="javascript:callsF9(500,325,'PostResume_f9LocationAction.action');" /></span>
						...
						<tr>
							<td width="100%" height="22" colspan="4" align="center"><s:submit
								...
								action="PostResume_postCandidate" /></td>
						</tr>
					</table>
					</td>
				</tr>
		...
		<tr>
			<td width="100%" colspan="4" align="left"><s:if
				...
				<s:else>
					<s:submit cssClass="cancel" value="Cancel"
						action="PostResume_cancelTransaction" />
				</s:else>
			</s:else> <input type="button" value=" Export In Xls " class="token"
				onclick="callReportForDisp('X');"></td>
		</tr>
...
<script>
	...
	function showRecord(fileName){
		...
		document.getElementById('paraFrm').action = "PostResume_viewCV.action?fileName="+fileName;
	...
	document.getElementById('paraFrm').target='main';
		    document.getElementById('paraFrm').action = "PostResume_cancelTransaction.action";
		document.getElementById('paraFrm').submit();
	...
	function clearKeepInformed()
	{
	 ...
	 function callReportForDisp(reportType)
		{ 
				//alert(reportType);
				document.getElementById('paraFrm').target='_blank';
				document.getElementById('paraFrm').action="PostResume_report.action";
				document.getElementById('paraFrm').submit(); 
		}
