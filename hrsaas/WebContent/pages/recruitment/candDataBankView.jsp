		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:if test="refFlag">
					<tr>
						<td colspan="5">
							<img src="../pages/common/css/default/images/space.gif" width="5" height="4" />
						</td>
				    </tr>
				</s:if>
				<s:else>
...
function nextFun(){
		...
		document.getElementById("paraFrm").action="CandDataBank_nextPageView.action";
...
function editFun(){
		document.getElementById("paraFrm").action="CandDataBank_editFirst.action";
	    document.getElementById("paraFrm").submit();
       return false;
