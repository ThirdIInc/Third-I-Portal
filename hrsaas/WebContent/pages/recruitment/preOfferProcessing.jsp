					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td width="20%"><label class="set" name="cand.name"
								id="candidate.name" ondblclick="callShowDiv(this);"><%=label.get("cand.name")%></label> :<font color="red">*</font></td>
							<td width="25%" nowrap="nowrap"><s:hidden name="candidateCode" /> <s:textfield
								name="candidateName" size="25" readonly="true" />
								<s:if test="candiFlag"></s:if> <s:else>
								<img src="../pages/images/search2.gif" height="16" align="absmiddle"
								width="16" theme="simple" onclick="javascript:callsF9(500,325,'PreOfferProcessing_f9Candidate.action')">
								</s:else>
								</td>
						...
						<tr>
							...
							<td width="25%" nowrap="nowrap"><s:hidden name="reqCode" /><s:textfield
								name="reqName" size="25" readonly="true" />
								<s:if test="candiFlag"></s:if> <s:else>
								<img src="../pages/images/search2.gif" height="16" align="absmiddle"
								width="16" theme="simple" onclick="javascript:callsF9(500,325,'PreOfferProcessing_f9Requistion.action')"> </s:else> </td>
						...
						<tr>
							...
							<div id="outSourceAgency1"><s:hidden
								...
								onclick="javascript:callsF9(500,325,'PreOfferProcessing_f9outsource.action')">
							</div>
							</td>
						...
						<tr>
							...
							<td width="25%"><!--Select Check List Type --> <label
								...
								ondblclick="callShowDiv(this);"><%=label.get("CheckListType")%></label> :<font color="red">*</font></td>
							<td width="25%"><!--<s:hidden name="requisitionCode"
									id="requisitionCode" /><s:textfield name="requisitionName"
									size="25" readonly="true" /><img
									src="../pages/images/search2.gif" height="16" align="absmiddle"
									width="16" theme="simple"
									onclick="javascript:callsF9(500,325,'PreOfferProcessing_f9CntPerson.action')">
								
								--><s:select theme="simple" name="checkListType" headerKey="S" onchange="return callChange();"
								headerValue="--Select--"
						...
						<tr>
							<td width="20%"><!-- Position --> <label class="set"
								name="position" id="Position" ondblclick="callShowDiv(this);"><%=label.get("position")%></label> :<font color="red">*</font></td>
							<td width="25%"><s:textfield name="position" size="25" /></td>
							<td width="25%">&nbsp;</td>
							<td width="25%"><s:submit cssClass="token" value="Show List"
								action="PreOfferProcessing_showCheckList"
		...
		<tr>
			<td width="100%" colspan="4"><s:if test="checklistTable">
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1"
					class="formbg">
					<tr>
						<td width="100%" colspan="2" class="formtxt"><strong
							class="formhead">
...
<label  class = "set" name="checklistname" id="checklistname" ondblclick="callShowDiv(this);">
						<%=label.get("checklistname")%></label>
						</td>
						<td width="30%" valign="top" class="formth"><!--  Response -->
						
<label  class = "set" name="response" id="response" ondblclick="callShowDiv(this);">
						<%=label.get("response")%></label>
						
						</td>
						<td width="30%" valign="top" class="formth"><!--  Comments-->
						
<label  class = "set" name="Listcomments" id="Listcomments" ondblclick="callShowDiv(this);"><%=label.get("Listcomments")%></label>
						</td>
					...
					<s:iterator value="ChkList">
						<tr>
							...
							<td class="sortabletd" width="15%"><s:textarea
								name="checkListComments" id="<%="checkListComments"+z%>"
								cols="25" rows="2" />&nbsp;&nbsp;<img src="../pages/images/zoomin.gif" height="12" align="absmiddle" width="12" theme="simple"
						...
						<table>
							<tr>
								...
								<input type="text"
									name="uploadLocFileName" size="20" readonly="true"
									id="paraFrm_uploadLocFileName<%=p%>"
									value='<s:property value="uploadLocFileName" />'size="20" />
								
								 </td>
								<td>
								
								<input type="button" name="uploadLoc" value="Select Doc."
										class="token"
										onclick="uploadFile('paraFrm_uploadLocFileName<%=p%>');" />
								
								 </td>
								<td>
								
								<input type="button"
									name="show" value="Show" class="token"
									onclick="showRecord('paraFrm_uploadLocFileName<%=p%>');" />
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="75%"><s:textarea name="overallComments" cols="50"
						rows="3" />&nbsp;&nbsp; <img src="../pages/images/zoomin.gif" height="12" align="absmiddle" width="12" theme="simple"
			...
			<s:hidden name="Chkreqcode"></s:hidden> <s:hidden
				name="Chkcandidatecode"></s:hidden> <s:hidden name="Chkoffercode"></s:hidden>
			</td>
		</tr>
...
//			window.open('../pages/images/'+path+'/checkList/'+name);
//			}
 ...
 function showRecord(fieldName)
	{
		...
		document.getElementById('paraFrm').action = "PreOfferProcessing_viewAttachedProof.action?fileName="+fileName;
		document.getElementById('paraFrm').submit();
