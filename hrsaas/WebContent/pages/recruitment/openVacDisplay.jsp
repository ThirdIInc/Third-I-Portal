	   ...
	   <tr>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
			   ...
			   <td width="25%" class="formth" ><b> <label  class = "set"  id="position"  name="position" ondblclick="callShowDiv(this);"><%=label.get("position")%></label></b></td>
			   <td width="15%" class="formth" ><b> <label  class = "set"  id="requisitionDate"  name="requisitionDate" ondblclick="callShowDiv(this);"><%=label.get("requisitionDate")%></label></b> </td>
			   <td width="16%" class="formth" ><b> <label  class = "set"  id="status"  name="status" ondblclick="callShowDiv(this);"><%=label.get("status")%></label> </b> </td>
			   <td width="7%"  class="formth" > <input type="checkbox" name="headerChk" id="headerChk" onclick="selectAllChk();"> </td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
			   ...
			   <td width="25%" class="formth" ><b> <label  class = "set"  id="position"  name="position" ondblclick="callShowDiv(this);"><%=label.get("position")%></label></b></td>
			   <td width="15%" class="formth" ><b> <label  class = "set"  id="requisitionDate"  name="requisitionDate" ondblclick="callShowDiv(this);"><%=label.get("requisitionDate")%></label></b> </td>
			   <td width="17%" class="formth" ><b> <label  class = "set"  id="status"  name="status" ondblclick="callShowDiv(this);"><%=label.get("status")%></label> </b> </td>
			   <td width="6%"  class="formth" > <input type="checkbox" name="headerChk" id="headerChk" onclick="selectAllChk();"> </td>
			</tr> 
			</table>
			</s:else>
