...
<s:form action="InterviewAssessMasterAction" validate="true"
	...
	<s:hidden name="paraName" />
	<s:hidden name="paraDes" />
	...
	<table width="100%" border="0" align="right" class="formbg">
		...
		<tr>
			...
			<table class="formbg" width="100%" cellspacing="0" cellspacing="1"
				border="0">
				<tr>
					<td colspan="2" class="txt"><strong class="text_head">Interview
						...
						<tr>
							...
							<table width="100%" border="0">
								<tr>
									...
									<td class="formth" align="center"><label class="set"
										name="paraname" id="paraname" ondblclick="callShowDiv(this);"><%=label.get("paraname")%></label></td>
									<td class="formth" align="center"><label class="set"
										name="parades" id="parades" ondblclick="callShowDiv(this);"><%=label.get("parades")%></label></td>
									...
									<s:if test="modeLength">
										...
										<s:iterator value="assesmentList">
											<tr <%if(count%2==0){
												...
												ondblclick="javascript:callForEdit('<s:property value="recassessCode"/>');">
												...
												<s:hidden value="%{recassessCode}"
													id='<%="recassessCode" + i%>'></s:hidden>
												<script type="text/javascript">
													records[<%=i%>] = document.getElementById('recassessCode' + '<%=i%>').value;
												</script>
												<td width="40%" align="left" class="sortableTD"><s:property
													value="paraName" /> <input type="hidden"
												...
												<td id="ctrlShow" align="center" nowrap="nowrap"
													...
													onclick="callForDelete1('<s:property value="recassessCode"/>','<%=i%>')" /></td>
											</tr>
...
<script>
	...
	function addnewFun() {
		...
		document.getElementById('paraFrm').action = 'InterviewAssessMasterAction_addNew.action';
	...
	function reportFun() {
		...
		document.getElementById('paraFrm').action = 'InterviewAssessMasterAction_report.action';
		document.getElementById('paraFrm').submit();
	}
...
function oldRowColor(cell,val) {
	...
	callButton('NA', 'Y', 2);
	  	document.getElementById('paraFrm_hiddencode').value=id;
	   	document.getElementById("paraFrm").action="InterviewAssessMasterAction_calforedit.action";
	...
	function chkDelete()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="InterviewAssessMasterAction_deleteChkRecords.action";
	   document.getElementById('paraFrm').target = "_self";
	    document.getElementById('paraFrm').submit();
	    }
	    else
