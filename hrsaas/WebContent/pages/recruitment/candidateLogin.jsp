...
<s:form action="CandidateLogin" method="post" validate="true"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="2" align="left"><b>Why you should be
									registering with us?</b><br>
									<hr>
									</td>
								</tr>
								<tr>
									...
									<td align="left">Your resume stays with us for a lifetime
									</td>
								</tr>
								<tr>
									<td><img align="absmiddle"
										src="../pages/common/css/default/images/dot.gif" /></td>
									<td align="left">You will have an added edge over others,
									as we will first go through our data bank for any future
									vacancies</td>
								</tr>
								<tr>
									<td><img align="absmiddle"
										src="../pages/common/css/default/images/dot.gif" /></td>
									<td align="left">We get to know you better!!</td>
								</tr>
								<tr>
									<td><img align="absmiddle"
										src="../pages/common/css/default/images/dot.gif" /></td>
									<td align="left">You have the opportunity of updating your
									resume and resending the same</td>
								</tr>
								<tr>
									<td><img align="absmiddle"
										src="../pages/common/css/default/images/dot.gif" /></td>
									<td align="left">You get to see regular updates from us</td>
								</tr>
							</table>
							...
							<table id="Table_01" align="center" width="200"
								...
								<tr>
									...
									<table border="0" width="100%" id="table6" cellpadding="0"
										cellspacing="0">
										<tr>
											<td colspan="2"><b class="bookmark">Candidate Login</b></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="74%"><s:submit
												action="CandidateLogin_submitnew" theme="simple"
										...
										<tr>
											...
											<table class="label" cellSpacing="0" cellPadding="0"
												...
												<tr vAlign="center" align="left">
													...
													<div align="center" class="bookmark">New Candidate<a
														href="#" class="contlink"
