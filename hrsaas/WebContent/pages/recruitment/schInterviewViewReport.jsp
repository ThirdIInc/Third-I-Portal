...
<s:form action="InterviewAnalysis" validate="true" id="paraFrm" theme="simple"> 
<s:hidden name="screenFlag"/>
	  ...
	  <tr>
			<td colspan="3" width="100%">  <s:hidden name="searchFlag"/>
				 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
					<tr>
						...
						<td width="93%" class="txt"><strong class="text_head">Schedule Interview Analysis</strong></td>
		   ...
		   <tr>
	         <td colspan="3">
	           <table width="100%" border="0" cellpadding="0" cellspacing="0" >
					<tr>
					    ...
					    <td align="right" width="20%" >  <s:if test="noData"> </s:if> <s:else> <label class="set" name="export.all" id="export.all" ondblclick="callShowDiv(this);"><%=label.get("export.all")%></label> : <input type="checkbox" name="exportAll" id="exportAll" checked="checked"  onclick="callChkBox('exportAll');" > </s:else>  </td>
					</tr>
				</table>
			</td>
		  </tr>
			...
			<td width="100%">  <s:hidden name="searchSetting"/>  <s:hidden name='aId'/> <s:hidden name='divId'/> <s:hidden name='backFlag'/> 
			 <s:hidden name="myPage"/>  <s:hidden name="myPageCandi"/> <s:hidden name="show"  />   <s:hidden name="checkedCount" value="12"/>
			 <s:hidden name="frmDate"/>    <s:hidden name="noDataCandi"/>  <s:hidden name="schStatusCom"/>  
			 <s:hidden name="toDate"  /> <s:hidden name="reqname"/> <s:hidden name="reqCode"  />  <s:hidden name="interviewerName"  />   <s:hidden name="interviewerCode"  /> 
	         ...
	         <s:hidden name="requirdeByDateTxt"/>    <s:hidden name="requirdeByDateCom"/>  
				<s:hidden name="candidateFlag"/><s:hidden name="candidateName"/>  <s:hidden name="candidateCode"/>   
				<s:hidden name="hidSelectedReqName"/> 
              <s:hidden name="candiCodeChk" value="on"/> <s:hidden name="schDateChk"  /> <s:hidden name="recruiterChk"/> <s:hidden name="roundTypeChk"  /> 
              <s:hidden name="interviewVenueChk"/> <s:hidden name="schStatusChk"  /> <s:hidden name="interviewDateChk"/> <s:hidden name="interviewerChk"  />
              <s:hidden name="contactNumChk"/> <s:hidden name="emailIdChk"  /> 
              <s:hidden name="interviewStatusChk"/>
               <s:hidden name="hiringMgrName"/> <s:hidden name="hiringMgrCode"  />
                <s:hidden name="intDateFilter" />
               <s:hidden name="intFrmDate"/> <s:hidden name="intToDate"/>
								 ...
								 <img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage" /> </a>&nbsp;
								  <a href="#" onclick="callPage('P','P');"> <img title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10"
									...
									onkeypress="callPageText(event);return numbersOnly()" maxlength="4" title="press Enter" /> of <%=totalPage%>
									 <a href="#" onclick="callPage('N','N')"> <img title="Next Page" src="../pages/common/img/next.gif"
					 ...
					 <td width="100%">
					  <table width="100%" class="formbg" cellpadding="1" cellspacing="4">
					   <s:hidden name="vReqName"/> <s:hidden name="vReqDate"  /> <s:hidden name="vBranch"/> <s:hidden name="vDepartment"  />
					     ...
					     <tr>
						  <td width="20%"><label  class = "set" name="reqs.code" id="reqs.code"  ondblclick="callShowDiv(this);"><%=label.get("reqs.code")%></label> : </td>
					   ...
					   <tr>
						  ...
						  <td width="20%"> <label  class = "set" name="position" id="position1111"  ondblclick="callShowDiv(this);"><%=label.get("position")%></label> : </td>
				                     ...
				                     <td colspan="3" width="100%">
										<table width="100%" border="0" cellpadding="1" cellspacing="1" class="sortable"><!--Table 6-->
											<tr>   
											    ...
											    <td width="20%" valign="top" class="formth"><label  class = "set" name="cand.name" id="cand.name22" ondblclick="callShowDiv(this);"><%=label.get("cand.name")%></label></td>
												...
												<td width="15%" valign="top" class="formth" ><label  class = "set" name="Interview.Round" id="Interview.Round" ondblclick="callShowDiv(this);"><%=label.get("Interview.Round")%></label></td>
						            		     ...
						            		     <s:if test="schDateChkFlag">
						            		    <td  valign="top" class="formth"  ><label  class = "set" name="schDateChkLabel" id="schDateChkLabel"  ondblclick="callShowDiv(this);"><%=label.get("schDateChkLabel")%></label></td> 
							            	 	</s:if>
												...
												<td width="15%" valign="top" class="formth" ><label  class = "set" name="interviewVenueLabel" id="interviewVenueLabel" 	ondblclick="callShowDiv(this);"><%=label.get("interviewVenueLabel")%></label></td> 
							            	 	 ...
							            	 	 <td width="15%" valign="top" class="formth" ><label  class = "set" name="interviewerChkLabel" id="interviewerChkLabel"  ondblclick="callShowDiv(this);"><%=label.get("interviewerChkLabel")%></label></td> 
							            		</s:if>
							            		 <s:if test="recruiterChkFlag">
							            		 <td width="15%" valign="top" class="formth" ><label  class = "set" name="rec.name" id="rec.name1111" ondblclick="callShowDiv(this);"><%=label.get("rec.name")%></label></td> 
							            	    </s:if>
							                     ...
							                     <s:if test="interviewStatusChkFlag">
							            	     <td width="15%" valign="top" class="formth" ><label  class = "set" name="intStatusChkLabel" id="intStatusChkLabel" ondblclick="callShowDiv(this);"><%=label.get("intStatusChkLabel")%></label></td> 
							                     </s:if>
							              	</tr>
							              	...
							              	<s:iterator value="candidateList">   
												...
												<td width="5%"  class="sortableTD" nowrap="nowrap">  <%++cntCandi;%> <%=++pgNoCandi%>
													 ...
													 <s:hidden name="ivSchStatus"/>   <s:hidden name="interviewStatus"/>  <s:hidden name="schDate"/>
												</td>   
												...
												<s:if test="schDateChkFlag">
												<td class="sortableTD" nowrap="nowrap" > <s:property value="schDate"/> &nbsp; </td>
												</s:if>
												<s:if test="interviewDateChkFlag">
												<td width="25%"  class="sortableTD"> <s:property value="ivInterviewDate"/>&nbsp;</td> 
												</s:if>
												 <s:if test="interviewVenueChkFlag">
												<td width="25%" class="sortableTD"   > <s:property value="ivVenue"/> &nbsp;</td>
												</s:if>
												  <s:if test="interviewerChkFlag">
												<td width="25%"  class="sortableTD" > <s:property value="ivInterviewver"/>&nbsp;</td> 
												</s:if> 
												  <s:if test="recruiterChkFlag">
												...
												<s:if test="interviewStatusChkFlag">
												<td width="25%"  class="sortableTD" align="right"> <s:property value="interviewStatus"/></td>  
												</s:if> 
											</tr>  
											</s:iterator>
											<s:if test="noDataCandi">
											...
											<s:else>
											  <tr>
													<td width="100%" colspan="12" align="right">  <b>Total records : <s:property value="dataLength"/></b>  </td>
											 </tr> 
											</s:else>
										</table>
					               </td>
	         ...
	         <td colspan="3">
	           <table width="100%" border="0" cellpadding="0" cellspacing="0" >
					<tr>
					    ...
					    <td align="right" width="20%" >  <s:if test="noData"> </s:if> <s:else> <label class="set" name="export.all" id="export.all" ondblclick="callShowDiv(this);"><%=label.get("export.all")%></label> : <input type="checkbox" name="exportAll_bot" id="exportAll_bot" checked="checked" onclick="callChkBox('exportAll_bot');" > </s:else>  </td>
					</tr>
				</table>
			</td>
		  </tr> 
 ...
 {  
	...
	function callPageTextCandi(id){   
		   ...
		   if(Number(pageNo)<=0)
			...
			document.getElementById('paraFrm').action='InterviewAnalysis_viewCandidate.action';
			document.getElementById('paraFrm').submit();
		}
...
function callBack()
 {
  ...
  document.getElementById('paraFrm').action='InterviewAnalysis_callBack.action';
  document.getElementById('paraFrm').submit(); 
 }
 ...
 function onPage()
   ...
   document.getElementById('paraFrm').action="InterviewAnalysis_viewSummary.action";
   document.getElementById('paraFrm').submit();
