...
<s:form action="CandChngPass" validate="true" id="paraFrm" theme="simple">
						...
						<tr>
								<td width="78%">
									<s:submit cssClass="save" 
										theme="simple" value="    Save  " action="CandChngPass_save"
										onclick="return save();" /> 
								</td>
							<td width="22%">
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td><s:textfield size="25" name="candName"
								...
								<tr>
									...
									<td colspan="2" width="40%"><s:password size="25" name="oldPassword"  />
									</td>
								</tr>
								
								<tr>
									<td width="25%">New Password :<font color="red">*</font></td>
									<td colspan="2" width="40%"><s:password size="25" name="newPassword" />
									</td>
								</tr>
								
								<tr>
									<td width="25%">Confirm New Password :<font color="red">*</font></td>
									<td colspan="2" width="40%"><s:password size="25" name="confirmPass" />
									</td>
								</tr>
							</table>
							</td>
...
var newPass = document.getElementById('paraFrm_newPassword').value;
var confPass = document.getElementById('paraFrm_confirmPass').value;
var oldPass = document.getElementById('paraFrm_oldPassword').value;
if(oldPass == ""){
