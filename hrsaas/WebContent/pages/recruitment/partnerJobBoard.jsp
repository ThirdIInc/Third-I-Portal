...
<s:form action="PartnerJobBoard" validate="true" id="paraFrm" theme="simple"> 
			...
			<td colspan="3" width="100%">  <s:hidden name="searchFlag"/>
				 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
					<tr>
						...
						<td width="93%" class="txt"><strong class="text_head">Partner Job Board </strong></td>
						...
						<td colspan="3" width="100%">
							<table width="100%" border="0" cellpadding="1" cellspacing="1" class="sortable"><!--Table 6-->
								...
								<s:iterator value="partnerJobList"> 
								    ...
								    <td width="12%"  class="sortableTD"  > <input type="button" value="Post Candidate" class="token" onclick="callPostCandidate('<s:property value="itReqCode"/>','<s:property value="itReqName"/>','<s:property value="itPosition"/>','<s:property value="itHiringManager"/>','<s:property value="itHiringManagerId"/>','postCandidateForm')" > </td> 
									<td width="12%"  class="sortableTD" align="center"  ><input type="button" value="View " class="token"  onclick="viewRequisition('<s:property value="itReqCode"/>');" > </td> 
 ...
 function onPage()
   {
	...
	document.getElementById('paraFrm').submit();
  	...
  	function viewRequisition(reqCode,status){ 
		...
		document.getElementById("paraFrm").action='PartnerJobBoard_viewReqDetails.action?reqCode='+reqCode+'&apprvFlag=false'
	  	document.getElementById("paraFrm").submit();
	  	document.getElementById("paraFrm").target = 'main';
	}
	
    function callPostCandidate(reqCode,requisitionName,position,hiringManager,hiringManagerCode, postCandidateForm)
    {   
		...
		document.getElementById("paraFrm").action='PartnerPostResume_input.action?postCandidateForm='+postCandidateForm;
