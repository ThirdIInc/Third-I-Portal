...
<s:form action="PreOfferProcessing" validate="true" id="paraFrm"
	theme="simple">
	        	...
	        	<td colspan="3" width="100%">
	        		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
	        			 <tr>
				          ...
				          <td width="93%" class="txt"><strong class="text_head">Pre Offer Processing </strong></td>
	...
	<s:hidden name="buttonpanelcode" />
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="top" width="20%"><!-- Candidate Name -->
					
					<label class="set" name="cand.name"
								id="candidate.name" ondblclick="callShowDiv(this);"><%=label.get("cand.name")%></label> :</td>
					<td valign="top" width="25%"><s:hidden name="candidateCode" /> <s:property
						value="candidateName" /></td>
					<td valign="top" width="25%"><!--Offer Status -->
					<label  class = "set" name="offer.status" id="offer.status" ondblclick="callShowDiv(this);">
					<%=label.get("offer.status")%></label>
					:</td>
					<td valign="top" width="25%"><s:property value="offerStatus" /></td>
				</tr>
				<tr>
					<td valign="top" width="20%"><!--Requisition Code -->
					<label class="set"
								name="reqs.code" id="requi.code"
								ondblclick="callShowDiv(this);"><%=label.get("reqs.code")%></label> :</td>
					<td valign="top" width="25%"><s:hidden name="reqCode" /><s:property
						value="reqName" /></td>
					<td valign="top" width="25%">
					<!--Background Check Type-->
					<label  class = "set" name="Background.type" id="Background.type" ondblclick="callShowDiv(this);"><%=label.get("Background.type")%></label>
					 :</td>
					<td valign="top" width="25%"><!--  <input name="bgCheckType" type="radio" value="I" onclick="enableIndoorSource();" checked="true"/>&nbsp;In 
					House&nbsp;
						<input name="bgCheckType"  type="radio" value="O" onclick="enableOutsource();" />
					Out Source	
					--> <s:hidden name="bgCheckType" /> <s:hidden id="bgCheckType1" />
					<s:hidden id="bgCheckType2" />
					 <s:property
						value="DupbgCheckType" /></td>
				</tr>
				<tr>
					<td valign="top" width="20%"><!--Division -->
<label  class = "set" name="division" id="bg.division" ondblclick="callShowDiv(this);">
<%=label.get("division")%></label>	
...
<label  class = "set" name="OutsourceAgency" id="OutsourceAgency" ondblclick="callShowDiv(this);">
<%=label.get("OutsourceAgency")%></label>:
</div>
					</td>

					<td valign="top" width="25%"><s:hidden name="outsourceAgencyName" />
					<div id="outSourceAgency1"> <s:property
						 value="outsourceAgencyName" />
						 <s:hidden
						name="outsourceAgencyCode" />
						 </div>
					</td>

				</tr>
				<tr>
					<td valign="top" width="20%"><!--Branch -->
					
<label  class = "set" name="branch" id="bg.branch" ondblclick="callShowDiv(this);">
<%=label.get("branch")%></label>
				...
				<tr>
					<td valign="top" width="20%"><!--Department -->
					
<label  class = "set" name="department" id="bg.department" ondblclick="callShowDiv(this);">
<%=label.get("department")%></label>

					:</td>
					<td valign="top" width="25%"><s:property value="department" /></td>
					<td valign="top" width="25%"><!--Select Check List Type-->
					<label  class = "set" name="CheckListType" id="CheckListType" ondblclick="callShowDiv(this);"><%=label.get("CheckListType")%></label>
					 :</td>
					<td valign="top" width="25%"><s:hidden name="checkListType" /> <s:property
						value="DupcheckListType" /></td>
				</tr>
				<tr>
					<td valign="top" width="20%"><!--Position -->
					
<label  class = "set" name="position" id="Position" ondblclick="callShowDiv(this);">
			...
			<td><s:if test="checklistTable">
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1"
				  ...
				  status = (String) request.getAttribute("listname");
					...
					<!--Table 6-->
					<tr>
						<td width="10%" valign="top" class="formth" nowrap="nowrap" align="center">
						<!--  Sr.No. --><b>
						<label  class = "set" name="serial.no" id="serial.no" ondblclick="callShowDiv(this);">
						<%=label.get("serial.no")%></label></b>
						</td>
						<td width="20%" valign="top" class="formth" nowrap="nowrap"><b>
						<label  class = "set" name="checklistname" id="checklistname" ondblclick="callShowDiv(this);">
						<%=label.get("checklistname")%></label></b>
						<!--  CheckList Name -->
						</td>
						<td width="10%" valign="top" class="formth">
						<!--  Response --><b>
						<label  class = "set" name="response" id="response" ondblclick="callShowDiv(this);">
						<%=label.get("response")%></label></b>
						</td>
						<td width="25%" valign="top" class="formth">
						<!--  Comments --><b>
						<label  class = "set" name="Listcomments" id="Listcomments" ondblclick="callShowDiv(this);">
						<%=label.get("Listcomments")%></label></b>
						</td>
					...
					<s:iterator value="ChkList">
						<tr>
							<td class="sortabletd" width="5%" nowrap="nowrap" align="center"><%=p%><s:hidden
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<!-- Overall Background Check List Comments-->
					
<label  class = "set" name="overallcomments" id="overallcomments" ondblclick="callShowDiv(this);">
<%=label.get("overallcomments")%></label>
					:</td>
					<td valign="top" width="45%"><s:property value="overallComments" /></td>
				</tr>
				...
				<tr>
					...
					<div id="saveForInDoor"><!--<s:submit value="Save"  onclick="return saveFun();"/>
		--></div>

					<div id="forwardForOutDoor"><!--<s:submit value="Forward To Outsource Agency"  onclick="return saveFun();"  />
		 --></div>
...
function addnewFun()
{
	document.getElementById('paraFrm').action="PreOfferProcessing_addNew.action";
...
function saveFun()
{
	...
	document.getElementById('paraFrm').action="PreOfferProcessing_save.action";
	document.getElementById('paraFrm').submit();
	return true;
}
...
function editFun()
{
	document.getElementById('paraFrm').action="PreOfferProcessing_edit.action";
	document.getElementById('paraFrm').submit();
}
...
function deleteFun()
{
	...
	if(con){
		   document.getElementById('paraFrm').action="PreOfferProcessing_delete.action";
		   document.getElementById('paraFrm').submit();
	} else{
	     return false;
	}
...
function searchFun()
{
	callsF9(500,300,"PreOfferProcessing_f9search.action");
...
function cancelFun()
{
	  ...
	  {
	   document.getElementById('paraFrm').action="PreOfferProcessing_cancelSec.action";
	  }else if(document.getElementById('paraFrm_buttonpanelcode').value=="3")
	  {
	   document.getElementById('paraFrm').action="PreOfferProcessing_cancelThrd.action";
	  }
	  else
	  {
	  document.getElementById('paraFrm').action="PreOfferProcessing_cancelFirst.action";
	  }
	  document.getElementById('paraFrm').submit();
	  return true;
