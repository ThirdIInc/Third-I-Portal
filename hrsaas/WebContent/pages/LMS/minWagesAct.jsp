...
<s:form action="ReturnAct" validate="true" id="paraFrm" validate="true"
	...
	<s:hidden name="generalInfo.generalInfoReturnId" />
	<s:hidden name="generalInfo.generalInfoId" />
	<s:hidden name="generalInfo.ownershipOptionValue" />
	<s:hidden name="pageToShow" value="minimumWages" />
	...
	<table width="96%" border="0" align="right" class="formbg"
					...
					<table width="100%" cellpadding="6" cellspacing="0" border="1"
						...
						<tr class="clsTROdd">
							...
							<table width="100%" border="0" cellpadding="3" cellspacing="0">
								...
								<tr>
									<td><s:textfield size="40" theme="simple"
										name="generalInfo.registrationNo"
										onfocus="clearText('paraFrm_registrationNo','Registration No.')"
										onblur="setText('paraFrm_registrationNo','Registration No.')" /></td>
