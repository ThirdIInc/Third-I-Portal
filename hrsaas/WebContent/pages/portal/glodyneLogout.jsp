...
<table width="100%" height="550" border="0"  cellpadding="8" cellspacing="8"  >
<tr>
...
<table width="36%" border="0" align="center" cellpadding="4" cellspacing="4"  class="formbg">
  <tr valign="middle">
    ...
    <td width="69%" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formhead">
      <tr>
        <td height="25" nowrap="nowrap"><div align="center" class="bluetxt">
          <div align="left">
   ...
   <tr>
    <td colspan="2" valign="middle" ><div align="right"><a href="http://<%=request.getServerName()%>">Login</a>&nbsp;&nbsp; <a href="javascript:closeWindow();">Close Window</a></div></td>
  </tr>
</table>
</td>
</tr>
