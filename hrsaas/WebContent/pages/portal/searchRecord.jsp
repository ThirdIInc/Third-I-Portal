						...
						<table width="100%" border="0" align="right" cellpadding="0"
							...
							<tr>
								<td><strong class="text_head"><img
									...
									height="25" /></strong></td>
								<td width="93%" class="txt"><strong class="text_head">Menu </strong></td>
				...
				<s:if test="empDataAvailable">
					...
					<%
						...
						String empurl = "EmployeePortal_getHomeSearch.action?searchType="
								+ searchTypeEmp + "&searchText=" + searchStringEmp
								+ "&random=" + Math.random();
					%>
					<tr>
						<td colspan="3">
					...
					<tr>
						...
						<table width="100%" class="formbg">
							<tr height="20">
								...
								Id</strong></td>
								<td width="25%" class="formth"><strong>Employee
								Name </strong></td>
								<%
										...
										.equals("Y")) {
								%>
								<td width="15%" class="formth"><strong>Designation
								</strong></td>
								<%
										}
							...
							<s:if test="pageFlag">
								...
								<tr height="20" <%if(count%2==0){
									...
									<td class="sortableTD" width="25%"><%=Utility.checkNull(String
...
{ 
	...
	alert(empCode);
	var searchType='emp';
	//document.getElementById('menuoremployee').value;
	var searchText='';
