...
<s:form action="LTAMisReport" method="post" id="paraFrm">
...
<table width="100%" border="0" align="right" cellpadding="2"
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">LTA Employees List</strong></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>MIS Report </strong></td>
							<%
	...
	<s:hidden name="applDivisionCode"/><s:hidden name="applDivisionName"/><s:hidden name="applBranchCode"/><s:hidden name="applBranchName"/>
	<s:hidden name="applDeptCode"/><s:hidden name="applDeptName"/><s:hidden name="applDesgCode"/><s:hidden name="applDesgName"/>
	<s:hidden name="applETypeCode"/><s:hidden name="applETypeName"/><s:hidden name="applGradeCode"/><s:hidden name="applGradeName"/>
	<s:hidden name="applEmpCode"/><s:hidden name="applEmpName"/><s:hidden name="sortBy1" id="sortBy"/><s:hidden name="sortBy2" id="thenBy1"/>
	<s:hidden name="sortBy3" id="thenBy2"/><s:hidden name="sortByOrder1"/><s:hidden name="sortByOrder2"/><s:hidden name="sortByOrder3"/>
	<s:hidden name="hiddenColumns"/><s:hidden name="hiddenSortBy"/><s:hidden name="hiddenThenBy1"/><s:hidden name="hiddenThenBy2"/>
	<s:hidden name="empTokenChk"/><s:hidden name="empNameChk"/><s:hidden name="divisionChk"/><s:hidden name="branchChk"/>
	<s:hidden name="blockYrChk"/><s:hidden name="visitYearChk"/><s:hidden name="claimDateChk"/><s:hidden name="claimTypeChk"/>
	<s:hidden name="claimAmtChk"/><s:hidden name="exemptedChk"/><s:hidden name="exemptedYearChk"/><s:hidden name="claimDateCompare"/>
	<s:hidden name="claimDateFrom"/><s:hidden name="claimDateTo"/><s:hidden name="yearOfVisitOperator"/><s:hidden name="yearOfVisitFilter"/>
	<s:hidden name="claimAmtOperator"/><s:hidden name="claimAmtFilter"/><s:hidden name="exemptionOperator"/><s:hidden name="exemptionFilter"/>
	<s:hidden name="dataLength"/><s:hidden name="hidReportView" /><s:hidden name="hidReportRadio" /><s:hidden name="reportType" />
	<s:hidden name="reportView" /><s:hidden name="myPage" /><s:hidden name="show" /><s:hidden name="backFlag" />
	</table>
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('LTAMisReport_export.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='LTAMisReport_back.action';
  	document.getElementById('paraFrm').submit(); 
}
</script>
