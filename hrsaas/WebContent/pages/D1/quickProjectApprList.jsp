...
<s:form action="QuickProjectAppr" method="post" name="LeaveForm"
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Quick Project Approval Form </strong></td>
		...
		<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					%> <a href="#"
						onclick="callPageLocal('1', 'F', '<%=totalPage%>', 'QuickProjectAppr_input.action','pageNoField','myPage');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('P', 'P', '<%=totalPage%>', 'QuickProjectAppr_input.action','pageNoField','myPage');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
						maxlength="10"
						onkeypress="callPageTextLocal(event, '<%=totalPage%>', 'QuickProjectAppr_input.action','pageNoField','myPage');return numbersOnly();" />
					of <%=totalPage%> <a href="#"
						onclick="callPageLocal('N', 'N', '<%=totalPage%>', 'QuickProjectAppr_input.action','pageNoField','myPage')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('<%=totalPage%>', 'L', '<%=totalPage%>', 'QuickProjectAppr_input.action','pageNoField','myPage');">
					...
					<table width="100%" class="formbg">
					<tr>
					<td class="formth" width="08%">Sr No </td>
				...
				<%=label.get("aplicationDate")%></label> </td>
					...
					<td   align="center" class="sortableTD"><input type="submit" value='<s:property value="buttonName"/>' class="token" onclick="editapplicationFun('<s:property value="ittquickProjectCode"/>','D');"> </td>
					</tr>
					</s:iterator>
					</s:if>
					<s:else>
...
<script>
 ...
 document.getElementById('paraFrm_flag').value=listType;
		...
		document.getElementById('paraFrm').action = 'QuickProjectAppr_input.action';
...
function addapplicationFun() {
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'QuickProjectAppr_addApplication.action';
		document.getElementById('paraFrm').submit();
	}
	function editapplicationFun(id,status) {
	document.getElementById('paraFrm_quickProjectCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'QuickProjectAppr_editApplication.action?status='+status;
		document.getElementById('paraFrm').submit();
	}
	...
	document.getElementById('paraFrm_quickProjectCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'QuickProjectAppr_editApplicationResubmit.action';
		document.getElementById('paraFrm').submit();
	}
