...
<s:form action="InformationSystemChangeRequest" id="paraFrm"
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /> </strong></td>
					<td width="92%" class="txt"><strong class="text_head">Information System Change Request List</strong></td>
		    ...
		    function setAction(listType){
		     if(listType=="p"){
		     	...
		     	document.getElementById('myPageSentBack').value = "1";
		      	document.getElementById('paraFrm').action='InformationSystemChangeRequest_input.action';
		     ...
		     if(listType=="a"){
		     	...
		     	document.getElementById('myPageApprovedCancel').value = "1";
		      	document.getElementById('paraFrm').action='InformationSystemChangeRequest_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     
		     if(listType=="c"){
		        document.getElementById('myPageCancel').value = "1";
		      	document.getElementById('paraFrm').action='InformationSystemChangeRequest_getCancelledList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     ...
		     if(listType=="r"){
		        ...
		        document.getElementById('myPageCancelRejected').value = "1";
		      	document.getElementById('paraFrm').action='InformationSystemChangeRequest_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		     } 
						...
						%>
							<s:if test="draftVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'InformationSystemChangeRequest_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'InformationSystemChangeRequest_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'InformationSystemChangeRequest_input.action');">
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<td width="25%" class="formth"><label
									...
									<td width="10%" class="formth"><label
										class="set" id="course.appl.date" name="appl.date"
									...
									<s:iterator value="draftVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD"><s:hidden
												name="infoSysReqId" /><s:property value="trackingNo"/>
											</td>
											...
											<td  align="center" ><input type="button"  id="ctrlShow"
															value=" Edit " class="edit" align="middle"
															onclick="editApplicationFunction('<s:property value="infoSysReqId"/>')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="inProcessVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'InformationSystemChangeRequest_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'InformationSystemChangeRequest_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%">
									...
									<td width="20%" class="formth"><label
										class="set" id="tracking.code" name="tracking.code"
										ondblclick="callShowDiv(this);"><%=label.get("tracking.code")%></label>
									</td>
									...
									<td width="10%" class="formth"><label
										class="set" id="schedule.date" name="schedule.date"
										ondblclick="callShowDiv(this);"><%=label.get("schedule.date")%></label>
									</td>
									
									<td width="15%" class="formth">
										<label class="set" id="pendingWithLabel" name="pendingWithLabel"
										ondblclick="callShowDiv(this);"><%=label.get("pendingWithLabel")%></label>
									</td>
									...
									<s:iterator value="inProcessVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center"><s:property value="applDate"/></td>
											<td class="sortableTD" align="center"><s:property value="changeSchedularOccur"/></td>
											<td class="sortableTD" align="center"><s:property value="pendingWithNameItr"/></td>
										<s:if test="%{status=='true'}">
											<td class="sortableTD" align="center">
												<input type="button"  id="ctrlShow"
													value=" Feedback | Reopen " class="token" align="middle"
													onclick="viewApplicationFunction('<s:property value="infoSysReqId"/>')">
											</td>									
										</s:if>
										<s:else>
											<td class="sortableTD" align="center">
						...
						%>
							<s:if test="sentBackVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'InformationSystemChangeRequest_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'InformationSystemChangeRequest_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalSentBackPage%>', 'L', '<%=totalSentBackPage%>', 'InformationSystemChangeRequest_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<td width="10%" class="formth"><label
										class="set" id="edit.application" name="edit.application"
										ondblclick="callShowDiv(this);"><%=label.get("edit.application")%></label>
									</td>
									...
									<s:iterator value="sentBackVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD"><s:property value="trackingNo"/></td>
											<td class="sortableTD"><s:property value="employeeName"/></td>
											<td class="sortableTD"><s:property value="changeTitleItr"/></td>
											<td class="sortableTD" align="center"><s:property value="applDate"/></td>
											<td class="sortableTD" align="center"><s:property value="changeSchedularOccur"/></td>
						...
						%>
							<s:if test="approvedApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'InformationSystemChangeRequest_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'InformationSystemChangeRequest_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="approvedApplicationIteratorList">
										<tr>
											...
											<td class="sortableTD">
												<s:hidden name="infoSysReqId" /><s:property value="trackingNo"/>
											</td>
											<td class="sortableTD"><s:property value="employeeName"/></td>
											<td class="sortableTD"><s:property value="changeTitleItr"/></td>
											<td class="sortableTD" align="center"><s:property value="applDate"/></td>
						...
						%>
							<s:if test="approvedCancellationApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApprovedCancellation('1', 'F', '<%=totalApprovedCancellationPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApprovedCancellation('P', 'P', '<%=totalApprovedCancellationPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedCancellationText(event, '<%=totalApprovedCancellationPage%>', 'InformationSystemChangeRequest_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedCancellationPage%> <a href="#"
										onclick="callPageApprovedCancellation('N', 'N', '<%=totalApprovedCancellationPage%>', 'InformationSystemChangeRequest_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApprovedCancellation('<%=totalApprovedCancellationPage%>', 'L', '<%=totalApprovedCancellationPage%>', 'InformationSystemChangeRequest_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<td width="20%" class="formth">Details</td>
						...
						%>
							<s:if test="cancelledVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageCancel('1', 'F', '<%=totalCancelPage%>', 'InformationSystemChangeRequest_getCancelledList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageCancel('P', 'P', '<%=totalCancelPage%>', 'InformationSystemChangeRequest_getCancelledList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoCancelField"
										id="pageNoCancelField" size="3" value="<%=cancelPageNo%>" maxlength="10"
										onkeypress="callPageCancelText(event, '<%=totalCancelPage%>', 'InformationSystemChangeRequest_getCancelledList.action');return numbersOnly();" />
									of <%=totalCancelPage%> <a href="#"
										onclick="callPageCancel('N', 'N', '<%=totalCancelPage%>', 'InformationSystemChangeRequest_getCancelledList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageCancel('<%=totalCancelPage%>', 'L', '<%=totalCancelPage%>', 'InformationSystemChangeRequest_getCancelledList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="rejectedApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'InformationSystemChangeRequest_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'InformationSystemChangeRequest_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'InformationSystemChangeRequest_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'InformationSystemChangeRequest_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'InformationSystemChangeRequest_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
<script>
	function addNewFunction() {  
         document.getElementById('paraFrm').action = "InformationSystemChangeRequest_addNew.action";
		 document.getElementById('paraFrm').submit();
		 document.getElementById('paraFrm').target ="main"; 
    }

	function viewDetails(persDataId,sendBack){  
		document.getElementById('paraFrm').action = "InformationSystemChangeRequest_callView.action?persDataId="+persDataId+'&sendBack='+sendBack;	  
		document.getElementById('paraFrm').submit();
	    document.getElementById('paraFrm').target = "main";
	} 
	...
	function viewPendingDetails(persDataId){  
		document.getElementById('paraFrm').action = 'InformationSystemChangeRequest_callView.action?persDataId='+persDataId;	  
		document.getElementById('paraFrm').submit();
	    document.getElementById('paraFrm').target = "main";
	} 
...
function callPageInProcessText(id, totalPage, action){   
	...
	// Function Rejected Cancellation List Ends
 	function editApplicationFunction(infoSysReqId)
{	//alert(infoSysReqId);
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="InformationSystemChangeRequest_editApplicationFunction.action?infoSysReqId="+infoSysReqId;
	  document.getElementById('paraFrm').submit();
}
	function viewApplicationFunction(infoSysReqId)
{//alert(inProcessVoucherID);
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="InformationSystemChangeRequest_viewApplicationFunction.action?infoSysReqId="+infoSysReqId;
	  document.getElementById('paraFrm').submit();
}
</script>