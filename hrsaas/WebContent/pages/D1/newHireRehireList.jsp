			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">New Hire/Rehire List</strong>
					</td>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		     	...
		     	document.getElementById('myPageSentBack').value = '1';
		      	...
		      	document.getElementById('paraFrm').action='NewHireRehire_input.action';
		     ...
		     if(listType=="a"){
		     	...
		     	document.getElementById('myPageApprovedCancel').value = '1';
		      	document.getElementById('paraFrm').action='NewHireRehire_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     
		     if(listType=="c"){
				document.getElementById('myPageCancel').value = '1';	     
		      	document.getElementById('paraFrm').action='NewHireRehire_getCancelledList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     ...
		     if(listType=="r"){
		        ...
		        document.getElementById('myPageCancelRejected').value = '1';
		      	document.getElementById('paraFrm').action='NewHireRehire_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		     } 
						...
						%>
							<s:if test="draftVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'NewHireRehire_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'NewHireRehire_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'NewHireRehire_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'NewHireRehire_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'NewHireRehire_input.action');">
							...
							<tr>
								...
								<table width="100%" border="0">
									<tr>								
										...
										<td width="25%" class="formth">
											<label class="set" id="tracking.code" name="tracking.code"
										...
										<td width="10%" class="formth">
											<label class="set" id="edit.application" name="edit.application"
									...
									<s:iterator value="draftVoucherIteratorList">
										<tr>
											...
											<td align="center" class="sortableTD" width="5%"><%=++i%></td>
											...
											<td class="sortableTD" align="center" width="10%">&nbsp;
												<input type="button" name="edit" value="Edit application" class="edit" onclick="editApplicationFunction('<s:property value="hireRehireId"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="inProcessVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'NewHireRehire_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'NewHireRehire_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'NewHireRehire_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'NewHireRehire_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'NewHireRehire_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="inProcessVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center" width="25%">&nbsp;			
												<s:hidden name="hireRehireId" />																
												<s:property	value="trackingNo" />																					
											</td>
											...
											<td class="sortableTD" align="center" width="10%">&nbsp;
												<input type="button" name="edit" value="View application" class="token" onclick="viewApplicationFunction('<s:property value="hireRehireId"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="sentBackVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'NewHireRehire_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'NewHireRehire_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'NewHireRehire_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'NewHireRehire_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalInProcessPage%>', 'L', '<%=totalSentBackPage%>', 'NewHireRehire_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="sentBackVoucherIteratorList">
										<tr>
											...
											<td align="center" class="sortableTD" width="5%"><%=++i7%></td>
						...
						%>
							<s:if test="approvedVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'NewHireRehire_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'NewHireRehire_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'NewHireRehire_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'NewHireRehire_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'NewHireRehire_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="approvedVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center" width="10%">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApprovedApplicationFunction('<s:property value="hireRehireId"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="rejectedVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'NewHireRehire_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'NewHireRehire_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'NewHireRehire_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'NewHireRehire_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'NewHireRehire_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
function addNewFunction()
{
  	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="NewHireRehire_addNew.action";
	  document.getElementById('paraFrm').submit();	   
}

function editApplicationFunction(hireRehireId)
{	
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="NewHireRehire_editApplicationFunction.action?hireRehireId="+hireRehireId;
	  document.getElementById('paraFrm').submit();
}

function viewApplicationFunction(hireRehireId)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="NewHireRehire_viewApplicationFunction.action?hireRehireId="+hireRehireId;
	  document.getElementById('paraFrm').submit();
}

function viewApprovedApplicationFunction(hireRehireId)
{
	 document.getElementById('paraFrm').target = "_self";
   	 document.getElementById('paraFrm').action="NewHireRehire_viewApprovedApplication.action?hireRehireId="+hireRehireId;
	 document.getElementById('paraFrm').submit();
}
