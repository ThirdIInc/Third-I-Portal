...
<s:form action="DeptMaster" id="paraFrm" validate="true" target="main"
	...
	<s:hidden name="bean.deptName" />
	
	<s:hidden name="bean.deptNumber" />
	<s:hidden name="bean.deptParName" />
	<s:hidden name="bean.deptDesc" />
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="1" cellspacing="1"
								...
								<tr class="td_bottom_border" >
									...
									<td class="formth" align="center" width="40%"><label name="department"
									...
									<td class="formth" align="center"><label name="is.active" width="20%"
										...
										<s:iterator value="deptList">
											<tr <%if(count%2==0){
												...
												<td width="40%" align="left" class="sortableTD">&nbsp;<s:property
													value="deptNumber" />&nbsp; <input type="hidden"
													name="hdeleteCode" id="hdeleteCode<%=i%>" /></td>
												<td class="sortableTD" width="50%">&nbsp; <s:property
													value="deptDesc" /></td>
												<td class="sortableTD" width="30%">&nbsp; <s:property value="isActive" /></td>
...
function addnewFun() {
		...
		document.getElementById('paraFrm').action = 'DepartmentNumberMaster_addNew.action';
	...
	function searchFun() {
		...
		document.getElementById("paraFrm").action ='DepartmentNumberMaster_searchAction.action';
		document.getElementById("paraFrm").submit();
	}
function reportFun() {
		document.getElementById('paraFrm').target = "_blank";
		document.getElementById('paraFrm').action = 'DepartmentNumberMaster_report.action';
		document.getElementById('paraFrm').submit();
	}
...
function oldRowColor(cell,val) {
	...
	function callForEdit(id){
	    callButton('NA', 'Y', 2);
	  	document.getElementById('paraFrm_hiddencode').value=id;
	   	document.getElementById("paraFrm").action="DepartmentNumberMaster_calforedit.action";
	...
	function chkDelete()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="DepartmentNumberMaster_delete1.action";
	   document.getElementById('paraFrm').target = "_self";
	    document.getElementById('paraFrm').submit();
	    }
	    else
