...
<s:form action="TravelApplication" id="paraFrm"
	...
	<s:hidden name="listType" value="%{listType}" id="listType"/>
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /> </strong></td>
					<td width="92%" class="txt"><strong class="text_head">Authorized Travel Request</strong></td>
		...
		<tr>
			...
			<table class="" width="100%">
				<tr>
					...
					Application</a> | <a href="#" onclick="setAction('approved')">Approved
					List</a>  | <a href="#" onclick="setAction('rejected')">Rejected
					List</a></td>
				</tr>
			</table>
			</td>
						...
						%>
							<s:if test="draftListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'TravelApplication_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'TravelApplication_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'TravelApplication_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'TravelApplication_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'TravelApplication_input.action');">
							...
							<tr>
								...
								<table width="100%" border="0">
									...
									<td width="25%" colspan="1" class="formth"><label
										class="set" id="Track" name="Track"
										ondblclick="callShowDiv(this);"><%=label.get("Track")%></label>
									</td>
									...
									<td width="10%" colspan="1" class="formth"><label
										class="set" id="destination" name="destination"
										ondblclick="callShowDiv(this);"><%=label.get("destination")%></label>
									</td>
										
									<td width="10%" colspan="1" class="formth"><label
										class="set" id="from" name="from"
									...
									<s:iterator value="draftList">
										<tr>
											...
											<td class="sortableTD"><s:property value="authorizedToken"/></td>
											...
											<td  align="center">
												<input type="button"  id="ctrlShow"
													...
													onclick="javascript:viewDetails('<s:property value="travelID"/>','draft')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="inProcessListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'TravelApplication_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'TravelApplication_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'TravelApplication_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'TravelApplication_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'TravelApplication_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<td width="25%" colspan="1" class="formth"><label
										class="set" id="Track" name="Track"
										ondblclick="callShowDiv(this);"><%=label.get("Track")%></label></td>
									<td width="20%" colspan="1" class="formth"><label
										class="set" id="emp.name" name="emp.name"
										ondblclick="callShowDiv(this);"><%=label.get("emp.name")%></label></td>
										...
										<tr>
											...
											<td  align="center">
												<input type="button"  id="ctrlShow"
													...
													onclick="javascript:viewDetails('<s:property value="travelID"/>','process')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="sendBackLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'TravelApplication_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'TravelApplication_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'TravelApplication_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'TravelApplication_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalInProcessPage%>', 'L', '<%=totalSentBackPage%>', 'TravelApplication_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
									...
									<s:iterator value="sendBackList">
										<tr>
											...
											<td align="center">
												<input type="button"  id="ctrlShow"
													value=" Edit Application " class="edit" align="middle"
													onclick="javascript:viewDetails('<s:property value="travelID"/>','sendBack')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="approvedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'TravelApplication_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'TravelApplication_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
									...
									<s:iterator value="approvedList">
										<tr>
											...
											<td width="78%" align="center">
												<input type="button"  id="ctrlShow"
													value=" View Application " class="token" align="middle"
													onclick="javascript:viewDetails('<s:property value="travelID"/>','approved')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="approvedCancelListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApprovedCancellation('1', 'F', '<%=totalApprovedCancellationPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApprovedCancellation('P', 'P', '<%=totalApprovedCancellationPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedCancellationText(event, '<%=totalApprovedCancellationPage%>', 'TravelApplication_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedCancellationPage%> <a href="#"
										onclick="callPageApprovedCancellation('N', 'N', '<%=totalApprovedCancellationPage%>', 'TravelApplication_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApprovedCancellation('<%=totalApprovedCancellationPage%>', 'L', '<%=totalApprovedCancellationPage%>', 'TravelApplication_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
									...
									<s:iterator value="approvedCancelList">
										<tr>
											...
											<td width="78%" align="center"><input type="button"  id="ctrlShow"
														value=" View Application " class="token" align="middle"
														onclick="javascript:viewDetails('<s:property value="travelID"/>','approvedCancel')">
											</td>
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="cancelledVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageCancel('1', 'F', '<%=totalCancelPage%>', 'TravelApplication_getCancelledList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageCancel('P', 'P', '<%=totalCancelPage%>', 'TravelApplication_getCancelledList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoCancelField"
										id="pageNoCancelField" size="3" value="<%=cancelPageNo%>" maxlength="10"
										onkeypress="callPageCancelText(event, '<%=totalCancelPage%>', 'TravelApplication_getCancelledList.action');return numbersOnly();" />
									of <%=totalCancelPage%> <a href="#"
										onclick="callPageCancel('N', 'N', '<%=totalCancelPage%>', 'TravelApplication_getCancelledList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageCancel('<%=totalCancelPage%>', 'L', '<%=totalCancelPage%>', 'TravelApplication_getCancelledList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="cancelledVoucherIteratorList">
										<tr>
											...
											<td width="78%" align="center"><input type="button"  id="ctrlShow"
														value=" View Application " class="token" align="middle"
														onclick="javascript:viewDetails('<s:property value="personalDataId"/>','')">
											</td>
										</tr>
									</s:iterator>
	...
	<!--  Rejected application List Begins  -->	
						...
						%>
							<s:if test="rejectListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'TravelApplication_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'TravelApplication_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="rejectList">
										<tr>
											...
											<td width="78%" align="center"><input type="button"  id="ctrlShow"
														value=" View Application " class="token" align="middle"
														onclick="javascript:viewRejectDetails('<s:property value="travelID"/>','reject')">
											</td>
										</tr>
									</s:iterator>
		...
		<!--  Rejected Cancellation Application List Begins  -->	
		<tr>
			<td>
				<table class="formbg" width="100%" cellspacing="1" cellspadding="0"	border="0">
				<tr>
					<td>
						<strong class="text_head"> Rejected Cancellation Applications  </strong>
					</td>
					<td width="70%" align="right">
						<%
							int totalRejectedCancellationPage = 0;
							int rejectedCancellationPageNo = 0;
						%>
							<s:if test="rejectCancelListLength">
								<table>
								<tr>
									<td id="ctrlShow" width="100%" align="right"><b>Page:</b>
									<%
									totalRejectedCancellationPage = (Integer) request.getAttribute("totalRejectedCancellationPage");
									rejectedCancellationPageNo = (Integer) request.getAttribute("rejectedCancellationPageNo");
									%> <a href="#"
										onclick="callPageRejectedCancellation('1', 'F', '<%=totalRejectedCancellationPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejectedCancellation('P', 'P', '<%=totalRejectedCancellationPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoRejectedCancellationField"
										id="pageNoRejectedCancellationField" size="3" value="<%=rejectedCancellationPageNo%>" maxlength="10"
										onkeypress="callPageRejectedCancellationText(event, '<%=totalRejectedCancellationPage%>', 'TravelApplication_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedCancellationPage%> <a href="#"
										onclick="callPageRejectedCancellation('N', 'N', '<%=totalRejectedCancellationPage%>', 'TravelApplication_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejectedCancellation('<%=totalRejectedCancellationPage%>', 'L', '<%=totalRejectedCancellationPage%>', 'TravelApplication_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<%!int d6 = 0;%>
									<%
										int i6 = rejectedCancellationPageNo * 20 - 20;									
									%>

									<s:iterator value="rejectCancelList">
										<tr>
											<s:hidden name="travelID" />	
											...
											<td width="78%" align="center"><input type="button"  id="ctrlShow"
														value=" View Application " class="token" align="middle"
														onclick="javascript:viewDetails('<s:property value="travelID"/>','rejectCancel')">
											</td>
										</tr>
									</s:iterator>
		...
		<!-- Rejected Cancellation Application List Ends -->	
		</s:if>
	<!-- ========= Approved and approved cancellation  application List Ends ============= -->	
...
<script>
	...
	function viewDetails(travelID,sendBack){  

		//alert("travelID : "+travelID);
		//alert("sendBack : "+sendBack);
		if(sendBack =='draft'){
			document.getElementById('paraFrm').action = "TravelApplication_callView.action?travelID="+travelID+'&sendBack='+sendBack;	  
			document.getElementById('paraFrm').submit();
		    document.getElementById('paraFrm').target = "main";
	    }
	...
	function viewRejectDetails(travelID,reject){  
		if(reject =='reject'){
			document.getElementById('paraFrm').action = "TravelApplication_callView.action?travelID="+travelID+'&sendBack='+reject;	
			document.getElementById('paraFrm').submit();
		    document.getElementById('paraFrm').target = "main";
	    }
	 }
...
function setAction(listType){
 try {
	  ...
	  if(listType=="rejected"){
	    ...
	    document.getElementById('listType').value='reject';
