...
<s:form action="TravelApplication" id="paraFrm" theme="simple" validate="true">
	...
	<table width="100%" class="formbg" align="right">
		...
		<s:else>
				...
				<table width="100%" class="formbg">
					<tr>
						<td width="4%" valign="bottom" class="txt"><strong
							...
							src="../pages/images/recruitment/review_shared.gif" width="25"
							height="25" /> </strong></td>
						<td width="92%" class="txt"><strong class="text_head">Authorized Travel Request
						</strong></td>
						<td width="4%" valign="middle" align="right" class="txt"><img
							src="../pages/images/recruitment/help.gif" width="16" height="16" />
						</td>
			...
			<tr>
				...
				<table width="100%" class="formbg">
					...
					<tr>
						<td width="20%" colspan="2"><b>Email to World Travel</b></td>
						<td id='ctrlShow'><s:property value="emailWorldTravel" /></td>
					</tr>
					</s:if>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					<td colspan="4"><b>Note:</b> No ticket will be booked without required approval.If you do not receive confirmation by way itinerary, 
you must follow up with approver to ensure timely submission of this ATR.
					</td>
				</tr>
...
<s:if test="bean.generalFlag">
						...
						<td width="80%" colspan="3"><s:textfield name="employeeToken"
							size="20" theme="simple" readonly="true" cssStyle="background-color: #F2F2F2;"/><s:textfield
							name="employeeName" size="70" theme="simple" readonly="true" cssStyle="background-color: #F2F2F2;"/>
...
<td width="20%"><label id="employee" name="employee"
						...
						<img
							...
							onclick="javascript:callsF9(500,325,'TravelApplication_f9Employee.action');"></s:else>
						</td>
				...
				<tr>
					...
					<!--<td width="25%"><s:textfield name="deptCode" readonly="true"
						size="20" cssStyle="background-color: #F2F2F2;" /></td>
				-->
					<td width="25%" colspan="1"><s:hidden
						name="deptCode"  /> <s:textfield name="deptName" size="20" readonly="true"/>
					<img src="../pages/images/recruitment/search2.gif" width="16"
						height="15" class="iconImage" id='ctrlHide'
						onclick="javascript:callsF9(500,325,'TravelApplication_f9deptNumber.action');"></td>
					...
					<td width="25%"><label id="date.ATR" name="date.ATR"
						ondblclick="callShowDiv(this);"><%=label.get("date.ATR")%></label>
					 <br>(DD-MM-YYYY) :<font color="red" id="ctrlHide">*</font></td>
					<td width="25%"><s:textfield
								name="dateOfAtr" size="20"
								value="%{dateOfAtr}" theme="simple" 
								 /><s:a
					...
					<td width="25%"><s:textfield name="empTravel" 
						size="20"  onkeypress="return isNumberKey(event);" maxlength="10"/></td>
				</tr>
				
				<tr>
					<td width="25%"><label id="from" name="from"
						ondblclick="callShowDiv(this);"><%=label.get("from")%></label> <br>(DD-MM-YYYY) :<font color="red" id="ctrlHide">*</font></td>
						<td width="25%"><s:textfield
					...
					<td width="25%" align="left"><label id="to" name="to"
						ondblclick="callShowDiv(this);"><%=label.get("to")%></label> <br>(DD-MM-YYYY) :<font color="red" id="ctrlHide">*</font></td>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					...
					<td width="25%"><s:checkbox name="managmentTraining" />
						</td>
				...
				<td width="25%"></td>
					<td width="25%" nowrap="nowrap">(Must explain "Other" in comments field.)</td>
					<td width="25%"></td>
					<td width="25%"></td>
				...
				<td width="25%"><label id="comments" name="comments"
					...
					<td width="25%"><s:textarea theme="simple" cols="22" rows="3"
							name="comments" id="comments" onkeypress="return imposeMaxLength(event, this, 500);"/></td>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<td width="25%" nowrap="nowrap" colspan="3">(Airfare is always Direct Billed when expensed.)</td>
				...
				<tr>
				<td nowrap="nowrap" colspan="1" width="25%">
				<td nowrap="nowrap" colspan="3">No(s) will be reported on monthly exception report provided to your functional executive.
					</td>
				</tr>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					...
					<td width="20%" colspan="1">$<s:textfield name="totalAirExp" 
						size="20" onkeyup=" total(); " onkeypress="return isNumberKey(event);" maxlength="20"/></td>
				...
				<tr>
					...
					<td width="20%" colspan="1">$<s:textfield name="carExp" 
						size="20" onkeypress=" return isNumberKey(event);" maxlength="20"/></td>
				...
				<tr>
					...
					<td width="20%" colspan="1">$<s:textfield name="totalHotelExp" onkeyup=" total(); " onkeypress="return isNumberKey(event);"
						size="20" maxlength="20"/></td>
				...
				<tr>
					...
					<td width="20%" colspan="1">Per Day</td>
					<td width="20%" colspan="1" nowrap="nowrap">$<s:textfield name="totalMealExp" onkeyup=" total(); " onkeypress="return isNumberKey(event);" 
						size="20" maxlength="20"/></td>
						<td width="20%" colspan="1">Total For Duration</td>
				</tr>
			...
			<tr>
					...
					<td width="20%" colspan="1"></td>
					<td width="20%" colspan="1" nowrap="nowrap">$<s:textfield name="totalOtherExp"  onkeyup=" total(); " onkeypress="return isNumberKey(event);" size="20" maxlength="20"/> </td>
					<td width="20%" colspan="1">Total For Duration</td>
				</tr>
				<tr><td>
				<br/></td></tr>
			...
			<table width="100%" border="0" align="center" cellpadding="2"
				...
				<tr>
					...
					<td colspan="2" width="80%"><s:textarea name="generalComments" cols="100" rows="2" onkeypress="return imposeMaxLength(event, this, 400);"/><img
						...
						onclick="javascript:callWindow('paraFrm_generalComments','gen.comments','','400','400');"></td>
		...
		<!--<s:if test="forApproval">
			...
			--><tr>
				...
				<table width="100%" border="0" align="center" cellpadding="2"
					...
					<tr>
						<td width="20%">
						<label class="set" name="changeManager"
									id="changeManager" ondblclick="callShowDiv(this);"><%=label.get("changeManager")%>:</label>
						</td>
...
<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="2"
					...
					<tr>
									...
									:</td>
									<td width="20%"><s:hidden name="completedByCode"></s:hidden>
								<s:hidden name="completedBy"></s:hidden>
								<s:property value="completedBy"/>   </td></td>
									<td width="20%"><b><label class="set" name="on"
										id="on" ondblclick="callShowDiv(this);"><%=label.get("on")%></label></b>
									:</td>
									<td width="20%"><s:hidden name="completedDate"></s:hidden>
...
function roundNumber(num, dec) {
	...
	if(totalOtherExp=="")
	{
	 ...
	 total=eval(parseFloat(totalAirExp))+eval(parseFloat(totalCarExp))+eval(parseFloat(totalHotelExp))+eval(parseFloat(totalMealExp))+eval(parseFloat(totalOtherExp));
	  
		  var totalCalculatedValue=roundNumber(total,4);
			document.getElementById('paraFrm_totalValue').value=totalCalculatedValue.toFixed(2);
...
{	
	...
	try{
		...
		var firstApproverCode=document.getElementById('paraFrm_firstApproverCode').value
	   			var approverName=document.getElementById('paraFrm_approverName').value
				if(firstApproverCode=="" ){
					if(approverName==""){
						alert("Please select approver ");
						document.getElementById('paraFrm_firstApproverCode').focus();
						return false;
					}
				}
...
function approveFun() {
		try{
		var emailWorldTravel=document.getElementById('paraFrm_emailWorldTravel').value
		if(emailWorldTravel==""){
