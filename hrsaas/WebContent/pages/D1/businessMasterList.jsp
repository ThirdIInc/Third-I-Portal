			...
			<table width="100%" border="0" align="right" class="formbg">
				<tr>
					...
					<td colspan="1" width="80%" class="txt"><strong
						class="text_head">Business Unit </strong></td>
		...
		<tr>
			...
			<table width="100%" cellspacing="2" cellspacing="2" border="0">
				...
				<s:if test="modeLength">
					...
					%> <a href="#"
						onclick="callPage('1', 'F', '<%=totalPage%>', 'BusinessUnit_callPage.action');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPage('P', 'P', '<%=totalPage%>', 'BusinessUnit_callPage.action');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
						maxlength="10"
						onkeypress="callPageText(event, '<%=totalPage%>', 'BusinessUnit_callPage.action');return numbersOnly();" />
					of <%=totalPage%> <a href="#"
						onclick="callPage('N', 'N', '<%=totalPage%>', 'BusinessUnit_callPage.action')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'BusinessUnit_callPage.action');">
								...
								<table width="100%" border="0" cellpadding="2" cellspacing="2">
									<tr>
										...
										<td class="formth" align="center" width="89%" colspan="1"><label
											class="set" name="business_unit_name" id="business_unit_name"
											ondblclick="callShowDiv(this);"><%=label.get("business_unit_name")%></label></td>

									<!--  	<td class="formth" align="center" width="50%" colspan="1"><label
											class="set" name="business_unit_div" id="business_unit_div"
											ondblclick="callShowDiv(this);"><%=label.get("business_unit_div")%></label></td> -->
									...
									<s:if test="modeLength">
										...
										<s:iterator value="businessUnitList">
											<tr <%if(count%2==0){
												%> class="tableCell1"
												...
												ondblclick="javascript:callForEdit('<s:property value="businessCode"/>');">
												...
												<s:hidden value="%{businessCode}"
													id='<%="businessCode" + i%>'></s:hidden>
												<script type="text/javascript">
													records[<%=i%>] = document.getElementById('businessCode' + '<%=i%>').value;
												</script>
												<td width="89%" align="left" class="sortableTD" colspan="1"><s:property
													value="unitName" /> <input type="hidden"
													name="hdeleteCode" id="hdeleteCode<%=i%>" /></td>

											<!-- 	<td class="sortableTD" width="50%" colspan="1">&nbsp; <s:property
													value="unitDivision" /></td>  -->
												...
												<td colspan="1" width="6%" id="ctrlShow" align="center" nowrap="nowrap"
													...
													onclick="callForDelete1('<s:property value="businessCode"/>','<%=i%>')" /></td>
											</tr>
...
function addnewFun() {
		...
		document.getElementById('paraFrm').action = 'BusinessUnit_addNew.action';
...
function searchFun() {
		...
		document.getElementById("paraFrm").action ='BusinessUnit_f9action.action';
		document.getElementById("paraFrm").submit();
	}
...
function callForEdit(id){
	callButton('NA', 'Y', 2);
	  	...
	  	document.getElementById('paraFrm_businessCode').value=id;
	   	document.getElementById("paraFrm").action="BusinessUnit_editBusinessData.action";
	   	document.getElementById('paraFrm').target = "_self";
	    document.getElementById("paraFrm").submit();
   }
...
function chk(){
	...
	function chkDelete()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="BusinessUnit_deleteChkRecords.action";
	   document.getElementById('paraFrm').target = "_self";
	    document.getElementById('paraFrm').submit();
	    }
	    else
