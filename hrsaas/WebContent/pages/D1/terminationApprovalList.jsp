...
<s:form action="TerminationApproval" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Termination Approval</strong>
					</td>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		     	...
		     	document.getElementById('myPagePendingCancel').value = "1";
		      	document.getElementById('paraFrm').action='TerminationApproval_input.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     
		     if(listType=="a"){
		     	document.getElementById('myPageApproved').value = "1";
		      	document.getElementById('paraFrm').action='TerminationApproval_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		    
		     if(listType=="r"){
		        document.getElementById('myPageRejected').value = "1";
		      	document.getElementById('paraFrm').action='TerminationApproval_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		     } 
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'TerminationApproval_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'TerminationApproval_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'TerminationApproval_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'TerminationApproval_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'TerminationApproval_input.action');">
								...
								<table width="100%" border="0">
									<tr>								
										...
										<td class="formth" align="center" width="25%">
											<label class="set" name="trackingNumIterator" id="trackingNumIterator" ondblclick="callShowDiv(this);"> <%=label.get("trackingNumIterator")%></label>
										</td>
										...
										<td class="formth" align="center" width="20%">
											<label class="set" name="terminationDateIterator" id="terminationDateIterator" ondblclick="callShowDiv(this);"> <%=label.get("terminationDateIterator")%></label>
										</td>	
									...
									<s:iterator value="pendingIteratorList">
										<tr>
											<s:hidden name="terminationHiddenID" />
												<s:hidden name="terminationHiddenStatus" />	
											...
											<td class="sortableTD" align="left">&nbsp;
												<s:property
													value="employeeNameIterator" />
											</td>
										
											<td class="sortableTD" align="center">&nbsp;
												<s:property
													value="terminationDateIterator" />
											</td>
										
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View application" class="token" onclick="viewApplicationFunction('<s:property value="terminationHiddenID"/>','<s:property value="terminationHiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="approvedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'TerminationApproval_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'TerminationApproval_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'TerminationApproval_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'TerminationApproval_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'TerminationApproval_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="rejectedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'TerminationApproval_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'TerminationApproval_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'TerminationApproval_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'TerminationApproval_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'TerminationApproval_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
function viewApplicationFunction(hiddenApplicationID,hiddenStatus)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="TerminationApproval_viewApplicationFunction.action?hiddenApplicationID="+hiddenApplicationID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
