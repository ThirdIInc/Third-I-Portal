...
<s:form action="CustConciergeServiceReqApprover" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Customer Concierge Program Service Alert Request Approval Form</strong>
					</td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='CustConciergeServiceReqApprover_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='CustConciergeServiceReqApprover_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='CustConciergeServiceReqApprover_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'CustConciergeServiceReqApprover_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'CustConciergeServiceReqApprover_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'CustConciergeServiceReqApprover_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'CustConciergeServiceReqApprover_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'CustConciergeServiceReqApprover_input.action');">
...
function viewApplicationFunction(applicationID)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="CustConciergeServiceReqApprover_viewApplicationFunction.action?applicationID="+applicationID;
	  document.getElementById('paraFrm').submit();
}
