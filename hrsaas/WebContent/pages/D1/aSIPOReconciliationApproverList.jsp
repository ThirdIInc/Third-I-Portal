<!-- Created by manish sakpal on 8th March 2011-->

<%@ taglib prefix="s" uri="/struts-tags"%>
<%@include file="/pages/common/labelManagement.jsp"%>
<s:form action="ASIPOReconciliationApprover" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">ASI PO Reconciliation Approval Form</strong>
					</td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ASIPOReconciliationApprover_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ASIPOReconciliationApprover_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='ASIPOReconciliationApprover_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'ASIPOReconciliationApprover_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'ASIPOReconciliationApprover_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'ASIPOReconciliationApprover_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'ASIPOReconciliationApprover_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'ASIPOReconciliationApprover_input.action');">
								...
								<table width="100%" border="0">
									<tr>								
										...
										<td class="formth" align="center" width="20%">
											<label class="set" name="partsReceivedDate" id="partsReceivedDate" ondblclick="callShowDiv(this);"> <%=label.get("partsReceivedDate")%></label>
										</td>	
									...
									<s:iterator value="pendingIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<s:property	value="partsReceivedDateIterator" />
											</td>
										
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApplicationFunction('<s:property value="purchaseHiddenID"/>');" />
											</td>										
										</tr>
									</s:iterator>
...
function viewApplicationFunction(applicationID)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ASIPOReconciliationApprover_viewApplicationFunction.action?applicationID="+applicationID;
	  document.getElementById('paraFrm').submit();
}
