			...
			<tr>
				...
				<table width="100%" border="0" align="right" cellpadding="0"
					...
					<tr>
						...
						and Location Change Approval </strong></td>
...
<br/>
					...
					<s:if test='!(applnStatus == "D" || applnStatus == "")'>
			<tr>
				<td width="100%" colspan="5">
				<table width="100%" class="formbg">
					<tr>
						<td width="20%" colspan="2" id='ctrlShow'><b>Approver Comments</b><font id='ctrlHide'
							color="red">*</font></td>
						<s:if test="forApproval">
						<td id='ctrlShow'><s:textarea theme="simple" cols="70" rows="3"
				...
				<tr>
					...
					<s:else>
							...
							<td colspan="3" width="80%"><s:hidden name="empId" /><s:textfield
								...
								cssStyle="background-color: #F2F2F2;"></s:textfield> <img
						...
						<tr>
							...
							<td colspan="1" width="30%"><s:textfield size="20"
								theme="simple" maxlength="30" name="executive" readonly="true"
					...
					<img src="../pages/images/recruitment/search2.gif" width="16"
						...
						<tr>
							...
							<s:select headerKey=""
								headerValue="--Select--" name="applnStatus" disabled="true"
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="2" cellspacing="2"
						...
						<tr>
							...
							<td colspan="1" width="20%">&nbsp;</td>
							<td colspan="1" width="30%"><s:textfield size="20"
								theme="simple" maxlength="30" name="to_workPhone" /></td>
						...
						<tr>
							...
							<td colspan="1" width="30%" nowrap="nowrap"><s:hidden
								name="to_managerID" /> <s:textfield size="20" theme="simple"
						...
						<tr>
							...
							<td colspan="1" width="30%" nowrap="nowrap"><s:textfield
								size="20" theme="simple" maxlength="30" name="city"
								readonly="true" cssStyle="background-color: #F2F2F2;" /><img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'DepartmentLocationChange_f9city.action');"
								id="ctrlHide"></td>
						</tr>
						...
						<tr>
							...
							<td colspan="1" width="20%"><label class="set" name="state"
								...
								color="red" id="ctrlHide"*</font>:</td>
							<td colspan="1" width="30%"><s:textfield size="20"
								theme="simple" maxlength="30" name="state" readonly="true"
								cssStyle="background-color: #F2F2F2;" /></td>
						...
						<tr>
							...
							:</td>
							<td colspan="1" width="30%"><s:textfield size="20"
								theme="simple" maxlength="30" name="country" readonly="true"
								cssStyle="background-color: #F2F2F2;" /></td>
						</tr>
						...
						<tr>
							<td colspan="1" width="20%"><label class="set" name="phone1"
								...
								color="red" id="ctrlHide">*</font>:</td>
							<td colspan="1" width="30%"><s:textfield size="20"
								theme="simple" maxlength="30" name="phone1" /></td>
...
<tr>
					...
					<table width="100%" border="0" cellpadding="2" cellspacing="2"
						...
						When you Approve this form, it will automatically be sent to HR.  </td>
						</tr>
				...
				<tr>
					...
					--></td>
								...
								<tr>
									<td><label class="set" name="app_name"
