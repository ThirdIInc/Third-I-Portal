...
<s:form action="Termination" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Termination Form</strong>
					</td>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		     	...
		     	document.getElementById('myPageSentBack').value = "1";
		      	document.getElementById('paraFrm').action='Termination_input.action';
		     ...
		     if(listType=="a"){
		     	...
		     	document.getElementById('myPageApprovedCancel').value = "1";
		      	document.getElementById('paraFrm').action='Termination_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		        ...
		        document.getElementById('myPageCancelRejected').value = "1";
		      	document.getElementById('paraFrm').action='Termination_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		     } 
						...
						%>
							<s:if test="draftVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'Termination_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'Termination_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'Termination_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'Termination_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'Termination_input.action');">
								...
								<table width="100%" border="0">
									<tr>								
										...
										<td class="formth" align="center" width="20%">
											<label class="set" name="terminationDate" id="terminationDate" ondblclick="callShowDiv(this);"> <%=label.get("terminationDate")%></label>
										</td>	
									...
									<s:iterator value="draftVoucherIteratorList">
										<tr>
											<s:hidden name="terminationHiddenID" />
											...
											<td class="sortableTD" align="center">&nbsp;
												<s:property	value="terminationDateIterator" />
											</td>
										
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="Edit application" class="token" onclick="viewApplicationFunction('<s:property value="terminationHiddenID"/>','<s:property value="hiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="inProcessVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'Termination_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'Termination_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'Termination_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'Termination_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'Termination_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="inProcessVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View application" class="token" onclick="viewApplicationFunction('<s:property value="terminationHiddenID"/>','<s:property value="hiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="sentBackVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'Termination_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'Termination_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'Termination_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'Termination_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalSentBackPage%>', 'L', '<%=totalSentBackPage%>', 'Termination_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="approvedVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'Termination_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'Termination_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'Termination_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'Termination_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'Termination_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="rejectedVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'Termination_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'Termination_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'Termination_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'Termination_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'Termination_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
function addNewFunction()
{
  	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="Termination_addnew.action";
	  document.getElementById('paraFrm').submit();
}

function viewApplicationFunction(terminationHiddenID,hiddenStatus)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="Termination_viewApplicationFunction.action?terminationHiddenID="+terminationHiddenID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
