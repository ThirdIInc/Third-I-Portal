...
<s:form action="Stationary" validate="true" id="paraFrm" validate="true"
	theme="simple">

	<!-- Hidden Fields Start-->
	<s:hidden name="stationaryhiddenCode" />
	<s:hidden name="stationaryCode" />
	<s:hidden name="stationaryName" />
	<!-- Hidden Fields End-->
			...
			<table class="formbg" width="100%" cellspacing="2" cellspacing="2"
				...
				<tr>
					<td colspan="1" class="txt" width="40%"><strong
						class="text_head">Stationary</strong></td>
					<td colspan="2" align="right" width="60%"><input type="button"
...
function searchFun() {
		...
		document.getElementById("paraFrm").action ='Stationary_f9action.action';
		document.getElementById("paraFrm").submit();
	}
...
function callForEdit(id){
	callButton('NA', 'Y', 2);
	  	...
	  	document.getElementById('paraFrm_stationaryhiddenCode').value=id;
