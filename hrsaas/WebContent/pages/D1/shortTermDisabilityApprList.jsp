...
<s:form action="ShortTermDisabilityAppr" method="post" name="LeaveForm"
	id="paraFrm" theme="simple">
		...
		<tr>
			<td width="100%"> <table width="100%" border="0" align="right" cellpadding="0"
				cellspacing="0"  >
				<tr>
		<td><a href="#" onclick="setAction('SS')">Submit
		...
		<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				...
				<tr>
					...
					%> <a href="#"
						onclick="callPageLocal('1', 'F', '<%=totalPage%>', 'ShortTermDisabilityAppr_getData.action','pageNoField','myPage');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('P', 'P', '<%=totalPage%>', 'ShortTermDisabilityAppr_getData.action','pageNoField','myPage');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
						maxlength="10"
						onkeypress="callPageTextLocal(event, '<%=totalPage%>', 'ShortTermDisabilityAppr_getData.action','pageNoField','myPage');return numbersOnly();" />
					of <%=totalPage%> <a href="#"
						onclick="callPageLocal('N', 'N', '<%=totalPage%>', 'ShortTermDisabilityAppr_getData.action','pageNoField','myPage')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('<%=totalPage%>', 'L', '<%=totalPage%>', 'ShortTermDisabilityAppr_getData.action','pageNoField','myPage');">
				...
				<%=label.get("aplicationDate")%></label> </td>
					...
					<td   align="center" class="sortableTD"><input type="submit" value="View Application" class="token" onclick="editapplicationFun('<s:property value="ittshortTermCode"/>','D');"> </td>
					</tr>
					</s:iterator>
					</s:if>
					<s:else>
...
<script>
 ...
 document.getElementById('paraFrm_flag').value=listType;
		...
		document.getElementById('paraFrm').action = 'ShortTermDisabilityAppr_getData.action';
	...
	document.getElementById('paraFrm_shortTermCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'ShortTermDisabilityAppr_editApplication.action?status='+status;
		document.getElementById('paraFrm').submit();
	}
