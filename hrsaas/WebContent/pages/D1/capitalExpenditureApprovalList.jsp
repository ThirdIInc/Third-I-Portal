...
<s:form action="CapitalExpenditureApproval" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Capital Expenditure Authorization Approval</strong>
					</td>
		...
		<tr>
			...
			<table class="" width="100%">
				<tr>
					...
					<td>
						<a href="#" onclick="setAction('p')">Pending Applications</a> | 
						<a href="#" onclick="setAction('a')">Approved Applications</a> | 
						<a href="#" onclick="setAction('r')">Rejected Applications</a>
					</td>
				</tr>
			</table>
			</td>
	...
	<!-- ========= Pending and pending cancellation application List Begins ============= -->
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'CapitalExpenditureApproval_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'CapitalExpenditureApproval_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'CapitalExpenditureApproval_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'CapitalExpenditureApproval_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'CapitalExpenditureApproval_input.action');">
		...
		<!-- Pending Cancellation Application List Ends -->
						...
						%>
							<s:if test="approvedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'CapitalExpenditureApproval_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'CapitalExpenditureApproval_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'CapitalExpenditureApproval_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'CapitalExpenditureApproval_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'CapitalExpenditureApproval_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="approveredIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApplicationFunctionApproved('<s:property value="capitalHiddenID"/>','<s:property value="hiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="rejectedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'CapitalExpenditureApproval_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'CapitalExpenditureApproval_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'CapitalExpenditureApproval_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'CapitalExpenditureApproval_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'CapitalExpenditureApproval_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="rejectedIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApplicationFunctionRejected('<s:property value="capitalHiddenID"/>','<s:property value="hiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
...
<script>
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='CapitalExpenditureApproval_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     	
		      	document.getElementById('paraFrm').action='CapitalExpenditureApproval_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='CapitalExpenditureApproval_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
...
function viewApplicationFunction(capitalHiddenID,hiddenStatus)
{
	  ...
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="CapitalExpenditureApproval_viewApplicationFunction.action?capitalHiddenID="+capitalHiddenID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}

function viewApplicationFunctionApproved(capitalHiddenID,hiddenStatus)
{

	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="CapitalExpenditureApproval_viewApplicationFunctionApproved.action?capitalHiddenID="+capitalHiddenID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}

function viewApplicationFunctionRejected(capitalHiddenID,hiddenStatus)
{
	  
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="CapitalExpenditureApproval_viewApplicationFunctionRejected.action?capitalHiddenID="+capitalHiddenID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
