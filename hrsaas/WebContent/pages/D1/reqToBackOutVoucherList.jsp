			   ...
			   <table width="100%" align="right" class="formbg">
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Request to Back Out Voucher</strong>
					</td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ReqToBackOutVoucher_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ReqToBackOutVoucher_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }
		     if(listType=="c"){
		     
		      	document.getElementById('paraFrm').action='ReqToBackOutVoucher_getCancelledList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='ReqToBackOutVoucher_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="draftVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'ReqToBackOutVoucher_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'ReqToBackOutVoucher_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'ReqToBackOutVoucher_input.action');">
							...
							<tr>
								...
								<table width="100%" border="0">
									<tr>								
										...
										<td class="formth" align="center" width="25%">
											<label	class="set" name="empName" id="empName"	ondblclick="callShowDiv(this);"> <%=label.get("empName")%></label>
										</td>						
									...
									<s:iterator value="draftVoucherIteratorList">
										<tr>
											<s:hidden name="vouherHiddenID" />	
											<s:hidden name="vouherHiddenStatus" />	
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="Edit Application" class="token" onclick="viewApplicationFunction('<s:property value="vouherHiddenID"/>','<s:property value="vouherHiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="inProcessVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'ReqToBackOutVoucher_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'ReqToBackOutVoucher_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="inProcessVoucherIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApplicationFunction('<s:property value="vouherHiddenID"/>','<s:property value="vouherHiddenStatus"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="sentBackVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'ReqToBackOutVoucher_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'ReqToBackOutVoucher_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalInProcessPage%>', 'L', '<%=totalSentBackPage%>', 'ReqToBackOutVoucher_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="cancelledVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageCancel('1', 'F', '<%=totalCancelPage%>', 'ReqToBackOutVoucher_getCancelledList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageCancel('P', 'P', '<%=totalCancelPage%>', 'ReqToBackOutVoucher_getCancelledList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoCancelField"
										id="pageNoCancelField" size="3" value="<%=cancelPageNo%>" maxlength="10"
										onkeypress="callPageCancelText(event, '<%=totalCancelPage%>', 'ReqToBackOutVoucher_getCancelledList.action');return numbersOnly();" />
									of <%=totalCancelPage%> <a href="#"
										onclick="callPageCancel('N', 'N', '<%=totalCancelPage%>', 'ReqToBackOutVoucher_getCancelledList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageCancel('<%=totalCancelPage%>', 'L', '<%=totalCancelPage%>', 'ReqToBackOutVoucher_getCancelledList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
function addNewFunction()
{
  	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ReqToBackOutVoucher_addNew.action";
	  document.getElementById('paraFrm').submit();	   
}

function viewApplicationFunction(hiddenVoucherID,hiddenStatus)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ReqToBackOutVoucher_viewApplicationFunction.action?hiddenVoucherID="+hiddenVoucherID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
