...
<s:form action="ExpenseApprovalReg" method="post" name="LeaveForm"
	...
	<table width="100%" border="0" align="right" cellpadding="2"
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				cellspacing="0">
				<tr>
					<td><s:hidden name="expenseApproverCode" /> <input
						type="submit" value="Add Application" class="add"
						onclick="addapplicationFun();">&nbsp;&nbsp; <a href="#"
						onclick="viewInstruction();"><font color="black"><u>Click
					here to View Instructions</u></font></a></td>
				</tr>
			</table>
			</td>
		</tr>
							...
							<s:if test="listDraft ||listReject||listApprove">
								<tr>
									<td id="ctrlShow" width="30%" align="right" class=""><b>Page:</b>
										...
										%> 
										<a href="#"
											onclick="callPageLocal('1', 'F', '<%=totalPage%>', 'ExpenseApprovalReg_input.action','pageNoField','myPage');">
											<img title="First Page" src="../pages/common/img/first.gif"
											width="10" height="10" class="iconImage" /> 
										</a>&nbsp; 
										<a href="#"
											onclick="callPageLocal('P', 'P', '<%=totalPage%>', 'ExpenseApprovalReg_input.action','pageNoField','myPage');">
										...
										<input type="text" name="pageNoField"
											...
											onkeypress="callPageTextLocal(event, '<%=totalPage%>', 'ExpenseApprovalReg_input.action','pageNoField','myPage');return numbersOnly();" />
											of <%=totalPage%> 
										<a href="#"
											onclick="callPageLocal('N', 'N', '<%=totalPage%>', 'ExpenseApprovalReg_input.action','pageNoField','myPage')">
											<img title="Next Page" src="../pages/common/img/next.gif"
											class="iconImage" /> 
										</a>&nbsp; 
										<a href="#"
											onclick="callPageLocal('<%=totalPage%>', 'L', '<%=totalPage%>', 'ExpenseApprovalReg_input.action','pageNoField','myPage');">
							...
							<table width="100%" class="formbg">
								<tr>
									...
									<td class="formth" width="40%">
										<label class="set" name="business.purpose.of.expense" id="business.purpose.of.expense" ondblclick="callShowDiv(this);">
								...
								<s:else>
									<tr>
										<td align="center" colspan="5" nowrap="nowrap"><font
											color="red">There is no data to display</font>
										</td>
									</tr>	
								</s:else>
					 		</table
					...
					<tr>
						...
						<table width="100%" class="formbg">
									<tr>
										...
										<td class="formth" width="10%" align="center">View Application</td>
									</tr>
								...
								<s:iterator value="listApprove">
									<tr>
										...
										<td align="center" class="sortableTD"><input
											...
											onclick="editapplicationFun('<s:property value="ittExpenseApproverCode"/>','A');">
										</td>
									</tr>
								</s:iterator>
							</s:if>
					...
					<tr>
						...
						<table width="100%" class="formbg">
							...
							<tr>
								...
								<td class="formth" width="10%" align="center">View
								Application</td>
							</tr>
							<s:if test="listReject">
								...
								<s:iterator value="listReject">
									<tr>
										...
										<td align="center" class="sortableTD"><input
											type="submit" value="View Application" class="token"
											onclick="editapplicationFun('<s:property value="ittExpenseApproverCode"/>','R');">
										</td>
									</tr>
								</s:iterator>
							</s:if>
						...
						<td colspan="3" align="right"><s:if test="listInProgress">
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									%> <a href="#"
										onclick="callPageLocal('1', 'F', '<%=totalPageP%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage1');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageLocal('P', 'P', '<%=totalPageP%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage1');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoFieldP"
										id="pageNoFieldP" size="3" value="<%=pageNoP%>" maxlength="10"
										onkeypress="callPageTextLocal(event, '<%=totalPageP%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage1');return numbersOnly();" />
									of <%=totalPageP%> <a href="#"
										onclick="callPageLocal('N', 'N', '<%=totalPageP%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage1')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageLocal('<%=totalPageP%>', 'L', '<%=totalPageP%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage1');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
							...
							<s:if test="listInProgress">
								<s:iterator value="listInProgress">
									<tr>
										...
										<td align="center" class="sortableTD"><input
											type="submit" value="View Application" class="token"
											onclick="editapplicationFun('<s:property value="ittExpenseApproverCode"/>','P');">
										</td>
									</tr>
								</s:iterator>
							</s:if>
						...
						<td colspan="2" align="right"><s:if test="listSendBack">
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									%> <a href="#"
										onclick="callPageLocal('1', 'F', '<%=totalPageB%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage2');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageLocal('P', 'P', '<%=totalPageB%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage2');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoFieldP"
										id="pageNoFieldP" size="3" value="<%=pageNoB%>" maxlength="10"
										onkeypress="callPageTextLocal(event, '<%=totalPageB%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage2');return numbersOnly();" />
									of <%=totalPageB%> <a href="#"
										onclick="callPageLocal('N', 'N', '<%=totalPageB%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage2')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageLocal('<%=totalPageB%>', 'L', '<%=totalPageB%>', 'ExpenseApprovalReg_input.action','pageNoFieldP','myPage2');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
							</table>
							...
							<s:if test="listSendBack">
								<s:iterator value="listSendBack">
									<tr>
										...
										<td align="center" class="sortableTD"><input
											type="submit" value="Edit Application" class="token"
											onclick="editapplicationFun('<s:property value="ittExpenseApproverCode"/>','B');">
										</td>
									</tr>
								</s:iterator>
							</s:if>
...
function viewInstruction() {		
		...
		document.getElementById('paraFrm').action = 'ExpenseApprovalReg_viewInstruction.action';
 ...
 function setAction(listType){
		...
		document.getElementById('paraFrm').action = 'ExpenseApprovalReg_input.action';
		document.getElementById('paraFrm').submit(); 
 }
...
function addapplicationFun() {
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'ExpenseApprovalReg_addApplication.action';
		document.getElementById('paraFrm').submit();
	}
	function editapplicationFun(id,status) {
	document.getElementById('paraFrm_expenseApproverCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'ExpenseApprovalReg_editApplication.action?status='+status;
		document.getElementById('paraFrm').submit();
	}
	...
	document.getElementById('paraFrm_expenseApproverCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'ExpenseApprovalReg_editApplicationResubmit.action';
		document.getElementById('paraFrm').submit();
	}
