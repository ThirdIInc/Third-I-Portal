...
<s:form action="ASIPOReconciliation" validate="true" id="paraFrm" validate="true" theme="simple">	
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">ASI PO Reconciliation Form</strong>
					</td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ASIPOReconciliation_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ASIPOReconciliation_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }
		     if(listType=="c"){
		     
		      	document.getElementById('paraFrm').action='ASIPOReconciliation_getCancelledList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='ASIPOReconciliation_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
...
function addNewFunction()
{
  	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ASIPOReconciliation_addnew.action";
	  document.getElementById('paraFrm').submit();
...
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ASIPOReconciliation_viewApplicationFunction.action?purchaseHiddenID="+purchaseHiddenID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
