...
<s:form action="HardwareSoftwareRequestApprover" validate="true"
	...
	<table width="100%" border="0" align="right" cellpadding="2"
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		     	...
		     	document.getElementById("paraFrm").target="_self";
		      	document.getElementById('paraFrm').action='HardwareSoftwareRequestApprover_input.action';
		     ...
		     if(listType=="a"){
		     	document.getElementById('myPageApproved').value = "1";
		      	document.getElementById("paraFrm").target="_self";
		      	document.getElementById('paraFrm').action='HardwareSoftwareRequestApprover_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     }
		     ...
		     if(listType=="r"){
		        ...
		        document.getElementById("paraFrm").target="_self";
		      	document.getElementById('paraFrm').action='HardwareSoftwareRequestApprover_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		     } 
		...
		<!-- Paging related issue changes done by nilesh 0n 6th July -->
		...
		<s:if test="%{listType == 'pending'}">
			...
			<tr>
				...
				<table class="formbg" width="100%" cellspacing="1" cellspadding="0"
					border="0">
					<tr>
						<td width="30%"><strong class="text_head"> Pending Application
						List </strong></td>
						...
						%> <s:if test="pendingListLength">
							<table width="100%">
								<tr>
									<td width="50%" align="right" ><s:hidden name="hwswSearchId"></s:hidden><s:hidden name="hwSwHiddenSearchId" /><s:hidden
										name="trackingNumIterator" /><s:hidden
										name="requesterNameIterator" /><s:hidden
										name="applicationDateIterator" /> 
									<s:if test="pendingSearchMgrListFlag">
									<input type="button"
										class="search" onclick="searchFun('P');" theme="simple"
										value="  Search " />
										</s:if>
										<s:else>
										<input type="button"
										class="search" onclick="searchFun('F');" theme="simple"
										value="  Search " />
									...
									<%
										totalPendingPage = (Integer) request
													...
													pendingPageNo = (Integer) request
															.getAttribute("pendingPageNo");
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'HardwareSoftwareRequestApprover_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'HardwareSoftwareRequestApprover_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>"
										maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'HardwareSoftwareRequestApprover_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'HardwareSoftwareRequestApprover_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'HardwareSoftwareRequestApprover_input.action');">
								...
								<table width="100%" border="0">
									<tr>
										...
										<td class="formth" align="center" width="20%"><label
											class="set" name="empName" id="empName"
										...
										<s:iterator value="pendingIteratorList">
											<tr>
												...
												<td class="sortableTD" align="left">&nbsp; 
													<s:property value="requesterNameIterator" />
												</td>
												...
												<td class="sortableTD" align="center">&nbsp; <input
													...
													class="token"
													onclick="viewApplicationFunction('<s:property value="hwSwHiddenID"/>','<s:property value="hwSwHiddenStatus"/>');" />
												</td>
											</tr>
										</s:iterator>
		...
		<s:if test="%{listType == 'approved'}">
			<tr>
				...
				<table class="formbg" width="100%" cellspacing="1" cellspadding="0"
					border="0">
					<tr>
						<td width="30%"><strong class="text_head"> Approved Application
						List </strong></td>
						<td width="70%">
						<%
						...
						%> <s:if test="approvedListLength">
							<table width="100%">
								<tr>
									<td width="50%" align="right"><s:hidden name="hwswSearchId"/><s:hidden name="hwSwHiddenSearchId" /><s:hidden
										name="trackingNumIterator" /><s:hidden
										name="requesterNameIterator" /><s:hidden
										name="applicationDateIterator" /> <s:if test="pendingSearchMgrListFlag">
									<input type="button"
										class="search" onclick="searchFun('A');" theme="simple"
										value="  Search" />
										</s:if>
										<s:else>
										<input type="button"
										class="search" onclick="searchFun('_A');" theme="simple"
										value="  Search" />
									...
									<%
										totalApprovedPage = (Integer) request
													...
													approvedPageNo = (Integer) request
															.getAttribute("approvedPageNo");
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'HardwareSoftwareRequestApprover_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'HardwareSoftwareRequestApprover_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text"
										name="pageNoApprovedField" id="pageNoApprovedField" size="3"
										value="<%=approvedPageNo%>" maxlength="10"
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'HardwareSoftwareRequestApprover_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'HardwareSoftwareRequestApprover_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'HardwareSoftwareRequestApprover_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
							</table>
										...
										<s:iterator value="approveredIteratorList">
											<tr>
												...
												<td class="sortableTD" align="center">&nbsp; <input
													type="button" name="edit" value="View Application"
													class="token"
													onclick="viewApprovedApplicationFunction('<s:property value="hwSwHiddenID"/>','<s:property value="hwSwHiddenStatus"/>');" />
												</td>
											</tr>
										</s:iterator>
		...
		<s:if test="%{listType == 'rejected'}">
			...
			<tr>
				...
				<table class="formbg" width="100%" cellspacing="1" cellspadding="0"
					border="0">
					<tr>
						<td width="30%"><strong class="text_head"> Rejected Application
						List </strong></td>
						<td width="70%">
						<%
							...
							<table width="100%">
								<tr>
									<td width="50%" align="right"><s:hidden name="hwswSearchId"/><s:hidden name="hwSwHiddenSearchId" /><s:hidden
										...
										name="applicationDateIterator" /> <s:if test="pendingSearchMgrListFlag">
									<input type="button"
										class="search" onclick="searchFun('R');" theme="simple"
										value="  Search" />
										</s:if>
										<s:else>
										<input type="button"
										class="search" onclick="searchFun('_R');" theme="simple"
										value="  Search" />
									...
									<%
										totalRejectedPage = (Integer) request
													...
													rejectedPageNo = (Integer) request
															.getAttribute("rejectedPageNo");
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'HardwareSoftwareRequestApprover_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'HardwareSoftwareRequestApprover_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text"
										name="pageNoRejectedField" id="pageNoRejectedField" size="3"
										value="<%=rejectedPageNo%>" maxlength="10"
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'HardwareSoftwareRequestApprover_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'HardwareSoftwareRequestApprover_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'HardwareSoftwareRequestApprover_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
							</table>
...
function viewApprovedApplicationFunction(applicationID,hiddenStatus)

{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="HardwareSoftwareRequestApprover_viewApprovedApplication.action?applicationID="+applicationID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}


function viewApplicationFunction(applicationID,hiddenStatus)

{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="HardwareSoftwareRequestApprover_viewApplicationFunction.action?applicationID="+applicationID+"&hiddenStatus="+hiddenStatus;
	  document.getElementById('paraFrm').submit();
}
...
// Function for Pending Cancellation List Begins
	...
	function searchFun(status) {
		...
		document.getElementById('paraFrm_hwswSearchId').value=searchStatus;
		document.getElementById("paraFrm").action ='HardwareSoftwareRequestApprover_f9action.action?status='+status;
		document.getElementById("paraFrm").submit();
	}
</script>
