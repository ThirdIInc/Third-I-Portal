...
<s:form action="ClassEnrollmentForm" id="paraFrm"
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /> </strong></td>
					<td width="92%" class="txt"><strong class="text_head">Class Enrollment Form List</strong></td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ClassEnrollmentForm_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ClassEnrollmentForm_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }
		     if(listType=="c"){
		     
		      	document.getElementById('paraFrm').action='ClassEnrollmentForm_getCancelledList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='ClassEnrollmentForm_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="draftVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalDraftPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalDraftPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=draftPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalDraftPage%>', 'ClassEnrollmentForm_input.action');return numbersOnly();" />
									of <%=totalDraftPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalDraftPage%>', 'ClassEnrollmentForm_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalDraftPage%>', 'L', '<%=totalDraftPage%>', 'ClassEnrollmentForm_input.action');">
									...
									<s:iterator value="draftVoucherIteratorList">
										<tr>
											...
											--><td  align="center"><input type="button"  id="ctrlShow"
															...
															onclick="editApplicationFunction('<s:property value="enrollmentHiddenID"/>')"></td>
						...
						%>
							<s:if test="inProcessVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageInProcess('1', 'F', '<%=totalInProcessPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageInProcess('P', 'P', '<%=totalInProcessPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageInProcessText(event, '<%=totalInProcessPage%>', 'ClassEnrollmentForm_input.action');return numbersOnly();" />
									of <%=totalInProcessPage%> <a href="#"
										onclick="callPageInProcess('N', 'N', '<%=totalInProcessPage%>', 'ClassEnrollmentForm_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageInProcess('<%=totalInProcessPage%>', 'L', '<%=totalInProcessPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
									...
									<s:iterator value="inProcessVoucherIteratorList">
										<tr>
											...
											--><td  align="center"><input type="button"  id="ctrlShow"
															...
															onclick="viewApplicationFunction('<s:property value="enrollmentHiddenID"/>')"></td>
						...
						%>
							<s:if test="sentBackVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageSentBack('1', 'F', '<%=totalSentBackPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageSentBack('P', 'P', '<%=totalSentBackPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageSentBackText(event, '<%=totalSentBackPage%>', 'ClassEnrollmentForm_input.action');return numbersOnly();" />
									of <%=totalSentBackPage%> <a href="#"
										onclick="callPageSentBack('N', 'N', '<%=totalSentBackPage%>', 'ClassEnrollmentForm_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageSentBack('<%=totalInProcessPage%>', 'L', '<%=totalSentBackPage%>', 'ClassEnrollmentForm_input.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="approvedApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'ClassEnrollmentForm_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'ClassEnrollmentForm_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="approvedCancellationApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApprovedCancellation('1', 'F', '<%=totalApprovedCancellationPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApprovedCancellation('P', 'P', '<%=totalApprovedCancellationPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedCancellationText(event, '<%=totalApprovedCancellationPage%>', 'ClassEnrollmentForm_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedCancellationPage%> <a href="#"
										onclick="callPageApprovedCancellation('N', 'N', '<%=totalApprovedCancellationPage%>', 'ClassEnrollmentForm_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApprovedCancellation('<%=totalApprovedCancellationPage%>', 'L', '<%=totalApprovedCancellationPage%>', 'ClassEnrollmentForm_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="cancelledVoucherListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageCancel('1', 'F', '<%=totalCancelPage%>', 'ClassEnrollmentForm_getCancelledList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageCancel('P', 'P', '<%=totalCancelPage%>', 'ClassEnrollmentForm_getCancelledList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoCancelField"
										id="pageNoCancelField" size="3" value="<%=cancelPageNo%>" maxlength="10"
										onkeypress="callPageCancelText(event, '<%=totalCancelPage%>', 'ClassEnrollmentForm_getCancelledList.action');return numbersOnly();" />
									of <%=totalCancelPage%> <a href="#"
										onclick="callPageCancel('N', 'N', '<%=totalCancelPage%>', 'ClassEnrollmentForm_getCancelledList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageCancel('<%=totalCancelPage%>', 'L', '<%=totalCancelPage%>', 'ClassEnrollmentForm_getCancelledList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="rejectedApplicationListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'ClassEnrollmentForm_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'ClassEnrollmentForm_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
			...
			<td>
				...
				<tr>
					...
					<td width="70%" align="right">
						...
						%>
							<s:if test="rejectedCancelApplicationListLength">
								<table>
								<tr>
									<td id="ctrlShow" width="100%" align="right"><b>Page:</b>
									<%
									...
									%> <a href="#"
										onclick="callPageRejectedCancellation('1', 'F', '<%=totalRejectedCancellationPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejectedCancellation('P', 'P', '<%=totalRejectedCancellationPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedCancellationText(event, '<%=totalRejectedCancellationPage%>', 'ClassEnrollmentForm_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedCancellationPage%> <a href="#"
										onclick="callPageRejectedCancellation('N', 'N', '<%=totalRejectedCancellationPage%>', 'ClassEnrollmentForm_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejectedCancellation('<%=totalRejectedCancellationPage%>', 'L', '<%=totalRejectedCancellationPage%>', 'ClassEnrollmentForm_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						<table width="100%" border="0"  class="formbg">
							<tr>
								...
								<table width="100%" border="0">
									...
									<s:iterator value="rejectedCancelApplicationIteratorList">
										<tr>
											<s:hidden
												name="enrollmentHiddenID" />
...
<script>
	...
	function addNewFunction()
     {  
         document.getElementById('paraFrm').action = "ClassEnrollmentForm_addNew.action";
		 document.getElementById('paraFrm').submit();
	...
	function viewDetails(persDataId,sendBack){  
		...
		document.getElementById('paraFrm').action = "ClassEnrollmentForm_callView.action?persDataId="+persDataId+'&sendBack='+sendBack;	  
		document.getElementById('paraFrm').submit();
	    document.getElementById('paraFrm').target = "main";
	}//end of viewDetails
	...
	function viewPendingDetails(persDataId){  
		...
		document.getElementById('paraFrm').action = 'ClassEnrollmentForm_callView.action?persDataId='+persDataId;	  
		document.getElementById('paraFrm').submit();
	    document.getElementById('paraFrm').target = "main";
...
function callPageInProcessText(id, totalPage, action){   
	...
	// Function Rejected Cancellation List Ends
 	function editApplicationFunction(enrollID)
{	//alert(enrollID);
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ClassEnrollmentForm_editApplicationFunction.action?enrollID="+enrollID;
	  document.getElementById('paraFrm').submit();
}
	function viewApplicationFunction(inProcessVoucherID)
{//alert(inProcessVoucherID);
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ClassEnrollmentForm_viewApplicationFunction.action?inProcessVoucherID="+inProcessVoucherID;
	  document.getElementById('paraFrm').submit();
}
</script>