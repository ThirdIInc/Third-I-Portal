...
<s:form action="TerminationMISReport" validate="true" id="paraFrm"
	theme="simple">
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					Termination Mis Report</strong></td>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td colspan="1" width="30%"><s:textfield size="30"
						...
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9division.action');" /></td>
					...
					<td colspan="1" width="30%"><s:textfield size="30"
						...
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9department.action');" /></td>
				</tr>

				<!-- BRANCH & EMPLOYEE TYPE -->
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						...
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9branch.action');" /></td>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9empType.action');" /></td>

					<!--    <td colspan="1" width="20%"><label class="set" name="designation"
						id="designation" ondblclick="callShowDiv(this);"><%=label.get("designation")%></label>
					:</td>
					<td colspan="1" width="30%"><s:textfield size="30"
						name="desigName" readonly="true" /><s:hidden name="desigId" />
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9designation.action');" /></td>-->
				</tr>
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9manager.action');" /></td>

<td colspan="1" width="20%"><label class="set"
						name="tracking_no" id="tracking_no"
						ondblclick="callShowDiv(this);"><%=label.get("tracking_no")%></label>
					:</td>
					<td colspan="1" width="30%"><s:textfield size="30"
						...
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9trackingNo.action');" /></td>
			...
			<!--<td colspan="1" width="20%"><label class="set" name="status"
				...
				<!--APPLICATION STATUS & Termination Type  -->
				...
				<tr>
					...
					--><td colspan="1" width="20%"><label class="set" name="ter.type"
						id="ter.type" ondblclick="callShowDiv(this);"><%=label.get("ter.type")%></label>
					:</td>
					<td colspan="1" width="30%"><s:select name="terminationType"
						headerKey="1" theme="simple"
						headerValue="-----------------Select------------------"
						cssStyle="width:165"
						list="#{'V':'Voluntary','I':'Involuntary','O':'Other'}" /></td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" width="80%" align="left"><s:textfield
						...
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'TerminationMISReport_f9employee.action');" /></td>
					</td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="terminationMIS.trackingNumberFlag"
						...
						<!-- STATUS,LOGIN IN TIME,LATE HRS., LATE HRS DEDUCT FROM -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
							...
							<td width="20%" align="right" colspan="1"><label class="set"
								...
								ondblclick="callShowDiv(this);"><%=label.get("termination.date")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="terminationDateFlag"
								onclick="AddItem('termination.date',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="last.day.worked" id="last.day.worked"
								ondblclick="callShowDiv(this);"><%=label.get("last.day.worked")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="lastDayFlag" onclick="AddItem('last.day.worked',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="ter.type" id="ter.type" ondblclick="callShowDiv(this);"><%=label.get("ter.type")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="terminationTypeFlag" onclick="AddItem('ter.type',this);" /></td>
						</tr>

						<!-- Extra Fields -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="ter.reason" id="ter.reason"
								ondblclick="callShowDiv(this);"><%=label.get("ter.reason")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="terminationReasonFlag"
								onclick="AddItem('ter.reason',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
							...
							<td colspan="1"><s:checkbox theme="simple"
								...
								onclick="AddItem('application.date',this);" /></td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="3"
						...
						<tr>
							...
							<td colspan="4"><select name="sortBy" id="sortBy"
								...
								<option value="Employee Code">Last Day Worked</option>
								<option value="Employee Code">Termination Type</option>
								<option value="Employee Code">Termination Reason</option>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					<td colspan="1" height="22" width="15%"><label class="set"
						...
						ondblclick="callShowDiv(this);"><%=label.get("termination.date")%></label>:</td>
					<td colspan="1" width="10%" align="left"><s:select
						theme="simple" name="terDateSelect" value="%{terDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'2','ter');" /></td>
					<td width="10%" colspan="1" height="22"><s:textfield
						name="terFromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_terFromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_terFromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="5%" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_terFromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22" width="60%">
					<table cellspacing="0" cellpadding="0" border="1"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel2" height="22"><s:textfield
								name="terToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_terToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_terToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker2"><s:a
								href="javascript:NewCal('paraFrm_terToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
			...
			<!--<tr>
					<td colspan="1" height="22" width="15%"><label class="set"
						name="last.day.date" id="last.day.date"
						ondblclick="callShowDiv(this);"><%=label.get("last.day.date")%></label>:</td>
					<td colspan="1" width="10%" align="left"><s:select
						theme="simple" name="workDateSelect" value="%{workDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'3','lastday');" /></td>
					<td width="10% colspan=" 1" height="22"><s:textfield
						name="workFromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_workFromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_workFromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="5%" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_workFromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22" width="60%">
					<table cellspacing="0" cellpadding="0" border="1"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel3" height="22"><s:textfield
								name="workToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_workToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_workToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker3"><s:a
								href="javascript:NewCal('paraFrm_workToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
				...
				<!--<tr>
					...
					<td colspan="1" width="10%" align="left"><s:select
						theme="simple" name="apprDateSelect" value="%{apprDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,' 4','appr');" /></td>
					<td width="10%" colspan="1" height="22"><s:textfield
						name="apprFromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_apprFromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_apprFromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="5%" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_apprFromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22" width="60%">
					<table cellspacing="0" cellpadding="0" border="1"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel4" height="22"><s:textfield
								name="apprToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_apprToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_apprToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker4"><s:a
								href="javascript:NewCal('paraFrm_apprToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="TerminationMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="TerminationMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'TerminationMISReport_searchSavedReport.action');
	}	
    ...
    function callAllDisable(){
	  	...
	  	if(document.getElementById("paraFrm_terDateSelect").value=="BN"){
	...
	/*  	if(document.getElementById("paraFrm_workDateSelect").value=="BN"){
	  	...
	  	if(document.getElementById("paraFrm_apprDateSelect").value=="BN"){
	...
	function generateReport()
	{
		try{
			...
			var terFromDate = document.getElementById('paraFrm_terFromDate').value;
			var terToDate = document.getElementById('paraFrm_terToDate').value;
		/*	var workFromDate = document.getElementById('paraFrm_workFromDate').value;
			var workToDate = document.getElementById('paraFrm_workToDate').value;
			var apprFromDate = document.getElementById('paraFrm_apprFromDate').value;
			var apprToDate = document.getElementById('paraFrm_apprToDate').value; */
			...
			if(document.getElementById("paraFrm_terDateSelect").value!=""){
				//alert(document.getElementById("paraFrm_attFromDate").value);
				if(terFromDate=="" || terFromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('termination.date').innerHTML);
					//document.getElementById('paraFrm_misreport_attFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_terDateSelect").value=="BN"){
					if(terToDate==""||terToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('termination.date').innerHTML);
				...
				if(terFromDate!=""||atFromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_terFromDate'];
				  	var lbl=['termination.date'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(terToDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_terToDate'];
			  		var lbl=['termination.date'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
			...
			/*	if(document.getElementById("paraFrm_workDateSelect").value!=""){
				//alert(document.getElementById("paraFrm_attFromDate").value);
				if(workFromDate=="" || workFromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('last.day.worked').innerHTML);
					//document.getElementById('paraFrm_misreport_attFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_workDateSelect").value=="BN"){
					if(workToDate==""||workToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('last.day.worked').innerHTML);
						//document.getElementById('paraFrm_misreport_attToDate').focus();
						return false;
					}
				...
				if(workFromDate!=""||atFromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_workFromDate'];
				  	var lbl=['last.day.worked'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(workToDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_workToDate'];
			  		var lbl=['last.day.worked'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
		...
		/*		if(document.getElementById("paraFrm_apprDateSelect").value!=""){
				//alert(document.getElementById("paraFrm_attFromDate").value);
				if(apprFromDate=="" || apprFromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('appr.date').innerHTML);
					//document.getElementById('paraFrm_misreport_attFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_apprDateSelect").value=="BN"){
					if(apprToDate==""||apprToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('appr.date').innerHTML);
						//document.getElementById('paraFrm_misreport_attToDate').focus();
						return false;
					}
				...
				if(apprFromDate!=""||atFromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_apprFromDate'];
				  	var lbl=['appr.date'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
	  			...
	  			if(apprToDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_apprToDate'];
			  		var lbl=['appr.date'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="TerminationMISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="TerminationMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
