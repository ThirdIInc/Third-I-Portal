...
<s:form action="ExpenseMISReport" validate="true" id="paraFrm" theme="simple">
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> Expense Request
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2" class="formbg">
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.divId" />
						...
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9division.action');" />
					</td>
					<td colspan="4"></td>
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.deptId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9department.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.branchId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9branch.action');" />
					</td>					
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empTypeId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9empType.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.desigId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9designation.action');" />
					</td>					
				</tr>	
				...
				<tr>
					...
					<td width="4%"></td>
					<td width="4%"></td>
					<td width="18%"><label class="set" name="tracking.no1" id="tracking.no1"
						ondblclick="callShowDiv(this);"><%=label.get("tracking.no1")%></label>
					:</td>
					<td width="25%"><s:textfield size="30"
						name="misreport.trackingNo" readonly="true" /></td>
					<td width="5%" align="left">
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9trackingNo.action');" />
					</td>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ExpenseMISReport_f9employee.action');" />
					</td>					
				</tr>				
			</table>
			</div>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.trackingNoFlag" onclick="AddItem('tracking.no',this);" /></td>
						</tr>			
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.logInFlag" onclick="AddItem('manager',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="business.purpose" id="business.purpose" ondblclick="callShowDiv(this);"><%=label.get("business.purpose")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.lateHrsFlag" onclick="AddItem('business.purpose',this);" /></td>							
							<td width="20%" align="right" colspan="1"><label class="set"
								name="total.expense" id="total.expense" ondblclick="callShowDiv(this);"><%=label.get("total.expense")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.lateHrsDeductFlag" onclick="AddItem('total.expense',this);" /></td>								
						</tr>	
					</table>
					</td>
				</tr>
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="ExpenseMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="ExpenseMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'ExpenseMISReport_searchSavedReport.action');
	}	
	...
	function generateReport()
	{
		try{
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="ExpenseMISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="ExpenseMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
