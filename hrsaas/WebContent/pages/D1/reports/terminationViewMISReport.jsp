...
<s:form action="TerminationMISReport" validate="true" id="paraFrm"
	...
	<s:hidden name="appliDateFlag" />
	<s:hidden name="attDateFlag" />
	<s:hidden name="statusFlag" />
	<s:hidden name="logInFlag" />
	<s:hidden name="lateHrsFlag" />
	<s:hidden name="lateHrsDeductFlag" />
	...
	<s:hidden name="terminationTypeFlag" />
	<s:hidden name="terminationReasonFlag" />
	<s:hidden name="applStatusFlag" />
	
	<s:hidden name="cityFlag" />
	<s:hidden name="terminationDateFlag" />
	<s:hidden name="applicationDateFlag" />
	<s:hidden name="lastDayFlag" />
	...
	<s:hidden name="workDateSelect" />
	<s:hidden name="workFromDate" />
	<s:hidden name="workToDate" />

	<s:hidden name="terDateSelect" />
	<s:hidden name="terFromDate]" />
	<s:hidden name="terToDate" />
...
<s:hidden name="managerName" />
	...
	<s:hidden name="terminationType" />
	<s:hidden name="terminationReason" />
<s:hidden name="applStatus" />

	<s:hidden name="city" />
	<s:hidden name="terminationDate" />

	<s:hidden name="applicationDate" />
	<s:hidden name="applicationStatus" />
	<s:hidden name="lastDay" />
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('TerminationMISReport_report.action');    
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='TerminationMISReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>