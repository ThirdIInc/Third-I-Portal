...
<!-- hidden variables -->
		...
		<s:hidden name="misreport.logInFlag"/>
		<s:hidden name="misreport.lateHrsFlag"/>
		<s:hidden name="misreport.lateHrsDeductFlag"/>
		...
		<s:hidden name="misreport.trackingNumber" />
		<s:hidden name="misreport.empFirstName" />
		<s:hidden name="misreport.actionReason" />
		<s:hidden name="misreport.firstNameFlag" />
		<s:hidden name="misreport.middleNameFlag" />
		<s:hidden name="misreport.lastNameFlag" />
		<s:hidden name="misreport.socialSecurityNumberFlag" />
		<s:hidden name="misreport.stateFlag" />
		<s:hidden name="misreport.phoneNumberFlag" />
		<s:hidden name="misreport.martialStatusFlag" />
		<s:hidden name="misreport.educationFlag" />
		<s:hidden name="misreport.birthDateFlag" />
		<s:hidden name="misreport.referalSourceFlag" />
		<s:hidden name="misreport.hireDateFlag" />
		<s:hidden name="misreport.physicalWorkLocationFlag" />
		<s:hidden name="misreport.actionReasonFlag" />
		<s:hidden name="misreport.payGroupFlag" />
		<s:hidden name="misreport.annualSalaryFlag" />
		<s:hidden name="misreport.executiveEmployeeFlag" />
		<s:hidden name="misreport.trackingNumberFlag" />
		<s:hidden name="misreport.socialInsuranceNumberFlag" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>Hire/Rehire Mis Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('HireRehireMisReport_report.action');    
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='HireRehireMisReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>