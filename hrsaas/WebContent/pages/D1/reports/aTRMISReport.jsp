...
<s:form action="ATRMISReport" validate="true" id="paraFrm"
	theme="simple">
	<table width="100%" border="0" align="right" cellpadding="2"
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="formbg"
				width="100%">
				<tr>
					<td width="20%"><s:hidden name="misreport.savedReport" /> <s:hidden
						name="misreport.reportId" /><!-- Report ID --> <label class="set"
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2"
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						...
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9division.action');" />
					</td>
					<td colspan="4"></td>
				</tr>
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9department.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden
						name="misreport.branchId" /> <img
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9branch.action');" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden
						name="misreport.empTypeId" /> <img
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9empType.action');" />
					</td>
					<td width="4%"></td>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9designation.action');" />
					</td>
				</tr>
				...
				<tr>
					<td width="18%"><label class="set" name="appl.status"
						id="appl.status" ondblclick="callShowDiv(this);"><%=label.get("appl.status")%></label>
					:</td>
					<td width="25%"><s:select name="misreport.status"
					...
					<td width="8%"></td>
					<td width="8%"></td>
					<td width="18%"><label class="set" name="tracking.number"
						id="tracking.number" ondblclick="callShowDiv(this);"><%=label.get("tracking.number")%></label>
					:</td>
					<td width="25%"><s:textfield size="30"
						name="misreport.trackingNumber" readonly="true" /><s:hidden
						name="misreport.trackingId" /></td>
					<td width="5%" align="left"><img
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9trackingNumber.action');" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="77%" colspan="5"><s:textfield size="20"
						name="misreport.empToken" readonly="true" /><s:textfield
						size="85" name="misreport.empName" readonly="true" /></td>
					<td width="5%" align="left"><s:hidden name="misreport.empId" />
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'ATRMISReport_f9employee.action');" />
					</td>
				</tr>
			</table>
			</div>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.nameFlag" onclick="AddItem('name',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
						...
						<tr>
							...
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.statusFlag"
								onclick="AddItem('application.status',this);" /></td>
						</tr>
						<!-- TRACKING NUMBER ,MANAGERE,CITY,ATR DATE -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="tracking.number" id="tracking.number"
								ondblclick="callShowDiv(this);"><%=label.get("tracking.number")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.trackingNumberFlag"
								onclick="AddItem('tracking.number',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="manager" id="manager" ondblclick="callShowDiv(this);"><%=label.get("manager")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.managerFlag" onclick="AddItem('manager',this);" /></td>
							<!--<td width="20%" align="right" colspan="1"><label class="set"
								name="city" id="city"
							...
							-->
							<td width="20%" align="right" colspan="1"><label class="set"
								name="date.atr" id="date.atr" ondblclick="callShowDiv(this);"><%=label.get("date.atr")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.atrDateRequestFlag"
								onclick="AddItem('date.atr',this);" /></td>
						</tr>
						<!-- FROM TRAVEL DATE ,TO TRAVEL DATE ,DIRECT BILING,TOTAL EXPENSE -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="from.travel.date" id="from.travel.date"
								ondblclick="callShowDiv(this);"><%=label.get("from.travel.date")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.fromTravelDateFlag"
								onclick="AddItem('from.travel.date',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="to.travel.date" id="to.travel.date"
								ondblclick="callShowDiv(this);"><%=label.get("to.travel.date")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.toTravelDateFlag"
								onclick="AddItem('to.travel.date',this);" /></td>
							<!--<td width="20%" align="right" colspan="1"><label class="set"
								name="direct.billing" id="direct.billing"
								ondblclick="callShowDiv(this);"><%=label.get("direct.billing")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.directBillingFlag"
								onclick="AddItem('direct.billing',this);" /></td>
							--><td width="20%" align="right" colspan="1"><label class="set"
								name="total.expense" id="total.expense"
								ondblclick="callShowDiv(this);"><%=label.get("total.expense")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.totalExpenseFlag"
								onclick="AddItem('total.expense',this);" /></td>
						</tr>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					<td colspan="1" height="22" width="15%"><label class="set"
						name="date.atr" id="date.atr" ondblclick="callShowDiv(this);"><%=label.get("date.atr")%></label>:</td>
					<td colspan="1" width="10%" align="left"><s:select
						theme="simple" name="attDateSelect" value="%{attDateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="ATRMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="ATRMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'ATRMISReport_searchSavedReport.action');
	}	
	...
	function generateReport()
	{
		try{
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="ATRMISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="ATRMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
