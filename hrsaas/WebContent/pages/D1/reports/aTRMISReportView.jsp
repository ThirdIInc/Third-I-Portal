...
<s:form action="ATRMISReport" validate="true" id="paraFrm" theme="simple">
...
<!-- hidden variables -->
		...
		<s:hidden name="misreport.trackingId"/>
		...
		<s:hidden name="misreport.nameFlag" />
		<s:hidden name="misreport.managerFlag" />
		<s:hidden name="misreport.atrDateRequestFlag" />
		<s:hidden name="misreport.fromTravelDateFlag" />
		<s:hidden name="misreport.toTravelDateFlag" />
		<s:hidden name="misreport.directBillingFlag" />
		<s:hidden name="misreport.totalExpenseFlag" />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> ATR
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>ATR Mis Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('ATRMISReport_report.action');    
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='ATRMISReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>