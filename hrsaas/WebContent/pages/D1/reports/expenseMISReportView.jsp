...
<s:hidden name="misreport.trackingNoFlag"/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>Expense Request Mis Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('ExpenseMISReport_report.action');    
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='ExpenseMISReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>