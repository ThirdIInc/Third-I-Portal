...
<s:form action="ApplicationSecurityRequestMisReport" validate="true" id="paraFrm" theme="simple">
				...
				<table width="100%" align="right" cellpadding="0" cellspacing="0" class="formbg">
					<tr>
						...
						<td width="93%" class="txt">
							...
							Application Security MIS Report</strong>
						</td>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="formbg"
				...
				<tr>
					...
					<td colspan="2">
						<s:textfield size="30" maxlength="30" name="reportTitle" onkeypress="return allCharacters();" />
					</td>
				</tr>
			</table>
			</td>
				...
				<div id="tabnav" style="vertical-align: bottom">
					<ul>
						<li id="list1"><a href="#" id="menuid1" class="on"
							onclick="showCurrent('menuid1','first')"> <span>Filter</span></a>
						</li>
					...
					<table width="100%" cellpadding="2" cellspacing="2"
						...
						<tr>
							...
							<td width="25%"><s:textfield size="30"
								name="divName" readonly="true" /></td>
							<td width="5%" align="left"><s:hidden name="divId" />
							<img src="../pages/images/recruitment/search2.gif"
								class="iconImage" height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9division.action');" />
							</td>
							<td colspan="4"></td>
						</tr>
						...
						<!-- DEPARTMENT & BRANCH -->
						<tr>
							<td width="18%"><label class="set" name="department"
								id="department" ondblclick="callShowDiv(this);"><%=label.get("department")%></label>
							:</td>
							<td width="25%"><s:textfield size="30"
								name="deptName" readonly="true" /></td>
							<td width="5%" align="left"><s:hidden name="deptId" />
							<img src="../pages/images/recruitment/search2.gif"
								class="iconImage" height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9department.action');" />
							</td>
							<td width="4%"></td>
							...
							<td width="5%" align="left"><s:hidden
								name="branchId" /> <img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9branch.action');" />
							</td>
						</tr>
		
						<!-- EMPLOYEE TYPE & DESIGNATION -->
						<tr>
							<td width="18%"><label class="set" name="employee.type"
								id="employee.type" ondblclick="callShowDiv(this);"><%=label.get("employee.type")%></label>
							:</td>
							<td width="25%"><s:textfield size="30"
								name="empTypeName" readonly="true" /></td>
							<td width="5%" align="left"><s:hidden
								name="empTypeId" /> <img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9empType.action');" />
							</td>
							<td width="4%"></td>
							<td width="18%"><label class="set" name="designation"
								id="designation" ondblclick="callShowDiv(this);"><%=label.get("designation")%></label>
							:</td>
							<td width="25%"><s:textfield size="30"
								name="desigName" readonly="true" /></td>
							<td width="5%" align="left"><s:hidden name="desigId" />
							<img src="../pages/images/recruitment/search2.gif"
								class="iconImage" height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9designation.action');" />
							</td>
						</tr>
						...
						<tr>
							...
							<td width="25%"><s:select name="status"
								headerKey="1" theme="simple" headerValue="--Select--"
								cssStyle="width:150"
								list="#{'D':'Draft','P':'Pending','F':'Forwarded','Z':'Authorized SignOff','A':'Approved','R':'Rejected','B':'Send Back'}" />
							</td>
							<td width="4%"></td>
							<td width="4%"></td>
							<td width="18%"><label class="set" name="tracking.no1"
								id="tracking.no1" ondblclick="callShowDiv(this);"><%=label.get("tracking.no1")%></label>
								:
							</td>
							<td width="25%"><s:textfield size="30"
								name="trackingNo" readonly="true" />
							</td>
							<td width="5%" align="left"><img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9trackingNo.action');" />
							</td>
						</tr>
						...
						<!-- EMPLOYEE -->
						<tr>
							<td width="18%"><label class="set" name="employee"
								id="employee" ondblclick="callShowDiv(this);"><%=label.get("employee")%></label>
							:</td>
							<td width="77%" colspan="5"><s:textfield size="20"
								name="empToken" readonly="true" /><s:textfield
								size="85" name="empName" readonly="true" /></td>
							<td width="5%" align="left"><s:hidden name="empId" />
							<img src="../pages/images/recruitment/search2.gif"
								class="iconImage" height="14" width="14" theme="simple"
								onclick="javascript:callsF9(500,325,'ApplicationSecurityRequestMisReport_f9employee.action');" />
							</td>
						</tr>
					</table>
				</div>
			<!-- FILTER DIV SECTION -- ENDS -->
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td colspan="1"><s:checkbox theme="simple"
										name="deptFlag" onclick="AddItem('department',this);" /></td>
									<td width="20%" align="right" colspan="1"><label class="set"
										name="branch" id="branch" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>:</td>
									<td colspan="1"><s:checkbox theme="simple"
										name="branchFlag" onclick="AddItem('branch',this);" /></td>
								</tr>						
								...
								<tr>
									...
									<td colspan="1"><s:checkbox theme="simple"
										name="desigFlag" onclick="AddItem('designation',this);" /></td>
									<td width="20%" align="right" colspan="1"><label class="set"
									...
									<td colspan="1"><s:checkbox theme="simple"
										name="appliDateFlag" onclick="AddItem('application.date',this);" /></td>
									<td width="20%" align="right" colspan="1"><label class="set"
										name="tracking.no" id="tracking.no" ondblclick="callShowDiv(this);"><%=label.get("tracking.no")%></label>:</td>
									<td colspan="1"><s:checkbox theme="simple"
										name="trackingNoFlag" onclick="AddItem('tracking.no',this);" /></td>
								</tr>			
								...
								<tr>
									...
									<td colspan="1"><s:checkbox theme="simple"
										name="statusFlag" onclick="AddItem('application.status',this);" /></td>																												
									<td width="20%" align="right" colspan="1"><label class="set"
										name="manager" id="manager"
										ondblclick="callShowDiv(this);"><%=label.get("manager")%></label>:</td>
									<td colspan="1"><s:checkbox theme="simple"
										name="managerFlag" onclick="AddItem('manager',this);" />
									</td>
								</tr>	
							</table>
							</td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<table width="366" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td width="123">
										<select id="columnOrdering" size="10" name="columnOrdering" multiple="true" />
										<s:hidden name="hiddenColumns" />
									</td>
									<td width="242">
										<img src="../pages/common/css/default/images/up.GIF" onclick="listbox_move('columnOrdering', 'up');" />
										<br />
										<br />
										<img src="../pages/common/css/default/images/down.GIF" onclick="listbox_move('columnOrdering', 'down');" />
									</td>
								</tr>
							</table>
							</td>					
					...
					<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
						...
						<tr>
							<td colspan="1" height="22" width="15%"><label class="set"
								...
								ondblclick="callShowDiv(this);"><%=label.get("approved.date")%></label>:
							</td>
							<td colspan="1" width="10%" align="left"><s:select
								theme="simple" name="approvedDateSelect" value="%{approvedDateSelect}"
								list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
								'OA':'On after','BN':'Between'}"
								onchange="callToDateDispOnClick(this,'2','att');" />
							</td>
							<td width="10%" colspan="1" height="22"><s:textfield
								name="attFromDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_attFromDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_attFromDate','dd-mm-yyyy')"
								maxlength="10" size="9" />
							</td>
							<td width="5%" colspan="1" height="22"><s:a
								href="javascript:NewCal('paraFrm_attFromDate','DDMMYYYY');">
								<img class="iconImage" src="../pages/images/recruitment/Date.gif"
									width="16" height="16" border="0" align="absmiddle" />
								</s:a>
							</td>
							...
							<table cellspacing="0" cellpadding="0" border="0"
								...
								<tr>
									...
									<td width="52" id="toDateDivLabel2" height="22"><s:textfield
										name="attToDate" maxlength="10"
										onkeypress="return numbersWithHiphen();"
										onfocus="clearText('paraFrm_attToDate','dd-mm-yyyy')"
										onblur="setText('paraFrm_attToDate','dd-mm-yyyy')"
										maxlength="10" size="9" /></td>
									<td width="449" id="toDatePicker2"><s:a
										href="javascript:NewCal('paraFrm_attToDate','DDMMYYYY');">
										<img class="iconImage"
											src="../pages/images/recruitment/Date.gif" width="16"
											height="16" border="0" align="absmiddle" />
									</s:a></td>
		...
		<tr>
			<td>
				<table width="100%" cellpadding="1" cellspacing="1" class="formbg">
					<tr>
						<td width="100%" colspan="2" class="formtext">
							<b>Display option</b>
						</td>
					</tr>
					<tr>
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="ApplicationSecurityRequestMisReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="ApplicationSecurityRequestMisReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'ApplicationSecurityRequestMisReport_searchSavedReport.action');
	}	
    ...
    function callAllDisable(){
	  	...
	  	if(document.getElementById("paraFrm_approvedDateSelect").value=="BN"){
	...
	function generateReport()
	{
		try{
			...
			var apFromDate = document.getElementById('paraFrm_appliFromDate').value;
			var apToDate = document.getElementById('paraFrm_appliToDate').value;
			var atFromDate = document.getElementById('paraFrm_attFromDate').value;
			var atToDate = document.getElementById('paraFrm_attToDate').value;
			...
			if(document.getElementById("paraFrm_appliDateSelect").value!=""){
				...
				if(apFromDate=="" || apFromDate=="dd-mm-yyyy"){
					...
					//document.getElementById('paraFrm_appliFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_appliDateSelect").value=="BN"){
					if(apToDate==""||apToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('application.date').innerHTML);
						//document.getElementById('paraFrm_appliToDate').focus();
						return false;
					}
				}
				...
				if(apFromDate!=""||apFromDate!="dd-mm-yyyy" ){
	  			...
	  			if(apToDate!="dd-mm-yyyy" ){
			   	...
			   	if(apFromDate!="" && apToDate!="") {
					var strDate1 = apFromDate.split("-"); 
					var starttime = new Date(strDate1[2],strDate1[1]-1,strDate1[0]); 
	
					var strDate2 = apToDate.split("-"); 
			...
			if(document.getElementById("paraFrm_approvedDateSelect").value!=""){
				if(atFromDate=="" || atFromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('approved.date').innerHTML);
					return false;
				}
				if(document.getElementById("paraFrm_approvedDateSelect").value=="BN"){
				...
				if(atFromDate!=""||atFromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_attFromDate'];
				  	var lbl=['approved.date'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(atToDate!="dd-mm-yyyy" ){
			   	...
			   	if(atFromDate!="" && atToDate!="") {
					var strDate1 = atFromDate.split("-"); 
					var starttime = new Date(strDate1[2],strDate1[1]-1,strDate1[0]); 
	
					var strDate2 = atToDate.split("-"); 
					var endtime = new Date(strDate2[2],strDate2[1]-1,strDate2[0]); 
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="ApplicationSecurityRequestMisReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="ApplicationSecurityRequestMisReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
