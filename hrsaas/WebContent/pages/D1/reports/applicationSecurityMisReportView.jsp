...
<s:form action="ApplicationSecurityRequestMisReport" validate="true" id="paraFrm"
	theme="simple">

	<!-- hidden variables -->

	<s:hidden name="trackingNoFlag" />
	...
	<s:hidden name="approvedDateSelect" />

	<s:hidden name="appliFromDate" />
	<s:hidden name="appliToDate" />
	<s:hidden name="attFromDate" />
	<s:hidden name="attToDate" />
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					Application Security MIS Report</strong></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<!-- TABLE5 -->
						<tr>
							<td height="27" class="text_head"><strong>Application Security MIS Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('ApplicationSecurityRequestMisReport_report.action');    
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='ApplicationSecurityRequestMisReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>