			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt">
						<strong class="text_head">Request to Back Out Voucher Approval</strong>
					</td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ReqToBackOutApprover_input.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ReqToBackOutApprover_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		     ...
		     if(listType=="r"){
		      	...
		      	document.getElementById('paraFrm').action='ReqToBackOutApprover_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
						...
						%>
							<s:if test="pendingListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPendingPage%>', 'ReqToBackOutApprover_input.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPendingPage%>', 'ReqToBackOutApprover_input.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=pendingPageNo%>" maxlength="10"
										onkeypress="callPageText(event, '<%=totalPendingPage%>', 'ReqToBackOutApprover_input.action');return numbersOnly();" />
									of <%=totalPendingPage%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPendingPage%>', 'ReqToBackOutApprover_input.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPendingPage%>', 'L', '<%=totalPendingPage%>', 'ReqToBackOutApprover_input.action');">
								...
								<table width="100%" border="0">
									...
									<s:iterator value="pendingIteratorList">
										<tr>
											...
											<td class="sortableTD" align="center">&nbsp;
												<input type="button" name="edit" value="View Application" class="token" onclick="viewApplicationFunction('<s:property value="vouherHiddenID"/>');" />
											</td>										
										</tr>
									</s:iterator>
						...
						%>
							<s:if test="approvedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageApproved('1', 'F', '<%=totalApprovedPage%>', 'ReqToBackOutApprover_getApprovedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageApproved('P', 'P', '<%=totalApprovedPage%>', 'ReqToBackOutApprover_getApprovedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageApprovedText(event, '<%=totalApprovedPage%>', 'ReqToBackOutApprover_getApprovedList.action');return numbersOnly();" />
									of <%=totalApprovedPage%> <a href="#"
										onclick="callPageApproved('N', 'N', '<%=totalApprovedPage%>', 'ReqToBackOutApprover_getApprovedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageApproved('<%=totalApprovedPage%>', 'L', '<%=totalApprovedPage%>', 'ReqToBackOutApprover_getApprovedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
						...
						%>
							<s:if test="rejectedListLength">
								...
								<tr>
									...
									%> <a href="#"
										onclick="callPageRejected('1', 'F', '<%=totalRejectedPage%>', 'ReqToBackOutApprover_getRejectedList.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPageRejected('P', 'P', '<%=totalRejectedPage%>', 'ReqToBackOutApprover_getRejectedList.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										...
										onkeypress="callPageRejectedText(event, '<%=totalRejectedPage%>', 'ReqToBackOutApprover_getRejectedList.action');return numbersOnly();" />
									of <%=totalRejectedPage%> <a href="#"
										onclick="callPageRejected('N', 'N', '<%=totalRejectedPage%>', 'ReqToBackOutApprover_getRejectedList.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPageRejected('<%=totalRejectedPage%>', 'L', '<%=totalRejectedPage%>', 'ReqToBackOutApprover_getRejectedList.action');">
									<img title="Last Page" src="../pages/common/img/last.gif"
										width="10" height="10" class="iconImage" /> </a></td>
								</tr>
								</table>
...
function viewApplicationFunction(rquestVoucherID)
{
	  document.getElementById('paraFrm').target = "_self";
   	  document.getElementById('paraFrm').action="ReqToBackOutApprover_viewApplicationFunction.action?rquestVoucherID="+rquestVoucherID;
	  document.getElementById('paraFrm').submit();
}
