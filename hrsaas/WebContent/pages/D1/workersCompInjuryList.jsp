...
<s:form action="WorkersCompInjury" method="post" name="LeaveForm"
	id="paraFrm" theme="simple">
		...
		<tr>
			<td width="100%"> <table width="100%" border="0" align="right" cellpadding="0"
				cellspacing="0"  >
				<tr>
					<td>	<s:hidden name="workersCode"/>	<jsp:include
		...
		<td><a href="#" onclick="setAction('')">Pending
					Application</a>|  <a href="#" onclick="setAction('BB')">Resubmit 
					List</a> | <a href="#" onclick="setAction('AA')">Approved
 ...
 %>
		...
		<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="1" border="0">
				...
				<tr>
					...
					%> <a href="#"
						onclick="callPageLocal('1', 'F', '<%=totalPage%>', 'WorkersCompInjury_input.action','pageNoField','myPage');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('P', 'P', '<%=totalPage%>', 'WorkersCompInjury_input.action','pageNoField','myPage');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
						maxlength="10"
						onkeypress="callPageTextLocal(event, '<%=totalPage%>', 'WorkersCompInjury_input.action','pageNoField','myPage');return numbersOnly();" />
					of <%=totalPage%> <a href="#"
						onclick="callPageLocal('N', 'N', '<%=totalPage%>', 'WorkersCompInjury_input.action','pageNoField','myPage')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('<%=totalPage%>', 'L', '<%=totalPage%>', 'WorkersCompInjury_input.action','pageNoField','myPage');">
				...
				<%=label.get("aplicationDate")%></label> </td>
					...
					<td   align="center" class="sortableTD"><input type="submit" value="Edit Application" class="token" onclick="editapplicationFun('<s:property value="ittWorkersCode"/>');"> </td>
					</tr>
					</s:iterator>
					</s:if>
					<s:else>
			...
			<tr>
				...
				<table width="100%" class="formbg">
					<tr>
					<td colspan="2" width="30%"><strong> Approved Application</strong> 
					<td width="70%" colspan="3">
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="formth" width="25%"><label class="set" name="tracking.no" id="tracking.no3" ondblclick="callShowDiv(this);">
				<%=label.get("tracking.no")%></label> </td>
				...
				<%int kk=1; %>
					...
					<td   class="sortableTD"><s:property value="ittEmployee"/> </td>
					<td  align="center"  class="sortableTD"><s:property value="ittApplicationDate"/> </td>
					<td   align="center" class="sortableTD"><input type="submit" value="View Application" class="token" onclick="editapplicationFun('<s:property value="ittWorkersCode"/>');"> </td>
					</tr>
					</s:iterator>
				</s:if>	
					<s:else>
		...
		<s:if test="%{flag =='RR'}">
			<tr>
				...
				<table width="100%" class="formbg">
					<tr>
					<td colspan="2" width="30%"><strong> Rejected Application</strong>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<tr><td class="formth" width="05%">Sr No </td>
					<td class="formth" width="25%"><label class="set" name="tracking.no" id="tracking.no4" ondblclick="callShowDiv(this);">
				<%=label.get("tracking.no")%></label> </td>
	...
	<!--  ********************   -->		
			...
			<tr>
				...
				<table width="100%" class="formbg">
					<tr>
					<td colspan="2" width="30%"><strong> Resubmit Application</strong>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<s:if test="listResubmit">	
				<%int rr=1; %>	
					<s:iterator value="listResubmit">
					<tr><td  class="sortableTD" > <%=rr++ %></td>
					<td   class="sortableTD"><s:hidden name="ittEmployeeId"/><s:hidden name="ittWorkersCode"/>
					<s:property value="ittEmployeeToken"/></td>
					<td   class="sortableTD"><s:property value="ittEmployee"/> </td>
					<td  align="center"  class="sortableTD"><s:property value="ittApplicationDate"/> </td>
					<td  align="center"  class="sortableTD"><input type="submit" value="View Application" class="token" onclick="editapplicationResubmitFun('<s:property value="ittWorkersCode"/>');"> </td>
					</tr>
					</s:iterator>
				</s:if>	
					<s:else>
 ...
 %>
					...
					%> <a href="#"
						onclick="callPageLocal('1', 'F', '<%=totalPageP%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage1');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('P', 'P', '<%=totalPageP%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage1');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoFieldP" id="pageNoFieldP" size="3" value="<%=pageNoP%>"
						maxlength="10"
						onkeypress="callPageTextLocal(event, '<%=totalPageP%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage1');return numbersOnly();" />
					of <%=totalPageP%> <a href="#"
						onclick="callPageLocal('N', 'N', '<%=totalPageP%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage1')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('<%=totalPageP%>', 'L', '<%=totalPageP%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage1');">
					<img title="Last Page" src="../pages/common/img/last.gif"
						width="10" height="10" class="iconImage" /> </a></td>
				...
				<%=label.get("tracking.no")%></label> </td>
					<td class="formth" width="25%"><label class="set" name="employee" id="employee3" ondblclick="callShowDiv(this);">
				<%=label.get("employee")%></label> </td>
 ...
 %>
					...
					%> <a href="#"
						onclick="callPageLocal('1', 'F', '<%=totalPageB%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage2');">
					<img title="First Page" src="../pages/common/img/first.gif"
						width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('P', 'P', '<%=totalPageB%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage2');">
					<img title="Previous Page" src="../pages/common/img/previous.gif"
						width="10" height="10" class="iconImage" /> </a> <input type="text"
						name="pageNoFieldP" id="pageNoFieldP" size="3" value="<%=pageNoB%>"
						maxlength="10"
						onkeypress="callPageTextLocal(event, '<%=totalPageB%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage2');return numbersOnly();" />
					of <%=totalPageB%> <a href="#"
						onclick="callPageLocal('N', 'N', '<%=totalPageB%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage2')">
					<img title="Next Page" src="../pages/common/img/next.gif"
						class="iconImage" /> </a>&nbsp; <a href="#"
						onclick="callPageLocal('<%=totalPageB%>', 'L', '<%=totalPageB%>', 'WorkersCompInjury_input.action','pageNoFieldP','myPage2');">
					<img title="Last Page" src="../pages/common/img/last.gif"
						width="10" height="10" class="iconImage" /> </a></td>
...
function addapplicationFun() {
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'WorkersCompInjury_addApplication.action';
		document.getElementById('paraFrm').submit();
	}
	function editapplicationFun(id) {
	document.getElementById('paraFrm_workersCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'WorkersCompInjury_editApplication.action';
		document.getElementById('paraFrm').submit();
	}
	...
	document.getElementById('paraFrm_workersCode').value=id;
		document.getElementById('paraFrm').target = "_self";
		document.getElementById('paraFrm').action = 'WorkersCompInjury_editApplicationResubmit.action';
		document.getElementById('paraFrm').submit();
	}
