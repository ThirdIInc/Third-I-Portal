...
<s:form action="HelpDeskMisReport" method="post" id="paraFrm">
<s:hidden name="report" />
<s:hidden name="reportAction" value='HelpDeskMisReport_getReport.action' />
			...
			<table width="100%" class="formbg">
				<tr>
					<td width="3%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="formhead">Request Detail Log Report</strong></td>
...
<script type="text/javascript">
	...
	function validateForm(){
		...
		if(employeeName == "" && fromDate == "" && status == "" && toDate == "" && teamMemberName =="" && deptName=="" && catagoryName =="" ){
...
//Added by Tinshuk Banafar ...Begin....
	...
	try{
	   ...
	   if(empName=="" &&  memName=="" && deptName=="" && categoryName=="" && fromDate=="" && toDate=="" && status=="" && centerName==""){
	   alert("Please select any/all search criteria to generate report ");
	   return false;
	   }
	 ...
	 function mailReportFun(type){
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='HelpDeskMisReport_mailReport.action';
		document.getElementById('paraFrm').submit();
			
		}
	function callReset(){
	document.getElementById('paraFrm').target='_self';
		document.getElementById('paraFrm').action='HelpDeskMisReport_reset.action';
		document.getElementById('paraFrm').submit();
	}
