...
<s:form action="probationDueListBean" method="post" id="paraFrm"
	theme="simple">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="78%" colspan="1"><input type="button" class="token"
						...
						value="   Probation Due List Report"  /> <s:submit
						cssClass="reset" action="probationDueListBean_clear" theme="simple"
						value="    Reset" /></td>
					<td width="22%">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="1" width="20%" class="formtext" height="22"><label
					  ...
					  :</td>
					<td colspan="3" width="80%"><s:hidden name="divCode" /> <s:textfield
						name="division" theme="simple" size="25" readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" height="18"
						class="iconImage" align="absmiddle" width="18"
						onclick="javascript:callsF9(500,325,'probationDueListBean_f9div.action');">
					</td>
				</tr>
				<tr>
					<td colspan="1" width="20%" class="formtext" height="22"><label
					...
					<td colspan="1" width="30%"><s:hidden
						...
						theme="simple" /> <s:textfield name="deptName"
						theme="simple" size="25" readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" height="18"
						class="iconImage" align="absmiddle" width="18"
						onclick="javascript:callsF9(500,325,'probationDueListBean_f9dept.action');">
					</td>
					<td colspan="1" width="20%" class="formtext"><label
						name="branch" id="branch" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>
					:</td>
					<td colspan="1" width="30%"><s:hidden
						name="centerNo" value="%{centerNo}"
						theme="simple" /> <s:textfield name="centerName"
						theme="simple" size="25" readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" height="18"
						align="absmiddle" width="18" class="iconImage"
						onclick="javascript:callsF9(500,325,'probationDueListBean_f9center.action');">
				...
				<tr>
					...
					<td colspan="1" width="30%"><s:hidden
						...
						theme="simple" /> <s:textfield name="empType"
						theme="simple" size="25" readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" height="18"
						class="iconImage" align="absmiddle" width="18"
						onclick="javascript:callsF9(500,325,'probationDueListBean_f9type.action');">
					</td>
					...
					:</td>
					<td colspan="1" width="30%"><s:hidden
						name="desgCode" value="%{desgCode}"
						theme="simple" /> <s:textfield name="desgName"
						theme="simple" size="25" readonly="true" /> <img
						src="../pages/images/recruitment/search2.gif" height="18"
						class="iconImage" align="absmiddle" width="18"
						onclick="javascript:callsF9(500,325,'probationDueListBean_f9desg.action');">
					</td>
				</tr>
				<tr>
					<td colspan="1" width="20%" class="formtext" height="22"><label
					...
					<td colspan="1" width="20%" class="formtext"><label
						name="todate" id="todate" ondblclick="callShowDiv(this);"><%=label.get("todate")%></label>
					<font color="red">*</font>:</td>
					<td colspan="1" width="30%"><s:textfield theme="simple"
...
<script type="text/javascript">
	...
	document.getElementById('paraFrm').action='probationDueListBean_report.action';
