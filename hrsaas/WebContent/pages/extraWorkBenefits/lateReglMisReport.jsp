...
<s:form action="LateReglMISReport" validate="true" id="paraFrm" theme="simple">
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> Late Regularization
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg">
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.divId" />
						...
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9division.action');" />
					</td>
					<td colspan="4"></td>
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.deptId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9department.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.branchId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9branch.action');" />
					</td>					
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empTypeId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9empType.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.desigId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9designation.action');" />
					</td>					
				</tr>	
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'LateReglMISReport_f9employee.action');" />
					</td>					
				</tr>				
			</table>
			</div>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="20%" align="right" colspan="1"><label class="set"
								name="attendance.date" id="attendance.date" ondblclick="callShowDiv(this);"><%=label.get("attendance.date")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.attDateFlag" onclick="AddItem('attendance.date',this);" /></td>
						</tr>			
						...
						<tr>
							...
							<td width="20%" align="right" colspan="1"><label class="set"
								name="login.time" id="login.time"
								ondblclick="callShowDiv(this);"><%=label.get("login.time")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.logInFlag" onclick="AddItem('login.time',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="latehrs" id="latehrs" ondblclick="callShowDiv(this);"><%=label.get("latehrs")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.lateHrsFlag" onclick="AddItem('latehrs',this);" /></td>							
							<td width="20%" align="right" colspan="1"><label class="set"
								name="latehrsdeductfrom" id="latehrsdeductfrom" ondblclick="callShowDiv(this);"><%=label.get("latehrsdeductfrom")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.lateHrsDeductFlag" onclick="AddItem('latehrsdeductfrom',this);" /></td>								
						</tr>	
					</table>
					</td>
				</tr>
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="LateReglMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="LateReglMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'LateReglMISReport_searchSavedReport.action');
	}	
	...
	function generateReport()
	{
		try{
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="LateReglMISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="LateReglMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
