<!--@author Ayyappa @date 01-04-2010 -->
<%@ taglib prefix="s" uri="/struts-tags"%>
<%@include file="/pages/common/labelManagement.jsp"%>

<s:form action="RedressalMISReport" validate="true" id="paraFrm" theme="simple">
	<table width="100%" border="0" align="right" cellpadding="2" cellspacing="1" class="formbg">
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> Redressal
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg">
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.divId" />
						...
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9division.action');" />
					</td>
					<td colspan="4"></td>
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.deptId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9department.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.branchId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9branch.action');" />
					</td>					
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empTypeId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9empType.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden name="misreport.desigId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9designation.action');" />
					</td>					
				</tr>	
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden name="misreport.empId" />
						<img src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'RedressalMISReport_f9employee.action');" />
					</td>					
				</tr>				
			</table>
			</div>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<!-- LEAVE FROM DATE,LEAVE TO DATE,LEAVE TYPE,LEAVE DAYS -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="leavefromdate" id="leavefromdate" ondblclick="callShowDiv(this);"><%=label.get("leavefromdate")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.leaveFromDateFlag" onclick="AddItem('leavefromdate',this);" /></td>						
							<td width="20%" align="right" colspan="1"><label class="set"
								name="leavetodate" id="leavetodate" ondblclick="callShowDiv(this);"><%=label.get("leavetodate")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.leaveToDateFlag" onclick="AddItem('leavetodate',this);" /></td>																												
							<td width="20%" align="right" colspan="1"><label class="set"
								name="leavetype" id="leavetype"
								ondblclick="callShowDiv(this);"><%=label.get("leavetype")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.leaveTypeFlag" onclick="AddItem('leavetype',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="leavedays" id="leavedays" ondblclick="callShowDiv(this);"><%=label.get("leavedays")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.leaveDaysFlag" onclick="AddItem('leavedays',this);" /></td>									
						</tr>
						<!-- REDRESSAL DAYS -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="redressaldays" id="redressaldays" ondblclick="callShowDiv(this);"><%=label.get("redressaldays")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.redDaysFlag" onclick="AddItem('redressaldays',this);" /></td>	
							<td colspan="6"></td>						
						</tr>
					</table>
					</td>
			...
			<table cellspacing="0" cellpadding="0" class="formbg" width="100%"
				...
				<tr>
					<td colspan="1" height="22" width="15%"><label class="set"
								name="leavefromdate" id="leavefromdate"
								ondblclick="callShowDiv(this);"><%=label.get("leavefromdate")%></label>:</td>
					<td colspan="1" width="10%" align="left"><s:select theme="simple"
						name="leave1DateSelect" value="%{leave1DateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'2','leave1');" /></td>
					<td width="10%" colspan="1" height="22"><s:textfield
						name="misreport.leave1FromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_misreport_leave1FromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_misreport_leave1FromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="5%" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_misreport_leave1FromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22" width="60%">
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel2" height="22"><s:textfield
								name="misreport.leave1ToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_misreport_leave1ToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_misreport_leave1ToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker2"><s:a
								href="javascript:NewCal('paraFrm_misreport_leave1ToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
				...
				<tr>
					<td colspan="1" height="22" width="15%"><label class="set"
								name="leavetodate" id="leavetodate"
								ondblclick="callShowDiv(this);"><%=label.get("leavetodate")%></label>:</td>
					<td colspan="1" width="10%" align="left"><s:select theme="simple"
						name="leave2DateSelect" value="%{leave2DateSelect}"
						list="#{'':'--Select--','ON':'On','BF':'Before','AF':'After','OB':'On before',
						'OA':'On after','BN':'Between'}"
						onchange="callToDateDispOnClick(this,'3','leave2');" /></td>
					<td width="10% colspan="1" height="22"><s:textfield
						name="misreport.leave2FromDate" maxlength="10"
						onkeypress="return numbersWithHiphen();"
						onfocus="clearText('paraFrm_misreport_leave2FromDate','dd-mm-yyyy')"
						onblur="setText('paraFrm_misreport_leave2FromDate','dd-mm-yyyy')"
						maxlength="10" size="9" /></td>
					<td width="5%" colspan="1" height="22"><s:a
						href="javascript:NewCal('paraFrm_misreport_leave2FromDate','DDMMYYYY');">
						<img class="iconImage" src="../pages/images/recruitment/Date.gif"
							width="16" height="16" border="0" align="absmiddle" />
					</s:a></td>
					<td colspan="3" height="22" width="60%">
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="52" id="toDateDivLabel3" height="22"><s:textfield
								name="misreport.leave2ToDate" maxlength="10"
								onkeypress="return numbersWithHiphen();"
								onfocus="clearText('paraFrm_misreport_leave2ToDate','dd-mm-yyyy')"
								onblur="setText('paraFrm_misreport_leave2ToDate','dd-mm-yyyy')"
								maxlength="10" size="9" /></td>
							<td width="449" id="toDatePicker3"><s:a
								href="javascript:NewCal('paraFrm_misreport_leave2ToDate','DDMMYYYY');">
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
...
<script type="text/javascript">
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="RedressalMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="RedressalMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'RedressalMISReport_searchSavedReport.action');
	}	
    ...
    function callAllDisable(){
	  	...
	  	if(document.getElementById("paraFrm_leave1DateSelect").value=="BN"){
	  	...
	  	if(document.getElementById("paraFrm_leave2DateSelect").value=="BN"){
	...
	function generateReport()
	{
		try{
			...
			var l1FromDate = document.getElementById('paraFrm_misreport_leave1FromDate').value;
			var l1ToDate = document.getElementById('paraFrm_misreport_leave1ToDate').value;
			var l2FromDate = document.getElementById('paraFrm_misreport_leave2FromDate').value;
			var l2ToDate = document.getElementById('paraFrm_misreport_leave2ToDate').value;
			...
			if(document.getElementById("paraFrm_leave1DateSelect").value!=""){
				//alert(document.getElementById("paraFrm_attFromDate").value);
				if(l1FromDate=="" || l1FromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('leavefromdate').innerHTML);
					//document.getElementById('paraFrm_misreport_attFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_leave1DateSelect").value=="BN"){
					if(l1ToDate==""||l1ToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('leavefromdate').innerHTML);
				...
				if(l1FromDate!=""||l1FromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_misreport_leave1FromDate'];
				  	var lbl=['leavefromdate'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
				   	}
	  			...
	  			if(l1ToDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_misreport_leave1ToDate'];
			  		var lbl=['leavefromdate'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
			...
			if(document.getElementById("paraFrm_leave2DateSelect").value!=""){
				//alert(document.getElementById("paraFrm_attFromDate").value);
				if(l2FromDate=="" || l2FromDate=="dd-mm-yyyy"){
					alert("Please enter "+document.getElementById('leavetodate').innerHTML);
					//document.getElementById('paraFrm_misreport_attFromDate').focus();
					return false;
				}
				if(document.getElementById("paraFrm_leave2DateSelect").value=="BN"){
					if(l2ToDate==""||l2ToDate=="dd-mm-yyyy"){
						alert("Please enter "+document.getElementById('leavetodate').innerHTML);
						//document.getElementById('paraFrm_misreport_attToDate').focus();
						return false;
					}
				...
				if(l2FromDate!=""||l2FromDate!="dd-mm-yyyy" ){
				  	var fld=['paraFrm_misreport_leave2FromDate'];
				  	var lbl=['leavetodate'];
			   		var chkfrmDate=validateDate(fld,lbl);
			   		if(!chkfrmDate) {
				    	return false;
	  			...
	  			if(l2ToDate!="dd-mm-yyyy" ){
			  		var fld=['paraFrm_misreport_leave2ToDate'];
			  		var lbl=['leavetodate'];
		   			var chktoDate=validateDate(fld,lbl);
		   			if(!chktoDate) {
			    		return false;
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="RedressalMISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="RedressalMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
