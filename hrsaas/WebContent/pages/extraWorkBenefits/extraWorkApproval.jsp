...
<s:form action="ExtraWorkApproval" validate="true" id="paraFrm"
	theme="simple">
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					Work Benefits Approval </strong></td>
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ExtraWorkApproval_callstatus.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ExtraWorkApproval_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }
		   if(listType=="r"){
		     
		      	document.getElementById('paraFrm').action='ExtraWorkApproval_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		...
		<s:if test="%{listType == 'pending'}">
			<tr>
				...
				<table width="100%" class="formbg" border="0">
					<tr>
						<td><b>Pending Applications List</b></td>
					</tr>
							...
							<s:if test="pendingLength">
								<tr>
									...
									<%
												...
												.getAttribute("totalPagePending");
										PageNoPending = (Integer) request.getAttribute("PageNoPending");
									%> <a href="#"
										onclick="callPage('1', 'F', '<%=totalPagePending%>', 'ExtraWorkApproval_callstatus.action');">
									<img title="First Page" src="../pages/common/img/first.gif"
										width="10" height="10" class="iconImage" /> </a>&nbsp; <a
										href="#"
										onclick="callPage('P', 'P', '<%=totalPagePending%>', 'ExtraWorkApproval_callstatus.action');">
									<img title="Previous Page"
										src="../pages/common/img/previous.gif" width="10" height="10"
										class="iconImage" /> </a> <input type="text" name="pageNoField"
										id="pageNoField" size="3" value="<%=PageNoPending%>"
										maxlength="10"
										onkeypress="callPageText(event, '<%=totalPagePending%>', 'ExtraWorkApproval_callstatus.action');return numbersOnly();" />
									of <%=totalPagePending%> <a href="#"
										onclick="callPage('N', 'N', '<%=totalPagePending%>', 'ExtraWorkApproval_callstatus.action')">
									<img title="Next Page" src="../pages/common/img/next.gif"
										class="iconImage" /> </a>&nbsp; <a href="#"
										onclick="callPage('<%=totalPagePending%>', 'L', '<%=totalPagePending%>', 'ExtraWorkApproval_callstatus.action');">
										...
										<s:iterator value="pendingList">
											...
											<tr class="sortableTD">
												...
												<td class="sortableTD" width="15%"><s:property
													value="tokenNo" /><s:hidden name="extWrkAppNo" /><s:hidden
												...
												<td class="sortableTD" width="20%" nowrap="nowrap"  align="center"><input
													...
													value=" View Details "
													onclick="viewDetails('<s:property value="extWrkAppNo"/>','<s:property value="pendingStatus"/>')" /></td>
 ...
 %> <a href="#"
								onclick="callPageApproved('1', 'F', '<%=totalPageApproved%>', 'ExtraWorkApproval_getApprovedList.action');">
							<img title="First Page" src="../pages/common/img/first.gif"
								width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
								onclick="callPageApproved('P', 'P', '<%=totalPageApproved%>', 'ExtraWorkApproval_getApprovedList.action');">
							<img title="Previous Page" src="../pages/common/img/previous.gif"
								width="10" height="10" class="iconImage" /> </a> <input type="text"
								name="pageNoField2" id="pageNoField2" size="3"
								value="<%=PageNoApproved%>" maxlength="10"
								onkeypress="callPageTextApprove(event, '<%=totalPageApproved%>', 'ExtraWorkApproval_getApprovedList.action');return numbersOnly();" />
							of <%=totalPageApproved%> <a href="#"
								onclick="callPageApproved('N', 'N', '<%=totalPageApproved%>', 'ExtraWorkApproval_getApprovedList.action')">
							<img title="Next Page" src="../pages/common/img/next.gif"
								class="iconImage" /> </a>&nbsp; <a href="#"
								onclick="callPageApproved('<%=totalPageApproved%>', 'L', '<%=totalPageApproved%>', 'ExtraWorkApproval_getApprovedList.action');">
							<img title="Last Page" src="../pages/common/img/last.gif"
								width="10" height="10" class="iconImage" /> </a></td>
						</tr>
					</s:if>
							...
							<tr>
								...
								<table width="100%" class="sorttable">
									<tr>
										...
										<td class="formth" width="20%"><b>Cancel Application</b></td>
										...
										<s:iterator value="appList">
											<tr>
												...
												<td class="sortableTD" width="15%"><s:hidden
													name="appEmpId" /><s:hidden name="appExtAppNo" /><s:hidden
												...
												<td class="sortableTD" width="20%" nowrap="nowrap"  align="center"><input
													type="button" name="view_Details" class="token"
													value=" View Details "
													onclick="viewDetails('<s:property value="appExtAppNo"/>','<s:property value="appStatus"/>')" />
									...
									<s:if test="rejectedLength">
										...
										<s:iterator value="rejList">
											<tr>
												...
												<td class="sortableTD" width="15%"><s:hidden
													name="rejEmpId" /><s:hidden name="rejExtAppNo" /><s:hidden
												...
												<td class="sortableTD" width="20%" nowrap="nowrap"  align="center"><input
													type="button" name="view_Details" class="token"
													value=" View Details "
													onclick="viewDetails('<s:property value="rejExtAppNo"/>','<s:property value="rejStatus"/>')" />
...
<script>
function viewDetails(extWrkAppNo,status){
	//alert("extWrkAppNo"+extWrkAppNo);
	//alert("status"+status);
	try{
	...
	//document.getElementById('paraFrm').action = 'ExtraWorkApplication_retrieveForApproval.action?extWrkApplicationNo='+extWrkAppNo+'&applicationStatus='+status;
...
function viewHistory(empCode){
	...
	document.getElementById('paraFrm').target = "wind";
	document.getElementById('paraFrm').action = 'ExtraWorkApplication_retrieveForHistory.action?employeeNo='+empCode;
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target = "_self";
}
