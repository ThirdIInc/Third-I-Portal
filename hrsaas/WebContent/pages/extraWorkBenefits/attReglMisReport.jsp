...
<s:form action="AttendanceReglMISReport" validate="true" id="paraFrm"
	theme="simple">
	<table width="100%" border="0" align="right" cellpadding="2"
		...
		<tr>
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					...
					Attendance Regularization MIS Report</strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						...
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9division.action');" />
					</td>
					<td colspan="4"></td>
				</tr>
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9department.action');" />
					</td>
					<td width="4%"></td>
					...
					<td width="5%" align="left"><s:hidden
						...
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9branch.action');" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="5%" align="left"><s:hidden
						...
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9empType.action');" />
					</td>
					<td width="4%"></td>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9designation.action');" />
					</td>
				</tr>
				...
				<tr>
					...
					<img src="../pages/images/recruitment/search2.gif"
						class="iconImage" height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'AttendanceReglMISReport_f9employee.action');" />
					</td>
				</tr>
			</table>
			</div>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="20%" align="right" colspan="1"><label class="set"
								name="attendance.date" id="attendance.date"
								ondblclick="callShowDiv(this);"><%=label.get("attendance.date")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.attDateFlag"
								onclick="AddItem('attendance.date',this);" /></td>
						</tr>
						<!-- STATUS,ACTUAL IN TIME,ACTUAL OUT TIME -->
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
							...
							<td width="20%" align="right" colspan="1"><label class="set"
								name="actualin.time" id="actualin.time"
								ondblclick="callShowDiv(this);"><%=label.get("actualin.time")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.actInFlag"
								onclick="AddItem('actualin.time',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="actualout.time" id="actualout.time"
								ondblclick="callShowDiv(this);"><%=label.get("actualout.time")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.actOutFlag"
								onclick="AddItem('actualout.time',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="application.reason" id="application.reason"
								ondblclick="callShowDiv(this);"><%=label.get("application.reason")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.reasonFlag"
								onclick="AddItem('application.reason',this);" /></td>

						</tr>
						<tr>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="recordedin.time" id="recordedin.time"
								ondblclick="callShowDiv(this);"><%=label.get("recordedin.time")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.recorderInFlag"
								onclick="AddItem('recordedin.time',this);" /></td>
							<td width="20%" align="right" colspan="1"><label class="set"
								name="recordedout.time" id="recordedout.time"
								ondblclick="callShowDiv(this);"><%=label.get("recordedout.time")%></label>:</td>
							<td colspan="5"><s:checkbox theme="simple"
								name="misreport.recorderOutFlag"
								onclick="AddItem('recordedout.time',this);" /></td>
						</tr>
					</table>
					</td>
				</tr>
			...
			<div id="fourth">
			<table cellspacing="1" cellpadding="1" class="formbg" width="100%"
...
<script type="text/javascript">
	...
	function onloadCall(){
		...
		// var sortBy = document.getElementById("parasortBy");
		//sortBy.add(option,"EmployeeCode"); 
		callAllDisable();
		setFieldsOnload();
	}
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').action="AttendanceReglMISReport_reset.action";
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="AttendanceReglMISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
	}	
	
	function searchReport() {
		callsF9(500,325,'AttendanceReglMISReport_searchSavedReport.action');
	}	
	...
	function generateReport()
	{
		try{
  		...
  		if(document.getElementById("reportViewV").checked){
			...
			document.getElementById('paraFrm').action="AttendanceReglMISReport_report.action";
			document.getElementById('paraFrm').submit();
			document.getElementById('paraFrm').target="main"; 
		}		
	}
	...
	function empBlank(){	
	 	document.getElementById('paraFrm_misreport_empToken').value ='';
		document.getElementById('paraFrm_misreport_empName').value =''
	}
</script>
