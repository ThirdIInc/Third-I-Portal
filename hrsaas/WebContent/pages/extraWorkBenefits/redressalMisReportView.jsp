...
<!-- hidden variables -->
		...
		<s:hidden name="misreport.leaveFromDateFlag"/>
		<s:hidden name="misreport.leaveToDateFlag"/>
		<s:hidden name="misreport.leaveTypeFlag"/>
		<s:hidden name="misreport.leaveDaysFlag"/>
		<s:hidden name="misreport.redDaysFlag"/>
		...
		<s:hidden name="leave1DateSelect" />
		<s:hidden name="leave2DateSelect" />
		
		<s:hidden name="misreport.appliFromDate" />
		<s:hidden name="misreport.appliToDate" />
		<s:hidden name="misreport.leave1FromDate" />
		<s:hidden name="misreport.leave1ToDate" />
		<s:hidden name="misreport.leave2FromDate" />
		<s:hidden name="misreport.leave2ToDate" />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> Redressal Regularization
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>Redressal Regularization Mis Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('RedressalMISReport_report.action');   
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='RedressalMISReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>