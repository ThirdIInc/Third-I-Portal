...
<!-- hidden variables -->
		...
		<s:hidden name="misreport.fromDateFlag"/>
		<s:hidden name="misreport.toDateFlag"/>
		<s:hidden name="misreport.fromTimeFlag"/>
		<s:hidden name="misreport.toTimeFlag"/>
		<s:hidden name="misreport.totalTimeFlag"/>
		...
		<s:hidden name="time1DateSelect" />
		<s:hidden name="time2DateSelect" />
		
		<s:hidden name="misreport.appliFromDate" />
		<s:hidden name="misreport.appliToDate" />
		<s:hidden name="misreport.time1FromDate" />
		<s:hidden name="misreport.time1ToDate" />
		<s:hidden name="misreport.time2FromDate" />
		<s:hidden name="misreport.time2ToDate" />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head"> Personal Time Regularization
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formbg"> <!-- TABLE4 -->
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="27" class="text_head"><strong>Personal Time Regularization Mis Report </strong></td>
							<%
...
<script type="text/javascript">
	...
	function callReportForDisp(reportType)
	{
		 ...
		 callReport('PersonalTimeMISReport_report.action');   
	}
	...
	function callBack(){
		...
		var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
	  	...
	  	document.getElementById('paraFrm').action='PersonalTimeMISReport_callBack.action';
	  	document.getElementById('paraFrm').submit(); 
	}	
</script>