...
<s:form action="ReimbursementReport" validate="true" id="paraFrm" theme="simple">
	   ...
	   <td>
	   		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="formbg">
	        	 <tr>
				    ...
				    <td width="93%" class="txt"><strong class="text_head">Reimbursement Report</strong></td>
       ...
       <tr>
		      ...
		      <td  colspan="1" height="20" class="formtext" width="78%">
		       ...
		       <td width="2%">    
				  	<img
						...
						onclick="javascript:callDropdown('paraFrm_division',350,250,'ReimbursementReport_f9Division.action',event,'false','no','right')">
		      </td>
		      </tr>
		       <tr>
		    <td class="formtext" colspan="1" height="20" class="formtext" width="20%">
		    ...
		    <td width="2%">    
		        <img
					src="../pages/images/recruitment/search2.gif" height="16"
					align="absmiddle" width="17" theme="simple"
					onclick="javascript:callDropdown('paraFrm_creditName',350,250,'ReimbursementReport_f9CreditHead.action',event,'false','no','right')">
		    </td>		    
		    
		    
		     <s:hidden name="reportType"></s:hidden>
		     <s:hidden name="reportAction" value='ReimbursementReport_getReport.action'/>
		      ...
		      <td  colspan="1" height="20" class="formtext" width="78%">
		       ...
		       <td width="2%"> 
			 		<img
						src="../pages/images/recruitment/search2.gif" height="16"
						align="absmiddle" width="17" theme="simple"
						onclick="javascript:callDropdown('paraFrm_branch',350,250,'ReimbursementReport_f9Branch.action',event,'false','no','right')">		              
		      </td>
		   </tr>		   
		    ...
		    <td  colspan="1" height="20" class="formtext" width="78%">
		     ...
		     <td width="2%">   
				<img
					src="../pages/images/recruitment/search2.gif" height="16"
					align="absmiddle" width="17" theme="simple"
					onclick="javascript:callDropdown('paraFrm_dept',350,250,'ReimbursementReport_f9Dept.action',event,'false','no','right')">
		    </td>
		    </tr>
		    <tr>
		     ...
		     <s:textarea name="paybillname" cols="120" rows="1" readonly="true" />
		      ...
		      <td width="2%">   
			  	<img
					src="../pages/images/recruitment/search2.gif" height="16"
					align="absmiddle" width="17" theme="simple"
					onclick="javascript:callDropdown('paraFrm_paybillname',350,250,'ReimbursementReport_f9Paybill.action',event,'false','no','right')">		              
		     </td>
		  </tr>
		    ...
		    <td  colspan="1" height="20" class="formtext" width="78%">
		     ...
		     <td width="2%">   
				<img
					src="../pages/images/recruitment/search2.gif" height="16"
					align="absmiddle" width="17" theme="simple"
					onclick="javascript:callDropdown('paraFrm_gradeName',350,250,'ReimbursementReport_f9Grade.action',event,'false','no','right')">
		    </td>
		 ...
		 <!--  <tr>
		  ...
		  <tr>
		  	...
		  	<table width="100%" border="0" cellpadding="2" cellspacing="2" class="formbg" >
		  		<tr>
		    <td class="formtext" colspan="1" height="20" class="formtext" width="22%">
		      	<label  class = "set" name="reimbursement.showsatatic"  id="reimbursement.showsatatic" ondblclick="callShowDiv(this);"><%=label.get("reimbursement.showsatatic")%></label><font color="red">*</font> :
		    </td>
		    <td  colspan="2" height="20" class="formtext" width="22%">
		     <input type="radio" name="staticshow" id="departmentWise" value="D" checked="checked"/>Department Wise
		    </td>    
		    
		    
		    
		     <td class="formtext"  colspan="3" height="20" class="formtext" width="22%">
		     <input type="radio" name="staticshow" id="costcenterWise" value="C"/>Costcenter Wise
...
function mailReportFun(type){
		...
		document.getElementById('paraFrm_reportType').value=type;
			...
			document.getElementById('paraFrm').action='ReimbursementReport_mailReport.action';
	...
	function validateFields()
	{
			...
			{
			 	alert("Please select Show Statistics ");
			 	return false;
			}
 	...
 	function callReset()
 		{	 
	 		document.getElementById('paraFrm').action="ReimbursementReport_reset.action";
	 		document.getElementById('paraFrm').submit();
		}
