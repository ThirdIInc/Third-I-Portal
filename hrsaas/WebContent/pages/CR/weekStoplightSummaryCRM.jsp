...
<s:form action="CRMAccountInfo" validate="true" id="paraFrm" theme="simple">
	  		...
	  		<td colspan="3" width="100%">
			   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
					<tr>
						...
						<td width="93%" class="txt"><strong class="text_head">Week Stoplight Summary
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								cellspacing="2">
								<tr>
									<td nowrap="nowrap">From Week :</td>
									<td><s:textfield size="25" name="fromWeek"
							...
							<s:a
								...
								<tr>
									<td nowrap="nowrap">To Week :</td>
									<td><s:textfield size="25" name="toWeek"
										maxlength="4" readonly="true"/>
										<s:a
								...
								<tr>
									...
									<s:hidden name="accountID"/>						
										...
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CRMAccountInfo_weeklyStopLoghtSummaryReport.action');">
									</td>
								</tr>
...
function callGenerateReport123(reportcode,accCode,inFromWeek,inToWeek){
	...
	var action_method= '<%=request.getContextPath()%>/cr/CRMAccountInfo_weeklyStopLoghtSummaryReport.action?reportcodeValue12='+reportcodeValue;
	generateCrystalReport(action_method);
	//document.getElementById('paraFrm').target = "_blank";
	//document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/cr/CRMAccountInfo_weeklyStopLoghtSummaryReport.action?reportcodeValue12='+reportcodeValue;
...
function generateCrystalReport(reportcode,accCode,inFromWeek,inToWeek,inlistAccountID,method_action){
	...
	//alert('<%=request.getContextPath()%>/cr/CRMAccountInfo_'+method_action+'?reportcodeValue12='+reportcodeValue);
	document.getElementById('paraFrm').target = "_blank";
