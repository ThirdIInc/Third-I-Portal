	...
	<tr>
		...
		<table width="80%" height="51" border="0" align="right"
			...
			<tr>
				...
				<td width="4%">&nbsp;</td>
				<td width="40%" align="right"><strong><font size="3" color="#969696">Account Report</font></strong></td>
			</tr>
		</table>
		</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<!--<td valign="top"><iframe id="myframe" frameborder="0"
								...
								<td valign="top"><iframe id="myframe" frameborder="0"
								style="float: left"
								src="<%=request.getContextPath()%>/cr/CustomerAccountInfo_getMultipleAccountList.action?isClickOn=Input&loginName=<%=request.getAttribute("loginName")%>&random_app="+<%=Math.random()%>"
								allowtransparency="yes" scrolling="auto" marginwidth="0"
								marginheight="0" vspace="0" name="main" width="100%" height="0"
								style="vertical-align: top; float: right;"> </iframe></td>
