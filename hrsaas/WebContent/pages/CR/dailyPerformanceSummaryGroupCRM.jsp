					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td nowrap="nowrap">From Date(DD-MM-YYYY) :<font color="red">*</font></td>
									<td><s:textfield size="25" name="fromWeek" maxlength="4" readonly="true"/>
										<s:a href="javascript:NewCal('paraFrm_fromWeek','DDMMYYYY');">
								...
								<tr>
									<td nowrap="nowrap">To Date(DD-MM-YYYY) :<font color="red">*</font></td>
									<td>
										<s:textfield size="25" name="toWeek" maxlength="4" readonly="true"/>
										<s:a href="javascript:NewCal('paraFrm_toWeek','DDMMYYYY');">
										<img class="iconImage" src="../pages/images/recruitment/Date.gif" width="16"
											height="16" border="0" align="absmiddle" /></s:a>
										</td>
									<td>&nbsp;</td>
								...
								<tr>
									...
									<s:hidden name="accountID"/>								
										...
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CRMAccountInfo_dailyPerformanceSummaryGroupReport.action');">
									</td>									
								</tr>
