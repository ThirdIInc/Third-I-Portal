						...
						<tr>
							...
							<s:a
								...
								<tr> 
									...
									<td nowrap="nowrap"><s:textfield size="18" name="toWeek"
										maxlength="4" readonly="true"/>
										<s:a
								...
								<tr>
									...
									<s:hidden name="hPublishDate"/>
										...
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CustomerAccountInfo_weeklyStopLoghtSummaryReport.action','paraFrm_hPublishDate','client');">
									</td>
								</tr>
							</table>
							</td>
...
function callGenerateReport123(reportcode,accCode,inFromWeek,inToWeek){
	...
	var action_method= '<%=request.getContextPath()%>/cr/CustomerAccountInfo_weeklyStopLoghtSummaryReport.action?reportcodeValue12='+reportcodeValue;
	generateCrystalReport(action_method);
	//document.getElementById('paraFrm').target = "_blank";
	//document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/cr/CustomerAccountInfo_weeklyStopLoghtSummaryReport.action?reportcodeValue12='+reportcodeValue;
