							...
							<s:a
								...
								<tr>
									...
									<input type="button" class="save" value="Generate Report" 
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CustomerAccountInfo_dailyPerformanceSummaryReport.action','paraFrm_hPublishDate','client');">
									</td>
								</tr>
