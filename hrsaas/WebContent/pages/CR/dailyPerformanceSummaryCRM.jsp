							...
							<s:a
								...
								<tr>
									...
									<input type="button" class="save" value="Generate Report" 
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CRMAccountInfo_dailyPerformanceSummaryReport.action');">
									</td>
								</tr>
