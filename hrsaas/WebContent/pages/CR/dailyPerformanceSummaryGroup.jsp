						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td nowrap="nowrap"><s:textfield size="18" name="fromWeek" maxlength="4" readonly="true"/>
								...
								<tr>
									...
									<td nowrap="nowrap">
										<s:textfield size="18" name="toWeek" maxlength="4" readonly="true"/>
								...
								<tr>
									...
									<s:hidden name="hPublishDate"/>
										...
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CustomerAccountInfo_dailyPerformanceSummaryGroupReport.action','paraFrm_hPublishDate','client');">
									</td>									
								</tr>
