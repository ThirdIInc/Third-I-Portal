						...
						<tr>
							...
							<s:a
								...
								<tr>
									...
									<td><s:textfield size="25" name="toWeek" maxlength="4" readonly="true"/>
										<s:a
								...
								<tr>
									...
									<s:hidden name="accountID"/>							
										...
										onclick="generateCrystalReport('paraFrm_reportCode','paraFrm_accountCode','paraFrm_fromWeek','paraFrm_toWeek','paraFrm_accountID','CRMAccountInfo_weeklyPerformanceSummaryReport.action');">
								</td>
								</tr>
...
function callGenerateReport123(reportcode,accCode,inFromWeek,inToWeek){
	...
	var action_method= '<%=request.getContextPath()%>/cr/CRMAccountInfo_weeklyPerformanceSummaryReport.action?reportcodeValue12='+reportcodeValue;
	generateCrystalReport(action_method);
	//document.getElementById('paraFrm').target = "_blank";
	//document.getElementById('paraFrm').action = '<%=request.getContextPath()%>/cr/CRMAccountInfo_weeklyPerformanceSummaryReport.action?reportcodeValue12='+reportcodeValue;
