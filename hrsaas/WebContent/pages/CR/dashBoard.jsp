...
//popup function is used for populating the component reports
	...
	<table width="100%" border="0"  align="top"  cellpadding="0" id="dashTab"
		...
		<tr>
			...
			%> <!-- For Menu List-->	
									<!--row start	-->
			<td style="background-color: #F9F9F9; width="20%" valign="top" >
			
			<table width="100%"  border="0" align="top" cellpadding="0"
				id="dashTab" name="dashTab" cellspacing="0" style="overflow:auto;">
				 
				<tr valign="top">
					<td><img src="../pages/images/icons/portal/myreports.jpg" /></td>
				</tr>
				
				
				
				<%
						//iteration for left menulist object
						for (int i = 0; i < objectReportMenuList.length; i++) {
				%>
				<tr valign="top">
					<td class="portalAppButtons" width="100%" valign="top" align="left" style="text-align: left;">
					<img src="../pages/images/icons/portal/insightone.png";	align="absmiddle" width="16" height="16" style="padding:0; margin:0;"/> 
					<a href="#"	onclick="popup('<%=objectReportMenuList[i][1]%>','<%=String.valueOf(objectReportMenuList[i][0])%>')"><%=String.valueOf(objectReportMenuList[i][0])%></a>
					<!-- <a href="#" onclick="showScheduleReport('<%=objectReportMenuList[i][1]%>','<%=String.valueOf(objectReportMenuList[i][0])%>')"><img src="../pages/cssv2/icons/attendance.gif"; class="iconImage"align="right" width="16" height="16" > </a> -->	
					</td>
				...
				<table border="0" align="top" style=" overflow: auto; " >
				<tr valign="top">
				<td>
				&nbsp;
				</td>
				...
				<tr>
				<td>
				<img src="../pages/images/icons/portal/MY_DOC.png";align="absmiddle"  />
				</td>
				</tr>
				...
				<td class="portalAppButtons" width="100%" valign="top" align="left" style="text-align: left;">
				<img src="../pages/images/icons/portal/File1_download.png";align="absmiddle" width="16" height="16"  />
				 <a href="#"  onclick="getMyDoc('<s:property value="documentFileloc"/>','<s:property value="documentFile"/>')" ><s:property value="documentFile"/></a>
				</td>
		...
		headerKey="-1" headerValue="Select Month"  name="dashMonth" list="#{'01':'Jan', '02':'Feb', '03':'Mar', '04':'Apr','05':'May','06':'Jun','07':'Jul','08':'Aug','09':'Sep','10':'Oct','11':'Nov','12':'Dec'}" 
		 
		></s:select>
		</td>
		<td width="5%" nowrap="nowrap">
		Year :
		<s:textfield name="dashYear" size="5"></s:textfield>
		</td>
		<td width="5%">
		<input type="button" value="Go" onclick="callDashBoard();">
		</td>
		<td width="76%">
		...
		<a href="#" onclick="callMIS();"><strong>Data Analysis >></strong></a>
		</td>
		</tr>
		</table>
