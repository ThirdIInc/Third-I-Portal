...
<s:form action="eGovPFReport" validate="true" id="paraFrm"
				...
				<tr>
					...
					<table width="98%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<s:textfield name="divName" theme="simple" readonly="true"
								...
								onclick="javascript:callsF9(500,325,'eGovPFReport_f9Div.action');">
							...
							<td colspan="1" width="30%"><s:hidden
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="16" align="absmiddle" width="16"
								onclick="javascript:callsF9(500,325,'eGovPFReport_f9BranchAction.action');">
						...
						<tr>
							...
							<td><s:hidden name="deptCode" /> <s:textfield
								...
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="16" align="absmiddle" width="16"
								onclick="javascript:callsF9(500,325,'eGovPFReport_f9Deptaction.action');">
							</td>
							...
							<td colspan="1" width="30%"><s:select theme="simple"
								name="reportType" cssStyle="width:165"
					...
					<td colspan="1" width="20%"><label class="set"
							...
							<td><s:hidden name="paybillId" /> <s:textfield name="payBill"
								theme="simple" readonly="true" maxlength="50" size="30" /><img src="../pages/images/recruitment/search2.gif"
								class="iconImage" height="18" align="absmiddle" width="18"
								onclick="javascript:callsF9(500,325,'eGovPFReport_f9payBill.action');"></td>
					</tr>
					</table>
					</td>
				</tr>
...
function callForReport(){
	var fields=["paraFrm_divName","paraFrm_branchName","paraFrm_reportType"];
	var labels=["division","branch","report.type"];
	var flag=["select","select","select"];
	
	if(!validateBlank(fields,labels,flag)){
		return false;
	}
	callReport("eGovPFReport_getPFBalanceReport.action");
