...
<s:form action="UploadMonthlyAttendanceEGov" name="UploadMonthlyAttendanceEGov" id="paraFrm" validate="true" target="main" theme="simple">	
				...
				<table width="100%">
					<tr>
				   		<td> <input type="button" name="report" value="Report" class="token" onclick="return showReport();" />
							<s:submit value=" Reset" cssClass="reset" action="UploadMonthlyAttendanceEGov_reset" title="Clear the fields" /> 
				...
				<table width="100%" class="formbg">
					...
					<tr>
						...
						<td width="10%">
							...
							width="18" title="Select the division" onclick="callsF9(500,325,'UploadMonthlyAttendanceEGov_f9Division.action');">
						</td>
						<td width="15%">
						...
						<td width="10%">
							<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="absmiddle" 
							width="18" title="Select the branch" onclick="callsF9(500,325,'UploadMonthlyAttendanceEGov_f9Branch.action');">
						</td>
					</tr> 
					<tr>
						<td width="15%">
						...
						<td width="10%">
							<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="absmiddle" 
							width="18" title="Select the department" onclick="callsF9(500,325,'UploadMonthlyAttendanceEGov_f9Department.action');">
						</td>
						<td width="15%">
						...
						<td width="10%">
							<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="absmiddle" 
							width="18" title="Select the type of an employee" onclick="callsF9(500,325,'UploadMonthlyAttendanceEGov_f9EmployeeType.action');">
						</td>
					</tr>   
					<tr>
						<td width="15%">
						...
						<td width="10%">
							<img src="../pages/images/recruitment/search2.gif" class="iconImage" height="18" align="absmiddle" 
							width="18" title="Select the pay bill group" onclick="callsF9(500,325,'UploadMonthlyAttendanceEGov_f9PayBill.action');">
						</td>
						<td width="15%">
			...
			<td>
				<table width="100%" class="formbg">
					...
					<tr>
						...
						<td>
							<s:submit value="Download" cssClass="token" action="UploadMonthlyAttendanceEGov_downLoadFile" 
		...
		<tr>
			<td>
				...
				<tr>
					...
					<tr>
						<td width="100%" align="center">
							<s:submit cssClass="token" theme="simple" value="Upload" action="UploadMonthlyAttendanceEGov_uploadMonSheet" 
...
<script>
	...
	callReport('UploadMonthlyAttendanceEGov_report.action');
	...
	function callF9Employee() {
		...
		callsF9(500,325,'UploadMonthlyAttendanceEGov_f9SeachEmployee.action');
	}
