...
<s:form action="ResignationApproval" validate="true" id="paraFrm"
	 theme="simple">
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<tr>
		    ...
		    function setAction(listType){
		     ...
		     if(listType=="p"){
		      	...
		      	document.getElementById('paraFrm').action='ResignationApproval_callstatus.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }if(listType=="a"){
		     
		      	document.getElementById('paraFrm').action='ResignationApproval_getApprovedList.action';
		      	document.getElementById('paraFrm').submit();
		      
		     }
		   if(listType=="r"){
		     
		      	document.getElementById('paraFrm').action='ResignationApproval_getRejectedList.action';
		      	document.getElementById('paraFrm').submit();
		...
		<s:if test="%{listType == 'pending'}">
			<tr>
				...
				<table width="100%" class="formbg" border="0">
					<tr>
						<td><b>Pending Resignation Application</b></td>
					</tr>
		...
		<s:if test="%{listType == 'approved'}">
			...
			<tr>
				...
				<table width="100%" class="formbg">
					<tr>
						<td><b>Approved Resignation Applications List</b></td>
					</tr>
		...
		<s:if test="%{listType == 'rejected'}">
			<tr>
				...
				<table width="100%" class="formbg">
					<tr>
						<td><b>Rejected Resignation Applications List</b></td>
					</tr>
					<tr>
						<td>
						<table width="100%">
...
<script>
	   ...
	   // var wind = window.open('','wind','width=800,height=500,scrollbars=yes,resizable=yes,menubar=no,top=200,left=100');	 
		...
		try{
		document.getElementById('paraFrm').action = 'ResignationApplication_retriveForApproval.action?resignApplicationNo='+resignAppNo+'&applicationStatus='+status;
		document.getElementById('paraFrm').submit();
