...
<s:form action="SettlementMisReport" method="post" id="paraFrm" theme="simple">


	<s:hidden name="settId" value="%{settId}" />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Settlement MIS Report
					</strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							</s:if> <s:submit cssClass="reset" action="SettlementMisReport_reset"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"  
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"  
								cellspacing="2">
								<tr>
									<td width="20%" colspan="1" class="formtext"><label  class = "set" name="employee" id="employee" ondblclick="callShowDiv(this);"><%=label.get("employee")%></label>:<s:hidden name="empCode" value="%{empCode}" /></td>
									<td width="80%" colspan="3"><s:textfield name="empToken"
										...
										onclick="javascript:callsF9(500,325,'SettlementMisReport_f9Employee.action');">
									</td>

								</tr>
								<tr>
									<td width="20%" colspan="1"  class="formtext"><label  class = "set" name="from" id="from" ondblclick="callShowDiv(this);"><%=label.get("from")%></label>:</td>
									...
									<td width="20%"  colspan="1" class="formtext"><label  class = "set" name="to" id="to" ondblclick="callShowDiv(this);"><%=label.get("to")%></label>:<s:hidden
										name="today" /></td>
								...
								<tr>
									...
									<td width="30%" colspan="1"><s:textfield size="20"
										theme="simple" name="settBranch" value="%{settBranch}"
										readonly="true" /> <img
										src="../pages/images/recruitment/search2.gif" height="16"
										align="absmiddle" width="16"
										onclick="javascript:callsF9(500,325,'SettlementMisReport_f9settBrnach.action');">
									<s:hidden name="settBranCode" value="%{settBranCode}" /></td>
									...
									<td width="30%" colspan="1"><s:textfield size="20"
										theme="simple" name="settDept" value="%{settDept}"
										readonly="true" /> <img
										src="../pages/images/recruitment/search2.gif" height="16"
										align="absmiddle" width="16"
										onclick="javascript:callsF9(500,325,'SettlementMisReport_f9settDept.action');">
									<s:hidden name="settDeptCode" value="%{settDeptCode}" /></td>
								</tr>
								...
								<tr>
									...
									<td width="30%" colspan="1"><s:textfield size="20"
										theme="simple" name="settDesg" readonly="true"
										value="%{settDesg}" /> <img
										src="../pages/images/recruitment/search2.gif" height="16"
										align="absmiddle" width="16"
										onclick="javascript:callsF9(500,325,'SettlementMisReport_f9settDesg.action');">
									<s:hidden name="settDesgCode" value="%{settDesgCode}" /></td>
									<td width="20%" colspan="1"><label  class = "set" name="division" id="division" ondblclick="callShowDiv(this);"><%=label.get("division")%></label> :</td>
									<td width="30%" colspan="1"><s:textfield size="20"
										theme="simple" name="settDiv" readonly="true"
										value="%{settDiv}" /> <img
										src="../pages/images/recruitment/search2.gif" height="16"
										align="absmiddle" width="16"
										onclick="javascript:callsF9(500,325,'SettlementMisReport_f9settDiv.action');">
									<s:hidden name="settDivCode" value="%{settDivCode}" /></td>

								</tr>
								<tr>
									<td width="20%" colspan="1"><label  class = "set" name="report" id="report" ondblclick="callShowDiv(this);"><%=label.get("report")%></label> :</td>
...
function callReportMis(){
  var frmDate=document.getElementById("paraFrm_frmDate").value;
    ...
    if((frmDate!="") && (toDate!="")) {
      ...
      document.getElementById('paraFrm').action="SettlementMisReport_report.action";
