...
<s:form action="SalarySlipMisReportGov" validate="true" id="paraFrm"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="4%" valign="bottom" class="txt"><strong
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">SalarySlip
							...
							<td>
								 <s:if test="%{salMisbean.generalFlag}">
								  	<input type="button" class="token" value=" Submit"
										   onclick="return callReport('SalarySlipMisReportGov_genreport.action');" />
								 </s:if>
								 <s:else>
								 	<input type="button" class="token" value=" Submit"
										  onclick="return callReport('SalarySlipMisReportGov_report.action');" />
								</s:else>
							...
							<table width="98%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<s:textfield name="salDivisionName" theme="simple" readonly="true"
										...
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9Division.action');">
									...
									<s:textfield name="salBranchName" theme="simple" readonly="true"
										...
										src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9Branch.action');">
								...
								<tr>
									...
									<td><s:hidden name="salDeptId" /> <s:textfield
										...
										src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9Dept.action');">
									</td>
									...
									<s:textfield name="salEmpTypeName" theme="simple"
										...
										src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9Emptype.action');">
								...
								<tr>
									...
									<img src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9designation.action');">
									</td>
									<td colspan="1" width="20%"><label class="set"
									...
									<img src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9paybill.action');">
									</td>
								</tr>
								<tr>
									<td>
									...
									<img src="../pages/images/recruitment/search2.gif"
										class="iconImage" height="18" align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9reportingTo.action');">	
									</td>
								</tr>
								</s:else>
								<tr>
									...
									<td colspan="3" width="80%"><s:hidden name="EmpCode" /> <s:textfield
										...
										<s:else> 
												<img src="../pages/images/recruitment/search2.gif"
													class="iconImage" height="18" align="absmiddle" width="18"
													onclick="javascript:callsF9(500,325,'SalarySlipMisReportGov_f9employee.action');">
										</s:else> 
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="1" width="30%"><s:select name="salarySlipFor"
										cssStyle="width:220"
										list="#{'S':'Salary (With arrears if paid with salary)','A':'Arrears (If paid separtely)'}" /></td>
									</td>
								</tr>
...
<script type="text/javascript">
	...
	function myonload()
	{
	 ...
	 function callFun(rowstart)
	 {
	 	  document.getElementById("paraFrm_recordFlag").value=true;
	   	  document.getElementById("paraFrm").action='SalarySlipMisReportGov_reportforLink.action?rangeValue='+eval(rowstart);
	...
	function resetScreen()
	{
				...
				document.getElementById('paraFrm').action="SalarySlipMisReportGov_reset.action";	
				document.getElementById('paraFrm').submit();	
				//document.getElementById('paraFrm').target="_self";	
	}
