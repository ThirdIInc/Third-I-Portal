				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formbg">
					...
					<tr>
						<td><label id="tomail" name="tomail" class="set" 
								   ondblclick="callShowDiv(this)"><%=label.get("tomail")%></label></b><font color="red">*</font> :</td>
						<td><s:textarea  name="tomail" rows="3" cols="30" /></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td><label id="subject" name="subject" class="set"
						 ondblclick="callShowDiv(this)"><%=label.get("subject")%></label></b><font color="red">*</font> :</td>
...
function sendmailFun(){
	...
	document.getElementById("paraFrm").action="EmployeeCardInfo_sendMailToVendor.action";
