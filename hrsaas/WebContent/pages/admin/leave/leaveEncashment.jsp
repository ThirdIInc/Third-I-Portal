	...
	<table width="100%" border="0" align="right" cellpadding="0"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td valign="bottom" class="txt"><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Leave Encashment Form</strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<s:if test="approvalFlag">
					<tr>
						<td width="78%">
							...
							onclick="javascript:callsF9(500,325,'LeaveEncashment_f9viewaction.action');" /> -->
							
							<input type="button" class="token" value=" Report"
								onclick="callReport('LeaveEncashment_report.action')" />
							</s:if>
							<!--<s:if test="isResult">
							<s:submit cssClass="add" action="LeaveEncashment_calculat" value="   Calculate" />
							</s:if> 
							<s:if test="status!='PD'">
							<input type="button" class="token" value=" Report"
								onclick="callReport('LeaveEncashment_report.action')" />
				...
				<s:elseif  test="approveStatusFlag=='PP'">
				<tr>
						<td width="78%">
				...
				<s:elseif  test="approveStatusFlag=='PR'">
				<tr>
						<td width="78%">
							<input type="button" class="token" value=" Back"
								onclick="callBack()" /> 
		...
		<s:if  test="approveStatusFlag=='PP'">

			<tr>
				<td colspan="4">
				<table width="100%" border="0" cellpadding="2" cellspacing="2" class="formbg">
					<tr>
						<td width="15%" class="formtext"><label
							name="approverComment" id="approverComment"
							ondblclick="callShowDiv(this);"><%=label.get("approverComment")%></label>
						<font color="red">*</font> :</td>
						<td width="85%"><s:textarea cols="70" rows="3"
							name="leaveEn.approverComments" /></td>
					</tr>
				</table>
				</td>
			</tr> 
						...
						<tr>
							...
							<td colspan="3">
								...
								<img id='ctrlHide' src="../pages/common/css/default/images/search2.gif"
									...
									onclick="javascript:callsF9(500,325,'LeaveEncashment_f9credits.action');"/>
							</td>
						...
						<td>
							<table border="0" width="100%"> 
								<tr>
									...
									<s:if test="statusFlag==''">
									<s:elseif  test="approveStatusFlag=='PD'||approveStatusFlag==''">
								...
								<tr>
									...
									<td width="" height="22" colspan="1">
										...
										<s:select theme="simple" name="status" disabled="true" cssStyle="width:150"
											list="#{'P':'Pending','A':'Approved','R':'Rejected','F':'Forwarded','N':'Cancelled'}" />
										<s:hidden name="level" />
									</td>
								</tr>
							</table>
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="1" cellspacing="1">
							...
							<tr>
								...
								<td class="formth"><label
								name="maxLimitofLeavestoEncash" id="maxLimitofLeavestoEncash"
								ondblclick="callShowDiv(this);"><%=label.get("maxLimitofLeavestoEncash")%></label></td>
								<!--
								<td class="formth"><label
...
<s:if test="isTotal">
			<tr>
				...
				<td></td>
				<td colspan="4" align="right">Total Rs.</td>
				...
				<tr>
					...
					<table border="0" width="100%">
						<tr>
							...
							<s:elseif  test="approveStatusFlag=='PA'||approveStatusFlag=='PP'">
									<s:textarea cols="70" rows="3" readonly="true"
									name="leaveEn.enComment"  cssStyle="background-color: #F2F2F2;"/>
							</s:elseif>
	...
	function calculate(k)
	{
		...
		var total=document.getElementById("total"+k).value;
			...
			else 
			{
				...
				document.getElementById("total"+k).value=Math.round(result*100)/100;
...
function onload1()	{
	try{
		...
		document.getElementById('paraFrm_leaveEn_totalAmt').value=total1;
	}
	catch(e){
		 alert(e);
	}
