<%@ taglib prefix="s" uri="/struts-tags" %>
  ...
  <table class="bodyTable" width="100%">
  	<tr>
  		<td  width="100%" colspan="5"  align="center" ><b><U>APPLICATION FOR LEAVE</U></td>
  	</tr>
  	<tr>
  	...
  	<tr><td colspan="5">
			 <table class="bodyTable" width="100%">
			  	<tr>  			
					<td class="bodyCell" style="background-color:gray" width="30%"><b><font size="1" >Leave Type</font></td>
					<td class="bodyCell" style="background-color:gray" width="20%"><b><font size="1" >Leave From Date</font></td>
					<td class="bodyCell" style="background-color:gray" width="20%"><b><font size="1" >Leave To Date</font></td>
					<td class="bodyCell" style="background-color:gray" width="10%"><b><font size="1" >Leave Days</font></td>
				</tr>	
	...
	<tr>
  	...
  	<tr><td width="10">8.&nbsp;&nbsp;</td>
  	    <td width="25%">Applicant Comments :</td>
