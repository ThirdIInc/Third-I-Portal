...
<s:form action="LWFConfigurationMaster" id="paraFrm" validate="true" target="main"
	theme="simple">
	<s:hidden name="show" value="%{show}" />
	<s:hidden name="hiddencode"  />
	<s:hidden name="lwfID" />
	<s:hidden name="configureState" />
	<s:hidden name="effectiveFrom" />
							...
							<table  width="100%" border="0" align="right" cellpadding="0" cellspacing="0" class="formbg" >
							    ...
							    <tr>
									  <td>
								    	 ...
								    	 <td width="93%" class="txt"><strong class="text_head">LWF Configuration</strong></td>
				...
				<table width="100%">
					<tr>
						...
						<td id="ctrlShow" width="30%" align="right" class="">
							...
							%>
							<a href="#" onclick="callPage('1', 'F', '<%=totalPage%>', 'LWFConfigurationMaster_input.action');">
								<img title="First Page" src="../pages/common/img/first.gif" width="10" height="10" class="iconImage"/>
							</a>&nbsp;
							<a href="#" onclick="callPage('P', 'P', '<%=totalPage%>', 'LWFConfigurationMaster_input.action');" >
								<img title="Previous Page" src="../pages/common/img/previous.gif" width="10" height="10" class="iconImage"/>
							</a> 
							<input type="text" name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>" maxlength="10"
							onkeypress="callPageText(event, '<%=totalPage%>', 'LWFConfigurationMaster_input.action');return numbersOnly();" /> of <%=totalPage%>
							<a href="#" onclick="callPage('N', 'N', '<%=totalPage%>', 'LWFConfigurationMaster_input.action')" >
								<img title="Next Page" src="../pages/common/img/next.gif" class="iconImage" />
							</a>&nbsp;
							<a href="#" onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'LWFConfigurationMaster_input.action');" >
		...
		<tr>
			<td colspan="3" width="100%">
				<table class="formbg" width="100%" cellspacing="0" cellspacing="1" border="0">
					<tr>
						<td colspan="2" class="txt"><strong class="text_head">LWF Configuration </strong></td>		
						<td  align="right">
							...
							class="formbg">
								...
								<table width="100%" border="0" cellpadding="1" cellspacing="1"
									...
									<tr class="td_bottom_border">
										...
										<td class="formth" align="center"><label name="configure.state"
											id="configure.state" ondblclick="callShowDiv(this);"><%=label.get("configure.state")%></label></td>
										
										 
										<td class="formth" align="center"><label name="effective.from"
											id="effective.from" ondblclick="callShowDiv(this);"><%=label.get("effective.from")%></label></td>
...
function addnewFun() {
		...
		document.getElementById('paraFrm').action = 'LWFConfigurationMaster_addNew.action';
	...
	function searchFun() {
		...
		document.getElementById("paraFrm").action ='LWFConfigurationMaster_f9action.action';
		document.getElementById("paraFrm").submit();
	}
	
	function reportFun() {
		document.getElementById('paraFrm').target = "_blank";
		document.getElementById('paraFrm').action = 'LWFConfigurationMaster_report.action';
		document.getElementById('paraFrm').submit();
	}
...
function oldRowColor(cell,val) {
  ...
  //alert(id);
  	callButton('NA', 'Y', 2);
	  	document.getElementById('paraFrm_lwfID').value=id;
	   	document.getElementById("paraFrm").action="LWFConfigurationMaster_calforedit.action";
	...
	function chkDelete()
	{
	 ...
	 if(con){
	   document.getElementById('paraFrm').action="LWFConfigurationMaster_delete1.action";
	   document.getElementById('paraFrm').target = "_self";
	    document.getElementById('paraFrm').submit();
	    }
	    else
...
function chk(){
  ...
  // alert ('x');
		...
		document.getElementById("paraFrm").target = 'myWin';
		document.getElementById("paraFrm").action = 'LWFConfigurationMaster_'+action+'.action';
		document.getElementById("paraFrm").submit();
	}
