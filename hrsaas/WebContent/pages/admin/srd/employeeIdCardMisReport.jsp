...
<s:form action="EmployeeIdCardMisReport" method="post" id="paraFrm" theme="simple">
	<s:hidden name="reportAction" value='EmployeeIdCardMisReport_businessReport.action' />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"> <img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Employee Id
					Card MIS Report </strong></td>
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td colspan="2"><s:hidden name="divCode" theme="simple" /><s:textarea
									...
									<td width="35%" align="left"><img
										...
										onclick="javascript:callDropdown('paraFrm_divsion',350,250,'EmployeeIdCardMisReport_f9MultiDiv.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									<td width="20%"><label class="set" name="department"
										id="department" ondblclick="callShowDiv(this);"><%=label.get("department")%></label>:</td>
									<td colspan="2"><s:hidden name="deptCode" theme="simple" /><s:textarea
										name="deptName" theme="simple" readonly="true" rows="1"
										cols="100"></s:textarea></td>
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_deptName',350,250,'EmployeeIdCardMisReport_f9MultiDept.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									<td width="20%"><label class="set" name="branch"
										id="branch" ondblclick="callShowDiv(this);"><%=label.get("branch")%></label>:</td>
									<td colspan="2"><s:hidden name="centerId" theme="simple" /><s:textarea
										name="centerName" theme="simple" readonly="true" rows="1"
										cols="100"></s:textarea></td>
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_centerName',350,250,'EmployeeIdCardMisReport_f9Brch.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									<td width="20%"><label class="set" name="designation"
										id="designation" ondblclick="callShowDiv(this);"><%=label.get("designation")%></label>:</td>
									<td colspan="2"><s:hidden name="desgCode" theme="simple" /><s:textarea
										name="desgName" theme="simple" readonly="true" rows="1"
										cols="100"></s:textarea></td>
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_desgName',350,250,'EmployeeIdCardMisReport_f9MultiRank.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									<td width="20%" colspan="1"><label class="set"
										name="employee" id="employee" ondblclick="callShowDiv(this);"><%=label.get("employee")%></label>:</td>
									<td colspan="3"><s:textfield theme="simple" name="token"
										readonly="true" size="20"></s:textfield><s:hidden
										theme="simple" name="empid" /><s:textfield theme="simple"
										name="empName" readonly="true" size="70"></s:textfield> <img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'EmployeeIdCardMisReport_f9action.action');"></td>
								</tr>
								<tr>
									...
									<td><s:select name="status" headerKey="-1"
										headerValue="--Select--"
										list="#{'A':'Approved','B':'Send Back','R':'Rejected','P':'Pending'}"></s:select></td>
								</tr>
							</table>
							</td>
...
<script type="text/javascript">
	...
	document.getElementById('paraFrm').action='EmployeeIdCardMisReport_report.action';
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target="main";
	}
	function callReset(){
  	document.getElementById('paraFrm').target='_self';
	document.getElementById('paraFrm').action='EmployeeIdCardMisReport_clear.action';
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target="_self";
	}
	...
	callReportCommon(type);		
 	...
 	function mailReportFun(type)
 	{
		...
		document.getElementById('paraFrm').action='RequestBusinessCardMisReport_mailReport.action';
		document.getElementById('paraFrm').submit();
		//return true;
	}
