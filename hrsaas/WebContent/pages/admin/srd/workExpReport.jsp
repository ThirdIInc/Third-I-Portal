...
<s:form action="WorkExp" id="paraFrm" target="main" >
<table width="100%" border="0">
<tr>
 <td width="100%" colspan="4" class="pageHeader" align="center" >Employee Work Experience</td>
</tr>
<tr> 	  
...
<tr>
 ...
 <tr>
  <td width="45%">&nbsp;</td>
  <td>
   <s:submit cssClass="pagebutton" cssClass="button" theme="simple"  value='Report' action="WorkExp_report"  />
  </td>
 </tr>
