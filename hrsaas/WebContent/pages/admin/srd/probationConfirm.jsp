...
<s:form action="ProbationConfirmation" validate="true" id="paraFrm"
								...
								<table width="99%" border="0" align="center" cellpadding="0"
									...
									<tr>
										<td height="27" class="formtxt"><a
											href="ProbationConfirmation_callstatus.action?status=P">Pending
										Confirmation Due List</a> | <a
											href="ProbationConfirmation_callstatus.action?status=C">Confirmed
										List</a> | <a
											href="ProbationConfirmation_callstatus.action?status=E">Extended
										Probation List</a> | <a
											href="ProbationConfirmation_callstatus.action?status=T">Terminated
										List</a></td>
									</tr>
								</table>
								</td>
 ...
 %> <a href="#"
							onclick="callPage('1', 'F', '<%=totalPage%>', 'ProbationConfirmation_callPage.action');">
						<img title="First Page" src="../pages/common/img/first.gif"
							width="10" height="10" class="iconImage" /> </a>&nbsp; <a href="#"
							onclick="callPage('P', 'P', '<%=totalPage%>', 'ProbationConfirmation_callPage.action');">
						<img title="Previous Page" src="../pages/common/img/previous.gif"
							width="10" height="10" class="iconImage" /> </a> <input type="text"
							name="pageNoField" id="pageNoField" size="3" value="<%=pageNo%>"
							maxlength="10"
							onkeypress="callPageText(event, '<%=totalPage%>', 'ProbationConfirmation_callPage.action');return numbersOnly();" />
						of <%=totalPage%> <a href="#"
							onclick="callPage('N', 'N', '<%=totalPage%>', 'ProbationConfirmation_callPage.action')">
						<img title="Next Page" src="../pages/common/img/next.gif"
							class="iconImage" /> </a>&nbsp; <a href="#"
							onclick="callPage('<%=totalPage%>', 'L', '<%=totalPage%>', 'ProbationConfirmation_callPage.action');">
					...
					<s:iterator value="list">
						<tr class="sortableTD">
							<td width="10%" align="left" class="sortableTD"><%=++cn%> <s:hidden
								name="ittprobationCode" /><s:hidden name="ittprobationStatus" /></td>
							...
							<td class="sortableTD" width="10%"><input type="button"
								class="token" value="View Details"
								onclick="viewDetails('<s:property value="employeeId"/>','<s:property value="ittprobationCode"/>','<s:property value="ittprobationStatus"/>');" /></td>
						</tr>
						<%
						y++;
						%>
					...
					<tr>
						...
						<table width="98%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<s:textfield readonly="true" name="employeeName" size="86" /><s:hidden
									name="empId" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="20%" colspan="1"><label name="current grade"
									id="current grade" ondblclick="callShowDiv(this);"><%=label.get("current grade")%></label>:</td>
								<td width="30%" colspan="1"><s:textfield
								...
								<td width="20%" colspan="1"><label name="new grade"
									id="new grade" ondblclick="callShowDiv(this);"><%=label.get("new grade")%></label>:</td>
			...
			<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="2"
					...
					<tr>
						...
						<td colspan="1" width="4%" nowrap="nowrap"><img
							class="iconImage" src="../pages/images/recruitment/search2.gif"
							width="16" id="ctrlHide" height="15" border="0"
						...
						:<font color="red">*</font></td>
						<td colspan="1" width="15%" nowrap="nowrap"><s:textfield
					...
					<tr>
						<td colspan="4" align="center"><s:submit
							value=" Generate Confirmation Letter "
