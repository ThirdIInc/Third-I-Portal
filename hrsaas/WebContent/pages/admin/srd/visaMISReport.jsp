...
<s:form action="VisaMISReport" method="post" id="paraFrm"
	theme="simple">
	<s:hidden name="report" />
	<s:hidden name="reportAction" value='VisaMISReport_getReport.action' />
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"> <img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Visa MIS Report</strong></td>
							...
							<table width="100%" border="0" align="center" cellpadding="1"
								...
								<tr>
									...
									<td width="35%"><img src="../pages/images/search2.gif"
										...
										onclick="javascript:callDropdown('paraFrm_divsion',350,250,'VisaMISReport_f9div.action',event,'false','no','right')">
									</td>
								...
								<tr>
									...
									<td width="35%"><img src="../pages/images/search2.gif"
										class="iconImage" height="16" align="absmiddle" width="16"
										onclick="javascript:callDropdown('paraFrm_deptName',350,250,'VisaMISReport_f9dept.action',event,'false','no','right')">
									</td>
								</tr>
								<!-- BRANCH   -->
								...
								<tr>
									...
									<td width="35%"><img src="../pages/images/search2.gif"
										class="iconImage" height="16" align="absmiddle" width="16"
										onclick="javascript:callDropdown('paraFrm_centerName',350,250,'VisaMISReport_f9center.action',event,'false','no','right')">
									</td>
								...
								<tr>
									...
									<td width="35%"><img src="../pages/images/search2.gif"
										class="iconImage" height="16" align="absmiddle" width="16"
										onclick="javascript:callDropdown('paraFrm_desgName',350,250,'VisaMISReport_f9desg.action',event,'false','no','right')">
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3" ><s:textfield theme="simple" size="22"
										name="empToken" readonly="true" /><s:hidden
										theme="simple" name="empid" />
										<s:textfield theme="simple" name="empName" size="70"
										readonly="true" /> <img
...
<script type="text/javascript">
	...
	/*function callMisReport(){
		...
		document.getElementById('paraFrm').action='VisaMISReport_report.action';
	...
	function callReset(){
		...
		document.getElementById('paraFrm').action='VisaMISReport_clear.action';
		document.getElementById('paraFrm').submit();
		document.getElementById('paraFrm').target="_self";
	}
	...
	try{
	 ...
	 function mailReportFun(type){
		document.getElementById('paraFrm_report').value=type;
		document.getElementById('paraFrm').action='VisaMISReport_mailReport.action';
		document.getElementById('paraFrm').submit();
