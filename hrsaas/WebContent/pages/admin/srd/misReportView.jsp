...
<s:form action="MISReport" validate="true" id="paraFrm"
	theme="simple">
	<table width="100%" border="0" align="right" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td width="93%" class="txt"><strong class="text_head">HR MIS
					Report</strong></td>
		...
		<s:hidden name="misreport.marriageDateFlag"/>
		...
		<s:hidden name="misreport.bloodGrpFlag" />
		<s:hidden name="misreport.marStatusFlag" />
		<s:hidden name="misreport.religionFlag" />
		<s:hidden name="misreport.catagoryFlag" />
		<s:hidden name="misreport.casteFlag" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td height="27" class="text_head"><strong>HR MIS Report </strong></td>
							<%
...
function callReportForDisp(reportType)
{
 document.getElementById('paraFrm_reportType').value=reportType;
   callReport('MISReport_report.action');    
}
...
function callBack(){
	...
	var thenBy1 = document.getElementById('paraFrm_thenBy1').value;
  	...
  	document.getElementById('paraFrm').action='MISReport_callBack.action';
  	document.getElementById('paraFrm').submit(); 
}
