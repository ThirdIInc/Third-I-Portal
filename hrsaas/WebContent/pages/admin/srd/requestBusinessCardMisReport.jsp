...
<s:form action="RequestBusinessCardMisReport" method="post" id="paraFrm"
	theme="simple">
	<s:hidden name="reportAction"
		value='RequestBusinessCardMisReport_businessReport.action' />
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="35%" align="left"><img
										...
										onclick="javascript:callDropdown('paraFrm_divsion',350,250,'RequestBusinessCardMisReport_f9MultiDiv.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									...
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_deptName',350,250,'RequestBusinessCardMisReport_f9MultiDept.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									...
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_centerName',350,250,'RequestBusinessCardMisReport_f9Brch.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									...
									<td width="35%" align="left"><img
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callDropdown('paraFrm_desgName',350,250,'RequestBusinessCardMisReport_f9MultiRank.action',event,'false','no','right')"></td>
								</tr>
								<tr>
									...
									<td colspan="3"><s:textfield theme="simple" name="token"
										...
										src="../pages/images/recruitment/search2.gif" height="18"
										align="absmiddle" width="18"
										onclick="javascript:callsF9(500,325,'RequestBusinessCardMisReport_f9action.action');"></td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	document.getElementById('paraFrm').action='RequestBusinessCardMisReport_report.action';
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target="main";
	}
	function callReset(){
  	document.getElementById('paraFrm').target='_self';
	document.getElementById('paraFrm').action='RequestBusinessCardMisReport_clear.action';
	document.getElementById('paraFrm').submit();
	document.getElementById('paraFrm').target="_self";
	}
