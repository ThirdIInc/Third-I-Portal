<%@ taglib prefix="s" uri="/struts-tags" %>
 ...
 <s:form action="FamilyPensionNom" id="paraFrm" >
...
<tr>
<tr>
 <td width="100%" colspan="4" class="pageHeader" align="center" >Family Pension Nomination Report</td>
 </tr>
<tr> 	  
<td width="32%" align="right">Select the Employee :
	...
	<s:if test="fpn.viewFlag"><img src="../pages/images/search.gif" class="iconImage" height="18" align="absmiddle"	width="18" onclick="javascript:callsF9(500,325,'FamilyPensionNom_f9type.action');">	
</s:if>
</td>
</tr>
...
<script >
 function call(){   
			...
			document.getElementById('paraFrm').action='FamilyPensionNom_report.action';	
