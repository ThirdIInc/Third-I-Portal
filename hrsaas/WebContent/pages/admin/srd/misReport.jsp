...
<s:form action="MISReport" validate="true" id="paraFrm" theme="simple">
			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">HR
					MIS Report </strong><s:hidden name="hiddenColumns" /></td>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="formbg"
				...
				<tr>
					...
					<td width="25%"><s:textfield name="misreport.savedReport"
						size="30" readonly="true" /></td>
					<td align="left"><s:hidden name="misreport.reportId" /><img
						src="../pages/images/recruitment/search2.gif" class="iconImage"
						height="14" width="14" theme="simple"
						onclick="javascript:callsF9(500,325,'MISReport_searchSavedReport.action');" />
					</td>
					<td></td>
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							:</td>
							<td colspan="1"><s:textfield size="15"
						...
						<tr>
							<td width="20%" colspan="1"><label class="set" name="gender"
						...
						<!-- BIRTHDAY IN MONTH & BLOOD GROUP -->
						<tr>
							<td width="20%" colspan="1"><label class="set"
								name="birthdays.month" id="birthdays.month"
								ondblclick="callShowDiv(this);"><%=label.get("birthdays.month")%></label>:</td>
							<td colspan="1"><s:select name="misreport.bDayMonth"
								cssStyle="width:157" headerKey="0"
								headerValue="------Select------"
								list="#{'01':'January','02':'February','03':'March','04':'April','05':'May',
								'06':'June','07':'July','08':'August','09':'September','10':'October',
								'11':'November','12':'December'}" /></td>
							<td width="20%" colspan="1"><label class="set"
						...
						<!-- STATUS -->
						<tr>
							<td width="20%" colspan="1"><label class="set" name="status"
								id="status" ondblclick="callShowDiv(this);"><%=label.get("status")%></label>
							:</td>
							<td colspan="3"><s:select name="misreport.status"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="25%" colspan="2"><img
								...
								onclick="javascript:callDropdown('paraFrm_rankName',350,250,'MISReport_f9desg.action',event,'false','no','right')"></td>
						</tr>
						...
						<tr>
							...
							<td width="25%" colspan="2"><img
								...
								onclick="javascript:callDropdown('paraFrm_payBillName',350,250,'MISReport_f9payBillaction.action',event,'false','no','right')" /></td>
						</tr>
						<!-- BRANCH -->
						<tr>
							...
							<s:textarea cols="70" rows="1" name="centerName" readonly="true" /></td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_centerName',350,250,'MISReport_f9Branch.action',event,'false','no','right')"></td>
						</tr>
						<!-- DEPARTMENT-->
						<tr>
							<td width="20%" colspan="1"><label class="set"
							...
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_deptName',350,250,'MISReport_f9deptaction.action',event,'false','no','right')" /></td>
						</tr>
						<!-- DIVISION -->
						<tr>
							<td width="20%" colspan="1"><label class="set"
							...
							<td width="10%" colspan="1"><s:hidden name="divCode" /> <s:textarea
								cols="70" rows="1" name="divName" readonly="true" /></td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_divName',350,250,'MISReport_f9divaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!-- EMPLOYEE TYPE-->
						<tr>
							...
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_typeName',350,250,'MISReport_f9typeaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!-- SHIFT -->
						<tr>
							<td width="20%" colspan="1"><label class="set" name="shift"
							...
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" class="iconImage"
								height="14" width="14" theme="simple"
								onclick="javascript:callDropdown('paraFrm_shiftType',350,250,'MISReport_f9shiftaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!--REPORTING TO-->
						<tr>
							...
							<s:hidden value="%{misreport.reportingToken}"
								name="misreport.reportingToken" /> <s:textarea cols="70"
								rows="1" name="reportingTo" readonly="true" /></td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_reportingTo',350,250,'MISReport_f9reporingToaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!-- RELIGION -->
						<tr>
							<td width="20%" colspan="1"><label class="set"
								name="religion" id="religion1" ondblclick="callShowDiv(this);"><%=label.get("religion")%></label>:</td>
							<td width="10%" colspan="1"><s:hidden name="religionCode" />
							<s:textarea cols="70" rows="1" name="religion" readonly="true" />
							</td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_religion',350,250,'MISReport_f9relgnaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!-- CASTE-->
						<tr>
							<td width="20%" colspan="1"><label class="set" name="caste"
								id="caste1" ondblclick="callShowDiv(this);"><%=label.get("caste")%></label>:</td>
							<td width="10%" colspan="1"><s:hidden name="castCode" /> <s:textarea
								cols="70" rows="1" name="castName" readonly="true" /></td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_castName',350,250,'MISReport_f9castaction.action',event,'false','no','right')" />
							</td>
						</tr>
						<!-- CASTE CATEGORY-->
						<tr>
							<td width="20%" colspan="1"><label class="set"
								name="caste.category" id="caste.category"
								ondblclick="callShowDiv(this);"><%=label.get("caste.category")%></label>:</td>
							<td width="10%" colspan="1"><s:hidden
								name="castCategoryCode" /> <s:textarea cols="70" rows="1"
								name="castCategory" readonly="true" /></td>
							<td width="25%" colspan="2"><img
								src="../pages/images/recruitment/search2.gif" width="16"
								height="15" class="iconImage"
								onclick="javascript:callDropdown('paraFrm_castCategory',350,250,'MISReport_f9castCataction.action',event,'false','no','right')" />
							</td>
						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td align="right" colspan="1"><label class="set" name="role"
								id="role" ondblclick="callShowDiv(this);"><%=label.get("role")%></label>
							:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.roleFlag" onclick="AddItem('role',this);" /></td>
							<td align="right" colspan="1"><label class="set"
								name="trade" id="trade" ondblclick="callShowDiv(this);"><%=label.get("trade")%></label>
							:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.tradeFlag" onclick="AddItem('trade',this);" /></td>
						...
						<!--
							<tr>
								...
								<td colspan="5"><s:checkbox theme="simple"
						...
						-->
						<!-- GENDER,BLOOD GROUP,MARITAL STATUS,RELIGION -->
						<tr>
							<td align="right" colspan="1"><label class="set"
							...
							<td align="right" colspan="1"><label class="set"
								...
								ondblclick="callShowDiv(this);"><%=label.get("blood.group")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.bloodGrpFlag"
								onclick="AddItem('blood.group1',this);" /></td>
							<td align="right" colspan="1"><label class="set"
								name="marital.status" id="marital.status1"
								ondblclick="callShowDiv(this);"><%=label.get("marital.status")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.marStatusFlag"
								onclick="AddItem('marital.status1',this);" /></td>
							<td align="right" colspan="1"><label class="set"
								name="religion11" id="religion11"
								ondblclick="callShowDiv(this);"><%=label.get("religion11")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.religionFlag"
								onclick="AddItem('religion1',this);" /></td>
						</tr>
						<!-- CASTE CATEGORY,CASTE,MOBILE NO,EMAIL ID -->
						<tr>
							<td align="right" colspan="1"><label class="set"
								name="caste.category" id="caste.category1"
								ondblclick="callShowDiv(this);"><%=label.get("caste.category")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.catagoryFlag"
								onclick="AddItem('caste.category1',this);" /></td>
							<td align="right" colspan="1"><label class="set"
								name="caste11" id="caste11" ondblclick="callShowDiv(this);"><%=label.get("caste11")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.casteFlag" onclick="AddItem('caste11',this);" /></td>
							<td align="right" colspan="1"><label class="set"
							...
							<td align="right" colspan="1"><label class="set"
								name="email.id11" id="email.id11"
								ondblclick="callShowDiv(this);"><%=label.get("email.id11")%></label>:</td>
							<td colspan="1"><s:checkbox theme="simple"
								name="misreport.emailFlag" onclick="AddItem('email.id11',this);" /></td>
						</tr>
						<tr>
							<td align="right" colspan="1"><label class="set"
								name="marriagedate" id="marriagedate"
								ondblclick="callShowDiv(this);"><%=label.get("marriagedate")%></label>:</td>
							<td colspan="5"><s:checkbox theme="simple"
								name="misreport.marriageDateFlag"
								onclick="AddItem('marriagedate',this);" /></td>
						</tr>
					...
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tr>
							...
							<td width="449" id="toDatePicker1"><s:a
								...
								<img class="iconImage"
									onclick="displayDate('paraFrm_misreport_DOBToDate');"
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							...
							<td width="449" id="toDatePicker2"><s:a
								...
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									onclick="displayDate('paraFrm_misreport_regularToDate');"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
						</tr>
					</table>
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							...
							<td width="449" id="toDatePicker3"><s:a
								...
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									onclick="displayDate('paraFrm_misreport_confToDate');"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
						</tr>
					</table>
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							...
							<td width="449" id="toDatePicker4"><s:a
								...
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									onclick="displayDate('paraFrm_misreport_leaveToDate');"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
						</tr>
					</table>
					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							...
							<td width="449" id="toDatePicker5"><s:a
								...
								<img class="iconImage"
									src="../pages/images/recruitment/Date.gif" width="16"
									onclick="displayDate('paraFrm_misreport_groupjoinToDate');"
									height="16" border="0" align="absmiddle" />
							</s:a></td>
						</tr>
					</table>
...
function dateDifferenceEqual(fromDate, toDate, fieldName, fromLabName, toLabName){
		...
		try{
   	  ...
   	  // == end of sort======
  		...
  		if(document.getElementById("reportViewV").checked){
	 		...
	 		document.getElementById('paraFrm').action="MISReport_viewOnScreen.action";
     		document.getElementById('paraFrm').submit();
		}else{
		  	document.getElementById('paraFrm').target='_blank';
			document.getElementById('paraFrm').action="MISReport_report.action";
			document.getElementById('paraFrm').submit();
	...
	function resetForm()
	{
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="MISReport_reset.action";
		document.getElementById('paraFrm').submit();
	...
	function saveReport(){
		...
		document.getElementById('paraFrm').target='main';
		document.getElementById('paraFrm').action="MISReport_saveReport.action";
		document.getElementById('paraFrm').submit();
