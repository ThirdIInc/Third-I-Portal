...
<s:form action="AlertClientSetting" method="post"
	name="AlertClientSettings" validate="true" id="paraFrm" theme="simple">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="20%" colspan="1"><label class="set" name="subject" id="subject"
						ondblclick="callShowDiv(this);"><%=label.get("subject")%></label></td>
				...
				<tr>
					<td width="20%"><label class="set" name="modName" id="modName"
						ondblclick="callShowDiv(this);"><%=label.get("modName")%></label></td>
				...
				<tr>
					<td width="20%"><label id="lbDuration" name="lbDuration"
						ondblclick="callShowDiv(this);"><%=label.get("lbDuration")%></label>
					...
					<td id="jobDayOfWeek1" width="20%" style="display: none;"><label
						...
						ondblclick="callShowDiv(this);"><%=label.get("lbDayOfWeek")%></label>
					:<font color="RED">*</font></td>
					...
					<td id="jobDayOfMonth1" width="20%" style="display: none;"><label
						...
						ondblclick="callShowDiv(this);"><%=label.get("lbDayOfMonth")%></label>
					:<font color="RED">*</font></td>
				...
				<tr>
					<td width="20%"><label id="lbStartTime" name="lbStartTime"
						ondblclick="callShowDiv(this);"><%=label.get("lbStartTime")%></label>
					:<font color="RED">*</font></td>
...
function stopschedulingFun() {
		...
		if(stopScheduler) {
			...
			document.getElementById('paraFrm').action = 'AlertClientSetting_stopScheduling.action';
...
var hiddenJobCode =document.getElementById('paraFrm_hiddenJobCode').value;
  ...
  if(hiddenJobCode=="")
  {
  	alert("Please search record");
		...
		document.getElementById('paraFrm').target = '_self';
		document.getElementById('paraFrm').action = 'AlertClientSetting_startScheduling.action';
	  	document.getElementById('paraFrm').submit();
