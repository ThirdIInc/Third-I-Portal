			...
			<table width="100%" border="0" align="right" cellpadding="0"
				...
				<tr>
					<td><strong class="text_head"><img
						...
						height="25" /></strong></td>
					<td width="93%" class="txt"><strong class="text_head">Component
					List </strong></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr class="td_bottom_border">
					...
					<td width="80%" valign="top" class="formth">Debit Heads </td>
				...
				<s:iterator value="bean.arr">
					<tr class="sortableTD">
						...
						<td class="sortableTD" width="80%"><input type="hidden"
							value='<s:property value="debitName"/>' id="debitName<%=y%>" />
						<s:property value="debitName" /></td>
...
var textId1=document.getElementById('hiddenfrmId').value;
		...
		function callClear(){
		try{
  ///alert(opener.document.getElementById('paraFrm_debitCode').value);
	///     alert(opener.document.getElementById('paraFrm_debitName').value);	
	 opener.document.getElementById('paraFrm_debitCode').value="";
    opener.document.getElementById('paraFrm_debitName').value="";
	window.close();	
	} catch(e){
		alert(e);
	}
...
function setValue()
{
	...
	//alert(getValue);
	 var value='<%=z%>'; 
      var oldval = opener.document.getElementById('paraFrm_debitName').value;
     // alert(oldval);
