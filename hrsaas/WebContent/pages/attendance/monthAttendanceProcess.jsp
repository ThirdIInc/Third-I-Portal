...
<s:form action="MonthAttendanceProcess" name="MonthAttendanceProcess" validate="true" id="paraFrm" target="main" theme="simple">
		...
		<tr>
			<td width="100%">
				<table width="100%">
					<tr>
						<td>
							<s:submit action="MonthAttendanceProcess_attendanceProcess" value="Process" cssClass="token" 
							title="Process the attendance" onclick="return attendanceProcess()" />
							<s:submit action="MonthAttendanceProcess_reset" value="Reset" cssClass="reset" title="Clear the fields" />
						</td>
								...
								<s:if test="divisionFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'MonthAttendanceProcess_f9Division.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="branchFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'MonthAttendanceProcess_f9Branch.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="departmentFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'MonthAttendanceProcess_f9Department.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="employeeTypeFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'MonthAttendanceProcess_f9EmployeeType.action');">
										</td>
									</tr>
								</s:if>
								...
								<s:if test="payBillFlag">
									<tr>
										...
										<td>
											...
											onclick="callsF9(500,325,'MonthAttendanceProcess_f9PayBill.action');">
										</td>
									</tr>
								</s:if>
