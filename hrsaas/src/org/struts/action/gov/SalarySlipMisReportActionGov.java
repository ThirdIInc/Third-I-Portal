...
import org.paradyne.model.gov.SalarySlipMisReportModelGov;
import org.struts.lib.ParaActionSupport;

public class SalarySlipMisReportActionGov extends ParaActionSupport {
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
	.getLogger(SalarySlipMisReportActionGov.class);
	
	SalarySlipMisReportGov salMisbean;
	...
	public SalarySlipMisReportGov getSalMisbean() {
		return salMisbean;
	}

	public void setSalMisbean(SalarySlipMisReportGov salMisbean) {
		this.salMisbean = salMisbean;
	}

	@Override
	public void prepare_local() throws Exception {
		salMisbean = new SalarySlipMisReportGov();
		salMisbean.setMenuCode(2279);
	...
	public String input() throws Exception {
		SalarySlipMisReportModelGov model = new SalarySlipMisReportModelGov();
