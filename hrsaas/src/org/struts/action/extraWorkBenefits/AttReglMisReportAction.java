 ...
 * @date 23-03-2010
 */
public class AttReglMisReportAction extends ParaActionSupport {
	AttReglMisReport misreport;
	
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
	.getLogger(org.struts.lib.ParaActionSupport.class);
	
	public void prepare_local() throws Exception {
		misreport = new AttReglMisReport();
		misreport.setMenuCode(1011);
	}
	
	public AttReglMisReport getModel() {
		return misreport;
	}
	...
	public String f9division() throws Exception {
		...
		String submitToMethod = "AttendanceReglMISReport_chk.action";
	...
	public String f9employee() throws Exception {
		...
		String submitToMethod = "AttendanceReglMISReport_chk1.action";
	...
	public String saveReport() throws Exception {
		AttReglMisReportModel model = new AttReglMisReportModel();
	...
	public String reset() throws Exception {
		...
		misreport.setActInFlag("");
		misreport.setActOutFlag("");
		misreport.setRecorderInFlag("");
		misreport.setRecorderOutFlag("");
		misreport.setCommentFlag("");
		misreport.setReasonFlag("");
	...
	public String searchSavedReport() throws Exception {
		...
		String query = " SELECT REPORT_CRITERIA, NVL(REPORT_TITLE,' '), REPORT_ID FROM  HRMS_MISREPORT_HDR "
				+ " WHERE REPORT_TYPE = 'AttendanceRegl'  ORDER BY  REPORT_ID ";
		 ...
		 */
		String submitToMethod = "AttendanceReglMISReport_setDetails.action";
	...
	public AttReglMisReport getMisreport() {
		return misreport;
	}

	public void setMisreport(AttReglMisReport misreport) {
	...
	public String viewOnScreen() {
		...
		try{
			...
			String labelNames[] = {getMessage("name"), getMessage("division"),
					...
					getMessage("application.date"), getMessage("attendance.date"),
					getMessage("application.status"),
					getMessage("actualin.time"), getMessage("actualout.time"),
					getMessage("application.reason"),
					getMessage("recordedin.time"), getMessage("recordedout.time")};
