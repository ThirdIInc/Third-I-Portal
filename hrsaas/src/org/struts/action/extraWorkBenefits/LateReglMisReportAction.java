...
import org.paradyne.model.extraWorkBenefits.LateReglMisReportModel;
...
public class LateReglMisReportAction extends ParaActionSupport {
	LateReglMisReport misreport;
	
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
	.getLogger(org.struts.lib.ParaActionSupport.class);
	
	public void prepare_local() throws Exception {
		misreport = new LateReglMisReport();
		misreport.setMenuCode(1016);
	}
	
	public LateReglMisReport getModel() {
		return misreport;
	}

	public LateReglMisReport getMisreport() {
		return misreport;
	}

	public void setMisreport(LateReglMisReport misreport) {
	...
	public String f9division() throws Exception {
		...
		String submitToMethod = "LateReglMISReport_chk.action";
	...
	public String f9employee() throws Exception {
		...
		String submitToMethod = "LateReglMISReport_chk1.action";
	...
	public String saveReport() throws Exception {
		LateReglMisReportModel model = new LateReglMisReportModel();
	...
	public String searchSavedReport() throws Exception {
		...
		String query = " SELECT REPORT_CRITERIA, NVL(REPORT_TITLE,' '), REPORT_ID FROM  HRMS_MISREPORT_HDR "
				+ " WHERE REPORT_TYPE = 'LateRegl'  ORDER BY  REPORT_ID ";
		 ...
		 */
		String submitToMethod = "LateReglMISReport_setDetails.action";
	...
	public String viewOnScreen() {
		...
		try{
			...
			String labelNames[] = {getMessage("name"), getMessage("division"),
					...
					getMessage("application.status"),getMessage("login.time"), 
					getMessage("latehrs"),getMessage("latehrsdeductfrom")};
			//CALL TO MODEL
