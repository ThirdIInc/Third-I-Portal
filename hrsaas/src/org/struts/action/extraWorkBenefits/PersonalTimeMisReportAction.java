...
import org.paradyne.model.extraWorkBenefits.PersonalTimeMisReportModel;
...
public class PersonalTimeMisReportAction extends ParaActionSupport {

	PersonalTimeMisReport misreport;
	
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
	.getLogger(org.struts.lib.ParaActionSupport.class);
	
	public void prepare_local() throws Exception {
		misreport = new PersonalTimeMisReport();
		misreport.setMenuCode(1020);
	}
	
	public PersonalTimeMisReport getModel() {
		return misreport;
	}

	public PersonalTimeMisReport getMisreport() {
		return misreport;
	}

	public void setMisreport(PersonalTimeMisReport misreport) {
	...
	public String f9division() throws Exception {
		...
		String submitToMethod = "PersonalTimeMISReport_chk.action";
	...
	public String f9employee() throws Exception {
		...
		String submitToMethod = "PersonalTimeMISReport_chk1.action";
	...
	public String saveReport() throws Exception {
		PersonalTimeMisReportModel model = new PersonalTimeMisReportModel();
	...
	public String reset() throws Exception {
		...
		misreport.setFromDateFlag("");
		misreport.setFromTimeFlag("");
		misreport.setToTimeFlag("");
		misreport.setTotalTimeFlag("");
		...
		misreport.setTime1DateSelect("");
		misreport.setTime1FromDate("");
		misreport.setTime1ToDate("");
	...
	public String searchSavedReport() throws Exception {
		...
		String query = " SELECT REPORT_CRITERIA, NVL(REPORT_TITLE,' '), REPORT_ID FROM  HRMS_MISREPORT_HDR "
				+ " WHERE REPORT_TYPE = 'PersonalTime'  ORDER BY  REPORT_ID ";
		 ...
		 */
		String submitToMethod = "PersonalTimeMISReport_setDetails.action";
	...
	public String viewOnScreen() {
		...
		try{
			...
			String labelNames[] = {getMessage("name"), getMessage("division"),
					...
					getMessage("fromdate"), 
					getMessage("fromtime"),getMessage("totime"),
					getMessage("totaltime")};
			//CALL TO MODEL
