...
public class GlodyneForgotPwdAction extends ActionSupport implements
	...
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(GlodyneForgotPwdAction.class);
	...
	public void getForgotPassQue() {
		...
		try {
			...
			Object[][] userLoginCode = loginModel.getSqlModel()
					.getSingleResult(userLoginCodeQuery);
			...
			Object[][] questionObj = loginModel.getSqlModel().getSingleResult(
					forgotPassQue);
			if (questionObj != null && questionObj.length > 0) {
				loginBean.setForgotPassQueCode(String
						.valueOf(questionObj[0][0]));
	...
	public String submitForgot() throws Exception {
		...
		try {
			...
			if (result.equals("invalidUserName")) {
				reset();
				addActionMessage("The Username does not exist.");
			}
