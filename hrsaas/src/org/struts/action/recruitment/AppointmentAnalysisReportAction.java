...
import org.paradyne.model.recruitment.AppointmentAnalysisReportModel;
 
import org.struts.lib.ParaActionSupport;

public class AppointmentAnalysisReportAction extends ParaActionSupport {

	AppointmentAnalysisReport bean;
		@Override
		public void prepare_local() throws Exception {
			// TODO Auto-generated method stub
			bean=new AppointmentAnalysisReport();
			bean.setMenuCode(920);
		...
		public AppointmentAnalysisReport getBean() {
			return bean;
		}

		public void setBean(AppointmentAnalysisReport bean) {
			this.bean = bean;
		}
	...
	beanturn String
		...
		public String report() { 
			AppointmentAnalysisReportModel model=new AppointmentAnalysisReportModel();
			model.initiate(context, session); 
			String[] colnames = { getMessage("serial.no"), getMessage("reqs.code"),
				getMessage("position"), getMessage("reqs.date"),
				getMessage("noOfVacLabel"), getMessage("offerDueLabel"),
				getMessage("offerIssueLabel"), getMessage("offerAccptedLabel"),
				getMessage("offerRejectedLabel"), getMessage("offerCancelLabel"),
				getMessage("appointmentDateLabel"), getMessage("recruiterNameLabel")};
