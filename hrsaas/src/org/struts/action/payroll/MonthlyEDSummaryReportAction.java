 ...
 *
 */
public class MonthlyEDSummaryReportAction extends ParaActionSupport {
	/**
     * Used for f9 windows.
     */
     ...
     * Log4j logger.
     */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(MonthlyEDSummaryReportAction.class);
	/**
	 * object of MonthlyLeaveRegistry.
	 */
	private MonthlyEDSummaryReportBean bean;
	...
	public void prepare_local() throws Exception {
		this.bean = new MonthlyEDSummaryReportBean();
		this.bean.setMenuCode(2264);
	}
	...
	public String getReport() {
		final MonthlyEDSummaryReportModel model = new MonthlyEDSummaryReportModel();
	...
	public String f9Brch() {
		try {
			...
			logger
					.error("Error in MonthlyEDSummaryReportAction.f9Brch() method Action : "
							+ e.getMessage());
			return "";
		}
	}
	...
	public String f9Div() {
		try {
			...
			logger
					.error("Error in MonthlyEDSummaryReportAction.f9Div() method Action : "
							+ e.getMessage());
			return "";
		}
	}
     ...
     * @return bean
     */
	public MonthlyEDSummaryReportBean getBean() {
		return this.bean;
	}
	/**
	 * @param bean : set bean
	 */
	public void setBean(final MonthlyEDSummaryReportBean bean) {
		this.bean = bean;
	}
	...
	public String f9gradeaction() {
		try {
			...
			logger
					.error("Error in LWFConfigurationMasterAction.f9gradeaction() method Action : "
							+ e.getMessage());
			return "";
		}
	}
...
//						+ ")";
	...
	public final String f9reportType() {
		try {
			...
			String submitToMethod = "MonthlyEDSummaryReport_mailReport.action";
	...
	public String f9CostCenter() {
		try {
			...
			logger
					.error("Error in MonthlyEDSummaryReportAction.f9CostCenter() method Action : "
							+ e.getMessage());
			return "";
		}
	}
