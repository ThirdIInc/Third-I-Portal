...
import org.paradyne.model.payroll.payroll_UMC.SalaryProcessModelUMC;
...
public class SalaryProcessActionUMC extends ParaActionSupport {

	SalaryProcessUMC salProcess;
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SalaryProcessActionUMC.class);
	
	public void prepare_local() throws Exception {
		salProcess = new SalaryProcessUMC();
	...
	public SalaryProcessUMC getSalProcess() {
		return salProcess;
	}

	public void setSalProcess(SalaryProcessUMC salProcess) {
		this.salProcess = salProcess;
	}
	
	public String input() {
		try{
			SalaryProcessModelUMC model = new SalaryProcessModelUMC();
