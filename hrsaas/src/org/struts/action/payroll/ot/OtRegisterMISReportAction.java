...
import org.paradyne.model.payroll.ot.OtRegisterMISReportModel;
 ...
 *
 */
public class OtRegisterMISReportAction extends ParaActionSupport {
	...
	/** bonusBean. */
	private OtRegisterMISReport bean; 
	...
	public void prepare_local() throws Exception {
		this.bean = new OtRegisterMISReport();
		this.bean.setMenuCode(2302);
	}
	 ...
	 * */
	public OtRegisterMISReport getbean() {
		return this.bean;
	}
	 ...
	 * */
	public void setbean(final OtRegisterMISReport bean) {
		this.bean = bean;
	}
	...
	public void prepare_withLoginProfileDetails() {
		final OtRegisterMISReportModel model = new OtRegisterMISReportModel();
	...
	public String f9Division() {
		try {
			...
			final String submitToMethod = "OtRegisterMISReport_getDoubleOtFlagDetails.action";
	...
	public String reset() {
		try {
			...
			this.bean.setShiftCode("");
			this.bean.setShiftName("");
			this.bean.setManagerID("");
			this.bean.setManagerName("");
			
			this.bean.setFromDate("");
			this.bean.setToDate("");
