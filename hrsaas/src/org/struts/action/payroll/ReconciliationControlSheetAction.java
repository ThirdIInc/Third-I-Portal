...
import org.paradyne.model.payroll.ReconciliationControlSheetModel;
 ...
 *
 */
public class ReconciliationControlSheetAction extends ParaActionSupport {
	/**
     * Used for f9 windows.
     */
     ...
     * Log4j logger.
     */
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ReconciliationControlSheetAction.class);
	/**
	 * object of MonthlyLeaveRegistry.
	 */
	private ReconciliationControlSheetBean bean;
	...
	public void prepare_local() throws Exception {
		this.bean = new ReconciliationControlSheetBean();
		this.bean.setMenuCode(2257);
	}
	...
	public String getReport() {
		final ReconciliationControlSheetModel model = new ReconciliationControlSheetModel();
		model.initiate(context, session);
		//model.getMonthLeaveRegistryReport(this.bean, response);
		//model.report(request,response,bean);
		//logger.info("General Report");
		String  reportPath = "";
		model.generateReport(bean, response,  request, reportPath);
	...
	public String f9Brch() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9Brch() method Action : "
							+ e.getMessage());
			return "";
		}
	}
	...
	public String f9Div() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9Div() method Action : "
							+ e.getMessage());
			return "";
		}
	}
     ...
     * @return bean
     */
	public ReconciliationControlSheetBean getBean() {
		return this.bean;
	}
	/**
	 * @param bean : set bean
	 */
	public void setBean(final ReconciliationControlSheetBean bean) {
		this.bean = bean;
	}
	...
	public String f9Department() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9Department() method Action : "
							+ e.getMessage());
			return "";
		}
	}
	...
	public String f9PayBill() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9PayBill() method Action : "
							+ e.getMessage());
			return "";
		}
	}
	...
	public String f9gradeaction() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9gradeaction() method Action : "
							+ e.getMessage());
			return "";
		}
	}
	...
	public final String f9reportType() {
		try {
			...
			String submitToMethod = "ReconciliationControlSheet_mailReport.action";
	...
	public String f9CostCenter() {
		try {
			...
			logger
					.error("Error in ReconciliationControlSheet.f9CostCenter() method Action : "
							+ e.getMessage());
			return "";
		}
	}
