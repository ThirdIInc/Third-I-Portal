...
import org.paradyne.model.payroll.pf.PFSlipDetailReportModel;
import org.struts.lib.ParaActionSupport;

public class PFSlipDetailReportAction extends ParaActionSupport {

	
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger
	.getLogger(PFSlipDetailReportAction.class);
	
	PFSlipDetailReport bean = null;
	
	public void prepare_local() throws Exception {
		bean = new PFSlipDetailReport();
		bean.setMenuCode(938);
	...
	public void setPFSlipDetailReport(PFSlipDetailReport bean) {
		this.bean = bean;
	}
	...
	{
		PFSlipDetailReportModel model = new PFSlipDetailReportModel();
