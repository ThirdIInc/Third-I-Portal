...
public class Form1Action extends ParaActionSupport {
	...
	public String report(){
		...
		model.report(request, response, form1, "");
		model.terminate();		
		return null;
	}
	...
	public final String mailReport(){
		try {
			...
			model.report(request, response, form1, reportPath);			
			model.terminate();
		} catch (Exception e) {
			e.printStackTrace();
		}
