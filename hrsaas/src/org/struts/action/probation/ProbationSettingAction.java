...
import org.paradyne.model.probation.ProbationSettingModel;
...
public class ProbationSettingAction extends ParaActionSupport {
	...
	public void prepare_local() throws Exception {
		...
		probationSetting.setMenuCode(932);
	}
	...
	public void prepare_withLoginProfileDetails() throws Exception {
		...
		try {
			...
			String query=" SELECT * FROM HRMS_PROBATION_DTL ";
			Object result[][] =model.getSqlModel().getSingleResult(query);
			if(result != null && result.length != 0)
			{
				model.setHdrRecord(probationSetting);
