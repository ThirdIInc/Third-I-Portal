...
/**
 * @author Tarun Chaturvedi - Modified by Nilesh Dhandare on 10th Jan 2012.
 * @date 15-03-2008
 * HelpDeskMisReportAction class to generate the MIS report
...
public class HelpDeskMisReportAction extends ParaActionSupport {

	HelpDeskMisReport helpDeskReport;
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HelpDeskMisReportAction.class);
	
	@Override
	public void prepare_local() throws Exception {
		// TODO Auto-generated method stub
		helpDeskReport = new HelpDeskMisReport();
		helpDeskReport.setMenuCode(526);
	 ...
	 */
	public void report(){
		logger.info("in action's report method");
		
		HelpDeskMisReportModel model = new HelpDeskMisReportModel();
		
		model.initiate(context, session);
		model.helpDeskReport(helpDeskReport, response,request);
		model.terminate();
	}
	...
	public final String getReport() throws Exception {
       HelpDeskMisReportModel model = new HelpDeskMisReportModel();
		model.initiate(context, session);
		String reportPath = "";
		model.getHelpDeskMisReport(helpDeskReport,request,response,reportPath);
		model.terminate();
		return null;
	}
	...
	public final String mailReport() {
		try {
		    final HelpDeskMisReportModel model = new HelpDeskMisReportModel();
			model.initiate(context, session);
