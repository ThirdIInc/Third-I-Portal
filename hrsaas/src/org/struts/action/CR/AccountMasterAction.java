...
public class AccountMasterAction extends ParaActionSupport
{
  AccountMaster bean = null;

  static Logger logger = Logger.getLogger(ParaActionSupport.class);

  public AccountMaster getBean()
  {
    return this.bean;
  }

  public void setTm(AccountMaster bean) {
    this.bean = bean;
  }
  ...
  public void prepare_local() throws Exception {
    this.bean = new AccountMaster();
    this.bean.setMenuCode(5032);
  }
    ...
    throws Exception
  {
   ...
   System.out.println("requestID=111=="+bean.getAccountCode());
  ...
  public String callForBusinessUserPaging()
  throws Exception
	{
	  AccountMasterModel model = new AccountMasterModel();
	  model.initiate(this.context, this.session);
