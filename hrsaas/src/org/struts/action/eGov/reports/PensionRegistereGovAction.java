 ...
 *
 */
public class PensionRegistereGovAction extends ParaActionSupport {

	/* (non-Javadoc)
	 * @see org.struts.lib.ParaActionSupport#prepare_local()
	 */
        PensionRegistereGovBean penReg;
	public void prepare_local() throws Exception {
		// TODO Auto-generated method stub
		penReg = new PensionRegistereGovBean();
		penReg.setMenuCode(2075);
	}
	...
	public PensionRegistereGovBean getPenReg() {
		return penReg;
	}

	public void setPenReg(PensionRegistereGovBean penReg) {
		this.penReg = penReg;
	}
	...
	public void getReport(){
		...
		PensionRegistereGovModel model = new PensionRegistereGovModel();
