...
import org.paradyne.bean.eGov.reports.PensionOnholdReporteGovBean;
import org.paradyne.bean.eGov.reports.PensionRegistereGovBean;
import org.paradyne.model.eGov.reports.PensionOnholdReporteGovModel;
import org.paradyne.model.eGov.reports.PensionRegistereGovModel;
 ...
 *
 */
public class PensionOnholdReporteGovAction extends ParaActionSupport {

	/* (non-Javadoc)
	 * @see org.struts.lib.ParaActionSupport#prepare_local()
	 */
        PensionOnholdReporteGovBean penReg;
	public void prepare_local() throws Exception {
		// TODO Auto-generated method stub
		penReg = new PensionOnholdReporteGovBean();
		penReg.setMenuCode(2077);
	}
	...
	public PensionOnholdReporteGovBean getPenReg() {
                return penReg;
        }

        public void setPenReg(PensionOnholdReporteGovBean penReg) {
                this.penReg = penReg;
        }
	...
	public void getReport(){
	        ...
	        PensionOnholdReporteGovModel model = new PensionOnholdReporteGovModel();
        ...
        public String f9PayBill() {
                try {
                      ...
                      //  query += getprofilePaybillQuery(bean);
                        ...
                        String[] fieldNames = {"penReg.payBillName", "penReg.payBillNo"};
