...
import org.paradyne.model.eGov.reports.MonthAttendanceReportModeleGov;
...
public class MonthAttendanceReportActioneGov extends ParaActionSupport {

	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(MonthAttendanceReportActioneGov.class);
	...
	public void report() {
		try {
			MonthAttendanceReportModeleGov model = new MonthAttendanceReportModeleGov();
