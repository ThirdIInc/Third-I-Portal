...
public class SalaryProcessActioneGov extends ParaActionSupport {

	SalaryProcesseGov salProcess;
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SalaryProcessActioneGov.class);
	public void prepare_local() throws Exception {
		salProcess=new SalaryProcesseGov();
		salProcess.setMenuCode(2099);
	}
	...
	public SalaryProcesseGov getSalProcess() {
		return salProcess;
	}

	public void setSalProcess(SalaryProcesseGov salProcess) {
		this.salProcess = salProcess;
	}
	public String input() {
		try{
			SalaryProcessModeleGov model = new SalaryProcessModeleGov();
	...
	public void viewSalaryReport() {
		...
		model.genReport("Xls", salProcess.getMonth(), salProcess.getYear(),
				...
				"N", "N", "N",salProcess.getPayBillId(),"N","","","", "","N","N","");
		model.terminate();
	}
