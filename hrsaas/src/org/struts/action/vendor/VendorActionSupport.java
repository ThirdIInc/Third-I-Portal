...
public abstract class VendorActionSupport extends ActionSupport implements ModelDriven, Preparable, ServletRequestAware, ServletResponseAware, ServletContextAware {
	...
	public void prepare()  
	{
		try {
			...
			prepare_local();
			VendorLogin bean = null;
			bean = (VendorLogin) request.getSession().getAttribute("loginBeanData");
			...
			applicationBean.setLoginPartnerCode(bean.getVendorLoginId());
