...
import org.paradyne.model.admin.srd.ExperinceMisReportModel;
 ...
 *
 */
public class ExperinceMisReportAction extends ParaActionSupport {
	 ...
	 */
	ExperinceMisReport rpt;
	@Override
	public void prepare_local() throws Exception {
		// TODO Auto-generated method stub
		rpt =new  ExperinceMisReport();
		rpt.setMenuCode(1153);
	}
	...
	public ExperinceMisReport getRpt() {
		return rpt;
	}

	public void setRpt(ExperinceMisReport rpt) {
		this.rpt = rpt;
	}

	public String report() {
		ExperinceMisReportModel  model = new ExperinceMisReportModel();
	...
	public String expReport()
	{
		ExperinceMisReportModel  model = new ExperinceMisReportModel();
		model.initiate(context, session);
		String reportPath="";
		model.getExpMISReport(rpt, request, response, reportPath);
		model.terminate();
		return null;
	}
  ...
  //To generate Mail Report
	public final String mailReport()
	{
		try
		{
		  final ExperinceMisReportModel model = new ExperinceMisReportModel();
		  model.initiate(context, session);
	...
	public String f9MultiDiv() {
		try {
			...
			if (this.rpt.getUserProfileDivision()!= null
					&& this.rpt.getUserProfileDivision().length() > 0)
				query += " WHERE DIV_ID IN (" + this.rpt.getUserProfileDivision()
						+ ")";
	...
	/**
	 * THIS METHOD IS USED OFR SELECTING QUALIFICATION
	 * 
	 * @return String
	 * @throws Exception
	 */
