...
import org.paradyne.model.admin.srd.FamilyPensionNomModel;

 import org.struts.lib.ParaActionSupport;


public class FamilyPensionNomAction extends ParaActionSupport  {
	private FamilyPensionNom fpn;
	 ...
	 * @return the fpn
	 */
	public FamilyPensionNom getFpn() {
		return fpn;
	}

	/**
	 * @param fpn the fpn to set
	 */
	public void setFpn(FamilyPensionNom fpn) {
		this.fpn = fpn;
	}
	...
	logger.info("Inside-->report()");
		...
		{			 
			try {
				FamilyPensionNomModel model = new FamilyPensionNomModel();
				model.initiate(context,session);
				
				
				
				model.generateReport(fpn,response);
