...
import org.paradyne.model.admin.master.CostCenterModel;
 ...
 * Date:23/09/09
 */
public class CostCenterMasterAction extends ParaActionSupport{

	static org.apache.log4j.Logger logger=org.apache.log4j.Logger.getLogger(org.struts.lib.ParaActionSupport.class);

	CostCenterMaster castMaster;
		public static org.apache.log4j.Logger getLogger() {
		return logger;
	}

	public CostCenterMaster getCastMaster() {
		return castMaster;
	}

	public void setCastMaster(CostCenterMaster castMaster) {
	...
	public void prepare_local() throws Exception {
		// TODO Auto-generated method stub
			castMaster = new CostCenterMaster();
...
public String reset() throws Exception{
	 castMaster.setCastCode("");
	 castMaster.setSubcastCode("");
	    castMaster.setCastAbbr("");
	    castMaster.setCastName("");
	    castMaster.setSubCastCenter("");
...
public String delete1() throws Exception {
	String deletedCostIds = request.getParameter("deletedCostIds");
	String deletedSubCostIds = request.getParameter("deletedSubCostIds");

	CostCenterModel model = new CostCenterModel();

	model.initiate(context, session);
	String message = model.deleteList(castMaster, deletedCostIds, deletedSubCostIds);
...
public String report(){
	...
	CostCenterModel model = new CostCenterModel();
	model.initiate(context,session);
	String[]label={"Sr.No",getMessage("cast.abbr"),getMessage("cast.name"),getMessage("subcast.abbr"),getMessage("subcast.center")};
...
public String addItem()throws Exception{
	...
	/*if(abbr !=null){
		...
		for (int i = 0; i < name.length; i++) {
			if(castMaster.getSubcastAbbr().toUpperCase().equals(""+abbr[i].toUpperCase()+"")&& castMaster.isHiddenFlag()==false){
				addActionMessage("Duplicate entry found.");
				castMaster.setSubCAbbr("");
				castMaster.setSubCName("");
	...
	if (castMaster.getCheckEdit().equals("")){
...
public String f9action() throws Exception {
	 ...
	 */
	String submitToMethod="CostCenterMaster_showRecord.action";
