...
public class CostCenterModelSql extends SqlBase{
	...
	public String getQuery(int code)
	{
		...
		case 6: return " SELECT  HRMS_COST_CENTER.COST_CENTER_ID,HRMS_COST_CENTER.COST_CENTER_ABBR, HRMS_COST_CENTER.COST_CENTER_NAME,SUB_COST_CENTER_ID,SUB_COST_CENTER_ABBR ,SUB_COST_CENTER_NAME FROM HRMS_COST_CENTER"
