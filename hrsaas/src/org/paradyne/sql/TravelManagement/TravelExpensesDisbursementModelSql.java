...
public class TravelExpensesDisbursementModelSql extends SqlBase {
	public String getQuery(int id) {
		...
		case 5: return " UPDATE HRMS_TMS_EXP_DISB  SET EXP_DISB_PAID_RECORD = NVL(EXP_DISB_PAID_RECORD,0)+? , EXP_DISB_BAL_RECORD =? ,EXP_DISB_STATUS = ? WHERE EXP_DISB_EXPAPP_ID =?";
		...
		case 6:
			return " INSERT INTO HRMS_TMS_EXP_DISB_BAL ( DISB_BAL_ID,DISB_BAL_TOT_BALANCE,DISB_BAL_PAID_BAL,DISB_BAL_PEND_BAL,DISB_BAL_PAYMENT_DATE,DISB_BAL_PAYMODE,DISB_BAL_CHEQUE_NO,DISB_BAL_CHEQUE_DATE,"
					+"DISB_BAL_BANK_NAME,DISB_BAL_SAL_MONTH ,DISB_BAL_SAL_YEAR,DISB_BAL_COMMENT,DISB_BAL_EXP_DISB_ID) VALUES( (SELECT NVL(MAX(DISB_BAL_ID),0)+1 FROM HRMS_TMS_EXP_DISB_BAL),?,?,?,TO_DATE(?,'DD-MM-YYYY'),?,?,TO_DATE(?,'DD-MM-YYYY'),?,?,?,?,?)";
