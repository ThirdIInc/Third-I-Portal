...
public class AttReglMisReport extends BeanBase {
	...
	private String actInFlag = "";
	private String actOutFlag = "";
	private String statusFlag = "";
	private String recorderInFlag="";
	private String recorderOutFlag="";
	...
	public String getActInFlag() {
		return actInFlag;
	}

	public void setActInFlag(String actInFlag) {
		this.actInFlag = actInFlag;
	}

	public String getActOutFlag() {
		return actOutFlag;
	}

	public void setActOutFlag(String actOutFlag) {
		this.actOutFlag = actOutFlag;
	}
	...
	public String getRecorderInFlag() {
		return recorderInFlag;
	}

	public void setRecorderInFlag(String recorderInFlag) {
		this.recorderInFlag = recorderInFlag;
	}

	public String getRecorderOutFlag() {
		return recorderOutFlag;
	}

	public void setRecorderOutFlag(String recorderOutFlag) {
		this.recorderOutFlag = recorderOutFlag;
	}
}
