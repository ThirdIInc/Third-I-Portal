 ...
 * @date 30-11-2009
 */
public class AccMISReport extends BeanBase {
	...
	private String reimbAccFlag = "";
	private String reimbBankFlag = "";
	...
	private String gratuityIDFlag = "";
	private String pensionAccNoFlag = "";
	private String pensionBankFlag = "";
	...
	/**
	 * @param grossSalSelect
	 *            the grossSalSelect to set
	 */
	...
	/**
	 * @param reportingToFlag
	 *            the reportingToFlag to set
	 */
	...
	public String getReimbAccFlag() {
		return reimbAccFlag;
	}

	public void setReimbAccFlag(String reimbAccFlag) {
		this.reimbAccFlag = reimbAccFlag;
	}
	...
	public String getReimbBankFlag() {
		return reimbBankFlag;
	}

	public void setReimbBankFlag(String reimbBankFlag) {
		this.reimbBankFlag = reimbBankFlag;
	}
	...
	/**
	 * @return the accCategoryFlag
	 */
	public String getAccCategoryFlag() {
		return accCategoryFlag;
	}

	/**
	 * @param accCategoryFlag
	 *            the accCategoryFlag to set
	 */
	public void setAccCategoryFlag(String accCategoryFlag) {
		this.accCategoryFlag = accCategoryFlag;
	}

	/**
	 * @return the costCenterFlag
	 */
	...
	/**
	 * @param costCenterFlag
	 *            the costCenterFlag to set
	 */
	...
	/**
	 * @return the subCostCenterFlag
	 */
	public String getSubCostCenterFlag() {
		return subCostCenterFlag;
	}

	/**
	 * @param subCostCenterFlag
	 *            the subCostCenterFlag to set
	 */
	public void setSubCostCenterFlag(String subCostCenterFlag) {
		this.subCostCenterFlag = subCostCenterFlag;
	}
	...
	public String getGratuityIDFlag() {
		return gratuityIDFlag;
	}

	public void setGratuityIDFlag(String gratuityIDFlag) {
		this.gratuityIDFlag = gratuityIDFlag;
	}

	public String getPensionAccNoFlag() {
		return pensionAccNoFlag;
	}

	public void setPensionAccNoFlag(String pensionAccNoFlag) {
		this.pensionAccNoFlag = pensionAccNoFlag;
	}

	public String getPensionBankFlag() {
		return pensionBankFlag;
	}

	public void setPensionBankFlag(String pensionBankFlag) {
		this.pensionBankFlag = pensionBankFlag;
	}
}
