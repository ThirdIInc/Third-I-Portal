...
public class TravelClass extends BeanBase {

	private String srNo = "";
	private String trvlClsId = "";
	private String trvlClass = "";
	private String trvlModeId = "";
	private String trvlMode = "";
	private String expnseAmnt="";
	private String status;

	//iterator fields...

	private String trvlClsItId = "";
	private String trvlClsIt = "";
	private String trvlModeIt = "";
	private String trvlStatusIt = "";
	...
	public String getTrvlClsId() {
		return trvlClsId;
	}

	public void setTrvlClsId(String trvlClsId) {
		this.trvlClsId = trvlClsId;
	}

	public String getTrvlClass() {
		return trvlClass;
	}

	public void setTrvlClass(String trvlClass) {
		this.trvlClass = trvlClass;
	}

	public String getTrvlModeId() {
		return trvlModeId;
	}

	public void setTrvlModeId(String trvlModeId) {
		this.trvlModeId = trvlModeId;
	}
	...
	public String getTrvlClsItId() {
		return trvlClsItId;
	}

	public void setTrvlClsItId(String trvlClsItId) {
		this.trvlClsItId = trvlClsItId;
	}

	public String getTrvlClsIt() {
		return trvlClsIt;
	}

	public void setTrvlClsIt(String trvlClsIt) {
		this.trvlClsIt = trvlClsIt;
	}

	public String getTrvlModeIt() {
		return trvlModeIt;
	}

	public void setTrvlModeIt(String trvlModeIt) {
		this.trvlModeIt = trvlModeIt;
	}

	public String getTrvlStatusIt() {
		return trvlStatusIt;
	}

	public void setTrvlStatusIt(String trvlStatusIt) {
		this.trvlStatusIt = trvlStatusIt;
	}
	...
	public String getExpnseAmnt() {
		return expnseAmnt;
	}

	public void setExpnseAmnt(String expnseAmnt) {
		this.expnseAmnt = expnseAmnt;
	}
