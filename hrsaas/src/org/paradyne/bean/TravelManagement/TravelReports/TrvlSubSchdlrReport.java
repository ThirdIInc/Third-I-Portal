 ...
 * 
 */
public class TrvlSubSchdlrReport extends BeanBase {
	...
	private String bookCycleSelect = "";
	private String bookCycleFrom = "";
	private String bookCycleTo = "";
	...
	/**
	 * @param mainSchdlrToken
	 *            the mainSchdlrToken to set
	 */
	...
	/**
	 * @param mainSchdlrCode
	 *            the mainSchdlrCode to set
	 */
	...
	/**
	 * @return the mainSchdlrName
	 */
	public String getMainSchdlrName() {
		return mainSchdlrName;
	}

	/**
	 * @param mainSchdlrName
	 *            the mainSchdlrName to set
	 */
	public void setMainSchdlrName(String mainSchdlrName) {
		this.mainSchdlrName = mainSchdlrName;
	}
...
//	}
	...
	/**
	 * @return the mainSchdlrFlag
	 */
	public String getMainSchdlrFlag() {
		return mainSchdlrFlag;
	}

	/**
	 * @param mainSchdlrFlag the mainSchdlrFlag to set
	 */
	public void setMainSchdlrFlag(String mainSchdlrFlag) {
		this.mainSchdlrFlag = mainSchdlrFlag;
	}
	...
	/**
	 * @return the bookCycleSelect
	 */
	public String getBookCycleSelect() {
		return bookCycleSelect;
	}

	/**
	 * @param bookCycleSelect
	 *            the bookCycleSelect to set
	 */
	public void setBookCycleSelect(String bookCycleSelect) {
		this.bookCycleSelect = bookCycleSelect;
	}

	/**
	 * @return the bookCycleFrom
	 */
	public String getBookCycleFrom() {
		return bookCycleFrom;
	}

	/**
	 * @param bookCycleFrom
	 *            the bookCycleFrom to set
	 */
	public void setBookCycleFrom(String bookCycleFrom) {
		this.bookCycleFrom = bookCycleFrom;
	}

	/**
	 * @return the bookCycleTo
	 */
	public String getBookCycleTo() {
		return bookCycleTo;
	}

	/**
	 * @param bookCycleTo
	 *            the bookCycleTo to set
	 */
	public void setBookCycleTo(String bookCycleTo) {
		this.bookCycleTo = bookCycleTo;
	}
