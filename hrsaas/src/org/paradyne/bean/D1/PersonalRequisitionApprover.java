...
public class PersonalRequisitionApprover extends BeanBase {
	...
	private String personalRequisitionApprID = "";
	...
	/**
	 * @return the personalRequisitionApprID
	 */
	public String getPersonalRequisitionApprID() {
		return this.personalRequisitionApprID;
	}
	/**
	 * @param personalRequisitionApprID the personalRequisitionApprID to set
	 */
	public void setPersonalRequisitionApprID(String personalRequisitionApprID) {
		this.personalRequisitionApprID = personalRequisitionApprID;
	}
	/**
