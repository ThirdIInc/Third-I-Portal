...
public class CapitalExpenditure extends BeanBase {
	/** applicantFlag. * */
	...
	/** approverCommentList. * */
	private List<CapitalExpenditure> approverCommentList;
	...
	/** detailIteratorList. * */
	private List<CapitalExpenditure> detailIteratorList;
	/** detailListLengthFlag. * */
	private boolean detailListLengthFlag;
	/** accountOnlyIteratorList. * */
	private List<CapitalExpenditure> accountOnlyIteratorList;
	/** checkDelete. * */
	...
	/** accountIteratorList. * */
	private List<CapitalExpenditure> accountIteratorList;
	/** accountListLengthFlag. * */
	private boolean accountListLengthFlag;
	/** subTotalCEARPriceList. * */
	...
	/** quotesAttachedRadioOptionValue. * */
	...
	//Manager Section
	/** forwardedManagerID. * */
	private String forwardedManagerID = "";
	/** forwardedManagerToken. * */
	private String forwardedManagerToken = "";
	/** forwardedManagerName. * */
	private String forwardedManagerName = "";
	/** ppoNumber. * */
	...
	/**
	 * @return the applicantFlag
	 */
	public boolean isApplicantFlag() {
		return this.applicantFlag;
	}
	/**
	 * @param applicantFlag the applicantFlag to set.
	 */
	public void setApplicantFlag(final boolean applicantFlag) {
		this.applicantFlag = applicantFlag;
	}
	/**
	 * @return the accountantFlag
	 */
	public boolean isAccountantFlag() {
		return this.accountantFlag;
	}
	/**
	 * @param accountantFlag the accountantFlag to set.
	 */
	public void setAccountantFlag(final boolean accountantFlag) {
	 ...
	 */
	public List<CapitalExpenditure> getDraftVoucherIteratorList() {
		return this.draftVoucherIteratorList;
	}
	/**
	 * @param draftVoucherIteratorList the draftVoucherIteratorList to set.
	 */
	public void setDraftVoucherIteratorList(List<CapitalExpenditure> draftVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getInProcessVoucherIteratorList() {
	...
	public void setInProcessVoucherIteratorList(
			final List<CapitalExpenditure> inProcessVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getSentBackVoucherIteratorList() {
	...
	public void setSentBackVoucherIteratorList(
			final List<CapitalExpenditure> sentBackVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getApprovedVoucherIteratorList() {
	...
	public void setApprovedVoucherIteratorList(
			final List<CapitalExpenditure> approvedVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getApprovedCancellationVoucherIteratorList() {
	...
	public void setApprovedCancellationVoucherIteratorList(
			final List<CapitalExpenditure> approvedCancellationVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getCancelledVoucherIteratorList() {
	...
	public void setCancelledVoucherIteratorList(
			final List<CapitalExpenditure> cancelledVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getRejectedVoucherIteratorList() {
	...
	public void setRejectedVoucherIteratorList(
			final List<CapitalExpenditure> rejectedVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getRejectedCancelVoucherIteratorList() {
	...
	public void setRejectedCancelVoucherIteratorList(
			final List<CapitalExpenditure> rejectedCancelVoucherIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getApproverCommentList() {
		return this.approverCommentList;
	}
	/**
	 * @param approverCommentList the approverCommentList to set.
	 */
	public void setApproverCommentList(final List<CapitalExpenditure> approverCommentList) {
	 ...
	 */
	public List<CapitalExpenditure> getDetailIteratorList() {
		return this.detailIteratorList;
	}
	/**
	 * @param detailIteratorList the detailIteratorList to set.
	 */
	public void setDetailIteratorList(final List<CapitalExpenditure> detailIteratorList) {
	 ...
	 */
	public void setDetailListLengthFlag(final boolean detailListLengthFlag) {
		this.detailListLengthFlag = detailListLengthFlag;
	}
	/**
	 * @return the accountOnlyIteratorList
	 */
	public List<CapitalExpenditure> getAccountOnlyIteratorList() {
		return this.accountOnlyIteratorList;
	}
	/**
	 * @param accountOnlyIteratorList the accountOnlyIteratorList to set.
	 */
	public void setAccountOnlyIteratorList(final List<CapitalExpenditure> accountOnlyIteratorList) {
	 ...
	 */
	public List<CapitalExpenditure> getAccountIteratorList() {
		return this.accountIteratorList;
	}
	/**
	 * @param accountIteratorList the accountIteratorList to set.
	 */
	public void setAccountIteratorList(final List<CapitalExpenditure> accountIteratorList) {
	 ...
	 */
	public final void setInvoiceTotal(final String invoiceTotal) {
	 ...
	 */
	public void setSubTotalUnitPrice(double subTotalUnitPrice) {
	 ...
	 */
	public void setSubTotalCEAR(double subTotalCEAR) {
	...
	/**
	 * @return the forwardedManagerID
	 */
	public String getForwardedManagerID() {
		return this.forwardedManagerID;
	}
	/**
	 * @param forwardedManagerID the forwardedManagerID to set
	 */
	public void setForwardedManagerID(final String forwardedManagerID) {
		this.forwardedManagerID = forwardedManagerID;
	}
	/**
	 * @return the forwardedManagerToken
	 */
	public String getForwardedManagerToken() {
		return this.forwardedManagerToken;
	}
	/**
	 * @param forwardedManagerToken the forwardedManagerToken to set
	 */
	public void setForwardedManagerToken(final String forwardedManagerToken) {
		this.forwardedManagerToken = forwardedManagerToken;
	}
	/**
	 * @return the forwardedManagerName
	 */
	public String getForwardedManagerName() {
		return this.forwardedManagerName;
	}
	/**
	 * @param forwardedManagerName the forwardedManagerName to set
	 */
	public void setForwardedManagerName(final String forwardedManagerName) {
		this.forwardedManagerName = forwardedManagerName;
	}
	/**
