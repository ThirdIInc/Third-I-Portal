...
/**
 * Bean for ReconciliationControlSheetBean application.
 * Date : 01 Dec'2011
 *
 */
public class ReconciliationControlSheetBean extends BeanBase {
	...
	private String groupByRadio = "";
	private String groupByGrade = "";
	...
	public String getGroupByRadio() {
		return groupByRadio;
	}
	public void setGroupByRadio(String groupByRadio) {
		this.groupByRadio = groupByRadio;
	}
	public String getGroupByGrade() {
		return groupByGrade;
	}
	public void setGroupByGrade(String groupByGrade) {
		this.groupByGrade = groupByGrade;
	}
