...
public class UmcLoanIssuedReport extends BeanBase {
	...
	private String loanAmountPaidChkBox ="";
	private String loanPendingAmtChkBox ="";
	...
	public String getLoanAmountPaidChkBox() {
		return loanAmountPaidChkBox;
	}
	public void setLoanAmountPaidChkBox(String loanAmountPaidChkBox) {
		this.loanAmountPaidChkBox = loanAmountPaidChkBox;
	}
	public String getLoanPendingAmtChkBox() {
		return loanPendingAmtChkBox;
	}
	public void setLoanPendingAmtChkBox(String loanPendingAmtChkBox) {
		this.loanPendingAmtChkBox = loanPendingAmtChkBox;
	}
