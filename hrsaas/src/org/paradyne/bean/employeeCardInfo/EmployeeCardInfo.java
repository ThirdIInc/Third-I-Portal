package org.paradyne.bean.employeeCardInfo;
 ...
 * @Date  18-Oct-2012
 */
public class EmployeeCardInfo extends BeanBase {
	private String isAttachClick ="";
	...
	private ArrayList <EmployeeCardInfo>managerList;
	...
	private ArrayList <EmployeeCardInfo>keepInformedList;
	...
	private ArrayList<EmployeeCardInfo> apprDtlLst;
	...
	public ArrayList<EmployeeCardInfo> getManagerList() {
		return managerList;
	}
	public void setManagerList(ArrayList<EmployeeCardInfo> managerList) {
		this.managerList = managerList;
	}
	public ArrayList<EmployeeCardInfo> getKeepInformedList() {
		return keepInformedList;
	}
	public void setKeepInformedList(ArrayList<EmployeeCardInfo> keepInformedList) {
	...
	public ArrayList<EmployeeCardInfo> getApprDtlLst() {
		return apprDtlLst;
	}
	public void setApprDtlLst(ArrayList<EmployeeCardInfo> apprDtlLst) {
	...
	public String getIsAttachClick() {
		return isAttachClick;
	}
	public void setIsAttachClick(String isAttachClick) {
		this.isAttachClick = isAttachClick;
	}
