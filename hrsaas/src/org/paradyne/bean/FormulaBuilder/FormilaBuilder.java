 ...
 * 
 */
package org.paradyne.bean.FormulaBuilder;
 ...
 *
 */
public class FormilaBuilder extends BeanBase {
	...
	//Eidted by Prashant starts
	private String myPage;
	private String formulaIdItt;
	private String formulaNameItt;
	ArrayList iteratorlist;
	
	private String hiddenFormulaId;
	private String copiedFormulaName;
	
	
	//Eidted by Prashant ends
	...
	public String getFormulaIdItt() {
		return formulaIdItt;
	}

	public void setFormulaIdItt(String formulaIdItt) {
		this.formulaIdItt = formulaIdItt;
	}

	public String getFormulaNameItt() {
		return formulaNameItt;
	}

	public void setFormulaNameItt(String formulaNameItt) {
		this.formulaNameItt = formulaNameItt;
	}
	 ...
	 * @return
	 */
	public String getCopiedFormulaName() {
		return copiedFormulaName;
	}

	/**
	 * @param copiedFormulaName
	 */
	public void setCopiedFormulaName(String copiedFormulaName) {
		this.copiedFormulaName = copiedFormulaName;
	}

	/**
	 * @return
	 */
	public String getHiddenFormulaId() {
		return hiddenFormulaId;
	}

	/**
	 * @param hiddenFormulaId
	 */
	public void setHiddenFormulaId(String hiddenFormulaId) {
		this.hiddenFormulaId = hiddenFormulaId;
	}
}
