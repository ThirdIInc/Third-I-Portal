 ...
 *	dete 06 July 2011
 */
public class MonthlyArrearsEGov extends BeanBase {
	...
	//ADDED BY SHASHIKANT
	private String leaveRecoveryName="";
	private String leaveRecoveryCode="";
	private String arrearFor="";
	// Flag
	...
	public String getLeaveRecoveryName() {
		return leaveRecoveryName;
	}

	public void setLeaveRecoveryName(String leaveRecoveryName) {
		this.leaveRecoveryName = leaveRecoveryName;
	}

	public String getLeaveRecoveryCode() {
		return leaveRecoveryCode;
	}

	public void setLeaveRecoveryCode(String leaveRecoveryCode) {
		this.leaveRecoveryCode = leaveRecoveryCode;
	}

	public String getArrearFor() {
		return arrearFor;
	}

	public void setArrearFor(String arrearFor) {
		this.arrearFor = arrearFor;
	}
