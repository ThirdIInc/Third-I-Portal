...
public class TrainingDetails extends BeanBase{
	...
	public String getChkTrngAppl() {
		return chkTrngAppl;
	}
	public void setChkTrngAppl(String chkTrngAppl) {
		this.chkTrngAppl = chkTrngAppl;
	}
