...
public class DisciplinaryMeasures extends BeanBase{
	...
	public String getChkDiscipAppl() {
		return chkDiscipAppl;
	}
	public void setChkDiscipAppl(String chkDiscipAppl) {
		this.chkDiscipAppl = chkDiscipAppl;
	}
