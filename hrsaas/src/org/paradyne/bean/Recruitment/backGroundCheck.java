...
public class backGroundCheck extends BeanBase {
	...
	private String bgcheckMailSubject = "";
	private String bgcheckMailToMailID = "";
	private String htmlcode = "";
	private String backgroundCheckCode ="";
	private String backgroundCheckListType = "";
	private String totalConductedRecords = "";
	private String totalPendingRecords = "";
	
    public String getBackgroundCheckListType() {
		return backgroundCheckListType;
	}
	public void setBackgroundCheckListType(String backgroundCheckListType) {
		this.backgroundCheckListType = backgroundCheckListType;
	}
	public String getBackgroundCheckCode() {
		return backgroundCheckCode;
	}
	public void setBackgroundCheckCode(String backgroundCheckCode) {
		this.backgroundCheckCode = backgroundCheckCode;
	}
	...
	public String getBgcheckMailToMailID() {
		return bgcheckMailToMailID;
	}
	public void setBgcheckMailToMailID(String bgcheckMailToMailID) {
		this.bgcheckMailToMailID = bgcheckMailToMailID;
	}
	...
	public String getBgcheckMailSubject() {
		return bgcheckMailSubject;
	}
	public void setBgcheckMailSubject(String bgcheckMailSubject) {
		this.bgcheckMailSubject = bgcheckMailSubject;
	}
	public String getTotalConductedRecords() {
		return totalConductedRecords;
	}
	public void setTotalConductedRecords(String totalConductedRecords) {
		this.totalConductedRecords = totalConductedRecords;
	}
