...
public class PartnerPostResume extends BeanBase {
	...
	private boolean postCandidateFromJobBoardFlag = false; 
	

	public boolean isPostCandidateFromJobBoardFlag() {
		return postCandidateFromJobBoardFlag;
	}

	public void setPostCandidateFromJobBoardFlag(
			boolean postCandidateFromJobBoardFlag) {
		this.postCandidateFromJobBoardFlag = postCandidateFromJobBoardFlag;
	}
	...
	/**
	 * @param addCandidateFlag
	 *            the addCandidateFlag to set
	 */
	...
	/**
	 * @param candExperience
	 *            the candExperience to set
	 */
	...
	/**
	 * @param firstNameIterator
	 *            the firstNameIterator to set
	 */
	...
	/**
	 * @param lastNameIterator
	 *            the lastNameIterator to set
	 */
	...
	/**
	 * @param emailIdIterator
	 *            the emailIdIterator to set
	 */
	...
	/**
	 * @param contactNoIterator
	 *            the contactNoIterator to set
	 */
	...
	/**
	 * @param expCtcIterator
	 *            the expCtcIterator to set
	 */
	...
	/**
	 * @param relocateIterator
	 *            the relocateIterator to set
	 */
	...
	/**
	 * @param uploadIterator
	 *            the uploadIterator to set
	 */
	...
	/**
	 * @param locationIterator
	 *            the locationIterator to set
	 */
	...
	/**
	 * @param genderIterator
	 *            the genderIterator to set
	 */
	...
	/**
	 * @param maritalStatusIterator
	 *            the maritalStatusIterator to set
	 */
	...
	/**
	 * @param formValuesList
	 *            the formValuesList to set
	 */
	...
	/**
	 * @param hiringManagerCode
	 *            the hiringManagerCode to set
	 */
	...
	/**
	 * @param hiddenMaritalStatus
	 *            the hiddenMaritalStatus to set
	 */
	...
	/**
	 * @param candidateNotIn
	 *            the candidateNotIn to set
	 */
