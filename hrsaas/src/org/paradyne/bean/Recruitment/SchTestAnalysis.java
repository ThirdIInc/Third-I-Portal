...
public class SchTestAnalysis extends BeanBase{
	...
	private String  interviewRoundTypeChk=""; 
	...
	private String  userIdChkFlag="false";
	private String  passwordChkFlag="false";
	private String  interviewRoundTypeChkFlag="false";
	...
	private String  ivInterviewRoundType="";
	...
	public String getUserIdChkFlag() {
		return userIdChkFlag;
	}
	public void setUserIdChkFlag(String userIdChkFlag) {
		this.userIdChkFlag = userIdChkFlag;
	}
	public String getPasswordChkFlag() {
		return passwordChkFlag;
	}
	public void setPasswordChkFlag(String passwordChkFlag) {
		this.passwordChkFlag = passwordChkFlag;
	}
	...
	public void setIvUserId(String ivUserId) {
		this.ivUserId = ivUserId;
	}
	public String getIvPassword() {
		return ivPassword;
	}
	public void setIvPassword(String ivPassword) {
	...
	public String getIvInterviewRoundType() {
		return ivInterviewRoundType;
	}
	public void setIvInterviewRoundType(String ivInterviewRoundType) {
		this.ivInterviewRoundType = ivInterviewRoundType;
	}
	public String getInterviewRoundTypeChk() {
		return interviewRoundTypeChk;
	}
	public void setInterviewRoundTypeChk(String interviewRoundTypeChk) {
		this.interviewRoundTypeChk = interviewRoundTypeChk;
	}
	public String getInterviewRoundTypeChkFlag() {
		return interviewRoundTypeChkFlag;
	}
	public void setInterviewRoundTypeChkFlag(String interviewRoundTypeChkFlag) {
		this.interviewRoundTypeChkFlag = interviewRoundTypeChkFlag;
	}
