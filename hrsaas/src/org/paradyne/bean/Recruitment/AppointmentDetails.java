 ...
 *
 */
public class AppointmentDetails extends BeanBase {
	private boolean addcandFlag = false;
	private boolean viewAppointmentFlag = false;
	...
	private String appointmentLetterRegCode = "";
	...
	public String getAppointmentLetterRegCode() {
		return appointmentLetterRegCode;
	}
	public void setAppointmentLetterRegCode(String appointmentLetterRegCode) {
		this.appointmentLetterRegCode = appointmentLetterRegCode;
	}
	...
	*//**
	...
	/**
	 * @return the viewAppointmentFlag
	 */
	public boolean isViewAppointmentFlag() {
		return viewAppointmentFlag;
	}
	/**
	 * @param viewAppointmentFlag the viewAppointmentFlag to set
	 */
	public void setViewAppointmentFlag(boolean viewAppointmentFlag) {
		this.viewAppointmentFlag = viewAppointmentFlag;
	}
	/**
