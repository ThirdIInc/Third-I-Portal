...
public class LoginBean extends BeanBase {
	...
	private String userFlag="true";
	 ...
	 private String isClientFlag="false";
	 //Added by Prajakta B(4 June 2013) for multiple profile codes
	 String multipleProfileCode = "";
	 //Ends Added by Prajakta B(4 June 2013) for multiple profile codes
	...
	/**
	 * @param isClientFlag the isClientFlag to set
	 */
	...
	public String getAccessProfileCode() {
		return accessProfileCode;
	}

	public void setAccessProfileCode(String accessProfileCode) {
		this.accessProfileCode = accessProfileCode;
	}
