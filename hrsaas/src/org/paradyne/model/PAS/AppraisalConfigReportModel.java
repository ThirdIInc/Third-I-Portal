...
public class AppraisalConfigReportModel extends ModelBase {
	...
	public void generateConfigReport(HttpServletRequest request,
		...
		String secDtlQry = " SELECT APPR_SECTION_NAME,PAS_APPR_PHASE_CONFIG.APPR_PHASE_NAME,APPR_SECTION_VISIBILITY,APPR_SECTION_RATING,APPR_SECTION_COMMENT,PAS_APPR_SECTION_DTL.APPR_SECTION_ID,PAS_APPR_PHASE_CONFIG.APPR_PHASE_ID  FROM PAS_APPR_SECTION_DTL "
				...
				+ " AND PAS_APPR_SECTION_DTL.APPR_TEMPLATE_ID = "
				+ tempCode
