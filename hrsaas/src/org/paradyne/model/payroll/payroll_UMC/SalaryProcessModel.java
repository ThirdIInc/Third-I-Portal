...
public class SalaryProcessModel extends ModelBase {
	 ...
	 * @return status
	 */	
	public String checkSalaryProcessStatus(SalaryProcess bean, String[] listOfFilters) {
		String status="";
		try {
	...
	public boolean unlockSalary(SalaryProcess bean) {
		boolean result =false;
	...
	public Object [][] getEmployeeDataToView(String [] dataString,HttpServletRequest request,SalaryProcess bean,Object [][] attnEmpIdSaved,String []listOfFilters){
	...
	public void getSalProcessList(SalaryProcess salProcess,	HttpServletRequest request) {
	...
	public Object[][] recalSalary(HttpServletRequest request,String[] recal_emp,
			String ledgerStatus,String path,SalaryProcess bean,String []dataString,String[] listOfFilters ) {
	...
	public void downloadTemplate(SalaryProcess bean, HttpServletResponse response) {
	...
	public String updCredits(SalaryProcess salProcess, Object[][] empObjFrmFile,
			String path) {
...
public double getPTAXAmount(Object[][] credit_amount ,String path,
			...
			String typeId, String branchId, String location, SalaryProcess salProcess) {
...
public String updDebits(SalaryProcess salProcess,Object[][] add,String debitCode){
	try {
		String empQuery ="select emp_id,emp_token from hrms_emp_offc ";
		ArrayList addList =new ArrayList();
		Object[][] empObj = getSqlModel().getSingleResult(empQuery);
...
public String pullExtraWorkBenefit(SalaryProcess bean,String path,String []listOfFilters){
	String result = "0";
	String filterQuery = setEmpFiletrs(listOfFilters);
	try {
...
public String pullLeaveEncashment(SalaryProcess bean,String path,String []listOfFilters){
	String result = "0";
	String filterQuery = setEmpFiletrs(listOfFilters);
	try{
...
public String pullAllowance(SalaryProcess bean,String path,String []listOfFilters){
	String result = "0";
	String filterQuery = setEmpFiletrs(listOfFilters);
	try{
...
public void addRecovery(SalaryProcess bean,String[] listOfFilters){
	...
	String empPrevCredits = "SELECT HRMS_SAL_CREDITS_" + prevYear
		...
		String ledgerInsertQuery = " INSERT INTO HRMS_ARREARS_LEDGER(ARREARS_CODE,ARREARS_REF_MONTH,ARREARS_REF_YEAR,ARREARS_STATUS,"
				...
				+ " VALUES(?,?,?,?,SYSDATE,?,?,?,?,?,?,'Y',?)";
		Object[][] ledgerObj = new Object[1][11];
