...
*/
			...
			if(intType.equals("N"))
			{
				 intrListQuery = " SELECT DISTINCT HRMS_REC_SCHINT.INT_CODE, INT_CAND_CODE, CAND_FIRST_NAME||' ' ||CAND_MID_NAME|| ' '||CAND_LAST_NAME, "
						+ " HRMS_REC_SCHINT.INT_REQS_CODE, REQS_NAME, RANK_NAME,RANK_ID, TO_CHAR(INT_DATE,'DD-MM-YYYY'), INT_TIME, INT_COMMENTS, ROUND_TYPE," //INT_NEW_ROUND_TYPE, "
				...
				intrListObj = getSqlModel().getSingleResult(intrListQuery);
				 ...
				 intrListQuery = " SELECT DISTINCT HRMS_REC_SCHINT.INT_CODE, INT_CAND_CODE,CAND_FIRST_NAME||' ' ||CAND_MID_NAME|| ' '||CAND_LAST_NAME, "
					+ " HRMS_REC_SCHINT.INT_REQS_CODE,REQS_NAME, RANK_NAME,RANK_ID, TO_CHAR(EVAL_CURRINT_DATE,'DD-MM-YYYY'), EVAL_CURRINT_TIME, EVAL_COMMENTS, ROUND_TYPE, " //INT_NEW_ROUND_TYPE, "
