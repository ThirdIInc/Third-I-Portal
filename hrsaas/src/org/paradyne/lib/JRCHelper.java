		...
		if (reportName == null || reportName.equals("")) {
			...
			for(int i = 0;i < tables.size();i++){
				...
				//	newTable = (ITable)origTable.clone(true);
					newTable = tables.findTableByAlias(origTable.getAlias());
					...
					System.out.println("#################################: ");
					System.out.println("origTable.getAlias() :"+origTable.getAlias());
					System.out.println("getAlias: "+origTable.getAlias());
					System.out.println("getName: "+origTable.getName());
					System.out.println("getQualifiedName: "+origTable.getQualifiedName());
				...
				//	newTable.setQualifiedName(origTable.getAlias());
					...
					connectionInfo = origTable.getConnectionInfo();
					newTable.setQualifiedName(username.toUpperCase()+"."+origTable.getName());
					...
					System.out.println("newTablegetQualifiedName: "+newTable.getQualifiedName());
					clientDoc.getDatabaseController().setTableLocation(origTable, newTable);
					//System.out.println("getDataFields: "+newTable.getDataFields());
					System.out.println("getOLDlias: "+origTable.getAlias());
					System.out.println("getNewAlias: "+newTable.getAlias());
				}
			}
		}
}catch(Exception e){
