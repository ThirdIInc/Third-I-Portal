...
public class LmsSqlModel {
	...
	org.paradyne.lib.LmsConnectionModel connModel = null;
	 ...
	 * @param dbConn
	 */
	public LmsSqlModel(java.sql.Connection dbConn) {
		this.dbConn = dbConn;
	}
	 ...
	 * @param context
	 */
	public LmsSqlModel(ServletContext context) {	
		this.context=context;
		this.connModel = new org.paradyne.lib.LmsConnectionModel();			
	}
	 ...
	 * @param session
	 */
	public LmsSqlModel(ServletContext context, HttpSession session) {
		this.context = context;
