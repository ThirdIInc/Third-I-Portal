...
public class ConnectionModel {
	...
	**/
	...
	private String otherDBconnection="NILL";
	/**
	 * Creates new pool
	 * @param context
	 * @param session
	**/
	public  void createPool(javax.servlet.ServletContext context,HttpSession session) {
		...
		try{
			//System.out.println("otherDBconnection  "+otherDBconnection);
			if(otherDBconnection.equals("NILL")) {
				poolName =(String)session.getAttribute("session_pool");//Get pool name from session
			} else {
				poolName =otherDBconnection;
			}
	...
	**/
	public synchronized org.paradyne.lib.DbConnectionBroker getPoolObject(javax.servlet.ServletContext context,HttpSession session) {
		//System.out.println("otherDBconnection 12 "+otherDBconnection);
		if(otherDBconnection.equals("NILL")) {
	...
	**/
	...
	public String getOtherDBconnection() {
		return otherDBconnection;
	}

	public void setOtherDBconnection(String otherDBconnection) {
		this.otherDBconnection = otherDBconnection;
	}
